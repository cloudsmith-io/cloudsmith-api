...
/*
ReposApiService Set the active GPG key for the Repository.
Set the active GPG key for the Repository.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param owner 
 * @param identifier 
 * @param optional nil or *ReposApiReposGpgCreateOpts - Optional Parameters:
     * @param "Data" (optional.Interface of ReposGpgCreate) - 

@return RepositoryGpgKey
*/

type ReposApiReposGpgCreateOpts struct { 
	Data optional.Interface
}

func (a *ReposApiService) ReposGpgCreate(ctx context.Context, owner string, identifier string, localVarOptionals *ReposApiReposGpgCreateOpts) (RepositoryGpgKey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/repos/{owner}/{identifier}/gpg/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", fmt.Sprintf("%v", owner), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"identifier"+"}", fmt.Sprintf("%v", identifier), -1)
	...
	if localVarOptionals != nil && localVarOptionals.Data.IsSet() {
		...
		localVarOptionalData, localVarOptionalDataok := localVarOptionals.Data.Value().(ReposGpgCreate)
		if !localVarOptionalDataok {
				return localVarReturnValue, nil, reportError("data should be ReposGpgCreate")
		}
		localVarPostBody = &localVarOptionalData
	}
	if ctx != nil {
...
/*
ReposApiService Retrieve the active GPG key for the Repository.
...
@return RepositoryGpgKey
*/
func (a *ReposApiService) ReposGpgList(ctx context.Context, owner string, identifier string) (RepositoryGpgKey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ReposApiService Regenerate GPG Key for the Repository.
...
@return RepositoryGpgKey
*/
func (a *ReposApiService) ReposGpgRegenerate(ctx context.Context, owner string, identifier string) (RepositoryGpgKey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/repos/{owner}/{identifier}/gpg/regenerate/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", fmt.Sprintf("%v", owner), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"identifier"+"}", fmt.Sprintf("%v", identifier), -1)
...
/*
ReposApiService Remove the specified repository privileges.
...
*/
func (a *ReposApiService) ReposPrivilegesDelete(ctx context.Context, owner string, identifier string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/repos/{owner}/{identifier}/privileges"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", fmt.Sprintf("%v", owner), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"identifier"+"}", fmt.Sprintf("%v", identifier), -1)
...
/*
ReposApiService List all explicity created privileges for the repository.
...
*/
func (a *ReposApiService) ReposPrivilegesList(ctx context.Context, owner string, identifier string) ([]RepositoryPrivilegeList, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ReposApiService Update the specified repository privileges.
...
*/
func (a *ReposApiService) ReposPrivilegesPartialUpdate(ctx context.Context, owner string, identifier string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ReposApiService Replace all existing repository privileges with those specified.
...
@return RepositoryPrivilegeList
*/
func (a *ReposApiService) ReposPrivilegesUpdate(ctx context.Context, owner string, identifier string) (RepositoryPrivilegeList, *http.Response, error) {
	var (
...
/*
ReposApiService Set the active RSA key for the Repository.
Set the active RSA key for the Repository.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param owner 
 * @param identifier 
 * @param optional nil or *ReposApiReposRsaCreateOpts - Optional Parameters:
     * @param "Data" (optional.Interface of ReposRsaCreate) - 

@return RepositoryRsaKey
*/

type ReposApiReposRsaCreateOpts struct { 
	Data optional.Interface
}

func (a *ReposApiService) ReposRsaCreate(ctx context.Context, owner string, identifier string, localVarOptionals *ReposApiReposRsaCreateOpts) (RepositoryRsaKey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/repos/{owner}/{identifier}/rsa/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", fmt.Sprintf("%v", owner), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"identifier"+"}", fmt.Sprintf("%v", identifier), -1)
	...
	if localVarOptionals != nil && localVarOptionals.Data.IsSet() {
		...
		localVarOptionalData, localVarOptionalDataok := localVarOptionals.Data.Value().(ReposRsaCreate)
		if !localVarOptionalDataok {
				return localVarReturnValue, nil, reportError("data should be ReposRsaCreate")
		}
		localVarPostBody = &localVarOptionalData
	}
	if ctx != nil {
...
/*
ReposApiService Retrieve the active RSA key for the Repository.
...
@return RepositoryRsaKey
*/
func (a *ReposApiService) ReposRsaList(ctx context.Context, owner string, identifier string) (RepositoryRsaKey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ReposApiService Regenerate RSA Key for the Repository.
...
@return RepositoryRsaKey
*/
func (a *ReposApiService) ReposRsaRegenerate(ctx context.Context, owner string, identifier string) (RepositoryRsaKey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/repos/{owner}/{identifier}/rsa/regenerate/"
	localVarPath = strings.Replace(localVarPath, "{"+"owner"+"}", fmt.Sprintf("%v", owner), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"identifier"+"}", fmt.Sprintf("%v", identifier), -1)
