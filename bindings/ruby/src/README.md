...
```shell
gem install ./cloudsmith-api-1.181.0.gem
```
(for development, run `gem install --dev ./cloudsmith-api-1.181.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cloudsmith-api', '~> 1.181.0'
