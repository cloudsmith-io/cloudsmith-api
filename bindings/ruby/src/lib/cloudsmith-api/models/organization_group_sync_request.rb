...
module CloudsmithApi
  class OrganizationGroupSyncRequest
    ...
    def valid?
      ...
      return false if @team !~ Regexp.new(/^[-a-zA-Z0-9_]+$/)
      true
    end
    ...
    def hash
      [idp_key, idp_value, organization, role, team].hash
    end
