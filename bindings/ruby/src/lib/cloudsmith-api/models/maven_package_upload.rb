...
module CloudsmithApi
  ...
  class MavenPackageUpload
    ...
    def hash
      [files, stage_updated_at, artifact_id, is_sync_failed, distro_version, checksum_sha256, repository_url, is_sync_in_progress, size, status_str, is_sync_awaiting, repository, subtype, status_url, status_updated_at, namespace, sync_finished_at, filename, sync_progress, group_id, epoch, version, is_sync_in_flight, namespace_url, slug_perm, indexed, uploader_url, cdn_url, checksum_sha1, distro, status, checksum_sha512, description, name, format, is_sync_completed, downloads, version_orig, architectures, uploader, status_reason, self_html_url, stage, self_url, packaging, slug, uploaded_at, license, extension, stage_str, package_type, summary, num_files, checksum_md5, release, type_display, format_url].hash
    end
