...
class DebUpstream
  ...
  attr_accessor :gpg_key_fingerprint_short
  ...
  def self.swagger_types
    {
      ...
      :'gpg_key_fingerprint_short' => :'String',
  ...
  def initialize(attributes = {})
    ...
    if attributes.has_key?(:'gpg_key_fingerprint_short')
      self.gpg_key_fingerprint_short = attributes[:'gpg_key_fingerprint_short']
    end
  ...
  def ==(o)
    ...
    self.class == o.class &&
        ...
        gpg_key_fingerprint_short == o.gpg_key_fingerprint_short &&
  ...
  def hash
    [auth_mode, auth_secret, auth_username, available, can_reindex, component, created_at, disable_reason, disable_reason_text, distro_versions, extra_header_1, extra_header_2, extra_value_1, extra_value_2, gpg_key_fingerprint_short, gpg_key_inline, gpg_key_url, gpg_verification, has_failed_signature_verification, include_sources, index_package_count, index_status, is_active, last_indexed, mode, name, pending_validation, priority, slug_perm, updated_at, upstream_distribution, upstream_url, verification_status, verify_ssl].hash
  end
