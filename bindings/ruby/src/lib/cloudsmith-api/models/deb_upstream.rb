...
class DebUpstream
  ...
  def hash
    [auth_mode, auth_secret, auth_username, component, created_at, distro_versions, extra_header_1, extra_header_2, extra_value_1, extra_value_2, include_sources, is_active, mode, name, priority, slug_perm, updated_at, upstream_distribution, upstream_url, verify_ssl].hash
  end
