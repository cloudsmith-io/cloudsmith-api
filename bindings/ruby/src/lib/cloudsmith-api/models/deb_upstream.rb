...
class DebUpstream
  ...
  def hash
    [auth_mode, auth_secret, auth_username, component, created_at, disable_reason, distro_versions, extra_header_1, extra_header_2, extra_value_1, extra_value_2, gpg_key_inline, gpg_key_url, gpg_verification, include_sources, is_active, mode, name, pending_validation, priority, slug_perm, updated_at, upstream_distribution, upstream_url, verification_status, verify_ssl].hash
  end
