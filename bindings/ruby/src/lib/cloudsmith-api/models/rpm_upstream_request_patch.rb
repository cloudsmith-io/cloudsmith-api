...
class RpmUpstreamRequestPatch
  ...
  def hash
    [auth_mode, auth_secret, auth_username, distro_version, extra_header_1, extra_header_2, extra_value_1, extra_value_2, include_sources, is_active, mode, name, priority, upstream_url, verify_ssl].hash
  end
