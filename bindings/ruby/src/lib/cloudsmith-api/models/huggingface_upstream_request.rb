...
class HuggingfaceUpstreamRequest
  ...
  def valid?
    auth_mode_validator = EnumAttributeValidator.new('String', ['None', 'Token'])
  ...
  def auth_mode=(auth_mode)
    validator = EnumAttributeValidator.new('String', ['None', 'Token'])
