...
class PackageDenyPolicy
  ...
  def list_invalid_properties
    ...
    if @package_query_string.nil?
      invalid_properties.push('invalid value for "package_query_string", package_query_string cannot be nil.')
    end
  ...
  def valid?
    action_validator = EnumAttributeValidator.new('String', ['Block downloads'])
    return false unless action_validator.valid?(@action)
    return false if @package_query_string.nil?
  ...
  def action=(action)
    validator = EnumAttributeValidator.new('String', ['Block downloads'])
  ...
  def hash
    [action, created_at, description, enabled, name, package_query_string, slug_perm, status, updated_at].hash
  end
