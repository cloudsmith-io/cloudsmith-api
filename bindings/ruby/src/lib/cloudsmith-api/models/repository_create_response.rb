...
module CloudsmithApi
  class RepositoryCreateResponse
    ...
    def list_invalid_properties
      ...
      if @name !~ Regexp.new(/^\\w[\\w \\-'\\.\/]+$/)
        invalid_properties.push('invalid value for "name", must conform to the pattern /^\\w[\\w \\-'\\.\/]+$/.')
      end

      if !@namespace.nil? && @namespace !~ Regexp.new(/^[-a-zA-Z0-9_]+$/)
        invalid_properties.push('invalid value for "namespace", must conform to the pattern /^[-a-zA-Z0-9_]+$/.')
      end
    ...
    def valid?
      ...
      return false if @name !~ Regexp.new(/^\\w[\\w \\-'\\.\/]+$/)
      return false if !@namespace.nil? && @namespace !~ Regexp.new(/^[-a-zA-Z0-9_]+$/)
    ...
    def name=(name)
      ...
      if name !~ Regexp.new(/^\\w[\\w \\-'\\.\/]+$/)
        fail ArgumentError, 'invalid value for "name", must conform to the pattern /^\\w[\\w \\-'\\.\/]+$/.'
      end
    ...
    def namespace=(namespace)
      if !namespace.nil? && namespace !~ Regexp.new(/^[-a-zA-Z0-9_]+$/)
        fail ArgumentError, 'invalid value for "namespace", must conform to the pattern /^[-a-zA-Z0-9_]+$/.'
      end
