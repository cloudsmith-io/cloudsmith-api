...
class CocoapodsPackageUploadResponse
  ...
  def list_invalid_properties
    ...
    if !@dependencies_checksum_md5.nil? && @dependencies_checksum_md5.to_s.length < 1
      invalid_properties.push('invalid value for "dependencies_checksum_md5", the character length must be great than or equal to 1.')
    end
    ...
    if !@format.nil? && @format.to_s.length < 1
      invalid_properties.push('invalid value for "format", the character length must be great than or equal to 1.')
    end


    if !@identifier_perm.nil? && @identifier_perm.to_s.length < 1
      invalid_properties.push('invalid value for "identifier_perm", the character length must be great than or equal to 1.')
    end


    if !@license.nil? && @license.to_s.length < 1
    ...
    if !@origin_repository.nil? && @origin_repository.to_s.length < 1
      invalid_properties.push('invalid value for "origin_repository", the character length must be great than or equal to 1.')
    end
    ...
    if !@repository.nil? && @repository.to_s.length < 1
      invalid_properties.push('invalid value for "repository", the character length must be great than or equal to 1.')
    end
    ...
    if !@uploader.nil? && @uploader.to_s.length < 1
      invalid_properties.push('invalid value for "uploader", the character length must be great than or equal to 1.')
    end
  ...
  def valid?
    return false if !@dependencies_checksum_md5.nil? && @dependencies_checksum_md5.to_s.length < 1
    return false if !@description.nil? && @description.to_s.length < 1
    return false if !@filename.nil? && @filename.to_s.length < 1
    return false if !@format.nil? && @format.to_s.length < 1
    return false if !@identifier_perm.nil? && @identifier_perm.to_s.length < 1
    return false if !@license.nil? && @license.to_s.length < 1
    return false if !@name.nil? && @name.to_s.length < 1
    return false if !@namespace.nil? && @namespace.to_s.length < 1
    return false if !@origin_repository.nil? && @origin_repository.to_s.length < 1
    return false if !@release.nil? && @release.to_s.length < 1
    return false if !@repository.nil? && @repository.to_s.length < 1
    ...
    return false if !@uploader.nil? && @uploader.to_s.length < 1
    return false if !@version.nil? && @version.to_s.length < 1
    true
  end

  # Custom attribute writer method with validation
  # @param [Object] dependencies_checksum_md5 Value to be assigned
  def dependencies_checksum_md5=(dependencies_checksum_md5)
    if !dependencies_checksum_md5.nil? && dependencies_checksum_md5.to_s.length < 1
      fail ArgumentError, 'invalid value for "dependencies_checksum_md5", the character length must be great than or equal to 1.'
    end
  ...
  def format=(format)
    if !format.nil? && format.to_s.length < 1
      fail ArgumentError, 'invalid value for "format", the character length must be great than or equal to 1.'
    end
  ...
  # Custom attribute writer method with validation
  # @param [Object] identifier_perm Value to be assigned
  def identifier_perm=(identifier_perm)
    if !identifier_perm.nil? && identifier_perm.to_s.length < 1
      fail ArgumentError, 'invalid value for "identifier_perm", the character length must be great than or equal to 1.'
    end
  ...
  def origin_repository=(origin_repository)
    if !origin_repository.nil? && origin_repository.to_s.length < 1
      fail ArgumentError, 'invalid value for "origin_repository", the character length must be great than or equal to 1.'
    end
  ...
  def repository=(repository)
    if !repository.nil? && repository.to_s.length < 1
      fail ArgumentError, 'invalid value for "repository", the character length must be great than or equal to 1.'
    end
  ...
  # Custom attribute writer method with validation
  # @param [Object] uploader Value to be assigned
  def uploader=(uploader)
    if !uploader.nil? && uploader.to_s.length < 1
      fail ArgumentError, 'invalid value for "uploader", the character length must be great than or equal to 1.'
    end
