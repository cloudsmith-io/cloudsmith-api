...
class DebUpstreamRequestPatch
  ...
  def hash
    [auth_mode, auth_secret, auth_username, component, distro_versions, extra_header_1, extra_header_2, extra_value_1, extra_value_2, gpg_key_inline, gpg_key_url, gpg_verification, include_sources, is_active, mode, name, priority, upstream_distribution, upstream_url, verify_ssl].hash
  end
