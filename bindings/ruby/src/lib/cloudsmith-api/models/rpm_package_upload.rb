...
module CloudsmithApi
  ...
  class RpmPackageUpload
    ...
    def hash
      [status, stage_updated_at, checksum_sha512, is_sync_failed, sync_finished_at, checksum_sha256, repository_url, is_sync_in_progress, size, status_str, is_sync_awaiting, num_files, status_url, status_updated_at, namespace, distro_version, filename, sync_progress, epoch, version, is_sync_in_flight, namespace_url, slug_perm, uploader_url, checksum_sha1, distro, files, cdn_url, description, repository, format, is_sync_completed, downloads, version_orig, architectures, uploader, self_html_url, stage, self_url, slug, uploaded_at, name, license, stage_str, package_type, summary, subtype, checksum_md5, extension, release, type_display, format_url].hash
    end
