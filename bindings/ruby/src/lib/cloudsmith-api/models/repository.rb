...
class Repository
  ...
  attr_accessor :generic_package_index_enabled
  ...
  attr_accessor :num_policy_violated_packages

  # Number of quarantined packages in a repository.
  attr_accessor :num_quarantined_packages
  ...
  attr_accessor :package_count_excl_subcomponents
  ...
  def self.swagger_types
    {
      ...
      :'ecdsa_keys' => :'Array<RepositoryEcdsaKey>',
      ...
      :'package_count_excl_subcomponents' => :'Integer',
  ...
  def initialize(attributes = {})
    ...
    if attributes.has_key?(:'ecdsa_keys')
      if (value = attributes[:'ecdsa_keys']).is_a?(Array)
        self.ecdsa_keys = value
      end
    end
    ...
    if attributes.has_key?(:'generic_package_index_enabled')
    ...
    if attributes.has_key?(:'num_policy_violated_packages')
      self.num_policy_violated_packages = attributes[:'num_policy_violated_packages']
    end

    if attributes.has_key?(:'num_quarantined_packages')
      self.num_quarantined_packages = attributes[:'num_quarantined_packages']
    end
    ...
    if attributes.has_key?(:'package_count_excl_subcomponents')
      self.package_count_excl_subcomponents = attributes[:'package_count_excl_subcomponents']
    end
  ...
  def valid?
    broadcast_state_validator = EnumAttributeValidator.new('String', ['Off', 'Private', 'Internal', 'Public', 'Open-Source'])
    return false unless broadcast_state_validator.valid?(@broadcast_state)
  ...
  # @param [Object] broadcast_state Object to be assigned
  def broadcast_state=(broadcast_state)
    validator = EnumAttributeValidator.new('String', ['Off', 'Private', 'Internal', 'Public', 'Open-Source'])
    unless validator.valid?(broadcast_state)
      fail ArgumentError, 'invalid value for "broadcast_state", must be one of #{validator.allowable_values}.'
    end
    @broadcast_state = broadcast_state
  end
  ...
  def ==(o)
    ...
    self.class == o.class &&
        ...
        package_count_excl_subcomponents == o.package_count_excl_subcomponents &&
