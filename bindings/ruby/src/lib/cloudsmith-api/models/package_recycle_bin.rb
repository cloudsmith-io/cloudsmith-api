...
class PackageRecycleBin
  ...
  def valid?
    ...
    action_validator = EnumAttributeValidator.new('String', ['hard_delete', 'restore'])
  ...
  def action=(action)
    validator = EnumAttributeValidator.new('String', ['hard_delete', 'restore'])
  ...
  def hash
    [action, identifiers, repository].hash
  end
