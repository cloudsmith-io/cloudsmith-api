...
class PackageBulkAction
  ...
  def valid?
    ...
    action_validator = EnumAttributeValidator.new('String', ['Delete', 'Resync', 'Quarantine', 'Unquarantine', 'Move', 'Copy', 'Rescan'])
  ...
  def action=(action)
    validator = EnumAttributeValidator.new('String', ['Delete', 'Resync', 'Quarantine', 'Unquarantine', 'Move', 'Copy', 'Rescan'])
  ...
  def hash
    [action, identifiers, repository, target_repository].hash
  end
