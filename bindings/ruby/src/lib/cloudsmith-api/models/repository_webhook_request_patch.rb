...
module CloudsmithApi
  class RepositoryWebhookRequestPatch
    ...
    def valid?
      ...
      return false if !@target_url.nil? && @target_url.to_s.length > 255
      return false if !@target_url.nil? && @target_url.to_s.length < 1
      true
    end
