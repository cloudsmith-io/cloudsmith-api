...
module CloudsmithApi
  ...
  class PackagesValidateuploadConan
    # Conan channel.
    ...
    def hash
      [conan_channel, conan_prefix, info_file, manifest_file, metadata_file, name, package_file, republish, security_scan_status, tags, version].hash
    end
