...
module CloudsmithApi
  class NamespaceAuditLogResponse
    attr_accessor :actor
    ...
    attr_accessor :target_slug_perm
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'target_kind')
        self.target_kind = attributes[:'target_kind']
      end

      if attributes.has_key?(:'target_slug_perm')
        self.target_slug_perm = attributes[:'target_slug_perm']
      end
    ...
    def list_invalid_properties
      ...
      if !@target_slug_perm.nil? && @target_slug_perm !~ Regexp.new(/^[-a-zA-Z0-9_]+$/)
        invalid_properties.push('invalid value for "target_slug_perm", must conform to the pattern /^[-a-zA-Z0-9_]+$/.')
      end
    ...
    def valid?
      ...
      return false if !@target_slug_perm.nil? && @target_slug_perm !~ Regexp.new(/^[-a-zA-Z0-9_]+$/)
      true
    end
    ...
    def target_slug_perm=(target_slug_perm)
      ...
      if !target_slug_perm.nil? && target_slug_perm !~ Regexp.new(/^[-a-zA-Z0-9_]+$/)
        fail ArgumentError, 'invalid value for "target_slug_perm", must conform to the pattern /^[-a-zA-Z0-9_]+$/.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target_slug_perm == o.target_slug_perm &&
          uuid == o.uuid
    end
    ...
    def hash
      [actor, actor_ip_address, actor_kind, actor_location, actor_slug_perm, actor_url, context, event, event_at, object, object_kind, object_slug_perm, target, target_kind, target_slug_perm, uuid].hash
    end
