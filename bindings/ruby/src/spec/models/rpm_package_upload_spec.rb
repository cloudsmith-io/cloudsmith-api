...
# Unit tests for CloudsmithApi::RpmPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RpmPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::RpmPackageUpload.new
  end
  ...
  describe 'test an instance of RpmPackageUpload' do
    it 'should create an instance of RpmPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::RpmPackageUpload)
    end
  end
