...
# Unit tests for CloudsmithApi::PackageResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageResponse.new
  end
  ...
  describe 'test an instance of PackageResponse' do
    it 'should create an instance of PackageResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageResponse)
    end
  end
