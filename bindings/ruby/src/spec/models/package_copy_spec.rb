...
# Unit tests for CloudsmithApi::PackageCopy
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageCopy' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageCopy.new
  end
  ...
  describe 'test an instance of PackageCopy' do
    it 'should create an instance of PackageCopy' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageCopy)
    end
  end
