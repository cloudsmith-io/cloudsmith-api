...
# Unit tests for CloudsmithApi::DistributionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DistributionResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::DistributionResponse.new
  end
  ...
  describe 'test an instance of DistributionResponse' do
    it 'should create an instance of DistributionResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::DistributionResponse)
    end
  end
