...
# Unit tests for CloudsmithApi::HexUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HexUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::HexUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of HexUpstreamRequestPatch' do
    it 'should create an instance of HexUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::HexUpstreamRequestPatch)
    end
  end
