...
# Unit tests for CloudsmithApi::VsxPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VsxPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::VsxPackageUpload.new
  end
  ...
  describe 'test an instance of VsxPackageUpload' do
    it 'should create an instance of VsxPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::VsxPackageUpload)
    end
  end
