...
# Unit tests for CloudsmithApi::ComposerPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComposerPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::ComposerPackageUpload.new
  end
  ...
  describe 'test an instance of ComposerPackageUpload' do
    it 'should create an instance of ComposerPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::ComposerPackageUpload)
    end
  end
