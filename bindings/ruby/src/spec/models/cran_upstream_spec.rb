...
# Unit tests for CloudsmithApi::CranUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CranUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::CranUpstream.new
  end
  ...
  describe 'test an instance of CranUpstream' do
    it 'should create an instance of CranUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::CranUpstream)
    end
  end
