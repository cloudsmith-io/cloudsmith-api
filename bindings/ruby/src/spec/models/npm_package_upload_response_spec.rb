...
# Unit tests for CloudsmithApi::NpmPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NpmPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::NpmPackageUploadResponse.new
  end
  ...
  describe 'test an instance of NpmPackageUploadResponse' do
    it 'should create an instance of NpmPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::NpmPackageUploadResponse)
    end
  end
