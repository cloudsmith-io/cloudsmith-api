...
# Unit tests for CloudsmithApi::NixUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NixUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::NixUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of NixUpstreamRequestPatch' do
    it 'should create an instance of NixUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::NixUpstreamRequestPatch)
    end
  end
