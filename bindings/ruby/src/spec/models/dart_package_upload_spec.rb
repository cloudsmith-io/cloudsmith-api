...
# Unit tests for CloudsmithApi::DartPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DartPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::DartPackageUpload.new
  end
  ...
  describe 'test an instance of DartPackageUpload' do
    it 'should create an instance of DartPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::DartPackageUpload)
    end
  end
