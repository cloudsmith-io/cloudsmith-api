...
# Unit tests for CloudsmithApi::PackageResync
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageResync' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageResync.new
  end
  ...
  describe 'test an instance of PackageResync' do
    it 'should create an instance of PackageResync' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageResync)
    end
  end
