...
# Unit tests for CloudsmithApi::CranPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CranPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::CranPackageUpload.new
  end
  ...
  describe 'test an instance of CranPackageUpload' do
    it 'should create an instance of CranPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::CranPackageUpload)
    end
  end
