...
# Unit tests for CloudsmithApi::GoUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::GoUpstreamRequest.new
  end
  ...
  describe 'test an instance of GoUpstreamRequest' do
    it 'should create an instance of GoUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::GoUpstreamRequest)
    end
  end
