...
# Unit tests for CloudsmithApi::CargoUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CargoUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::CargoUpstreamRequest.new
  end
  ...
  describe 'test an instance of CargoUpstreamRequest' do
    it 'should create an instance of CargoUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::CargoUpstreamRequest)
    end
  end
