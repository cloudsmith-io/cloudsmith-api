...
# Unit tests for CloudsmithApi::ConanPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConanPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::ConanPackageUpload.new
  end
  ...
  describe 'test an instance of ConanPackageUpload' do
    it 'should create an instance of ConanPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::ConanPackageUpload)
    end
  end
