...
# Unit tests for CloudsmithApi::ComposerUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComposerUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::ComposerUpstreamRequest.new
  end
  ...
  describe 'test an instance of ComposerUpstreamRequest' do
    it 'should create an instance of ComposerUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::ComposerUpstreamRequest)
    end
  end
