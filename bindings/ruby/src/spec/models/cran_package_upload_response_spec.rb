...
# Unit tests for CloudsmithApi::CranPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CranPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::CranPackageUploadResponse.new
  end
  ...
  describe 'test an instance of CranPackageUploadResponse' do
    it 'should create an instance of CranPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::CranPackageUploadResponse)
    end
  end
