...
# Unit tests for CloudsmithApi::McpPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'McpPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::McpPackageUpload.new
  end
  ...
  describe 'test an instance of McpPackageUpload' do
    it 'should create an instance of McpPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::McpPackageUpload)
    end
  end
