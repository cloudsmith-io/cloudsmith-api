...
# Unit tests for CloudsmithApi::PackageQuarantineResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageQuarantineResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageQuarantineResponse.new
  end
  ...
  describe 'test an instance of PackageQuarantineResponse' do
    it 'should create an instance of PackageQuarantineResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageQuarantineResponse)
    end
  end
