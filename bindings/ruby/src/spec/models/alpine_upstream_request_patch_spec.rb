...
# Unit tests for CloudsmithApi::AlpineUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlpineUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::AlpineUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of AlpineUpstreamRequestPatch' do
    it 'should create an instance of AlpineUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::AlpineUpstreamRequestPatch)
    end
  end
