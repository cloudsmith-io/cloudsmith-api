...
# Unit tests for CloudsmithApi::PackageResyncResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageResyncResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageResyncResponse.new
  end
  ...
  describe 'test an instance of PackageResyncResponse' do
    it 'should create an instance of PackageResyncResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageResyncResponse)
    end
  end
