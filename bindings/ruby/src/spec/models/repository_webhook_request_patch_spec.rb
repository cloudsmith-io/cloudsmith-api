...
# Unit tests for CloudsmithApi::RepositoryWebhookRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoryWebhookRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::RepositoryWebhookRequestPatch.new
  end
  ...
  describe 'test an instance of RepositoryWebhookRequestPatch' do
    it 'should create an instance of RepositoryWebhookRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::RepositoryWebhookRequestPatch)
    end
  end
