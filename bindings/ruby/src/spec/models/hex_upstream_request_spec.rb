...
# Unit tests for CloudsmithApi::HexUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HexUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::HexUpstreamRequest.new
  end
  ...
  describe 'test an instance of HexUpstreamRequest' do
    it 'should create an instance of HexUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::HexUpstreamRequest)
    end
  end
