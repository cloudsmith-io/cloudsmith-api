...
# Unit tests for CloudsmithApi::GoUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::GoUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of GoUpstreamRequestPatch' do
    it 'should create an instance of GoUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::GoUpstreamRequestPatch)
    end
  end
