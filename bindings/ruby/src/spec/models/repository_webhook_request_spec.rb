...
# Unit tests for CloudsmithApi::RepositoryWebhookRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoryWebhookRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::RepositoryWebhookRequest.new
  end
  ...
  describe 'test an instance of RepositoryWebhookRequest' do
    it 'should create an instance of RepositoryWebhookRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::RepositoryWebhookRequest)
    end
  end
