...
# Unit tests for CloudsmithApi::NugetUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NugetUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::NugetUpstream.new
  end
  ...
  describe 'test an instance of NugetUpstream' do
    it 'should create an instance of NugetUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::NugetUpstream)
    end
  end
