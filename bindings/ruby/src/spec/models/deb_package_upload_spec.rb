...
# Unit tests for CloudsmithApi::DebPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DebPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::DebPackageUpload.new
  end
  ...
  describe 'test an instance of DebPackageUpload' do
    it 'should create an instance of DebPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::DebPackageUpload)
    end
  end
