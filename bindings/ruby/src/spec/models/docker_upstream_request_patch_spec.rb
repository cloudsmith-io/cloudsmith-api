...
# Unit tests for CloudsmithApi::DockerUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DockerUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::DockerUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of DockerUpstreamRequestPatch' do
    it 'should create an instance of DockerUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::DockerUpstreamRequestPatch)
    end
  end
