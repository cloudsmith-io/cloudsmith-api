...
# Unit tests for CloudsmithApi::CondaUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CondaUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::CondaUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of CondaUpstreamRequestPatch' do
    it 'should create an instance of CondaUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::CondaUpstreamRequestPatch)
    end
  end
