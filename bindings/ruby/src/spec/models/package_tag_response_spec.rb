...
# Unit tests for CloudsmithApi::PackageTagResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageTagResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageTagResponse.new
  end
  ...
  describe 'test an instance of PackageTagResponse' do
    it 'should create an instance of PackageTagResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageTagResponse)
    end
  end
