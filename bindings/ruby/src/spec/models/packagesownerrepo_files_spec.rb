...
# Unit tests for CloudsmithApi::PackagesownerrepoFiles
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackagesownerrepoFiles' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackagesownerrepoFiles.new
  end
  ...
  describe 'test an instance of PackagesownerrepoFiles' do
    it 'should create an instance of PackagesownerrepoFiles' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackagesownerrepoFiles)
    end
  end
