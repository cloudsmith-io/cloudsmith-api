...
# Unit tests for CloudsmithApi::CargoUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CargoUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::CargoUpstream.new
  end
  ...
  describe 'test an instance of CargoUpstream' do
    it 'should create an instance of CargoUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::CargoUpstream)
    end
  end
