...
# Unit tests for CloudsmithApi::ComposerUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComposerUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::ComposerUpstream.new
  end
  ...
  describe 'test an instance of ComposerUpstream' do
    it 'should create an instance of ComposerUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::ComposerUpstream)
    end
  end
