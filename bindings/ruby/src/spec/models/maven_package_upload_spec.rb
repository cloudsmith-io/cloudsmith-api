...
# Unit tests for CloudsmithApi::MavenPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MavenPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::MavenPackageUpload.new
  end
  ...
  describe 'test an instance of MavenPackageUpload' do
    it 'should create an instance of MavenPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::MavenPackageUpload)
    end
  end
