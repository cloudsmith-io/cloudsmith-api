...
# Unit tests for CloudsmithApi::LuarocksPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LuarocksPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::LuarocksPackageUpload.new
  end
  ...
  describe 'test an instance of LuarocksPackageUpload' do
    it 'should create an instance of LuarocksPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::LuarocksPackageUpload)
    end
  end
