...
# Unit tests for CloudsmithApi::OrganizationMembershipRoleUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganizationMembershipRoleUpdate' do
  before do
    # run before each test
    @instance = CloudsmithApi::OrganizationMembershipRoleUpdate.new
  end
  ...
  describe 'test an instance of OrganizationMembershipRoleUpdate' do
    it 'should create an instance of OrganizationMembershipRoleUpdate' do
      expect(@instance).to be_instance_of(CloudsmithApi::OrganizationMembershipRoleUpdate)
    end
  end
