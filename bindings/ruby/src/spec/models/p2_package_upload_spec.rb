...
# Unit tests for CloudsmithApi::P2PackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'P2PackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::P2PackageUpload.new
  end
  ...
  describe 'test an instance of P2PackageUpload' do
    it 'should create an instance of P2PackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::P2PackageUpload)
    end
  end
