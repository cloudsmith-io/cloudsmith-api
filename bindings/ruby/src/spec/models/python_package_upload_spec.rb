...
# Unit tests for CloudsmithApi::PythonPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PythonPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::PythonPackageUpload.new
  end
  ...
  describe 'test an instance of PythonPackageUpload' do
    it 'should create an instance of PythonPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::PythonPackageUpload)
    end
  end
