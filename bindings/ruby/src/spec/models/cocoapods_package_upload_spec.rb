...
# Unit tests for CloudsmithApi::CocoapodsPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CocoapodsPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::CocoapodsPackageUpload.new
  end
  ...
  describe 'test an instance of CocoapodsPackageUpload' do
    it 'should create an instance of CocoapodsPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::CocoapodsPackageUpload)
    end
  end
