...
# Unit tests for CloudsmithApi::CargoPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CargoPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::CargoPackageUpload.new
  end
  ...
  describe 'test an instance of CargoPackageUpload' do
    it 'should create an instance of CargoPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::CargoPackageUpload)
    end
  end
