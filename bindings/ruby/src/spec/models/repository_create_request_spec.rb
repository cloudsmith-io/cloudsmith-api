...
# Unit tests for CloudsmithApi::RepositoryCreateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoryCreateRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::RepositoryCreateRequest.new
  end
  ...
  describe 'test an instance of RepositoryCreateRequest' do
    it 'should create an instance of RepositoryCreateRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::RepositoryCreateRequest)
    end
  end
