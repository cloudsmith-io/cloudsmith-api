...
# Unit tests for CloudsmithApi::RawPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RawPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::RawPackageUploadResponse.new
  end
  ...
  describe 'test an instance of RawPackageUploadResponse' do
    it 'should create an instance of RawPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::RawPackageUploadResponse)
    end
  end
