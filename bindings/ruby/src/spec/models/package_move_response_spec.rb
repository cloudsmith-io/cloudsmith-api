...
# Unit tests for CloudsmithApi::PackageMoveResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageMoveResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageMoveResponse.new
  end
  ...
  describe 'test an instance of PackageMoveResponse' do
    it 'should create an instance of PackageMoveResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageMoveResponse)
    end
  end
