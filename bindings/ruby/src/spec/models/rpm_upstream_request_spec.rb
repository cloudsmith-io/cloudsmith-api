...
# Unit tests for CloudsmithApi::RpmUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RpmUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::RpmUpstreamRequest.new
  end
  ...
  describe 'test an instance of RpmUpstreamRequest' do
    it 'should create an instance of RpmUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::RpmUpstreamRequest)
    end
  end
