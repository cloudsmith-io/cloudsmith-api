...
# Unit tests for CloudsmithApi::CondaUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CondaUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::CondaUpstream.new
  end
  ...
  describe 'test an instance of CondaUpstream' do
    it 'should create an instance of CondaUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::CondaUpstream)
    end
  end
