...
# Unit tests for CloudsmithApi::CargoUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CargoUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::CargoUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of CargoUpstreamRequestPatch' do
    it 'should create an instance of CargoUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::CargoUpstreamRequestPatch)
    end
  end
