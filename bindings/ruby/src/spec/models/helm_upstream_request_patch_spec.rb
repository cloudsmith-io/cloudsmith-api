...
# Unit tests for CloudsmithApi::HelmUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HelmUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::HelmUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of HelmUpstreamRequestPatch' do
    it 'should create an instance of HelmUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::HelmUpstreamRequestPatch)
    end
  end
