...
# Unit tests for CloudsmithApi::RawPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RawPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::RawPackageUpload.new
  end
  ...
  describe 'test an instance of RawPackageUpload' do
    it 'should create an instance of RawPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::RawPackageUpload)
    end
  end
