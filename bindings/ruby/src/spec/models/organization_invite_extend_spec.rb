...
# Unit tests for CloudsmithApi::OrganizationInviteExtend
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganizationInviteExtend' do
  before do
    # run before each test
    @instance = CloudsmithApi::OrganizationInviteExtend.new
  end
  ...
  describe 'test an instance of OrganizationInviteExtend' do
    it 'should create an instance of OrganizationInviteExtend' do
      expect(@instance).to be_instance_of(CloudsmithApi::OrganizationInviteExtend)
    end
  end
