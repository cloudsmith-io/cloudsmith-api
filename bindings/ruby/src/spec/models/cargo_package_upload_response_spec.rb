...
# Unit tests for CloudsmithApi::CargoPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CargoPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::CargoPackageUploadResponse.new
  end
  ...
  describe 'test an instance of CargoPackageUploadResponse' do
    it 'should create an instance of CargoPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::CargoPackageUploadResponse)
    end
  end
