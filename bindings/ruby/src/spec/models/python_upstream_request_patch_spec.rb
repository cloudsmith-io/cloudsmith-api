...
# Unit tests for CloudsmithApi::PythonUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PythonUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::PythonUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of PythonUpstreamRequestPatch' do
    it 'should create an instance of PythonUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::PythonUpstreamRequestPatch)
    end
  end
