...
# Unit tests for CloudsmithApi::RpmPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RpmPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::RpmPackageUploadResponse.new
  end
  ...
  describe 'test an instance of RpmPackageUploadResponse' do
    it 'should create an instance of RpmPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::RpmPackageUploadResponse)
    end
  end
