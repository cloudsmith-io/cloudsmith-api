...
# Unit tests for CloudsmithApi::MavenPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MavenPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::MavenPackageUploadResponse.new
  end
  ...
  describe 'test an instance of MavenPackageUploadResponse' do
    it 'should create an instance of MavenPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::MavenPackageUploadResponse)
    end
  end
