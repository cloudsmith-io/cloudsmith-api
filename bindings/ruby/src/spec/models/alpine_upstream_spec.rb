...
# Unit tests for CloudsmithApi::AlpineUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlpineUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::AlpineUpstream.new
  end
  ...
  describe 'test an instance of AlpineUpstream' do
    it 'should create an instance of AlpineUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::AlpineUpstream)
    end
  end
