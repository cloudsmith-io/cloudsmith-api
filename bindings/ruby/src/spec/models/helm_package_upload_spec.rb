...
# Unit tests for CloudsmithApi::HelmPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HelmPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::HelmPackageUpload.new
  end
  ...
  describe 'test an instance of HelmPackageUpload' do
    it 'should create an instance of HelmPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::HelmPackageUpload)
    end
  end
