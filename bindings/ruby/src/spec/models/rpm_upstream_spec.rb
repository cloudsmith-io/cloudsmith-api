...
# Unit tests for CloudsmithApi::RpmUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RpmUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::RpmUpstream.new
  end
  ...
  describe 'test an instance of RpmUpstream' do
    it 'should create an instance of RpmUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::RpmUpstream)
    end
  end
