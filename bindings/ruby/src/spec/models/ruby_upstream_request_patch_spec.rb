...
# Unit tests for CloudsmithApi::RubyUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RubyUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::RubyUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of RubyUpstreamRequestPatch' do
    it 'should create an instance of RubyUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::RubyUpstreamRequestPatch)
    end
  end
