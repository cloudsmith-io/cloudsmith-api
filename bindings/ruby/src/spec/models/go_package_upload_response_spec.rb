...
# Unit tests for CloudsmithApi::GoPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::GoPackageUploadResponse.new
  end
  ...
  describe 'test an instance of GoPackageUploadResponse' do
    it 'should create an instance of GoPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::GoPackageUploadResponse)
    end
  end
