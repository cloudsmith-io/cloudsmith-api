...
# Unit tests for CloudsmithApi::ConanPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConanPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::ConanPackageUploadResponse.new
  end
  ...
  describe 'test an instance of ConanPackageUploadResponse' do
    it 'should create an instance of ConanPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::ConanPackageUploadResponse)
    end
  end
