...
# Unit tests for CloudsmithApi::PackageStatusResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageStatusResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageStatusResponse.new
  end
  ...
  describe 'test an instance of PackageStatusResponse' do
    it 'should create an instance of PackageStatusResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageStatusResponse)
    end
  end
