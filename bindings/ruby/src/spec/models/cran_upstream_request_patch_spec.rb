...
# Unit tests for CloudsmithApi::CranUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CranUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::CranUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of CranUpstreamRequestPatch' do
    it 'should create an instance of CranUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::CranUpstreamRequestPatch)
    end
  end
