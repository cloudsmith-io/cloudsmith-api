...
# Unit tests for CloudsmithApi::HuggingfaceUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HuggingfaceUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::HuggingfaceUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of HuggingfaceUpstreamRequestPatch' do
    it 'should create an instance of HuggingfaceUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::HuggingfaceUpstreamRequestPatch)
    end
  end
  describe 'test attribute "auth_mode"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["None", "Token"])
