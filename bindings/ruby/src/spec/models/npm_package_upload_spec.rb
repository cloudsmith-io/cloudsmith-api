...
# Unit tests for CloudsmithApi::NpmPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NpmPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::NpmPackageUpload.new
  end
  ...
  describe 'test an instance of NpmPackageUpload' do
    it 'should create an instance of NpmPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::NpmPackageUpload)
    end
  end
