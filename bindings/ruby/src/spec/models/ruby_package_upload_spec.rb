...
# Unit tests for CloudsmithApi::RubyPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RubyPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::RubyPackageUpload.new
  end
  ...
  describe 'test an instance of RubyPackageUpload' do
    it 'should create an instance of RubyPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::RubyPackageUpload)
    end
  end
