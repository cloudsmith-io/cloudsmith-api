...
# Unit tests for CloudsmithApi::CranUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CranUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::CranUpstreamRequest.new
  end
  ...
  describe 'test an instance of CranUpstreamRequest' do
    it 'should create an instance of CranUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::CranUpstreamRequest)
    end
  end
