...
# Unit tests for CloudsmithApi::SwiftPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SwiftPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::SwiftPackageUpload.new
  end
  ...
  describe 'test an instance of SwiftPackageUpload' do
    it 'should create an instance of SwiftPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::SwiftPackageUpload)
    end
  end
