...
# Unit tests for CloudsmithApi::PythonPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PythonPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::PythonPackageUploadResponse.new
  end
  ...
  describe 'test an instance of PythonPackageUploadResponse' do
    it 'should create an instance of PythonPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::PythonPackageUploadResponse)
    end
  end
