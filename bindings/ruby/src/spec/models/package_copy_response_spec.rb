...
# Unit tests for CloudsmithApi::PackageCopyResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageCopyResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageCopyResponse.new
  end
  ...
  describe 'test an instance of PackageCopyResponse' do
    it 'should create an instance of PackageCopyResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageCopyResponse)
    end
  end
