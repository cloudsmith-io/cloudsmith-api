...
# Unit tests for CloudsmithApi::ComposerUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComposerUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::ComposerUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of ComposerUpstreamRequestPatch' do
    it 'should create an instance of ComposerUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::ComposerUpstreamRequestPatch)
    end
  end
