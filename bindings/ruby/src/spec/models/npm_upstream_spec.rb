...
# Unit tests for CloudsmithApi::NpmUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NpmUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::NpmUpstream.new
  end
  ...
  describe 'test an instance of NpmUpstream' do
    it 'should create an instance of NpmUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::NpmUpstream)
    end
  end
