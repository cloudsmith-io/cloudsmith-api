...
# Unit tests for CloudsmithApi::HuggingfaceUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HuggingfaceUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::HuggingfaceUpstreamRequest.new
  end
  ...
  describe 'test an instance of HuggingfaceUpstreamRequest' do
    it 'should create an instance of HuggingfaceUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::HuggingfaceUpstreamRequest)
    end
  end
