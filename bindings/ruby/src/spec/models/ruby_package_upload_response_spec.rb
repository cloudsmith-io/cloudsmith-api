...
# Unit tests for CloudsmithApi::RubyPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RubyPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::RubyPackageUploadResponse.new
  end
  ...
  describe 'test an instance of RubyPackageUploadResponse' do
    it 'should create an instance of RubyPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::RubyPackageUploadResponse)
    end
  end
