...
# Unit tests for CloudsmithApi::DockerUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DockerUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::DockerUpstreamRequest.new
  end
  ...
  describe 'test an instance of DockerUpstreamRequest' do
    it 'should create an instance of DockerUpstreamRequest' do
