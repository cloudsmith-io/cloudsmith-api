...
# Unit tests for CloudsmithApi::PackageMove
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageMove' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageMove.new
  end
  ...
  describe 'test an instance of PackageMove' do
    it 'should create an instance of PackageMove' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageMove)
    end
  end
