...
# Unit tests for CloudsmithApi::P2PackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'P2PackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::P2PackageUploadResponse.new
  end
  ...
  describe 'test an instance of P2PackageUploadResponse' do
    it 'should create an instance of P2PackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::P2PackageUploadResponse)
    end
  end
