...
# Unit tests for CloudsmithApi::GoPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::GoPackageUpload.new
  end
  ...
  describe 'test an instance of GoPackageUpload' do
    it 'should create an instance of GoPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::GoPackageUpload)
    end
  end
