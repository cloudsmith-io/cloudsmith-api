...
# Unit tests for CloudsmithApi::PackageDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageDetail' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageDetail.new
  end
  ...
  describe 'test an instance of PackageDetail' do
    it 'should create an instance of PackageDetail' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageDetail)
    end
  end
  ...
  describe 'test attribute "has_dependencies"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
