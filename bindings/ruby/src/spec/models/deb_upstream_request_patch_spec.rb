...
# Unit tests for CloudsmithApi::DebUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DebUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::DebUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of DebUpstreamRequestPatch' do
    it 'should create an instance of DebUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::DebUpstreamRequestPatch)
    end
  end
  ...
  describe 'test attribute "distro_versions"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "upstream_distribution"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
