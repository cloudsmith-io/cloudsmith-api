...
# Unit tests for CloudsmithApi::CondaPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CondaPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::CondaPackageUpload.new
  end
  ...
  describe 'test an instance of CondaPackageUpload' do
    it 'should create an instance of CondaPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::CondaPackageUpload)
    end
  end
