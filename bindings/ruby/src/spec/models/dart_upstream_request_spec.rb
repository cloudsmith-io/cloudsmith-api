...
# Unit tests for CloudsmithApi::DartUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DartUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::DartUpstreamRequest.new
  end
  ...
  describe 'test an instance of DartUpstreamRequest' do
    it 'should create an instance of DartUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::DartUpstreamRequest)
    end
  end
