...
# Unit tests for CloudsmithApi::NugetPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NugetPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::NugetPackageUploadResponse.new
  end
  ...
  describe 'test an instance of NugetPackageUploadResponse' do
    it 'should create an instance of NugetPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::NugetPackageUploadResponse)
    end
  end
