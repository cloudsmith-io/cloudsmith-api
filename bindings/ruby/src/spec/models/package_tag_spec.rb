...
# Unit tests for CloudsmithApi::PackageTag
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageTag' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageTag.new
  end
  ...
  describe 'test an instance of PackageTag' do
    it 'should create an instance of PackageTag' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageTag)
    end
  end
