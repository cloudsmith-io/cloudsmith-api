...
# Unit tests for CloudsmithApi::PythonUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PythonUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::PythonUpstreamRequest.new
  end
  ...
  describe 'test an instance of PythonUpstreamRequest' do
    it 'should create an instance of PythonUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::PythonUpstreamRequest)
    end
  end
