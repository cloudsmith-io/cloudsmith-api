...
# Unit tests for CloudsmithApi::HexUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HexUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::HexUpstream.new
  end
  ...
  describe 'test an instance of HexUpstream' do
    it 'should create an instance of HexUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::HexUpstream)
    end
  end
