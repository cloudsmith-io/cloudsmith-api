...
# Unit tests for CloudsmithApi::NugetUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NugetUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::NugetUpstreamRequest.new
  end
  ...
  describe 'test an instance of NugetUpstreamRequest' do
    it 'should create an instance of NugetUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::NugetUpstreamRequest)
    end
  end
