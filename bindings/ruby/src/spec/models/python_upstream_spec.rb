...
# Unit tests for CloudsmithApi::PythonUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PythonUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::PythonUpstream.new
  end
  ...
  describe 'test an instance of PythonUpstream' do
    it 'should create an instance of PythonUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::PythonUpstream)
    end
  end
