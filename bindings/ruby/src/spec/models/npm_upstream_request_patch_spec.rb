...
# Unit tests for CloudsmithApi::NpmUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NpmUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::NpmUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of NpmUpstreamRequestPatch' do
    it 'should create an instance of NpmUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::NpmUpstreamRequestPatch)
    end
  end
