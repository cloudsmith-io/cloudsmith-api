...
# Unit tests for CloudsmithApi::CondaUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CondaUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::CondaUpstreamRequest.new
  end
  ...
  describe 'test an instance of CondaUpstreamRequest' do
    it 'should create an instance of CondaUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::CondaUpstreamRequest)
    end
  end
