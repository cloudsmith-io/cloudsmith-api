...
# Unit tests for CloudsmithApi::DockerUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DockerUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::DockerUpstream.new
  end
  ...
  describe 'test an instance of DockerUpstream' do
    it 'should create an instance of DockerUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::DockerUpstream)
    end
  end
