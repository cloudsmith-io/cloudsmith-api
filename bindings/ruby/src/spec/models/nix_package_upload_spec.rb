...
# Unit tests for CloudsmithApi::NixPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NixPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::NixPackageUpload.new
  end
  ...
  describe 'test an instance of NixPackageUpload' do
    it 'should create an instance of NixPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::NixPackageUpload)
    end
  end
