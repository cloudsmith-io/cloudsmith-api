...
# Unit tests for CloudsmithApi::DartPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DartPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::DartPackageUploadResponse.new
  end
  ...
  describe 'test an instance of DartPackageUploadResponse' do
    it 'should create an instance of DartPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::DartPackageUploadResponse)
    end
  end
