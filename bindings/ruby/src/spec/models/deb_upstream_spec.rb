...
# Unit tests for CloudsmithApi::DebUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DebUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::DebUpstream.new
  end
  ...
  describe 'test an instance of DebUpstream' do
    it 'should create an instance of DebUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::DebUpstream)
    end
  end
  ...
  describe 'test attribute "gpg_key_fingerprint_short"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
