...
# Unit tests for CloudsmithApi::AlpineUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlpineUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::AlpineUpstreamRequest.new
  end
  ...
  describe 'test an instance of AlpineUpstreamRequest' do
    it 'should create an instance of AlpineUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::AlpineUpstreamRequest)
    end
  end
