...
# Unit tests for CloudsmithApi::TerraformPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TerraformPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::TerraformPackageUpload.new
  end
  ...
  describe 'test an instance of TerraformPackageUpload' do
    it 'should create an instance of TerraformPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::TerraformPackageUpload)
    end
  end
