...
# Unit tests for CloudsmithApi::HuggingfaceUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HuggingfaceUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::HuggingfaceUpstream.new
  end
  ...
  describe 'test an instance of HuggingfaceUpstream' do
    it 'should create an instance of HuggingfaceUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::HuggingfaceUpstream)
    end
  end
