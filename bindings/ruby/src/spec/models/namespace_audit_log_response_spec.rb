...
# Unit tests for CloudsmithApi::NamespaceAuditLogResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NamespaceAuditLogResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::NamespaceAuditLogResponse.new
  end
  ...
  describe 'test an instance of NamespaceAuditLogResponse' do
    it 'should create an instance of NamespaceAuditLogResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::NamespaceAuditLogResponse)
    end
  end
