...
# Unit tests for CloudsmithApi::RubyUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RubyUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::RubyUpstreamRequest.new
  end
  ...
  describe 'test an instance of RubyUpstreamRequest' do
    it 'should create an instance of RubyUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::RubyUpstreamRequest)
    end
  end
