...
# Unit tests for CloudsmithApi::PackageQuarantine
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageQuarantine' do
  before do
    # run before each test
    @instance = CloudsmithApi::PackageQuarantine.new
  end
  ...
  describe 'test an instance of PackageQuarantine' do
    it 'should create an instance of PackageQuarantine' do
      expect(@instance).to be_instance_of(CloudsmithApi::PackageQuarantine)
    end
  end
