...
# Unit tests for CloudsmithApi::DartUpstream
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DartUpstream' do
  before do
    # run before each test
    @instance = CloudsmithApi::DartUpstream.new
  end
  ...
  describe 'test an instance of DartUpstream' do
    it 'should create an instance of DartUpstream' do
      expect(@instance).to be_instance_of(CloudsmithApi::DartUpstream)
    end
  end
