...
# Unit tests for CloudsmithApi::RpmUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RpmUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::RpmUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of RpmUpstreamRequestPatch' do
    it 'should create an instance of RpmUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::RpmUpstreamRequestPatch)
    end
  end
