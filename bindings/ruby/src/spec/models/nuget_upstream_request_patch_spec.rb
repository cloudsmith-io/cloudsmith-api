...
# Unit tests for CloudsmithApi::NugetUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NugetUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::NugetUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of NugetUpstreamRequestPatch' do
    it 'should create an instance of NugetUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::NugetUpstreamRequestPatch)
    end
  end
