...
# Unit tests for CloudsmithApi::DebPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DebPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::DebPackageUploadResponse.new
  end
  ...
  describe 'test an instance of DebPackageUploadResponse' do
    it 'should create an instance of DebPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::DebPackageUploadResponse)
    end
  end
