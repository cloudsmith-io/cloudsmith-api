...
# Unit tests for CloudsmithApi::DartUpstreamRequestPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DartUpstreamRequestPatch' do
  before do
    # run before each test
    @instance = CloudsmithApi::DartUpstreamRequestPatch.new
  end
  ...
  describe 'test an instance of DartUpstreamRequestPatch' do
    it 'should create an instance of DartUpstreamRequestPatch' do
      expect(@instance).to be_instance_of(CloudsmithApi::DartUpstreamRequestPatch)
    end
  end
