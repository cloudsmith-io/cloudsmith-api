...
# Unit tests for CloudsmithApi::DebUpstreamRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DebUpstreamRequest' do
  before do
    # run before each test
    @instance = CloudsmithApi::DebUpstreamRequest.new
  end
  ...
  describe 'test an instance of DebUpstreamRequest' do
    it 'should create an instance of DebUpstreamRequest' do
      expect(@instance).to be_instance_of(CloudsmithApi::DebUpstreamRequest)
    end
  end
