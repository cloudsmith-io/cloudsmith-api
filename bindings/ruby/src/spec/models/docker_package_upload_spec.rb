...
# Unit tests for CloudsmithApi::DockerPackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DockerPackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::DockerPackageUpload.new
  end
  ...
  describe 'test an instance of DockerPackageUpload' do
    it 'should create an instance of DockerPackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::DockerPackageUpload)
    end
  end
