...
# Unit tests for CloudsmithApi::RepositoryResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoryResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::RepositoryResponse.new
  end
  ...
  describe 'test an instance of RepositoryResponse' do
    it 'should create an instance of RepositoryResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::RepositoryResponse)
    end
  end
