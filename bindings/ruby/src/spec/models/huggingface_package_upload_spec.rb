...
# Unit tests for CloudsmithApi::HuggingfacePackageUpload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HuggingfacePackageUpload' do
  before do
    # run before each test
    @instance = CloudsmithApi::HuggingfacePackageUpload.new
  end
  ...
  describe 'test an instance of HuggingfacePackageUpload' do
    it 'should create an instance of HuggingfacePackageUpload' do
      expect(@instance).to be_instance_of(CloudsmithApi::HuggingfacePackageUpload)
    end
  end
