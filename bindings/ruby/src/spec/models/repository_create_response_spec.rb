...
# Unit tests for CloudsmithApi::RepositoryCreateResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoryCreateResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::RepositoryCreateResponse.new
  end
  ...
  describe 'test an instance of RepositoryCreateResponse' do
    it 'should create an instance of RepositoryCreateResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::RepositoryCreateResponse)
    end
  end
