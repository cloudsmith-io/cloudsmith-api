...
# Unit tests for CloudsmithApi::CondaPackageUploadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CondaPackageUploadResponse' do
  before do
    # run before each test
    @instance = CloudsmithApi::CondaPackageUploadResponse.new
  end
  ...
  describe 'test an instance of CondaPackageUploadResponse' do
    it 'should create an instance of CondaPackageUploadResponse' do
      expect(@instance).to be_instance_of(CloudsmithApi::CondaPackageUploadResponse)
    end
  end
