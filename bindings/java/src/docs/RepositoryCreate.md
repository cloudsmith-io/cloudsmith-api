...
**deletedAt** | [**OffsetDateTime**](OffsetDateTime.md) | The datetime the repository was manually deleted at. |  [optional]
...
**isPublicHidden** | **Boolean** | If checked, this repository will be hidden from the list of public broadcasts for the workspace. |  [optional]
...
**numQuarantinedPackages** | **java.math.BigInteger** | Number of quarantined packages in a repository. |  [optional]
...
**selfWebappUrl** | **String** | Webapp URL for this repository. |  [optional]
