...
<a name="reposUpstreamCondaCreate"></a>
...
<a name="reposUpstreamCondaDelete"></a>
...
<a name="reposUpstreamCondaList"></a>
...
java.math.BigInteger pageSize = new java.math.BigInteger(); // java.math.BigInteger | Number of results to return per page.
try {
    List<CondaUpstream> result = apiInstance.reposUpstreamCondaList(owner, identifier, page, pageSize);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="reposUpstreamCondaPartialUpdate"></a>
...
<a name="reposUpstreamCondaRead"></a>
...
<a name="reposUpstreamCondaUpdate"></a>
...
<a name="reposUpstreamGenericCreate"></a>
...
<a name="reposUpstreamGenericDelete"></a>
...
<a name="reposUpstreamGenericList"></a>
...
java.math.BigInteger pageSize = new java.math.BigInteger(); // java.math.BigInteger | Number of results to return per page.
try {
    List<GenericUpstream> result = apiInstance.reposUpstreamGenericList(owner, identifier, page, pageSize);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="reposUpstreamGenericPartialUpdate"></a>
...
<a name="reposUpstreamGenericRead"></a>
...
<a name="reposUpstreamGenericUpdate"></a>
...
<a name="reposUpstreamHuggingfaceCreate"></a>
...
<a name="reposUpstreamHuggingfaceDelete"></a>
...
<a name="reposUpstreamHuggingfaceList"></a>
...
java.math.BigInteger pageSize = new java.math.BigInteger(); // java.math.BigInteger | Number of results to return per page.
try {
    List<HuggingfaceUpstream> result = apiInstance.reposUpstreamHuggingfaceList(owner, identifier, page, pageSize);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="reposUpstreamHuggingfacePartialUpdate"></a>
...
<a name="reposUpstreamHuggingfaceRead"></a>
...
<a name="reposUpstreamHuggingfaceUpdate"></a>
...
<a name="reposX509EcdsaList"></a>
# **reposX509EcdsaList**
> RepositoryX509EcdsaCertificate reposX509EcdsaList(owner, identifier)
...
String identifier = "identifier_example"; // String | 
try {
    RepositoryX509EcdsaCertificate result = apiInstance.reposX509EcdsaList(owner, identifier);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling ReposApi#reposX509EcdsaList");
    e.printStackTrace();
}
```
...
<a name="reposX509RsaList"></a>
# **reposX509RsaList**
> RepositoryX509RsaCertificate reposX509RsaList(owner, identifier)
...
String identifier = "identifier_example"; // String | 
try {
    RepositoryX509RsaCertificate result = apiInstance.reposX509RsaList(owner, identifier);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling ReposApi#reposX509RsaList");
    e.printStackTrace();
}
```
