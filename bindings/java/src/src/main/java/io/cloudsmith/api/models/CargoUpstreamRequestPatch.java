...
public class CargoUpstreamRequestPatch implements Serializable {
  ...
  public CargoUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public CargoUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public CargoUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public CargoUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public CargoUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CargoUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CargoUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public CargoUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public CargoUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public CargoUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public CargoUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public CargoUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CargoUpstreamRequestPatch cargoUpstreamRequestPatch = (CargoUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, cargoUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, cargoUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, cargoUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, cargoUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, cargoUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, cargoUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, cargoUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, cargoUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, cargoUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, cargoUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, cargoUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, cargoUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, cargoUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class CargoUpstreamRequestPatch {\n");
