...
public class PythonPackageUploadResponse implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "A textual description of this package.")
  ...
  public PythonPackageUploadResponse distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public PythonPackageUploadResponse distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public PythonPackageUploadResponse tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PythonPackageUploadResponse pythonPackageUploadResponse = (PythonPackageUploadResponse) o;
    return Objects.equals(this.architectures, pythonPackageUploadResponse.architectures) &&
        Objects.equals(this.cdnUrl, pythonPackageUploadResponse.cdnUrl) &&
        Objects.equals(this.checksumMd5, pythonPackageUploadResponse.checksumMd5) &&
        Objects.equals(this.checksumSha1, pythonPackageUploadResponse.checksumSha1) &&
        Objects.equals(this.checksumSha256, pythonPackageUploadResponse.checksumSha256) &&
        Objects.equals(this.checksumSha512, pythonPackageUploadResponse.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, pythonPackageUploadResponse.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, pythonPackageUploadResponse.dependenciesUrl) &&
        Objects.equals(this.description, pythonPackageUploadResponse.description) &&
        Objects.equals(this.distro, pythonPackageUploadResponse.distro) &&
        Objects.equals(this.distroVersion, pythonPackageUploadResponse.distroVersion) &&
        Objects.equals(this.downloads, pythonPackageUploadResponse.downloads) &&
        Objects.equals(this.epoch, pythonPackageUploadResponse.epoch) &&
        Objects.equals(this.extension, pythonPackageUploadResponse.extension) &&
        Objects.equals(this.filename, pythonPackageUploadResponse.filename) &&
        Objects.equals(this.files, pythonPackageUploadResponse.files) &&
        Objects.equals(this.format, pythonPackageUploadResponse.format) &&
        Objects.equals(this.formatUrl, pythonPackageUploadResponse.formatUrl) &&
        Objects.equals(this.identifierPerm, pythonPackageUploadResponse.identifierPerm) &&
        Objects.equals(this.indexed, pythonPackageUploadResponse.indexed) &&
        Objects.equals(this.isDownloadable, pythonPackageUploadResponse.isDownloadable) &&
        Objects.equals(this.isQuarantined, pythonPackageUploadResponse.isQuarantined) &&
        Objects.equals(this.isSyncAwaiting, pythonPackageUploadResponse.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, pythonPackageUploadResponse.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, pythonPackageUploadResponse.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, pythonPackageUploadResponse.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, pythonPackageUploadResponse.isSyncInProgress) &&
        Objects.equals(this.license, pythonPackageUploadResponse.license) &&
        Objects.equals(this.name, pythonPackageUploadResponse.name) &&
        Objects.equals(this.namespace, pythonPackageUploadResponse.namespace) &&
        Objects.equals(this.namespaceUrl, pythonPackageUploadResponse.namespaceUrl) &&
        Objects.equals(this.numFiles, pythonPackageUploadResponse.numFiles) &&
        Objects.equals(this.originRepository, pythonPackageUploadResponse.originRepository) &&
        Objects.equals(this.originRepositoryUrl, pythonPackageUploadResponse.originRepositoryUrl) &&
        Objects.equals(this.packageType, pythonPackageUploadResponse.packageType) &&
        Objects.equals(this.release, pythonPackageUploadResponse.release) &&
        Objects.equals(this.repository, pythonPackageUploadResponse.repository) &&
        Objects.equals(this.repositoryUrl, pythonPackageUploadResponse.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, pythonPackageUploadResponse.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, pythonPackageUploadResponse.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, pythonPackageUploadResponse.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, pythonPackageUploadResponse.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, pythonPackageUploadResponse.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, pythonPackageUploadResponse.selfUrl) &&
        Objects.equals(this.signatureUrl, pythonPackageUploadResponse.signatureUrl) &&
        Objects.equals(this.size, pythonPackageUploadResponse.size) &&
        Objects.equals(this.slug, pythonPackageUploadResponse.slug) &&
        Objects.equals(this.slugPerm, pythonPackageUploadResponse.slugPerm) &&
        Objects.equals(this.stage, pythonPackageUploadResponse.stage) &&
        Objects.equals(this.stageStr, pythonPackageUploadResponse.stageStr) &&
        Objects.equals(this.stageUpdatedAt, pythonPackageUploadResponse.stageUpdatedAt) &&
        Objects.equals(this.status, pythonPackageUploadResponse.status) &&
        Objects.equals(this.statusReason, pythonPackageUploadResponse.statusReason) &&
        Objects.equals(this.statusStr, pythonPackageUploadResponse.statusStr) &&
        Objects.equals(this.statusUpdatedAt, pythonPackageUploadResponse.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, pythonPackageUploadResponse.statusUrl) &&
        Objects.equals(this.subtype, pythonPackageUploadResponse.subtype) &&
        Objects.equals(this.summary, pythonPackageUploadResponse.summary) &&
        Objects.equals(this.syncFinishedAt, pythonPackageUploadResponse.syncFinishedAt) &&
        Objects.equals(this.syncProgress, pythonPackageUploadResponse.syncProgress) &&
        Objects.equals(this.tagsImmutable, pythonPackageUploadResponse.tagsImmutable) &&
        Objects.equals(this.typeDisplay, pythonPackageUploadResponse.typeDisplay) &&
        Objects.equals(this.uploadedAt, pythonPackageUploadResponse.uploadedAt) &&
        Objects.equals(this.uploader, pythonPackageUploadResponse.uploader) &&
        Objects.equals(this.uploaderUrl, pythonPackageUploadResponse.uploaderUrl) &&
        Objects.equals(this.version, pythonPackageUploadResponse.version) &&
        Objects.equals(this.versionOrig, pythonPackageUploadResponse.versionOrig) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, pythonPackageUploadResponse.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class PythonPackageUploadResponse {\n");
