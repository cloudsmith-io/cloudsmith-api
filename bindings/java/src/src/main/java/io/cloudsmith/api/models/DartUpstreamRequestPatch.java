...
public class DartUpstreamRequestPatch implements Serializable {
  ...
  public DartUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public DartUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public DartUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public DartUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public DartUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public DartUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DartUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DartUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public DartUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public DartUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public DartUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public DartUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public DartUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DartUpstreamRequestPatch dartUpstreamRequestPatch = (DartUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, dartUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, dartUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, dartUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, dartUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, dartUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, dartUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, dartUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, dartUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, dartUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, dartUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, dartUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, dartUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, dartUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class DartUpstreamRequestPatch {\n");
