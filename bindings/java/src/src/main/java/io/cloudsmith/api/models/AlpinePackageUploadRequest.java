...
public class AlpinePackageUploadRequest implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(required = true, value = "The primary file for the package.")
  ...
  public AlpinePackageUploadRequest republish(Boolean republish) {
  ...
  **/
  ...
  public AlpinePackageUploadRequest tags(String tags) {
    this.tags = tags;
    return this;
  }
