...
public class CargoUpstreamRequest implements Serializable {
  ...
  public CargoUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public CargoUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public CargoUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public CargoUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public CargoUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public CargoUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CargoUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CargoUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public CargoUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public CargoUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public CargoUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public CargoUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public CargoUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CargoUpstreamRequest cargoUpstreamRequest = (CargoUpstreamRequest) o;
    return Objects.equals(this.authMode, cargoUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, cargoUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, cargoUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, cargoUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, cargoUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, cargoUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, cargoUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, cargoUpstreamRequest.isActive) &&
        Objects.equals(this.mode, cargoUpstreamRequest.mode) &&
        Objects.equals(this.name, cargoUpstreamRequest.name) &&
        Objects.equals(this.priority, cargoUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, cargoUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, cargoUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class CargoUpstreamRequest {\n");
