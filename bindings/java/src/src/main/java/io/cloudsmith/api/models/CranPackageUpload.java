...
public class CranPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public CranPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public CranPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public CranPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public CranPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CranPackageUpload cranPackageUpload = (CranPackageUpload) o;
    return Objects.equals(this.architectures, cranPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, cranPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, cranPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, cranPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, cranPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, cranPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, cranPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, cranPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, cranPackageUpload.description) &&
        Objects.equals(this.displayName, cranPackageUpload.displayName) &&
        Objects.equals(this.displaySource, cranPackageUpload.displaySource) &&
        Objects.equals(this.distro, cranPackageUpload.distro) &&
        Objects.equals(this.distroVersion, cranPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, cranPackageUpload.downloads) &&
        Objects.equals(this.epoch, cranPackageUpload.epoch) &&
        Objects.equals(this.extension, cranPackageUpload.extension) &&
        Objects.equals(this.filename, cranPackageUpload.filename) &&
        Objects.equals(this.files, cranPackageUpload.files) &&
        Objects.equals(this.format, cranPackageUpload.format) &&
        Objects.equals(this.formatUrl, cranPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, cranPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, cranPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, cranPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, cranPackageUpload.identifiers) &&
        Objects.equals(this.indexed, cranPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, cranPackageUpload.isCancellable) &&
        ...
        Objects.equals(this.isResyncable, cranPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, cranPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, cranPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, cranPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, cranPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, cranPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, cranPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, cranPackageUpload.license) &&
        Objects.equals(this.name, cranPackageUpload.name) &&
        Objects.equals(this.namespace, cranPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, cranPackageUpload.namespaceUrl) &&
        ...
        Objects.equals(this.rawLicense, cranPackageUpload.rawLicense) &&
        ...
        Objects.equals(this.securityScanCompletedAt, cranPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, cranPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, cranPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, cranPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, cranPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, cranPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, cranPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, cranPackageUpload.signatureUrl) &&
        Objects.equals(this.size, cranPackageUpload.size) &&
        Objects.equals(this.slug, cranPackageUpload.slug) &&
        Objects.equals(this.slugPerm, cranPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, cranPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, cranPackageUpload.stage) &&
        Objects.equals(this.stageStr, cranPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, cranPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, cranPackageUpload.status) &&
        Objects.equals(this.statusReason, cranPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class CranPackageUpload {\n");
