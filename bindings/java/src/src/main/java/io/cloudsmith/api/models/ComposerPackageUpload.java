...
public class ComposerPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public ComposerPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public ComposerPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public ComposerPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public ComposerPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public ComposerPackageUpload version(String version) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ComposerPackageUpload composerPackageUpload = (ComposerPackageUpload) o;
    return Objects.equals(this.architectures, composerPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, composerPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, composerPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, composerPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, composerPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, composerPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, composerPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, composerPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, composerPackageUpload.description) &&
        Objects.equals(this.displayName, composerPackageUpload.displayName) &&
        Objects.equals(this.displaySource, composerPackageUpload.displaySource) &&
        Objects.equals(this.distro, composerPackageUpload.distro) &&
        Objects.equals(this.distroVersion, composerPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, composerPackageUpload.downloads) &&
        Objects.equals(this.epoch, composerPackageUpload.epoch) &&
        Objects.equals(this.extension, composerPackageUpload.extension) &&
        Objects.equals(this.filename, composerPackageUpload.filename) &&
        ...
        Objects.equals(this.isResyncable, composerPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, composerPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, composerPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, composerPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, composerPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, composerPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, composerPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, composerPackageUpload.license) &&
        Objects.equals(this.name, composerPackageUpload.name) &&
        Objects.equals(this.namespace, composerPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, composerPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, composerPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, composerPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, composerPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, composerPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, composerPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, composerPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, composerPackageUpload.rawLicense) &&
        Objects.equals(this.release, composerPackageUpload.release) &&
        Objects.equals(this.repository, composerPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, composerPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, composerPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, composerPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, composerPackageUpload.securityScanStatus) &&
        ...
        Objects.equals(this.slugPerm, composerPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, composerPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, composerPackageUpload.stage) &&
        Objects.equals(this.stageStr, composerPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, composerPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, composerPackageUpload.status) &&
        Objects.equals(this.statusReason, composerPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class ComposerPackageUpload {\n");
