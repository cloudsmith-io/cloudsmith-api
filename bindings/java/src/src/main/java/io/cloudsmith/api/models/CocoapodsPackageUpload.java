...
public class CocoapodsPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public CocoapodsPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public CocoapodsPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public CocoapodsPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public CocoapodsPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CocoapodsPackageUpload cocoapodsPackageUpload = (CocoapodsPackageUpload) o;
    return Objects.equals(this.architectures, cocoapodsPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, cocoapodsPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, cocoapodsPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, cocoapodsPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, cocoapodsPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, cocoapodsPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, cocoapodsPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, cocoapodsPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, cocoapodsPackageUpload.description) &&
        Objects.equals(this.displayName, cocoapodsPackageUpload.displayName) &&
        Objects.equals(this.displaySource, cocoapodsPackageUpload.displaySource) &&
        Objects.equals(this.distro, cocoapodsPackageUpload.distro) &&
        Objects.equals(this.distroVersion, cocoapodsPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, cocoapodsPackageUpload.downloads) &&
        Objects.equals(this.epoch, cocoapodsPackageUpload.epoch) &&
        Objects.equals(this.extension, cocoapodsPackageUpload.extension) &&
        Objects.equals(this.filename, cocoapodsPackageUpload.filename) &&
        Objects.equals(this.files, cocoapodsPackageUpload.files) &&
        Objects.equals(this.format, cocoapodsPackageUpload.format) &&
        Objects.equals(this.formatUrl, cocoapodsPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, cocoapodsPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, cocoapodsPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, cocoapodsPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, cocoapodsPackageUpload.identifiers) &&
        Objects.equals(this.indexed, cocoapodsPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, cocoapodsPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, cocoapodsPackageUpload.isCopyable) &&
        ...
        Objects.equals(this.isResyncable, cocoapodsPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, cocoapodsPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, cocoapodsPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, cocoapodsPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, cocoapodsPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, cocoapodsPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, cocoapodsPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, cocoapodsPackageUpload.license) &&
        Objects.equals(this.name, cocoapodsPackageUpload.name) &&
        Objects.equals(this.namespace, cocoapodsPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, cocoapodsPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, cocoapodsPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, cocoapodsPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, cocoapodsPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, cocoapodsPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, cocoapodsPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, cocoapodsPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, cocoapodsPackageUpload.rawLicense) &&
        Objects.equals(this.release, cocoapodsPackageUpload.release) &&
        Objects.equals(this.repository, cocoapodsPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, cocoapodsPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, cocoapodsPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, cocoapodsPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, cocoapodsPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, cocoapodsPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, cocoapodsPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, cocoapodsPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, cocoapodsPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, cocoapodsPackageUpload.signatureUrl) &&
        Objects.equals(this.size, cocoapodsPackageUpload.size) &&
        Objects.equals(this.slug, cocoapodsPackageUpload.slug) &&
        Objects.equals(this.slugPerm, cocoapodsPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, cocoapodsPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, cocoapodsPackageUpload.stage) &&
        Objects.equals(this.stageStr, cocoapodsPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, cocoapodsPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, cocoapodsPackageUpload.status) &&
        Objects.equals(this.statusReason, cocoapodsPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class CocoapodsPackageUpload {\n");
