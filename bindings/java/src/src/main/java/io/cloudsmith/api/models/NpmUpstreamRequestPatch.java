...
public class NpmUpstreamRequestPatch implements Serializable {
  ...
  public NpmUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public NpmUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public NpmUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public NpmUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public NpmUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public NpmUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NpmUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NpmUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public NpmUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public NpmUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public NpmUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public NpmUpstreamRequestPatch trustLevel(TrustLevelEnum trustLevel) {
  ...
  **/
  ...
  public NpmUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public NpmUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NpmUpstreamRequestPatch npmUpstreamRequestPatch = (NpmUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, npmUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, npmUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, npmUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, npmUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, npmUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, npmUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, npmUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, npmUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, npmUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, npmUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, npmUpstreamRequestPatch.priority) &&
        Objects.equals(this.trustLevel, npmUpstreamRequestPatch.trustLevel) &&
        Objects.equals(this.upstreamUrl, npmUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, npmUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class NpmUpstreamRequestPatch {\n");
