...
public class DockerUpstreamRequestPatch implements Serializable {
  ...
  **/
  ...
  public DockerUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public DockerUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public DockerUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public DockerUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public DockerUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DockerUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DockerUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public DockerUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public DockerUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public DockerUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public DockerUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public DockerUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.authMode, dockerUpstreamRequestPatch.authMode) &&
        ...
        Objects.equals(this.extraHeader2, dockerUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, dockerUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, dockerUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, dockerUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, dockerUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, dockerUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, dockerUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, dockerUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, dockerUpstreamRequestPatch.verifySsl);
  }
