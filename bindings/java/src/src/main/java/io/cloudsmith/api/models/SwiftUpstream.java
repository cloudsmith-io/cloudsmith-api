...
public class SwiftUpstream implements Serializable {
  ...
  public SwiftUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public SwiftUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public SwiftUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public SwiftUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public SwiftUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public SwiftUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public SwiftUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public SwiftUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public SwiftUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public SwiftUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public SwiftUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public SwiftUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public SwiftUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SwiftUpstream swiftUpstream = (SwiftUpstream) o;
    return Objects.equals(this.authMode, swiftUpstream.authMode) &&
        Objects.equals(this.authSecret, swiftUpstream.authSecret) &&
        Objects.equals(this.authUsername, swiftUpstream.authUsername) &&
        Objects.equals(this.available, swiftUpstream.available) &&
        Objects.equals(this.canReindex, swiftUpstream.canReindex) &&
        Objects.equals(this.createdAt, swiftUpstream.createdAt) &&
        Objects.equals(this.disableReason, swiftUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, swiftUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, swiftUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, swiftUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, swiftUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, swiftUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, swiftUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, swiftUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, swiftUpstream.indexStatus) &&
        Objects.equals(this.isActive, swiftUpstream.isActive) &&
        Objects.equals(this.lastIndexed, swiftUpstream.lastIndexed) &&
        Objects.equals(this.mode, swiftUpstream.mode) &&
        Objects.equals(this.name, swiftUpstream.name) &&
        Objects.equals(this.pendingValidation, swiftUpstream.pendingValidation) &&
        Objects.equals(this.priority, swiftUpstream.priority) &&
        Objects.equals(this.slugPerm, swiftUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, swiftUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, swiftUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, swiftUpstream.verifySsl);
  }
