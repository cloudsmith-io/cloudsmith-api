...
public class PythonUpstreamRequest implements Serializable {
  ...
  public PythonUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public PythonUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public PythonUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public PythonUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public PythonUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public PythonUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public PythonUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public PythonUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public PythonUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public PythonUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public PythonUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public PythonUpstreamRequest trustLevel(TrustLevelEnum trustLevel) {
  ...
  **/
  ...
  public PythonUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public PythonUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PythonUpstreamRequest pythonUpstreamRequest = (PythonUpstreamRequest) o;
    return Objects.equals(this.authMode, pythonUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, pythonUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, pythonUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, pythonUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, pythonUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, pythonUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, pythonUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, pythonUpstreamRequest.isActive) &&
        Objects.equals(this.mode, pythonUpstreamRequest.mode) &&
        Objects.equals(this.name, pythonUpstreamRequest.name) &&
        Objects.equals(this.priority, pythonUpstreamRequest.priority) &&
        Objects.equals(this.trustLevel, pythonUpstreamRequest.trustLevel) &&
        Objects.equals(this.upstreamUrl, pythonUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, pythonUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class PythonUpstreamRequest {\n");
