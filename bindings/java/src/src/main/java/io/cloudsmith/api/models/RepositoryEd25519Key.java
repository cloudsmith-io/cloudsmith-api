...
public class RepositoryEd25519Key implements Serializable {
  ...
  **/
   ...
   * @return fingerprint
  **/
 @Size(min=1)  @ApiModelProperty(value = "Uppercase hex-encoded SHA-256 fingerprint of the public key.")
 ...
 @Size(min=1)  @ApiModelProperty(value = "The public key in `<name>:<base64>` wire format, ready to paste into Nix `trusted-public-keys`.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RepositoryEd25519Key repositoryEd25519Key = (RepositoryEd25519Key) o;
    return Objects.equals(this.active, repositoryEd25519Key.active) &&
        Objects.equals(this.createdAt, repositoryEd25519Key.createdAt) &&
  ...
  public String toString() {
    ...
    sb.append("class RepositoryEd25519Key {\n");
