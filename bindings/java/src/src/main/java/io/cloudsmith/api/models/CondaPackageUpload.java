...
public class CondaPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public CondaPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public CondaPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public CondaPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public CondaPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CondaPackageUpload condaPackageUpload = (CondaPackageUpload) o;
    return Objects.equals(this.architectures, condaPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, condaPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, condaPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, condaPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, condaPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, condaPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, condaPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, condaPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, condaPackageUpload.description) &&
        Objects.equals(this.displayName, condaPackageUpload.displayName) &&
        Objects.equals(this.displaySource, condaPackageUpload.displaySource) &&
        Objects.equals(this.distro, condaPackageUpload.distro) &&
        Objects.equals(this.distroVersion, condaPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, condaPackageUpload.downloads) &&
        Objects.equals(this.epoch, condaPackageUpload.epoch) &&
        Objects.equals(this.extension, condaPackageUpload.extension) &&
        Objects.equals(this.filename, condaPackageUpload.filename) &&
        Objects.equals(this.files, condaPackageUpload.files) &&
        Objects.equals(this.format, condaPackageUpload.format) &&
        Objects.equals(this.formatUrl, condaPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, condaPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, condaPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, condaPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, condaPackageUpload.identifiers) &&
        Objects.equals(this.indexed, condaPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, condaPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, condaPackageUpload.isCopyable) &&
        ...
        Objects.equals(this.isResyncable, condaPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, condaPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, condaPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, condaPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, condaPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, condaPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, condaPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, condaPackageUpload.license) &&
        Objects.equals(this.name, condaPackageUpload.name) &&
        Objects.equals(this.namespace, condaPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, condaPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, condaPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, condaPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, condaPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, condaPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, condaPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, condaPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, condaPackageUpload.rawLicense) &&
        Objects.equals(this.release, condaPackageUpload.release) &&
        Objects.equals(this.repository, condaPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, condaPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, condaPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, condaPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, condaPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, condaPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, condaPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, condaPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, condaPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, condaPackageUpload.signatureUrl) &&
        Objects.equals(this.size, condaPackageUpload.size) &&
        Objects.equals(this.slug, condaPackageUpload.slug) &&
        Objects.equals(this.slugPerm, condaPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, condaPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, condaPackageUpload.stage) &&
        Objects.equals(this.stageStr, condaPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, condaPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, condaPackageUpload.status) &&
        Objects.equals(this.statusReason, condaPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class CondaPackageUpload {\n");
