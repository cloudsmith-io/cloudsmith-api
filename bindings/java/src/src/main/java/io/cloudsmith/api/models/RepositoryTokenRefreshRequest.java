...
public class RepositoryTokenRefreshRequest implements Serializable {
  ...
  public RepositoryTokenRefreshRequest accessPrivateBroadcasts(Boolean accessPrivateBroadcasts) {
  ...
  **/
  ...
  public RepositoryTokenRefreshRequest limitBandwidth(java.math.BigInteger limitBandwidth) {
 ...
 @Min(-9223372036854775808L) @Max(9223372036854775807L)  @ApiModelProperty(value = "The maximum download bandwidth allowed for the token. Values are expressed as the selected unit of bandwidth. Please note that since downloads are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point. ")
  ...
  public RepositoryTokenRefreshRequest limitBandwidthUnit(LimitBandwidthUnitEnum limitBandwidthUnit) {
  ...
  **/
  ...
  public RepositoryTokenRefreshRequest limitNumClients(java.math.BigInteger limitNumClients) {
 ...
 @Min(-9223372036854775808L) @Max(9223372036854775807L)  @ApiModelProperty(value = "The maximum number of unique clients allowed for the token. Please note that since clients are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point.")
  ...
  public RepositoryTokenRefreshRequest limitNumDownloads(java.math.BigInteger limitNumDownloads) {
  ...
  **/
  ...
  public RepositoryTokenRefreshRequest scheduledResetPeriod(ScheduledResetPeriodEnum scheduledResetPeriod) {
 ...
 @Size(min=1)  @ApiModelProperty(value = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accessPrivateBroadcasts, repositoryTokenRefreshRequest.accessPrivateBroadcasts) &&
        Objects.equals(this.eulaRequired, repositoryTokenRefreshRequest.eulaRequired) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessPrivateBroadcasts, eulaRequired, isActive, limitBandwidth, limitBandwidthUnit, limitDateRangeFrom, limitDateRangeTo, limitNumClients, limitNumDownloads, limitPackageQuery, limitPathQuery, metadata, scheduledResetAt, scheduledResetPeriod, token);
  }
