...
public class LuarocksPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public LuarocksPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public LuarocksPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public LuarocksPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public LuarocksPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LuarocksPackageUpload luarocksPackageUpload = (LuarocksPackageUpload) o;
    return Objects.equals(this.architectures, luarocksPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, luarocksPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, luarocksPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, luarocksPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, luarocksPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, luarocksPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, luarocksPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, luarocksPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, luarocksPackageUpload.description) &&
        Objects.equals(this.displayName, luarocksPackageUpload.displayName) &&
        Objects.equals(this.displaySource, luarocksPackageUpload.displaySource) &&
        Objects.equals(this.distro, luarocksPackageUpload.distro) &&
        Objects.equals(this.distroVersion, luarocksPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, luarocksPackageUpload.downloads) &&
        Objects.equals(this.epoch, luarocksPackageUpload.epoch) &&
        Objects.equals(this.extension, luarocksPackageUpload.extension) &&
        Objects.equals(this.filename, luarocksPackageUpload.filename) &&
        Objects.equals(this.files, luarocksPackageUpload.files) &&
        Objects.equals(this.format, luarocksPackageUpload.format) &&
        Objects.equals(this.formatUrl, luarocksPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, luarocksPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, luarocksPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, luarocksPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, luarocksPackageUpload.identifiers) &&
        Objects.equals(this.indexed, luarocksPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, luarocksPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, luarocksPackageUpload.isCopyable) &&
        ...
        Objects.equals(this.isResyncable, luarocksPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, luarocksPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, luarocksPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, luarocksPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, luarocksPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, luarocksPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, luarocksPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, luarocksPackageUpload.license) &&
        Objects.equals(this.name, luarocksPackageUpload.name) &&
        Objects.equals(this.namespace, luarocksPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, luarocksPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, luarocksPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, luarocksPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, luarocksPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, luarocksPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, luarocksPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, luarocksPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, luarocksPackageUpload.rawLicense) &&
        Objects.equals(this.release, luarocksPackageUpload.release) &&
        Objects.equals(this.repository, luarocksPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, luarocksPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, luarocksPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, luarocksPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, luarocksPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, luarocksPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, luarocksPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, luarocksPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, luarocksPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, luarocksPackageUpload.signatureUrl) &&
        Objects.equals(this.size, luarocksPackageUpload.size) &&
        Objects.equals(this.slug, luarocksPackageUpload.slug) &&
        Objects.equals(this.slugPerm, luarocksPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, luarocksPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, luarocksPackageUpload.stage) &&
        Objects.equals(this.stageStr, luarocksPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, luarocksPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, luarocksPackageUpload.status) &&
        Objects.equals(this.statusReason, luarocksPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class LuarocksPackageUpload {\n");
