...
public class HexUpstreamRequest implements Serializable {
  ...
  public HexUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public HexUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public HexUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public HexUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public HexUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public HexUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HexUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HexUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public HexUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public HexUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public HexUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public HexUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public HexUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HexUpstreamRequest hexUpstreamRequest = (HexUpstreamRequest) o;
    return Objects.equals(this.authMode, hexUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, hexUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, hexUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, hexUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, hexUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, hexUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, hexUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, hexUpstreamRequest.isActive) &&
        Objects.equals(this.mode, hexUpstreamRequest.mode) &&
        Objects.equals(this.name, hexUpstreamRequest.name) &&
        Objects.equals(this.priority, hexUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, hexUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, hexUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class HexUpstreamRequest {\n");
