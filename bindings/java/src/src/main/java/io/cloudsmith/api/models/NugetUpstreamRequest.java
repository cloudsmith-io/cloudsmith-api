...
public class NugetUpstreamRequest implements Serializable {
  ...
  public NugetUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public NugetUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public NugetUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public NugetUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public NugetUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public NugetUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NugetUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NugetUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public NugetUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public NugetUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public NugetUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public NugetUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public NugetUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NugetUpstreamRequest nugetUpstreamRequest = (NugetUpstreamRequest) o;
    return Objects.equals(this.authMode, nugetUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, nugetUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, nugetUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, nugetUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, nugetUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, nugetUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, nugetUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, nugetUpstreamRequest.isActive) &&
        Objects.equals(this.mode, nugetUpstreamRequest.mode) &&
        Objects.equals(this.name, nugetUpstreamRequest.name) &&
        Objects.equals(this.priority, nugetUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, nugetUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, nugetUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class NugetUpstreamRequest {\n");
