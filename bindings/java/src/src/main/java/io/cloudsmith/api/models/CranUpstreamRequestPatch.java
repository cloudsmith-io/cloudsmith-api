...
public class CranUpstreamRequestPatch implements Serializable {
  ...
  public CranUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public CranUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public CranUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public CranUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public CranUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public CranUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CranUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CranUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public CranUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public CranUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public CranUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public CranUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public CranUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CranUpstreamRequestPatch cranUpstreamRequestPatch = (CranUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, cranUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, cranUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, cranUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, cranUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, cranUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, cranUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, cranUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, cranUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, cranUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, cranUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, cranUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, cranUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, cranUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class CranUpstreamRequestPatch {\n");
