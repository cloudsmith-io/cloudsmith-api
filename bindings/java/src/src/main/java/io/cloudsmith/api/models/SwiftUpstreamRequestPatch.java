...
public class SwiftUpstreamRequestPatch implements Serializable {
  ...
  public SwiftUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public SwiftUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public SwiftUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public SwiftUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public SwiftUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public SwiftUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public SwiftUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public SwiftUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public SwiftUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public SwiftUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public SwiftUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public SwiftUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public SwiftUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SwiftUpstreamRequestPatch swiftUpstreamRequestPatch = (SwiftUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, swiftUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, swiftUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, swiftUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, swiftUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, swiftUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, swiftUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, swiftUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, swiftUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, swiftUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, swiftUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, swiftUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, swiftUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, swiftUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwiftUpstreamRequestPatch {\n");
