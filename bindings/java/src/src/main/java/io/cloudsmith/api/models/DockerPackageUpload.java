...
public class DockerPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public DockerPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public DockerPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public DockerPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public DockerPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DockerPackageUpload dockerPackageUpload = (DockerPackageUpload) o;
    return Objects.equals(this.architectures, dockerPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, dockerPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, dockerPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, dockerPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, dockerPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, dockerPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, dockerPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, dockerPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, dockerPackageUpload.description) &&
        Objects.equals(this.displayName, dockerPackageUpload.displayName) &&
        Objects.equals(this.displaySource, dockerPackageUpload.displaySource) &&
        Objects.equals(this.distro, dockerPackageUpload.distro) &&
        Objects.equals(this.distroVersion, dockerPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, dockerPackageUpload.downloads) &&
        Objects.equals(this.epoch, dockerPackageUpload.epoch) &&
        Objects.equals(this.extension, dockerPackageUpload.extension) &&
        Objects.equals(this.filename, dockerPackageUpload.filename) &&
        Objects.equals(this.files, dockerPackageUpload.files) &&
        Objects.equals(this.format, dockerPackageUpload.format) &&
        Objects.equals(this.formatUrl, dockerPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, dockerPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, dockerPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, dockerPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, dockerPackageUpload.identifiers) &&
        Objects.equals(this.indexed, dockerPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, dockerPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, dockerPackageUpload.isCopyable) &&
        ...
        Objects.equals(this.isResyncable, dockerPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, dockerPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, dockerPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, dockerPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, dockerPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, dockerPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, dockerPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, dockerPackageUpload.license) &&
        Objects.equals(this.name, dockerPackageUpload.name) &&
        Objects.equals(this.namespace, dockerPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, dockerPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, dockerPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, dockerPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, dockerPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, dockerPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, dockerPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, dockerPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, dockerPackageUpload.rawLicense) &&
        Objects.equals(this.release, dockerPackageUpload.release) &&
        Objects.equals(this.repository, dockerPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, dockerPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, dockerPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, dockerPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, dockerPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, dockerPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, dockerPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, dockerPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, dockerPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, dockerPackageUpload.signatureUrl) &&
        Objects.equals(this.size, dockerPackageUpload.size) &&
        Objects.equals(this.slug, dockerPackageUpload.slug) &&
        Objects.equals(this.slugPerm, dockerPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, dockerPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, dockerPackageUpload.stage) &&
        Objects.equals(this.stageStr, dockerPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, dockerPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, dockerPackageUpload.status) &&
        Objects.equals(this.statusReason, dockerPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class DockerPackageUpload {\n");
