...
public class RpmUpstreamRequest implements Serializable {
  ...
  public RpmUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public RpmUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public RpmUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public RpmUpstreamRequest distroVersion(String distroVersion) {
  ...
  **/
  ...
  public RpmUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public RpmUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public RpmUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public RpmUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public RpmUpstreamRequest gpgKeyInline(String gpgKeyInline) {
  ...
  **/
  ...
  public RpmUpstreamRequest gpgKeyUrl(String gpgKeyUrl) {
 ...
 @Size(max=254)  @ApiModelProperty(value = "When provided, Cloudsmith will fetch, validate, and associate a public GPG key found at the provided URL. When using the Cloudsmith setup script, this GPG key will be automatically imported on your deployment machines to allow upstream packages to validate and install.")
  ...
  public RpmUpstreamRequest gpgVerification(GpgVerificationEnum gpgVerification) {
  ...
  **/
  ...
  public RpmUpstreamRequest includeSources(Boolean includeSources) {
  ...
  **/
  ...
  public RpmUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public RpmUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public RpmUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public RpmUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public RpmUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public RpmUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RpmUpstreamRequest rpmUpstreamRequest = (RpmUpstreamRequest) o;
    return Objects.equals(this.authMode, rpmUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, rpmUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, rpmUpstreamRequest.authUsername) &&
        Objects.equals(this.distroVersion, rpmUpstreamRequest.distroVersion) &&
        Objects.equals(this.extraHeader1, rpmUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, rpmUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, rpmUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, rpmUpstreamRequest.extraValue2) &&
        Objects.equals(this.gpgKeyInline, rpmUpstreamRequest.gpgKeyInline) &&
        Objects.equals(this.gpgKeyUrl, rpmUpstreamRequest.gpgKeyUrl) &&
        Objects.equals(this.gpgVerification, rpmUpstreamRequest.gpgVerification) &&
        Objects.equals(this.includeSources, rpmUpstreamRequest.includeSources) &&
        Objects.equals(this.isActive, rpmUpstreamRequest.isActive) &&
        Objects.equals(this.mode, rpmUpstreamRequest.mode) &&
        Objects.equals(this.name, rpmUpstreamRequest.name) &&
        Objects.equals(this.priority, rpmUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, rpmUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, rpmUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class RpmUpstreamRequest {\n");
