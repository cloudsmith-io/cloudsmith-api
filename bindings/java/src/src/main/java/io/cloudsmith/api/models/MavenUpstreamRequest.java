...
public class MavenUpstreamRequest implements Serializable {
  ...
  public MavenUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public MavenUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public MavenUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public MavenUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public MavenUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public MavenUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public MavenUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public MavenUpstreamRequest gpgKeyInline(String gpgKeyInline) {
  ...
  **/
  ...
  public MavenUpstreamRequest gpgKeyUrl(String gpgKeyUrl) {
 ...
 @Size(max=254)  @ApiModelProperty(value = "When provided, Cloudsmith will fetch, validate, and associate a public GPG key found at the provided URL. When using the Cloudsmith setup script, this GPG key will be automatically imported on your deployment machines to allow upstream packages to validate and install.")
  ...
  public MavenUpstreamRequest gpgVerification(GpgVerificationEnum gpgVerification) {
  ...
  **/
  ...
  public MavenUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public MavenUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public MavenUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public MavenUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public MavenUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MavenUpstreamRequest mavenUpstreamRequest = (MavenUpstreamRequest) o;
    return Objects.equals(this.authMode, mavenUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, mavenUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, mavenUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, mavenUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, mavenUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, mavenUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, mavenUpstreamRequest.extraValue2) &&
        Objects.equals(this.gpgKeyInline, mavenUpstreamRequest.gpgKeyInline) &&
        Objects.equals(this.gpgKeyUrl, mavenUpstreamRequest.gpgKeyUrl) &&
        Objects.equals(this.gpgVerification, mavenUpstreamRequest.gpgVerification) &&
        Objects.equals(this.isActive, mavenUpstreamRequest.isActive) &&
  ...
  public String toString() {
    ...
    sb.append("class MavenUpstreamRequest {\n");
