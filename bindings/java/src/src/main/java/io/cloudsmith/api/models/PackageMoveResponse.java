...
public class PackageMoveResponse implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "A textual description of this package.")
  ...
  public PackageMoveResponse distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public PackageMoveResponse distroVersion(DistributionVersion distroVersion) {
 ...
 @Size(min=1)  @ApiModelProperty(value = "The release of the package version (if any).")
   ...
   * @return repository
  **/
 @Size(min=1)  @ApiModelProperty(value = "The repository the package will be moved to.")
  ...
  **/
  ...
  public PackageMoveResponse tags(Tags tags) {
    this.tags = tags;
    return this;
  }
  ...
  **/
  ...
  public PackageMoveResponse tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PackageMoveResponse packageMoveResponse = (PackageMoveResponse) o;
    return Objects.equals(this.architectures, packageMoveResponse.architectures) &&
        Objects.equals(this.cdnUrl, packageMoveResponse.cdnUrl) &&
        Objects.equals(this.checksumMd5, packageMoveResponse.checksumMd5) &&
        Objects.equals(this.checksumSha1, packageMoveResponse.checksumSha1) &&
        Objects.equals(this.checksumSha256, packageMoveResponse.checksumSha256) &&
        Objects.equals(this.checksumSha512, packageMoveResponse.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, packageMoveResponse.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, packageMoveResponse.dependenciesUrl) &&
        Objects.equals(this.description, packageMoveResponse.description) &&
        Objects.equals(this.distro, packageMoveResponse.distro) &&
        Objects.equals(this.distroVersion, packageMoveResponse.distroVersion) &&
        Objects.equals(this.downloads, packageMoveResponse.downloads) &&
        Objects.equals(this.epoch, packageMoveResponse.epoch) &&
        Objects.equals(this.extension, packageMoveResponse.extension) &&
        Objects.equals(this.filename, packageMoveResponse.filename) &&
        Objects.equals(this.files, packageMoveResponse.files) &&
        Objects.equals(this.format, packageMoveResponse.format) &&
        Objects.equals(this.formatUrl, packageMoveResponse.formatUrl) &&
        Objects.equals(this.identifierPerm, packageMoveResponse.identifierPerm) &&
        Objects.equals(this.indexed, packageMoveResponse.indexed) &&
        Objects.equals(this.isDownloadable, packageMoveResponse.isDownloadable) &&
        Objects.equals(this.isQuarantined, packageMoveResponse.isQuarantined) &&
        Objects.equals(this.isSyncAwaiting, packageMoveResponse.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, packageMoveResponse.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, packageMoveResponse.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, packageMoveResponse.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, packageMoveResponse.isSyncInProgress) &&
        Objects.equals(this.license, packageMoveResponse.license) &&
        Objects.equals(this.name, packageMoveResponse.name) &&
        Objects.equals(this.namespace, packageMoveResponse.namespace) &&
        Objects.equals(this.namespaceUrl, packageMoveResponse.namespaceUrl) &&
        Objects.equals(this.numFiles, packageMoveResponse.numFiles) &&
        Objects.equals(this.originRepository, packageMoveResponse.originRepository) &&
        Objects.equals(this.originRepositoryUrl, packageMoveResponse.originRepositoryUrl) &&
        Objects.equals(this.packageType, packageMoveResponse.packageType) &&
        Objects.equals(this.release, packageMoveResponse.release) &&
        Objects.equals(this.repository, packageMoveResponse.repository) &&
        Objects.equals(this.repositoryUrl, packageMoveResponse.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, packageMoveResponse.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, packageMoveResponse.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, packageMoveResponse.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, packageMoveResponse.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, packageMoveResponse.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, packageMoveResponse.selfUrl) &&
        Objects.equals(this.signatureUrl, packageMoveResponse.signatureUrl) &&
        Objects.equals(this.size, packageMoveResponse.size) &&
        Objects.equals(this.slug, packageMoveResponse.slug) &&
        Objects.equals(this.slugPerm, packageMoveResponse.slugPerm) &&
        Objects.equals(this.stage, packageMoveResponse.stage) &&
        Objects.equals(this.stageStr, packageMoveResponse.stageStr) &&
        Objects.equals(this.stageUpdatedAt, packageMoveResponse.stageUpdatedAt) &&
        Objects.equals(this.status, packageMoveResponse.status) &&
        Objects.equals(this.statusReason, packageMoveResponse.statusReason) &&
        Objects.equals(this.statusStr, packageMoveResponse.statusStr) &&
        Objects.equals(this.statusUpdatedAt, packageMoveResponse.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, packageMoveResponse.statusUrl) &&
        Objects.equals(this.subtype, packageMoveResponse.subtype) &&
        Objects.equals(this.summary, packageMoveResponse.summary) &&
        Objects.equals(this.syncFinishedAt, packageMoveResponse.syncFinishedAt) &&
        Objects.equals(this.syncProgress, packageMoveResponse.syncProgress) &&
        Objects.equals(this.tags, packageMoveResponse.tags) &&
        Objects.equals(this.tagsImmutable, packageMoveResponse.tagsImmutable) &&
        Objects.equals(this.typeDisplay, packageMoveResponse.typeDisplay) &&
        Objects.equals(this.uploadedAt, packageMoveResponse.uploadedAt) &&
        Objects.equals(this.uploader, packageMoveResponse.uploader) &&
        Objects.equals(this.uploaderUrl, packageMoveResponse.uploaderUrl) &&
        Objects.equals(this.version, packageMoveResponse.version) &&
        Objects.equals(this.versionOrig, packageMoveResponse.versionOrig) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, packageMoveResponse.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class PackageMoveResponse {\n");
