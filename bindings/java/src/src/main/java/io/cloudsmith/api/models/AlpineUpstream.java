...
public class AlpineUpstream implements Serializable {
  ...
  public AlpineUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public AlpineUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public AlpineUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public AlpineUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public AlpineUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public AlpineUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public AlpineUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public AlpineUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public AlpineUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public AlpineUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AlpineUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public AlpineUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public AlpineUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AlpineUpstream alpineUpstream = (AlpineUpstream) o;
    return Objects.equals(this.authMode, alpineUpstream.authMode) &&
        Objects.equals(this.authSecret, alpineUpstream.authSecret) &&
        Objects.equals(this.authUsername, alpineUpstream.authUsername) &&
        Objects.equals(this.available, alpineUpstream.available) &&
        Objects.equals(this.canReindex, alpineUpstream.canReindex) &&
        Objects.equals(this.createdAt, alpineUpstream.createdAt) &&
        Objects.equals(this.disableReason, alpineUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, alpineUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, alpineUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, alpineUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, alpineUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, alpineUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, alpineUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, alpineUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, alpineUpstream.indexStatus) &&
        Objects.equals(this.isActive, alpineUpstream.isActive) &&
        Objects.equals(this.lastIndexed, alpineUpstream.lastIndexed) &&
        Objects.equals(this.mode, alpineUpstream.mode) &&
        ...
        Objects.equals(this.verifySsl, alpineUpstream.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlpineUpstream {\n");
