...
public class NpmUpstreamRequest implements Serializable {
  ...
  public NpmUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public NpmUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public NpmUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public NpmUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public NpmUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public NpmUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NpmUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NpmUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public NpmUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public NpmUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public NpmUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public NpmUpstreamRequest trustLevel(TrustLevelEnum trustLevel) {
  ...
  **/
  ...
  public NpmUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public NpmUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NpmUpstreamRequest npmUpstreamRequest = (NpmUpstreamRequest) o;
    return Objects.equals(this.authMode, npmUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, npmUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, npmUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, npmUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, npmUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, npmUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, npmUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, npmUpstreamRequest.isActive) &&
        Objects.equals(this.mode, npmUpstreamRequest.mode) &&
        Objects.equals(this.name, npmUpstreamRequest.name) &&
        Objects.equals(this.priority, npmUpstreamRequest.priority) &&
        Objects.equals(this.trustLevel, npmUpstreamRequest.trustLevel) &&
        Objects.equals(this.upstreamUrl, npmUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, npmUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class NpmUpstreamRequest {\n");
