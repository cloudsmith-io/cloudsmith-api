...
public class GoUpstreamRequestPatch implements Serializable {
  ...
  public GoUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public GoUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public GoUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public GoUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public GoUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public GoUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public GoUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public GoUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public GoUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public GoUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public GoUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public GoUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public GoUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GoUpstreamRequestPatch goUpstreamRequestPatch = (GoUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, goUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, goUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, goUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, goUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, goUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, goUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, goUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, goUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, goUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, goUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, goUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, goUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, goUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoUpstreamRequestPatch {\n");
