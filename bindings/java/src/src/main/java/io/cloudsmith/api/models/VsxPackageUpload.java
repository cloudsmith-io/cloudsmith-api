...
public class VsxPackageUpload implements Serializable {
  ...
  **/
  ...
  public VsxPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public VsxPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public VsxPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public VsxPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public VsxPackageUpload vulnerabilityCounts(WebOSVSeverityCounts vulnerabilityCounts) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VsxPackageUpload vsxPackageUpload = (VsxPackageUpload) o;
    return Objects.equals(this.architectures, vsxPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, vsxPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, vsxPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, vsxPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, vsxPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, vsxPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, vsxPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, vsxPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, vsxPackageUpload.description) &&
        Objects.equals(this.displayName, vsxPackageUpload.displayName) &&
        Objects.equals(this.distro, vsxPackageUpload.distro) &&
        Objects.equals(this.distroVersion, vsxPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, vsxPackageUpload.downloads) &&
        Objects.equals(this.epoch, vsxPackageUpload.epoch) &&
        Objects.equals(this.extension, vsxPackageUpload.extension) &&
        Objects.equals(this.filename, vsxPackageUpload.filename) &&
        Objects.equals(this.files, vsxPackageUpload.files) &&
        Objects.equals(this.format, vsxPackageUpload.format) &&
        Objects.equals(this.formatUrl, vsxPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, vsxPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, vsxPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, vsxPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, vsxPackageUpload.identifiers) &&
        Objects.equals(this.indexed, vsxPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, vsxPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, vsxPackageUpload.isCopyable) &&
        Objects.equals(this.isDeleteable, vsxPackageUpload.isDeleteable) &&
        Objects.equals(this.isDownloadable, vsxPackageUpload.isDownloadable) &&
        Objects.equals(this.isHidden, vsxPackageUpload.isHidden) &&
        Objects.equals(this.isMalwareDetected, vsxPackageUpload.isMalwareDetected) &&
        Objects.equals(this.isMoveable, vsxPackageUpload.isMoveable) &&
        Objects.equals(this.isQuarantinable, vsxPackageUpload.isQuarantinable) &&
        Objects.equals(this.isQuarantined, vsxPackageUpload.isQuarantined) &&
        Objects.equals(this.isResyncable, vsxPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, vsxPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, vsxPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, vsxPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, vsxPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, vsxPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, vsxPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, vsxPackageUpload.license) &&
        Objects.equals(this.name, vsxPackageUpload.name) &&
        Objects.equals(this.namespace, vsxPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, vsxPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, vsxPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, vsxPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, vsxPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, vsxPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, vsxPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, vsxPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, vsxPackageUpload.rawLicense) &&
        Objects.equals(this.release, vsxPackageUpload.release) &&
        Objects.equals(this.repository, vsxPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, vsxPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, vsxPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, vsxPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, vsxPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, vsxPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, vsxPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, vsxPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, vsxPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, vsxPackageUpload.signatureUrl) &&
        Objects.equals(this.size, vsxPackageUpload.size) &&
        Objects.equals(this.slug, vsxPackageUpload.slug) &&
        Objects.equals(this.slugPerm, vsxPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, vsxPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, vsxPackageUpload.stage) &&
        Objects.equals(this.stageStr, vsxPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, vsxPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, vsxPackageUpload.status) &&
        Objects.equals(this.statusReason, vsxPackageUpload.statusReason) &&
        Objects.equals(this.statusStr, vsxPackageUpload.statusStr) &&
        Objects.equals(this.statusUpdatedAt, vsxPackageUpload.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, vsxPackageUpload.statusUrl) &&
        Objects.equals(this.storePath, vsxPackageUpload.storePath) &&
        Objects.equals(this.subtype, vsxPackageUpload.subtype) &&
        Objects.equals(this.summary, vsxPackageUpload.summary) &&
        Objects.equals(this.syncFinishedAt, vsxPackageUpload.syncFinishedAt) &&
        Objects.equals(this.syncProgress, vsxPackageUpload.syncProgress) &&
        Objects.equals(this.tagsAutomatic, vsxPackageUpload.tagsAutomatic) &&
        Objects.equals(this.tagsImmutable, vsxPackageUpload.tagsImmutable) &&
        Objects.equals(this.tagsStatic, vsxPackageUpload.tagsStatic) &&
        Objects.equals(this.typeDisplay, vsxPackageUpload.typeDisplay) &&
        Objects.equals(this.uploadedAt, vsxPackageUpload.uploadedAt) &&
        Objects.equals(this.uploader, vsxPackageUpload.uploader) &&
        Objects.equals(this.uploaderUrl, vsxPackageUpload.uploaderUrl) &&
        Objects.equals(this.version, vsxPackageUpload.version) &&
        Objects.equals(this.versionOrig, vsxPackageUpload.versionOrig) &&
        Objects.equals(this.vulnerabilityCounts, vsxPackageUpload.vulnerabilityCounts) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, vsxPackageUpload.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class VsxPackageUpload {\n");
