...
public class DockerUpstream implements Serializable {
  ...
  public DockerUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public DockerUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public DockerUpstream authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public DockerUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public DockerUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DockerUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public DockerUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public DockerUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DockerUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public DockerUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public DockerUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DockerUpstream dockerUpstream = (DockerUpstream) o;
    return Objects.equals(this.authMode, dockerUpstream.authMode) &&
        ...
        Objects.equals(this.pendingValidation, dockerUpstream.pendingValidation) &&
        Objects.equals(this.priority, dockerUpstream.priority) &&
        Objects.equals(this.slugPerm, dockerUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, dockerUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, dockerUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, dockerUpstream.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class DockerUpstream {\n");
