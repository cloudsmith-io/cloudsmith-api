...
public class RepositoryTokenResponse implements Serializable {
  ...
  **/
  ...
  public RepositoryTokenResponse eulaAccepted(Eula eulaAccepted) {
 ...
 @Size(min=1)  @ApiModelProperty(value = "")
  ...
  public RepositoryTokenResponse eulaRequired(Boolean eulaRequired) {
  ...
  **/
  ...
  public RepositoryTokenResponse isActive(Boolean isActive) {
  ...
  **/
  ...
  public RepositoryTokenResponse limitBandwidth(java.math.BigInteger limitBandwidth) {
 ...
 @Min(-9223372036854775808L) @Max(9223372036854775807L)  @ApiModelProperty(value = "The maximum download bandwidth allowed for the token. Values are expressed as the selected unit of bandwidth. Please note that since downloads are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point. ")
  ...
  public RepositoryTokenResponse limitBandwidthUnit(String limitBandwidthUnit) {
  ...
  **/
  ...
  public RepositoryTokenResponse limitDateRangeFrom(OffsetDateTime limitDateRangeFrom) {
  ...
  **/
  ...
  public RepositoryTokenResponse limitDateRangeTo(OffsetDateTime limitDateRangeTo) {
  ...
  **/
  ...
  public RepositoryTokenResponse limitNumClients(java.math.BigInteger limitNumClients) {
 ...
 @Min(-9223372036854775808L) @Max(9223372036854775807L)  @ApiModelProperty(value = "The maximum number of unique clients allowed for the token. Please note that since clients are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point.")
  ...
  public RepositoryTokenResponse limitNumDownloads(java.math.BigInteger limitNumDownloads) {
 ...
 @Min(-9223372036854775808L) @Max(9223372036854775807L)  @ApiModelProperty(value = "The maximum number of downloads allowed for the token. Please note that since downloads are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point.")
  ...
  public RepositoryTokenResponse limitPackageQuery(String limitPackageQuery) {
 ...
 @Size(max=1024)  @ApiModelProperty(value = "The package-based search query to apply to restrict downloads to. This uses the same syntax as the standard search used for repositories, and also supports boolean logic operators such as OR/AND/NOT and parentheses for grouping. This will still allow access to non-package files, such as metadata.")
  ...
  public RepositoryTokenResponse limitPathQuery(String limitPathQuery) {
 ...
 @Size(max=1024)  @ApiModelProperty(value = "The path-based search query to apply to restrict downloads to. This supports boolean logic operators such as OR/AND/NOT and parentheses for grouping. The path evaluated does not include the domain name, the namespace, the entitlement code used, the package format, etc. and it always starts with a forward slash.")
  ...
  public RepositoryTokenResponse metadata(Object metadata) {
  ...
  **/
  ...
  public RepositoryTokenResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public RepositoryTokenResponse scheduledResetAt(OffsetDateTime scheduledResetAt) {
  ...
  **/
  ...
  public RepositoryTokenResponse scheduledResetPeriod(String scheduledResetPeriod) {
 ...
 @Pattern(regexp="^[-a-zA-Z0-9_]+$") @Size(min=1)  @ApiModelProperty(value = "")
  ...
  public RepositoryTokenResponse token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RepositoryTokenResponse repositoryTokenResponse = (RepositoryTokenResponse) o;
    return Objects.equals(this.clients, repositoryTokenResponse.clients) &&
        Objects.equals(this.createdAt, repositoryTokenResponse.createdAt) &&
        Objects.equals(this.createdBy, repositoryTokenResponse.createdBy) &&
        Objects.equals(this.createdByUrl, repositoryTokenResponse.createdByUrl) &&
        Objects.equals(this._default, repositoryTokenResponse._default) &&
        Objects.equals(this.disableUrl, repositoryTokenResponse.disableUrl) &&
        Objects.equals(this.downloads, repositoryTokenResponse.downloads) &&
        Objects.equals(this.enableUrl, repositoryTokenResponse.enableUrl) &&
        Objects.equals(this.eulaAccepted, repositoryTokenResponse.eulaAccepted) &&
        Objects.equals(this.eulaAcceptedAt, repositoryTokenResponse.eulaAcceptedAt) &&
        Objects.equals(this.eulaAcceptedFrom, repositoryTokenResponse.eulaAcceptedFrom) &&
        Objects.equals(this.eulaRequired, repositoryTokenResponse.eulaRequired) &&
        Objects.equals(this.hasLimits, repositoryTokenResponse.hasLimits) &&
        Objects.equals(this.identifier, repositoryTokenResponse.identifier) &&
        Objects.equals(this.isActive, repositoryTokenResponse.isActive) &&
        Objects.equals(this.isLimited, repositoryTokenResponse.isLimited) &&
        Objects.equals(this.limitBandwidth, repositoryTokenResponse.limitBandwidth) &&
        Objects.equals(this.limitBandwidthUnit, repositoryTokenResponse.limitBandwidthUnit) &&
        Objects.equals(this.limitDateRangeFrom, repositoryTokenResponse.limitDateRangeFrom) &&
        Objects.equals(this.limitDateRangeTo, repositoryTokenResponse.limitDateRangeTo) &&
        Objects.equals(this.limitNumClients, repositoryTokenResponse.limitNumClients) &&
        Objects.equals(this.limitNumDownloads, repositoryTokenResponse.limitNumDownloads) &&
        Objects.equals(this.limitPackageQuery, repositoryTokenResponse.limitPackageQuery) &&
        Objects.equals(this.limitPathQuery, repositoryTokenResponse.limitPathQuery) &&
        Objects.equals(this.metadata, repositoryTokenResponse.metadata) &&
        Objects.equals(this.name, repositoryTokenResponse.name) &&
        Objects.equals(this.refreshUrl, repositoryTokenResponse.refreshUrl) &&
        Objects.equals(this.resetUrl, repositoryTokenResponse.resetUrl) &&
        Objects.equals(this.scheduledResetAt, repositoryTokenResponse.scheduledResetAt) &&
        Objects.equals(this.scheduledResetPeriod, repositoryTokenResponse.scheduledResetPeriod) &&
        Objects.equals(this.selfUrl, repositoryTokenResponse.selfUrl) &&
        Objects.equals(this.slugPerm, repositoryTokenResponse.slugPerm) &&
        Objects.equals(this.token, repositoryTokenResponse.token) &&
        Objects.equals(this.updatedAt, repositoryTokenResponse.updatedAt) &&
        Objects.equals(this.updatedBy, repositoryTokenResponse.updatedBy) &&
        Objects.equals(this.updatedByUrl, repositoryTokenResponse.updatedByUrl) &&
        Objects.equals(this.usage, repositoryTokenResponse.usage) &&
        Objects.equals(this.user, repositoryTokenResponse.user) &&
        Objects.equals(this.userUrl, repositoryTokenResponse.userUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepositoryTokenResponse {\n");
