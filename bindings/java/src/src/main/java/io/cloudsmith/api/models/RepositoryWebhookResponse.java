...
public class RepositoryWebhookResponse implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "")
  ...
  public RepositoryWebhookResponse events(List<EventsEnum> events) {
    this.events = events;
    return this;
  }

  public RepositoryWebhookResponse addEventsItem(EventsEnum eventsItem) {
  ...
  **/
  ...
  public RepositoryWebhookResponse isActive(Boolean isActive) {
  ...
  **/
  ...
  public RepositoryWebhookResponse packageQuery(String packageQuery) {
 ...
 @Size(max=1024)  @ApiModelProperty(value = "The package-based search query for webhooks to fire. This uses the same syntax as the standard search used for repositories, and also supports boolean logic operators such as OR/AND/NOT and parentheses for grouping. If a package does not match, the webhook will not fire.")
  ...
  public RepositoryWebhookResponse requestBodyFormat(java.math.BigInteger requestBodyFormat) {
 ...
 @Size(min=1)  @ApiModelProperty(value = "")
  ...
  public RepositoryWebhookResponse requestBodyTemplateFormat(java.math.BigInteger requestBodyTemplateFormat) {
 ...
 @Size(min=1)  @ApiModelProperty(value = "")
  ...
  public RepositoryWebhookResponse requestContentType(String requestContentType) {
 ...
 @Size(max=128)  @ApiModelProperty(value = "The value that will be sent for the 'Content Type' header. ")
  ...
  public RepositoryWebhookResponse secretHeader(String secretHeader) {
 ...
 @Pattern(regexp="^[-a-zA-Z0-9_]+$") @Size(min=1)  @ApiModelProperty(value = "")
  ...
  public RepositoryWebhookResponse targetUrl(String targetUrl) {
 ...
 @Size(min=1,max=255)  @ApiModelProperty(required = true, value = "The destination URL that webhook payloads will be POST'ed to.")
  ...
  public RepositoryWebhookResponse templates(List<WebhookTemplate> templates) {
    this.templates = templates;
    return this;
  }

  public RepositoryWebhookResponse addTemplatesItem(WebhookTemplate templatesItem) {
  ...
  **/
  ...
  public RepositoryWebhookResponse verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RepositoryWebhookResponse repositoryWebhookResponse = (RepositoryWebhookResponse) o;
    return Objects.equals(this.createdAt, repositoryWebhookResponse.createdAt) &&
        Objects.equals(this.createdBy, repositoryWebhookResponse.createdBy) &&
        Objects.equals(this.createdByUrl, repositoryWebhookResponse.createdByUrl) &&
        Objects.equals(this.disableReason, repositoryWebhookResponse.disableReason) &&
        Objects.equals(this.disableReasonStr, repositoryWebhookResponse.disableReasonStr) &&
        Objects.equals(this.events, repositoryWebhookResponse.events) &&
        Objects.equals(this.identifier, repositoryWebhookResponse.identifier) &&
        Objects.equals(this.isActive, repositoryWebhookResponse.isActive) &&
        Objects.equals(this.isLastResponseBad, repositoryWebhookResponse.isLastResponseBad) &&
        Objects.equals(this.lastResponseStatus, repositoryWebhookResponse.lastResponseStatus) &&
        Objects.equals(this.lastResponseStatusStr, repositoryWebhookResponse.lastResponseStatusStr) &&
        Objects.equals(this.numSent, repositoryWebhookResponse.numSent) &&
        Objects.equals(this.packageQuery, repositoryWebhookResponse.packageQuery) &&
        Objects.equals(this.requestBodyFormat, repositoryWebhookResponse.requestBodyFormat) &&
        Objects.equals(this.requestBodyFormatStr, repositoryWebhookResponse.requestBodyFormatStr) &&
        Objects.equals(this.requestBodyTemplateFormat, repositoryWebhookResponse.requestBodyTemplateFormat) &&
        Objects.equals(this.requestBodyTemplateFormatStr, repositoryWebhookResponse.requestBodyTemplateFormatStr) &&
        Objects.equals(this.requestContentType, repositoryWebhookResponse.requestContentType) &&
        Objects.equals(this.secretHeader, repositoryWebhookResponse.secretHeader) &&
        Objects.equals(this.selfUrl, repositoryWebhookResponse.selfUrl) &&
        Objects.equals(this.slugPerm, repositoryWebhookResponse.slugPerm) &&
        Objects.equals(this.targetUrl, repositoryWebhookResponse.targetUrl) &&
        Objects.equals(this.templates, repositoryWebhookResponse.templates) &&
        Objects.equals(this.updatedAt, repositoryWebhookResponse.updatedAt) &&
        Objects.equals(this.updatedBy, repositoryWebhookResponse.updatedBy) &&
        Objects.equals(this.updatedByUrl, repositoryWebhookResponse.updatedByUrl) &&
        Objects.equals(this.verifySsl, repositoryWebhookResponse.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepositoryWebhookResponse {\n");
