...
public class AlpineUpstreamRequest implements Serializable {
  ...
  public AlpineUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public AlpineUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public AlpineUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public AlpineUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public AlpineUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public AlpineUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public AlpineUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public AlpineUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public AlpineUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public AlpineUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public AlpineUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public AlpineUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AlpineUpstreamRequest alpineUpstreamRequest = (AlpineUpstreamRequest) o;
    return Objects.equals(this.authMode, alpineUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, alpineUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, alpineUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, alpineUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, alpineUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, alpineUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, alpineUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, alpineUpstreamRequest.isActive) &&
  ...
  public String toString() {
    ...
    sb.append("class AlpineUpstreamRequest {\n");
