...
public class HuggingfaceUpstreamRequestPatch implements Serializable {
  ...
  public HuggingfaceUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public HuggingfaceUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public HuggingfaceUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public HuggingfaceUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public HuggingfaceUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HuggingfaceUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HuggingfaceUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public HuggingfaceUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public HuggingfaceUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public HuggingfaceUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public HuggingfaceUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public HuggingfaceUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HuggingfaceUpstreamRequestPatch huggingfaceUpstreamRequestPatch = (HuggingfaceUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, huggingfaceUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, huggingfaceUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, huggingfaceUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, huggingfaceUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, huggingfaceUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, huggingfaceUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, huggingfaceUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, huggingfaceUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, huggingfaceUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, huggingfaceUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, huggingfaceUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, huggingfaceUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, huggingfaceUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class HuggingfaceUpstreamRequestPatch {\n");
