...
public class SwiftPackageUpload implements Serializable {
  ...
  **/
  ...
  public SwiftPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public SwiftPackageUpload version(String version) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.architectures, swiftPackageUpload.architectures) &&
        ...
        Objects.equals(this.checksumSha256, swiftPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, swiftPackageUpload.checksumSha512) &&
        ...
        Objects.equals(this.displaySource, swiftPackageUpload.displaySource) &&
        ...
        Objects.equals(this.epoch, swiftPackageUpload.epoch) &&
        Objects.equals(this.extension, swiftPackageUpload.extension) &&
        Objects.equals(this.filename, swiftPackageUpload.filename) &&
        Objects.equals(this.files, swiftPackageUpload.files) &&
        Objects.equals(this.format, swiftPackageUpload.format) &&
        Objects.equals(this.formatUrl, swiftPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, swiftPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, swiftPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, swiftPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, swiftPackageUpload.identifiers) &&
        Objects.equals(this.indexed, swiftPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, swiftPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, swiftPackageUpload.isCopyable) &&
        Objects.equals(this.isDeleteable, swiftPackageUpload.isDeleteable) &&
        Objects.equals(this.isDownloadable, swiftPackageUpload.isDownloadable) &&
        Objects.equals(this.isHidden, swiftPackageUpload.isHidden) &&
        Objects.equals(this.isMoveable, swiftPackageUpload.isMoveable) &&
        Objects.equals(this.isQuarantinable, swiftPackageUpload.isQuarantinable) &&
        Objects.equals(this.isQuarantined, swiftPackageUpload.isQuarantined) &&
        Objects.equals(this.isResyncable, swiftPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, swiftPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, swiftPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, swiftPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, swiftPackageUpload.isSyncFailed) &&
        ...
        Objects.equals(this.osiApproved, swiftPackageUpload.osiApproved) &&
        ...
        Objects.equals(this.securityScanStatusUpdatedAt, swiftPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, swiftPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, swiftPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, swiftPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, swiftPackageUpload.signatureUrl) &&
        ...
        Objects.equals(this.status, swiftPackageUpload.status) &&
        Objects.equals(this.statusReason, swiftPackageUpload.statusReason) &&
        Objects.equals(this.statusStr, swiftPackageUpload.statusStr) &&
        Objects.equals(this.statusUpdatedAt, swiftPackageUpload.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, swiftPackageUpload.statusUrl) &&
        Objects.equals(this.storePath, swiftPackageUpload.storePath) &&
        Objects.equals(this.subtype, swiftPackageUpload.subtype) &&
        ...
        Objects.equals(this.tagsStatic, swiftPackageUpload.tagsStatic) &&
        ...
        Objects.equals(this.uploader, swiftPackageUpload.uploader) &&
        Objects.equals(this.uploaderUrl, swiftPackageUpload.uploaderUrl) &&
        Objects.equals(this.version, swiftPackageUpload.version) &&
        Objects.equals(this.versionOrig, swiftPackageUpload.versionOrig) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, swiftPackageUpload.vulnerabilityScanResultsUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(architectures, authorName, authorOrg, cdnUrl, checksumMd5, checksumSha1, checksumSha256, checksumSha512, dependenciesChecksumMd5, dependenciesUrl, description, displayName, displaySource, distro, distroVersion, downloads, epoch, extension, filename, files, format, formatUrl, freeableStorage, fullyQualifiedName, identifierPerm, identifiers, indexed, isCancellable, isCopyable, isDeleteable, isDownloadable, isHidden, isMoveable, isQuarantinable, isQuarantined, isResyncable, isSecurityScannable, isSyncAwaiting, isSyncCompleted, isSyncFailed, isSyncInFlight, isSyncInProgress, license, licenseUrl, name, namespace, namespaceUrl, numFiles, originRepository, originRepositoryUrl, osiApproved, packageType, policyViolated, rawLicense, readmeUrl, release, repository, repositoryUrl, scope, securityScanCompletedAt, securityScanStartedAt, securityScanStatus, securityScanStatusUpdatedAt, selfHtmlUrl, selfUrl, selfWebappUrl, signatureUrl, size, slug, slugPerm, spdxLicense, stage, stageStr, stageUpdatedAt, status, statusReason, statusStr, statusUpdatedAt, statusUrl, storePath, subtype, summary, syncFinishedAt, syncProgress, tagsAutomatic, tagsImmutable, tagsStatic, typeDisplay, uploadedAt, uploader, uploaderUrl, version, versionOrig, vulnerabilityScanResultsUrl);
  }
