...
public class DebUpstreamRequest implements Serializable {
  ...
  public DebUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public DebUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public DebUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public DebUpstreamRequest component(String component) {
 ...
 @Size(min=1,max=64)  @ApiModelProperty(value = "The component to fetch from the upstream")
  ...
  public DebUpstreamRequest distroVersions(List<String> distroVersions) {
    this.distroVersions = distroVersions;
    return this;
  }

  public DebUpstreamRequest addDistroVersionsItem(String distroVersionsItem) {
  ...
  **/
  @NotNull
  @ApiModelProperty(required = true, value = "The distribution version that packages found on this upstream could be associated with.")
  ...
  public DebUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public DebUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public DebUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DebUpstreamRequest extraValue2(String extraValue2) {
  ...
  **/
  ...
  public DebUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public DebUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public DebUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public DebUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public DebUpstreamRequest upstreamDistribution(String upstreamDistribution) {
 ...
 @Size(min=1,max=64)  @ApiModelProperty(value = "The distribution to fetch from the upstream")
  ...
  public DebUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public DebUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DebUpstreamRequest debUpstreamRequest = (DebUpstreamRequest) o;
    return Objects.equals(this.authMode, debUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, debUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, debUpstreamRequest.authUsername) &&
        Objects.equals(this.component, debUpstreamRequest.component) &&
        Objects.equals(this.distroVersions, debUpstreamRequest.distroVersions) &&
        Objects.equals(this.extraHeader1, debUpstreamRequest.extraHeader1) &&
        ...
        Objects.equals(this.name, debUpstreamRequest.name) &&
        Objects.equals(this.priority, debUpstreamRequest.priority) &&
        Objects.equals(this.upstreamDistribution, debUpstreamRequest.upstreamDistribution) &&
        Objects.equals(this.upstreamUrl, debUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, debUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class DebUpstreamRequest {\n");
