...
public class HelmUpstreamRequestPatch implements Serializable {
  ...
  public HelmUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public HelmUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public HelmUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public HelmUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public HelmUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public HelmUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HelmUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HelmUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public HelmUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public HelmUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public HelmUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public HelmUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public HelmUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HelmUpstreamRequestPatch helmUpstreamRequestPatch = (HelmUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, helmUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, helmUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, helmUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, helmUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, helmUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, helmUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, helmUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, helmUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, helmUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, helmUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, helmUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, helmUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, helmUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class HelmUpstreamRequestPatch {\n");
