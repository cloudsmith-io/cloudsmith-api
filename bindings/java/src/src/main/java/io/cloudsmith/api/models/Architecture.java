...
public class Architecture implements Serializable {
  ...
  public Architecture description(String description) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "")
  ...
  public Architecture name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Size(min=1,max=32)  @ApiModelProperty(required = true, value = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.description, architecture.description) &&
        Objects.equals(this.name, architecture.name);
  }
