...
public class HexUpstream implements Serializable {
  ...
  public HexUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public HexUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public HexUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public HexUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public HexUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public HexUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HexUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public HexUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public HexUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public HexUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public HexUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public HexUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public HexUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HexUpstream hexUpstream = (HexUpstream) o;
    return Objects.equals(this.authMode, hexUpstream.authMode) &&
        Objects.equals(this.authSecret, hexUpstream.authSecret) &&
        Objects.equals(this.authUsername, hexUpstream.authUsername) &&
        Objects.equals(this.available, hexUpstream.available) &&
        Objects.equals(this.canReindex, hexUpstream.canReindex) &&
        Objects.equals(this.createdAt, hexUpstream.createdAt) &&
        Objects.equals(this.disableReason, hexUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, hexUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, hexUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, hexUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, hexUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, hexUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, hexUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, hexUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, hexUpstream.indexStatus) &&
        Objects.equals(this.isActive, hexUpstream.isActive) &&
        Objects.equals(this.lastIndexed, hexUpstream.lastIndexed) &&
        Objects.equals(this.mode, hexUpstream.mode) &&
        Objects.equals(this.name, hexUpstream.name) &&
        Objects.equals(this.pendingValidation, hexUpstream.pendingValidation) &&
        Objects.equals(this.priority, hexUpstream.priority) &&
        Objects.equals(this.slugPerm, hexUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, hexUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, hexUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, hexUpstream.verifySsl);
  }
