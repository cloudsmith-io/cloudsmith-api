...
public class CondaUpstreamRequestPatch implements Serializable {
  ...
  public CondaUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public CondaUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public CondaUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public CondaUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public CondaUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CondaUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CondaUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public CondaUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public CondaUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public CondaUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public CondaUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public CondaUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CondaUpstreamRequestPatch condaUpstreamRequestPatch = (CondaUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, condaUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, condaUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, condaUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, condaUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, condaUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, condaUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, condaUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, condaUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, condaUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, condaUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, condaUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, condaUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, condaUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class CondaUpstreamRequestPatch {\n");
