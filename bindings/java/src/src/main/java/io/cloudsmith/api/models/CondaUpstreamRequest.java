...
public class CondaUpstreamRequest implements Serializable {
  ...
  public CondaUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public CondaUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public CondaUpstreamRequest authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public CondaUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public CondaUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CondaUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CondaUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public CondaUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public CondaUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public CondaUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public CondaUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public CondaUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CondaUpstreamRequest condaUpstreamRequest = (CondaUpstreamRequest) o;
    return Objects.equals(this.authMode, condaUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, condaUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, condaUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, condaUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, condaUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, condaUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, condaUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, condaUpstreamRequest.isActive) &&
        Objects.equals(this.mode, condaUpstreamRequest.mode) &&
        Objects.equals(this.name, condaUpstreamRequest.name) &&
        Objects.equals(this.priority, condaUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, condaUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, condaUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class CondaUpstreamRequest {\n");
