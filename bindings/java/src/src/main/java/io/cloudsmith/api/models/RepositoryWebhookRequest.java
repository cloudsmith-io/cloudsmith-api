...
public class RepositoryWebhookRequest implements Serializable {
  ...
  public RepositoryWebhookRequest events(List<EventsEnum> events) {
    this.events = events;
    return this;
  }

  public RepositoryWebhookRequest addEventsItem(EventsEnum eventsItem) {
  ...
  **/
  ...
  public RepositoryWebhookRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public RepositoryWebhookRequest packageQuery(String packageQuery) {
 ...
 @Size(max=1024)  @ApiModelProperty(value = "The package-based search query for webhooks to fire. This uses the same syntax as the standard search used for repositories, and also supports boolean logic operators such as OR/AND/NOT and parentheses for grouping. If a package does not match, the webhook will not fire.")
  ...
  public RepositoryWebhookRequest requestBodyFormat(java.math.BigInteger requestBodyFormat) {
  ...
  **/
  ...
  public RepositoryWebhookRequest requestBodyTemplateFormat(java.math.BigInteger requestBodyTemplateFormat) {
  ...
  **/
  ...
  public RepositoryWebhookRequest requestContentType(String requestContentType) {
 ...
 @Size(max=128)  @ApiModelProperty(value = "The value that will be sent for the 'Content Type' header. ")
  ...
  public RepositoryWebhookRequest secretHeader(String secretHeader) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The header to send the predefined secret in. This must be unique from existing headers or it won't be sent. You can use this as a form of authentication on the endpoint side.")
  ...
  public RepositoryWebhookRequest secretValue(String secretValue) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=512)  @ApiModelProperty(value = "The value for the predefined secret (note: this is treated as a passphrase and is encrypted when we store it). You can use this as a form of authentication on the endpoint side.")
  ...
  public RepositoryWebhookRequest signatureKey(String signatureKey) {
 ...
 @Size(min=1,max=512)  @ApiModelProperty(value = "The value for the signature key - This is used to generate an HMAC-based hex digest of the request body, which we send as the X-Cloudsmith-Signature header so that you can ensure that the request wasn't modified by a malicious party (note: this is treated as a passphrase and is encrypted when we store it).")
  ...
  public RepositoryWebhookRequest targetUrl(String targetUrl) {
 ...
 @Size(min=1,max=255)  @ApiModelProperty(required = true, value = "The destination URL that webhook payloads will be POST'ed to.")
  ...
  public RepositoryWebhookRequest templates(List<WebhookTemplate> templates) {
    this.templates = templates;
    return this;
  }

  public RepositoryWebhookRequest addTemplatesItem(WebhookTemplate templatesItem) {
  ...
  **/
  ...
  public RepositoryWebhookRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RepositoryWebhookRequest repositoryWebhookRequest = (RepositoryWebhookRequest) o;
    return Objects.equals(this.events, repositoryWebhookRequest.events) &&
        Objects.equals(this.isActive, repositoryWebhookRequest.isActive) &&
        Objects.equals(this.packageQuery, repositoryWebhookRequest.packageQuery) &&
        Objects.equals(this.requestBodyFormat, repositoryWebhookRequest.requestBodyFormat) &&
        Objects.equals(this.requestBodyTemplateFormat, repositoryWebhookRequest.requestBodyTemplateFormat) &&
        Objects.equals(this.requestContentType, repositoryWebhookRequest.requestContentType) &&
        Objects.equals(this.secretHeader, repositoryWebhookRequest.secretHeader) &&
        Objects.equals(this.secretValue, repositoryWebhookRequest.secretValue) &&
        Objects.equals(this.signatureKey, repositoryWebhookRequest.signatureKey) &&
        Objects.equals(this.targetUrl, repositoryWebhookRequest.targetUrl) &&
        Objects.equals(this.templates, repositoryWebhookRequest.templates) &&
        Objects.equals(this.verifySsl, repositoryWebhookRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepositoryWebhookRequest {\n");
