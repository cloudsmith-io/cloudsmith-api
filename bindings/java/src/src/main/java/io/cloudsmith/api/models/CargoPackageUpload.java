...
public class CargoPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public CargoPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public CargoPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public CargoPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public CargoPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CargoPackageUpload cargoPackageUpload = (CargoPackageUpload) o;
    return Objects.equals(this.architectures, cargoPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, cargoPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, cargoPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, cargoPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, cargoPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, cargoPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, cargoPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, cargoPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, cargoPackageUpload.description) &&
        Objects.equals(this.displayName, cargoPackageUpload.displayName) &&
        Objects.equals(this.displaySource, cargoPackageUpload.displaySource) &&
        Objects.equals(this.distro, cargoPackageUpload.distro) &&
        Objects.equals(this.distroVersion, cargoPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, cargoPackageUpload.downloads) &&
        Objects.equals(this.epoch, cargoPackageUpload.epoch) &&
        Objects.equals(this.extension, cargoPackageUpload.extension) &&
        Objects.equals(this.filename, cargoPackageUpload.filename) &&
        Objects.equals(this.files, cargoPackageUpload.files) &&
        Objects.equals(this.format, cargoPackageUpload.format) &&
        Objects.equals(this.formatUrl, cargoPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, cargoPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, cargoPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, cargoPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, cargoPackageUpload.identifiers) &&
        Objects.equals(this.indexed, cargoPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, cargoPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, cargoPackageUpload.isCopyable) &&
        ...
        Objects.equals(this.isResyncable, cargoPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, cargoPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, cargoPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, cargoPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, cargoPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, cargoPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, cargoPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, cargoPackageUpload.license) &&
        Objects.equals(this.name, cargoPackageUpload.name) &&
        Objects.equals(this.namespace, cargoPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, cargoPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, cargoPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, cargoPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, cargoPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, cargoPackageUpload.osiApproved) &&
        ...
        Objects.equals(this.securityScanCompletedAt, cargoPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, cargoPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, cargoPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, cargoPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, cargoPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, cargoPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, cargoPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, cargoPackageUpload.signatureUrl) &&
        ...
        Objects.equals(this.status, cargoPackageUpload.status) &&
        Objects.equals(this.statusReason, cargoPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class CargoPackageUpload {\n");
