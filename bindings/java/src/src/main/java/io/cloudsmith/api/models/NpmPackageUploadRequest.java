...
public class NpmPackageUploadRequest implements Serializable {
 ...
 @Size(min=1,max=255)  @ApiModelProperty(value = "The default npm dist-tag for this package/version - This will replace any other package/version if they are using the same tag.")
  ...
  public NpmPackageUploadRequest packageFile(String packageFile) {
 ...
 @Size(min=1)  @ApiModelProperty(required = true, value = "The primary file for the package.")
  ...
  public NpmPackageUploadRequest republish(Boolean republish) {
  ...
  **/
  ...
  public NpmPackageUploadRequest tags(String tags) {
    this.tags = tags;
    return this;
  }
