...
public class RecycleBinApi {
    ...
    public PackageBulkActionResponse recycleBinAction(String owner, PackageRecycleBin data) throws ApiException {
        ApiResponse<PackageBulkActionResponse> resp = recycleBinActionWithHttpInfo(owner, data);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PackageBulkActionResponse> recycleBinActionWithHttpInfo( @NotNull String owner,  PackageRecycleBin data) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call recycleBinActionAsync(String owner, PackageRecycleBin data, final ApiCallback<PackageBulkActionResponse> callback) throws ApiException {
