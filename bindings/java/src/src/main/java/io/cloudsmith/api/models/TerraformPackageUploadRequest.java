...
public class TerraformPackageUploadRequest implements Serializable {
  ...
  **/
  ...
  public TerraformPackageUploadRequest packageFile(String packageFile) {
 ...
 @Size(min=1)  @ApiModelProperty(required = true, value = "The primary file for the package.")
  ...
  public TerraformPackageUploadRequest republish(Boolean republish) {
  ...
  **/
  ...
  public TerraformPackageUploadRequest tags(String tags) {
    this.tags = tags;
    return this;
  }
 ...
 @Size(min=1,max=1024)  @ApiModelProperty(value = "A comma-separated values list of tags to add to the package.")
  ...
  public TerraformPackageUploadRequest vulnerabilityCounts(WebOSVSeverityCounts vulnerabilityCounts) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TerraformPackageUploadRequest terraformPackageUploadRequest = (TerraformPackageUploadRequest) o;
    return Objects.equals(this.isMalwareDetected, terraformPackageUploadRequest.isMalwareDetected) &&
        Objects.equals(this.packageFile, terraformPackageUploadRequest.packageFile) &&
        Objects.equals(this.republish, terraformPackageUploadRequest.republish) &&
        Objects.equals(this.tags, terraformPackageUploadRequest.tags) &&
        Objects.equals(this.vulnerabilityCounts, terraformPackageUploadRequest.vulnerabilityCounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerraformPackageUploadRequest {\n");
