...
public class DockerUpstreamRequest implements Serializable {
  ...
  **/
  ...
  public DockerUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public DockerUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public DockerUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public DockerUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public DockerUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DockerUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DockerUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public DockerUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public DockerUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public DockerUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public DockerUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public DockerUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.authCertificate, dockerUpstreamRequest.authCertificate) &&
        ...
        Objects.equals(this.extraHeader2, dockerUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, dockerUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, dockerUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, dockerUpstreamRequest.isActive) &&
        Objects.equals(this.mode, dockerUpstreamRequest.mode) &&
        Objects.equals(this.name, dockerUpstreamRequest.name) &&
        Objects.equals(this.priority, dockerUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, dockerUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, dockerUpstreamRequest.verifySsl);
  }
