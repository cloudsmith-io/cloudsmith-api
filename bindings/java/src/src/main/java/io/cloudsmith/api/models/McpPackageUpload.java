...
public class McpPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public McpPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public McpPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public McpPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public McpPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public McpPackageUpload version(String version) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    McpPackageUpload mcpPackageUpload = (McpPackageUpload) o;
    return Objects.equals(this.architectures, mcpPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, mcpPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, mcpPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, mcpPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, mcpPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, mcpPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, mcpPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, mcpPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, mcpPackageUpload.description) &&
        Objects.equals(this.displayName, mcpPackageUpload.displayName) &&
        Objects.equals(this.displaySource, mcpPackageUpload.displaySource) &&
        Objects.equals(this.distro, mcpPackageUpload.distro) &&
        Objects.equals(this.distroVersion, mcpPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, mcpPackageUpload.downloads) &&
        Objects.equals(this.epoch, mcpPackageUpload.epoch) &&
        Objects.equals(this.extension, mcpPackageUpload.extension) &&
        Objects.equals(this.filename, mcpPackageUpload.filename) &&
        Objects.equals(this.files, mcpPackageUpload.files) &&
        Objects.equals(this.format, mcpPackageUpload.format) &&
        Objects.equals(this.formatUrl, mcpPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, mcpPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, mcpPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, mcpPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, mcpPackageUpload.identifiers) &&
        Objects.equals(this.indexed, mcpPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, mcpPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, mcpPackageUpload.isCopyable) &&
        ...
        Objects.equals(this.isResyncable, mcpPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, mcpPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, mcpPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, mcpPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, mcpPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, mcpPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, mcpPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, mcpPackageUpload.license) &&
        Objects.equals(this.name, mcpPackageUpload.name) &&
        Objects.equals(this.namespace, mcpPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, mcpPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, mcpPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, mcpPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, mcpPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, mcpPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, mcpPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, mcpPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, mcpPackageUpload.rawLicense) &&
        Objects.equals(this.release, mcpPackageUpload.release) &&
        Objects.equals(this.repository, mcpPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, mcpPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, mcpPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, mcpPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, mcpPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, mcpPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, mcpPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, mcpPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, mcpPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, mcpPackageUpload.signatureUrl) &&
        Objects.equals(this.size, mcpPackageUpload.size) &&
        Objects.equals(this.slug, mcpPackageUpload.slug) &&
        Objects.equals(this.slugPerm, mcpPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, mcpPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, mcpPackageUpload.stage) &&
        Objects.equals(this.stageStr, mcpPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, mcpPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, mcpPackageUpload.status) &&
        Objects.equals(this.statusReason, mcpPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class McpPackageUpload {\n");
