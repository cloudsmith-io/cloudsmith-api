...
public class DebUpstream implements Serializable {
  ...
  public DebUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public DebUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public DebUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public DebUpstream addDistroVersionsItem(String distroVersionsItem) {
  ...
  **/
  ...
  public DebUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public DebUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public DebUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DebUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public DebUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DebUpstream upstreamDistribution(String upstreamDistribution) {
 ...
 @Size(min=1,max=64)  @ApiModelProperty(value = "The distribution to fetch from the upstream")
  ...
  public DebUpstream upstreamUrl(String upstreamUrl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DebUpstream debUpstream = (DebUpstream) o;
