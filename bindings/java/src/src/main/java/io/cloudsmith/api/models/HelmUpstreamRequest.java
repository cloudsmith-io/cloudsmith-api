...
public class HelmUpstreamRequest implements Serializable {
  ...
  public HelmUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public HelmUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public HelmUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public HelmUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public HelmUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public HelmUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HelmUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HelmUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public HelmUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public HelmUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public HelmUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public HelmUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public HelmUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HelmUpstreamRequest helmUpstreamRequest = (HelmUpstreamRequest) o;
    return Objects.equals(this.authMode, helmUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, helmUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, helmUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, helmUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, helmUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, helmUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, helmUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, helmUpstreamRequest.isActive) &&
        Objects.equals(this.mode, helmUpstreamRequest.mode) &&
        Objects.equals(this.name, helmUpstreamRequest.name) &&
        Objects.equals(this.priority, helmUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, helmUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, helmUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class HelmUpstreamRequest {\n");
