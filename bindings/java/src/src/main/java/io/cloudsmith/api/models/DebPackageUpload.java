...
public class DebPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public DebPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public DebPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public DebPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public DebPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DebPackageUpload debPackageUpload = (DebPackageUpload) o;
    return Objects.equals(this.architectures, debPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, debPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, debPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, debPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, debPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, debPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, debPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, debPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, debPackageUpload.description) &&
        Objects.equals(this.displayName, debPackageUpload.displayName) &&
        Objects.equals(this.displaySource, debPackageUpload.displaySource) &&
        Objects.equals(this.distro, debPackageUpload.distro) &&
        Objects.equals(this.distroVersion, debPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, debPackageUpload.downloads) &&
        Objects.equals(this.epoch, debPackageUpload.epoch) &&
        Objects.equals(this.extension, debPackageUpload.extension) &&
        Objects.equals(this.filename, debPackageUpload.filename) &&
        Objects.equals(this.files, debPackageUpload.files) &&
        Objects.equals(this.format, debPackageUpload.format) &&
        Objects.equals(this.formatUrl, debPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, debPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, debPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, debPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, debPackageUpload.identifiers) &&
        Objects.equals(this.indexed, debPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, debPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, debPackageUpload.isCopyable) &&
        ...
        Objects.equals(this.isResyncable, debPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, debPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, debPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, debPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, debPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, debPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, debPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, debPackageUpload.license) &&
        Objects.equals(this.name, debPackageUpload.name) &&
        Objects.equals(this.namespace, debPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, debPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, debPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, debPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, debPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, debPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, debPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, debPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, debPackageUpload.rawLicense) &&
        Objects.equals(this.release, debPackageUpload.release) &&
        Objects.equals(this.repository, debPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, debPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, debPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, debPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, debPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, debPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, debPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, debPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, debPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, debPackageUpload.signatureUrl) &&
        Objects.equals(this.size, debPackageUpload.size) &&
        Objects.equals(this.slug, debPackageUpload.slug) &&
        Objects.equals(this.slugPerm, debPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, debPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, debPackageUpload.stage) &&
        Objects.equals(this.stageStr, debPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, debPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, debPackageUpload.status) &&
        Objects.equals(this.statusReason, debPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class DebPackageUpload {\n");
