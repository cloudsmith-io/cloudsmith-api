...
public class NugetUpstreamRequestPatch implements Serializable {
  ...
  public NugetUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public NugetUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public NugetUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public NugetUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public NugetUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public NugetUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NugetUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NugetUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public NugetUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public NugetUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public NugetUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public NugetUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public NugetUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NugetUpstreamRequestPatch nugetUpstreamRequestPatch = (NugetUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, nugetUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, nugetUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, nugetUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, nugetUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, nugetUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, nugetUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, nugetUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, nugetUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, nugetUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, nugetUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, nugetUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, nugetUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, nugetUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class NugetUpstreamRequestPatch {\n");
