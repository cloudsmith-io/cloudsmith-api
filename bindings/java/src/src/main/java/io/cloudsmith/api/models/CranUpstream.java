...
public class CranUpstream implements Serializable {
  ...
  public CranUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public CranUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public CranUpstream authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public CranUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public CranUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CranUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public CranUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public CranUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public CranUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CranUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public CranUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CranUpstream cranUpstream = (CranUpstream) o;
    return Objects.equals(this.authMode, cranUpstream.authMode) &&
        Objects.equals(this.authSecret, cranUpstream.authSecret) &&
        Objects.equals(this.authUsername, cranUpstream.authUsername) &&
        Objects.equals(this.available, cranUpstream.available) &&
        Objects.equals(this.canReindex, cranUpstream.canReindex) &&
        Objects.equals(this.createdAt, cranUpstream.createdAt) &&
        Objects.equals(this.disableReason, cranUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, cranUpstream.disableReasonText) &&
        ...
        Objects.equals(this.extraValue2, cranUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, cranUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, cranUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, cranUpstream.indexStatus) &&
        Objects.equals(this.isActive, cranUpstream.isActive) &&
        Objects.equals(this.lastIndexed, cranUpstream.lastIndexed) &&
        ...
        Objects.equals(this.upstreamUrl, cranUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, cranUpstream.verifySsl);
  }
