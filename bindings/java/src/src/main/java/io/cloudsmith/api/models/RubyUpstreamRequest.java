...
public class RubyUpstreamRequest implements Serializable {
  ...
  public RubyUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public RubyUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public RubyUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public RubyUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public RubyUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public RubyUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public RubyUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public RubyUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public RubyUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public RubyUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public RubyUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public RubyUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public RubyUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RubyUpstreamRequest rubyUpstreamRequest = (RubyUpstreamRequest) o;
    return Objects.equals(this.authMode, rubyUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, rubyUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, rubyUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, rubyUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, rubyUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, rubyUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, rubyUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, rubyUpstreamRequest.isActive) &&
        Objects.equals(this.mode, rubyUpstreamRequest.mode) &&
        Objects.equals(this.name, rubyUpstreamRequest.name) &&
        Objects.equals(this.priority, rubyUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, rubyUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, rubyUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class RubyUpstreamRequest {\n");
