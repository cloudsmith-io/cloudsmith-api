...
public class HexPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public HexPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public HexPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public HexPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public HexPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HexPackageUpload hexPackageUpload = (HexPackageUpload) o;
    return Objects.equals(this.architectures, hexPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, hexPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, hexPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, hexPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, hexPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, hexPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, hexPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, hexPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, hexPackageUpload.description) &&
        Objects.equals(this.displayName, hexPackageUpload.displayName) &&
        Objects.equals(this.displaySource, hexPackageUpload.displaySource) &&
        Objects.equals(this.distro, hexPackageUpload.distro) &&
        Objects.equals(this.distroVersion, hexPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, hexPackageUpload.downloads) &&
        Objects.equals(this.epoch, hexPackageUpload.epoch) &&
        Objects.equals(this.extension, hexPackageUpload.extension) &&
        Objects.equals(this.filename, hexPackageUpload.filename) &&
        Objects.equals(this.files, hexPackageUpload.files) &&
        Objects.equals(this.format, hexPackageUpload.format) &&
        Objects.equals(this.formatUrl, hexPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, hexPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, hexPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, hexPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, hexPackageUpload.identifiers) &&
        Objects.equals(this.indexed, hexPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, hexPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, hexPackageUpload.isCopyable) &&
        ...
        Objects.equals(this.isResyncable, hexPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, hexPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, hexPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, hexPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, hexPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, hexPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, hexPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, hexPackageUpload.license) &&
        Objects.equals(this.name, hexPackageUpload.name) &&
        Objects.equals(this.namespace, hexPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, hexPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, hexPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, hexPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, hexPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, hexPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, hexPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, hexPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, hexPackageUpload.rawLicense) &&
        Objects.equals(this.release, hexPackageUpload.release) &&
        Objects.equals(this.repository, hexPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, hexPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, hexPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, hexPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, hexPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, hexPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, hexPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, hexPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, hexPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, hexPackageUpload.signatureUrl) &&
        Objects.equals(this.size, hexPackageUpload.size) &&
        Objects.equals(this.slug, hexPackageUpload.slug) &&
        Objects.equals(this.slugPerm, hexPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, hexPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, hexPackageUpload.stage) &&
        Objects.equals(this.stageStr, hexPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, hexPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, hexPackageUpload.status) &&
        Objects.equals(this.statusReason, hexPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class HexPackageUpload {\n");
