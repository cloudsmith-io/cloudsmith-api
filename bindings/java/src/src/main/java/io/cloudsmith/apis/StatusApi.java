...
import io.cloudsmith.models.StatusBasic;
...
public class StatusApi {
    ...
    /**
     * Build call for statusCheckBasic
    ...
    private com.squareup.okhttp.Call statusCheckBasicValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        try {
            ...
            Method method = this.getClass().getMethod("statusCheckBasicWithHttpInfo");
            Set<ConstraintViolation<StatusApi>> violations = executableValidator.validateParameters(this, method,
                    parameterValues);
    ...
    /**
     * Endpoint to check basic API connectivity. (asynchronously)
     * Endpoint to check basic API connectivity.
