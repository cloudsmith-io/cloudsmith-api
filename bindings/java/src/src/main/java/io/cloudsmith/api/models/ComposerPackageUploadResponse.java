...
public class ComposerPackageUploadResponse implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "A textual description of this package.")
  ...
  public ComposerPackageUploadResponse distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public ComposerPackageUploadResponse distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public ComposerPackageUploadResponse tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ComposerPackageUploadResponse composerPackageUploadResponse = (ComposerPackageUploadResponse) o;
    return Objects.equals(this.architectures, composerPackageUploadResponse.architectures) &&
        Objects.equals(this.cdnUrl, composerPackageUploadResponse.cdnUrl) &&
        Objects.equals(this.checksumMd5, composerPackageUploadResponse.checksumMd5) &&
        Objects.equals(this.checksumSha1, composerPackageUploadResponse.checksumSha1) &&
        Objects.equals(this.checksumSha256, composerPackageUploadResponse.checksumSha256) &&
        Objects.equals(this.checksumSha512, composerPackageUploadResponse.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, composerPackageUploadResponse.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, composerPackageUploadResponse.dependenciesUrl) &&
        Objects.equals(this.description, composerPackageUploadResponse.description) &&
        Objects.equals(this.distro, composerPackageUploadResponse.distro) &&
        Objects.equals(this.distroVersion, composerPackageUploadResponse.distroVersion) &&
        Objects.equals(this.downloads, composerPackageUploadResponse.downloads) &&
        Objects.equals(this.epoch, composerPackageUploadResponse.epoch) &&
        Objects.equals(this.extension, composerPackageUploadResponse.extension) &&
        Objects.equals(this.filename, composerPackageUploadResponse.filename) &&
        Objects.equals(this.files, composerPackageUploadResponse.files) &&
        Objects.equals(this.format, composerPackageUploadResponse.format) &&
        Objects.equals(this.formatUrl, composerPackageUploadResponse.formatUrl) &&
        Objects.equals(this.identifierPerm, composerPackageUploadResponse.identifierPerm) &&
        Objects.equals(this.indexed, composerPackageUploadResponse.indexed) &&
        Objects.equals(this.isDownloadable, composerPackageUploadResponse.isDownloadable) &&
        Objects.equals(this.isQuarantined, composerPackageUploadResponse.isQuarantined) &&
        Objects.equals(this.isSyncAwaiting, composerPackageUploadResponse.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, composerPackageUploadResponse.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, composerPackageUploadResponse.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, composerPackageUploadResponse.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, composerPackageUploadResponse.isSyncInProgress) &&
        Objects.equals(this.license, composerPackageUploadResponse.license) &&
        Objects.equals(this.name, composerPackageUploadResponse.name) &&
        Objects.equals(this.namespace, composerPackageUploadResponse.namespace) &&
        Objects.equals(this.namespaceUrl, composerPackageUploadResponse.namespaceUrl) &&
        Objects.equals(this.numFiles, composerPackageUploadResponse.numFiles) &&
        Objects.equals(this.originRepository, composerPackageUploadResponse.originRepository) &&
        Objects.equals(this.originRepositoryUrl, composerPackageUploadResponse.originRepositoryUrl) &&
        Objects.equals(this.packageType, composerPackageUploadResponse.packageType) &&
        Objects.equals(this.release, composerPackageUploadResponse.release) &&
        Objects.equals(this.repository, composerPackageUploadResponse.repository) &&
        Objects.equals(this.repositoryUrl, composerPackageUploadResponse.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, composerPackageUploadResponse.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, composerPackageUploadResponse.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, composerPackageUploadResponse.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, composerPackageUploadResponse.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, composerPackageUploadResponse.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, composerPackageUploadResponse.selfUrl) &&
        Objects.equals(this.signatureUrl, composerPackageUploadResponse.signatureUrl) &&
        Objects.equals(this.size, composerPackageUploadResponse.size) &&
        Objects.equals(this.slug, composerPackageUploadResponse.slug) &&
        Objects.equals(this.slugPerm, composerPackageUploadResponse.slugPerm) &&
        Objects.equals(this.stage, composerPackageUploadResponse.stage) &&
        Objects.equals(this.stageStr, composerPackageUploadResponse.stageStr) &&
        Objects.equals(this.stageUpdatedAt, composerPackageUploadResponse.stageUpdatedAt) &&
        Objects.equals(this.status, composerPackageUploadResponse.status) &&
        Objects.equals(this.statusReason, composerPackageUploadResponse.statusReason) &&
        Objects.equals(this.statusStr, composerPackageUploadResponse.statusStr) &&
        Objects.equals(this.statusUpdatedAt, composerPackageUploadResponse.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, composerPackageUploadResponse.statusUrl) &&
        Objects.equals(this.subtype, composerPackageUploadResponse.subtype) &&
        Objects.equals(this.summary, composerPackageUploadResponse.summary) &&
        Objects.equals(this.syncFinishedAt, composerPackageUploadResponse.syncFinishedAt) &&
        Objects.equals(this.syncProgress, composerPackageUploadResponse.syncProgress) &&
        Objects.equals(this.tagsImmutable, composerPackageUploadResponse.tagsImmutable) &&
        Objects.equals(this.typeDisplay, composerPackageUploadResponse.typeDisplay) &&
        Objects.equals(this.uploadedAt, composerPackageUploadResponse.uploadedAt) &&
        Objects.equals(this.uploader, composerPackageUploadResponse.uploader) &&
        Objects.equals(this.uploaderUrl, composerPackageUploadResponse.uploaderUrl) &&
        Objects.equals(this.version, composerPackageUploadResponse.version) &&
        Objects.equals(this.versionOrig, composerPackageUploadResponse.versionOrig) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, composerPackageUploadResponse.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComposerPackageUploadResponse {\n");
