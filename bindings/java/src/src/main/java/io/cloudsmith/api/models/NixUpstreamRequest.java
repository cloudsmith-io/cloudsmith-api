...
public class NixUpstreamRequest implements Serializable {
  ...
  public NixUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public NixUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public NixUpstreamRequest authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public NixUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public NixUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NixUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NixUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public NixUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public NixUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public NixUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public NixUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public NixUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NixUpstreamRequest nixUpstreamRequest = (NixUpstreamRequest) o;
    return Objects.equals(this.authMode, nixUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, nixUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, nixUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, nixUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, nixUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, nixUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, nixUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, nixUpstreamRequest.isActive) &&
        Objects.equals(this.mode, nixUpstreamRequest.mode) &&
        Objects.equals(this.name, nixUpstreamRequest.name) &&
        Objects.equals(this.priority, nixUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, nixUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, nixUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class NixUpstreamRequest {\n");
