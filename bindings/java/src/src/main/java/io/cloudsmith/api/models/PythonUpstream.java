...
public class PythonUpstream implements Serializable {
  ...
  public PythonUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public PythonUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public PythonUpstream authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public PythonUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public PythonUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public PythonUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public PythonUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public PythonUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public PythonUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public PythonUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PythonUpstream pythonUpstream = (PythonUpstream) o;
  ...
  public String toString() {
    ...
    sb.append("class PythonUpstream {\n");
