...
public class PackageResyncResponse implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "A textual description of this package.")
  ...
  public PackageResyncResponse distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public PackageResyncResponse distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public PackageResyncResponse tags(Tags tags) {
    this.tags = tags;
    return this;
  }
  ...
  **/
  ...
  public PackageResyncResponse tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PackageResyncResponse packageResyncResponse = (PackageResyncResponse) o;
    return Objects.equals(this.architectures, packageResyncResponse.architectures) &&
        Objects.equals(this.cdnUrl, packageResyncResponse.cdnUrl) &&
        Objects.equals(this.checksumMd5, packageResyncResponse.checksumMd5) &&
        Objects.equals(this.checksumSha1, packageResyncResponse.checksumSha1) &&
        Objects.equals(this.checksumSha256, packageResyncResponse.checksumSha256) &&
        Objects.equals(this.checksumSha512, packageResyncResponse.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, packageResyncResponse.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, packageResyncResponse.dependenciesUrl) &&
        Objects.equals(this.description, packageResyncResponse.description) &&
        Objects.equals(this.distro, packageResyncResponse.distro) &&
        Objects.equals(this.distroVersion, packageResyncResponse.distroVersion) &&
        Objects.equals(this.downloads, packageResyncResponse.downloads) &&
        Objects.equals(this.epoch, packageResyncResponse.epoch) &&
        Objects.equals(this.extension, packageResyncResponse.extension) &&
        Objects.equals(this.filename, packageResyncResponse.filename) &&
        Objects.equals(this.files, packageResyncResponse.files) &&
        Objects.equals(this.format, packageResyncResponse.format) &&
        Objects.equals(this.formatUrl, packageResyncResponse.formatUrl) &&
        Objects.equals(this.identifierPerm, packageResyncResponse.identifierPerm) &&
        Objects.equals(this.indexed, packageResyncResponse.indexed) &&
        Objects.equals(this.isDownloadable, packageResyncResponse.isDownloadable) &&
        Objects.equals(this.isQuarantined, packageResyncResponse.isQuarantined) &&
        Objects.equals(this.isSyncAwaiting, packageResyncResponse.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, packageResyncResponse.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, packageResyncResponse.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, packageResyncResponse.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, packageResyncResponse.isSyncInProgress) &&
        Objects.equals(this.license, packageResyncResponse.license) &&
        Objects.equals(this.name, packageResyncResponse.name) &&
        Objects.equals(this.namespace, packageResyncResponse.namespace) &&
        Objects.equals(this.namespaceUrl, packageResyncResponse.namespaceUrl) &&
        Objects.equals(this.numFiles, packageResyncResponse.numFiles) &&
        Objects.equals(this.originRepository, packageResyncResponse.originRepository) &&
        Objects.equals(this.originRepositoryUrl, packageResyncResponse.originRepositoryUrl) &&
        Objects.equals(this.packageType, packageResyncResponse.packageType) &&
        Objects.equals(this.release, packageResyncResponse.release) &&
        Objects.equals(this.repository, packageResyncResponse.repository) &&
        Objects.equals(this.repositoryUrl, packageResyncResponse.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, packageResyncResponse.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, packageResyncResponse.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, packageResyncResponse.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, packageResyncResponse.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, packageResyncResponse.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, packageResyncResponse.selfUrl) &&
        Objects.equals(this.signatureUrl, packageResyncResponse.signatureUrl) &&
        Objects.equals(this.size, packageResyncResponse.size) &&
        Objects.equals(this.slug, packageResyncResponse.slug) &&
        Objects.equals(this.slugPerm, packageResyncResponse.slugPerm) &&
        Objects.equals(this.stage, packageResyncResponse.stage) &&
        Objects.equals(this.stageStr, packageResyncResponse.stageStr) &&
        Objects.equals(this.stageUpdatedAt, packageResyncResponse.stageUpdatedAt) &&
        Objects.equals(this.status, packageResyncResponse.status) &&
        Objects.equals(this.statusReason, packageResyncResponse.statusReason) &&
        Objects.equals(this.statusStr, packageResyncResponse.statusStr) &&
        Objects.equals(this.statusUpdatedAt, packageResyncResponse.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, packageResyncResponse.statusUrl) &&
        Objects.equals(this.subtype, packageResyncResponse.subtype) &&
        Objects.equals(this.summary, packageResyncResponse.summary) &&
        Objects.equals(this.syncFinishedAt, packageResyncResponse.syncFinishedAt) &&
        Objects.equals(this.syncProgress, packageResyncResponse.syncProgress) &&
        Objects.equals(this.tags, packageResyncResponse.tags) &&
        Objects.equals(this.tagsImmutable, packageResyncResponse.tagsImmutable) &&
        Objects.equals(this.typeDisplay, packageResyncResponse.typeDisplay) &&
        Objects.equals(this.uploadedAt, packageResyncResponse.uploadedAt) &&
        Objects.equals(this.uploader, packageResyncResponse.uploader) &&
        Objects.equals(this.uploaderUrl, packageResyncResponse.uploaderUrl) &&
        Objects.equals(this.version, packageResyncResponse.version) &&
        Objects.equals(this.versionOrig, packageResyncResponse.versionOrig) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, packageResyncResponse.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class PackageResyncResponse {\n");
