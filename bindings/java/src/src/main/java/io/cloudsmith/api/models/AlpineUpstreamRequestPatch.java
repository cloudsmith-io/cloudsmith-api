...
public class AlpineUpstreamRequestPatch implements Serializable {
  ...
  public AlpineUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public AlpineUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public AlpineUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public AlpineUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public AlpineUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public AlpineUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public AlpineUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public AlpineUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public AlpineUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public AlpineUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public AlpineUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public AlpineUpstreamRequestPatch rsaKeyUrl(String rsaKeyUrl) {
 ...
 @Size(max=254)  @ApiModelProperty(value = "When provided, Cloudsmith will fetch and validate the RSA public key at this URL and use it to verify package signatures from this upstream.")
  ...
  public AlpineUpstreamRequestPatch rsaVerification(RsaVerificationEnum rsaVerification) {
  ...
  **/
  ...
  public AlpineUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public AlpineUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AlpineUpstreamRequestPatch alpineUpstreamRequestPatch = (AlpineUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, alpineUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, alpineUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, alpineUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, alpineUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, alpineUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, alpineUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, alpineUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, alpineUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, alpineUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, alpineUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, alpineUpstreamRequestPatch.priority) &&
        Objects.equals(this.rsaKeyUrl, alpineUpstreamRequestPatch.rsaKeyUrl) &&
        Objects.equals(this.rsaVerification, alpineUpstreamRequestPatch.rsaVerification) &&
        Objects.equals(this.upstreamUrl, alpineUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, alpineUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlpineUpstreamRequestPatch {\n");
