...
public class UserApi {
    ...
    public InlineResponse2004 userTokensList(java.math.BigInteger page, java.math.BigInteger pageSize) throws ApiException {
        ApiResponse<InlineResponse2004> resp = userTokensListWithHttpInfo(page, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2004> userTokensListWithHttpInfo( java.math.BigInteger page,  java.math.BigInteger pageSize) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call userTokensListAsync(java.math.BigInteger page, java.math.BigInteger pageSize, final ApiCallback<InlineResponse2004> callback) throws ApiException {
