...
import io.cloudsmith.auth.Authentication;
import io.cloudsmith.auth.HttpBasicAuth;
import io.cloudsmith.auth.ApiKeyAuth;
import io.cloudsmith.auth.OAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        setUserAgent("Swagger-Codegen/0.21.4/java");
