...
public class MavenUpstream implements Serializable {
  ...
  public MavenUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public MavenUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public MavenUpstream authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public MavenUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public MavenUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public MavenUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public MavenUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public MavenUpstream upstreamUrl(String upstreamUrl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MavenUpstream mavenUpstream = (MavenUpstream) o;
