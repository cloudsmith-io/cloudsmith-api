...
public class RubyUpstreamRequestPatch implements Serializable {
  ...
  public RubyUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public RubyUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public RubyUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public RubyUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public RubyUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public RubyUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public RubyUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public RubyUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public RubyUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public RubyUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public RubyUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public RubyUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public RubyUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RubyUpstreamRequestPatch rubyUpstreamRequestPatch = (RubyUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, rubyUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, rubyUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, rubyUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, rubyUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, rubyUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, rubyUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, rubyUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, rubyUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, rubyUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, rubyUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, rubyUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, rubyUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, rubyUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class RubyUpstreamRequestPatch {\n");
