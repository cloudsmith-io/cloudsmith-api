...
public class PackagesApi {
    ...
    /**
     * Build call for packagesUpdateLicense
     * @param owner  (required)
     * @param repo  (required)
     * @param identifier  (required)
     * @param data  (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call packagesUpdateLicenseCall(String owner, String repo, String identifier, PackageLicenseRequestPatch data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = data;

        // create path and map variables
        String localVarPath = "/packages/{owner}/{repo}/{identifier}/update-license/"
            .replaceAll("\\{" + "owner" + "\\}", apiClient.escapeString(owner.toString()))
            .replaceAll("\\{" + "repo" + "\\}", apiClient.escapeString(repo.toString()))
            .replaceAll("\\{" + "identifier" + "\\}", apiClient.escapeString(identifier.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call packagesUpdateLicenseValidateBeforeCall(String owner, String repo, String identifier, PackageLicenseRequestPatch data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        try {
            ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
            ExecutableValidator executableValidator = factory.getValidator().forExecutables();

            Object[] parameterValues = { owner, repo, identifier, data };
            Method method = this.getClass().getMethod("packagesUpdateLicenseWithHttpInfo", String.class, String.class, String.class, PackageLicenseRequestPatch.class);
            Set<ConstraintViolation<PackagesApi>> violations = executableValidator.validateParameters(this, method,
                    parameterValues);

            if (violations.size() == 0) {
                com.squareup.okhttp.Call call = packagesUpdateLicenseCall(owner, repo, identifier, data, progressListener, progressRequestListener);
                return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ModelPackage packagesUpdateLicense(String owner, String repo, String identifier, PackageLicenseRequestPatch data) throws ApiException {
        ApiResponse<ModelPackage> resp = packagesUpdateLicenseWithHttpInfo(owner, repo, identifier, data);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ModelPackage> packagesUpdateLicenseWithHttpInfo( @NotNull String owner,  @NotNull String repo,  @NotNull String identifier,  PackageLicenseRequestPatch data) throws ApiException {
        com.squareup.okhttp.Call call = packagesUpdateLicenseValidateBeforeCall(owner, repo, identifier, data, null, null);
        Type localVarReturnType = new TypeToken<ModelPackage>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Update the license for a package. (asynchronously)
     * Update the license for a package.
     * @param owner  (required)
     * @param repo  (required)
     * @param identifier  (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call packagesUpdateLicenseAsync(String owner, String repo, String identifier, PackageLicenseRequestPatch data, final ApiCallback<ModelPackage> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = packagesUpdateLicenseValidateBeforeCall(owner, repo, identifier, data, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ModelPackage>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public GenericPackageUpload packagesUploadGeneric(String owner, String repo, GenericPackageUploadRequest data) throws ApiException {
        ApiResponse<GenericPackageUpload> resp = packagesUploadGenericWithHttpInfo(owner, repo, data);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GenericPackageUpload> packagesUploadGenericWithHttpInfo( @NotNull String owner,  @NotNull String repo,  GenericPackageUploadRequest data) throws ApiException {
        com.squareup.okhttp.Call call = packagesUploadGenericValidateBeforeCall(owner, repo, data, null, null);
        Type localVarReturnType = new TypeToken<GenericPackageUpload>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call packagesUploadGenericAsync(String owner, String repo, GenericPackageUploadRequest data, final ApiCallback<GenericPackageUpload> callback) throws ApiException {
    ...
    /**
     * Create a new HuggingFace package (asynchronously)
     * Create a new HuggingFace package
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
    ...
    /**
     * Build call for packagesUploadMcp
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call packagesUploadMcpCall(String owner, String repo, McpPackageUploadRequest data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = data;

        // create path and map variables
        String localVarPath = "/packages/{owner}/{repo}/upload/mcp/"
            .replaceAll("\\{" + "owner" + "\\}", apiClient.escapeString(owner.toString()))
            .replaceAll("\\{" + "repo" + "\\}", apiClient.escapeString(repo.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call packagesUploadMcpValidateBeforeCall(String owner, String repo, McpPackageUploadRequest data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        try {
            ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
            ExecutableValidator executableValidator = factory.getValidator().forExecutables();

            Object[] parameterValues = { owner, repo, data };
            Method method = this.getClass().getMethod("packagesUploadMcpWithHttpInfo", String.class, String.class, McpPackageUploadRequest.class);
            Set<ConstraintViolation<PackagesApi>> violations = executableValidator.validateParameters(this, method,
                    parameterValues);

            if (violations.size() == 0) {
                com.squareup.okhttp.Call call = packagesUploadMcpCall(owner, repo, data, progressListener, progressRequestListener);
                return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public McpPackageUpload packagesUploadMcp(String owner, String repo, McpPackageUploadRequest data) throws ApiException {
        ApiResponse<McpPackageUpload> resp = packagesUploadMcpWithHttpInfo(owner, repo, data);
        return resp.getData();
    }
     ...
     * @param repo  (required)
     * @param data  (optional)
     * @return ApiResponse&lt;McpPackageUpload&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<McpPackageUpload> packagesUploadMcpWithHttpInfo( @NotNull String owner,  @NotNull String repo,  McpPackageUploadRequest data) throws ApiException {
        com.squareup.okhttp.Call call = packagesUploadMcpValidateBeforeCall(owner, repo, data, null, null);
        Type localVarReturnType = new TypeToken<McpPackageUpload>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create a new MCP package (asynchronously)
     * Create a new MCP package
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call packagesUploadMcpAsync(String owner, String repo, McpPackageUploadRequest data, final ApiCallback<McpPackageUpload> callback) throws ApiException {
    ...
    /**
     * Build call for packagesUploadVsx
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call packagesUploadVsxCall(String owner, String repo, VsxPackageUploadRequest data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = data;

        // create path and map variables
        String localVarPath = "/packages/{owner}/{repo}/upload/vsx/"
            .replaceAll("\\{" + "owner" + "\\}", apiClient.escapeString(owner.toString()))
            .replaceAll("\\{" + "repo" + "\\}", apiClient.escapeString(repo.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call packagesUploadVsxValidateBeforeCall(String owner, String repo, VsxPackageUploadRequest data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        try {
            ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
            ExecutableValidator executableValidator = factory.getValidator().forExecutables();

            Object[] parameterValues = { owner, repo, data };
            Method method = this.getClass().getMethod("packagesUploadVsxWithHttpInfo", String.class, String.class, VsxPackageUploadRequest.class);
            Set<ConstraintViolation<PackagesApi>> violations = executableValidator.validateParameters(this, method,
                    parameterValues);

            if (violations.size() == 0) {
                com.squareup.okhttp.Call call = packagesUploadVsxCall(owner, repo, data, progressListener, progressRequestListener);
                return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public VsxPackageUpload packagesUploadVsx(String owner, String repo, VsxPackageUploadRequest data) throws ApiException {
        ApiResponse<VsxPackageUpload> resp = packagesUploadVsxWithHttpInfo(owner, repo, data);
        return resp.getData();
    }
     ...
     * @param repo  (required)
     * @param data  (optional)
     * @return ApiResponse&lt;VsxPackageUpload&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<VsxPackageUpload> packagesUploadVsxWithHttpInfo( @NotNull String owner,  @NotNull String repo,  VsxPackageUploadRequest data) throws ApiException {
        com.squareup.okhttp.Call call = packagesUploadVsxValidateBeforeCall(owner, repo, data, null, null);
        Type localVarReturnType = new TypeToken<VsxPackageUpload>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create a new VSX package (asynchronously)
     * Create a new VSX package
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call packagesUploadVsxAsync(String owner, String repo, VsxPackageUploadRequest data, final ApiCallback<VsxPackageUpload> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = packagesUploadVsxValidateBeforeCall(owner, repo, data, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VsxPackageUpload>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> packagesValidateUploadGenericWithHttpInfo( @NotNull String owner,  @NotNull String repo,  GenericPackageUploadRequest data) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call packagesValidateUploadGenericAsync(String owner, String repo, GenericPackageUploadRequest data, final ApiCallback<Void> callback) throws ApiException {
    ...
    /**
     * Validate parameters for create HuggingFace package (asynchronously)
     * Validate parameters for create HuggingFace package
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
    ...
    /**
     * Build call for packagesValidateUploadMcp
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call packagesValidateUploadMcpCall(String owner, String repo, McpPackageUploadRequest data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = data;

        // create path and map variables
        String localVarPath = "/packages/{owner}/{repo}/validate-upload/mcp/"
            .replaceAll("\\{" + "owner" + "\\}", apiClient.escapeString(owner.toString()))
            .replaceAll("\\{" + "repo" + "\\}", apiClient.escapeString(repo.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call packagesValidateUploadMcpValidateBeforeCall(String owner, String repo, McpPackageUploadRequest data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        try {
            ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
            ExecutableValidator executableValidator = factory.getValidator().forExecutables();

            Object[] parameterValues = { owner, repo, data };
            Method method = this.getClass().getMethod("packagesValidateUploadMcpWithHttpInfo", String.class, String.class, McpPackageUploadRequest.class);
            Set<ConstraintViolation<PackagesApi>> violations = executableValidator.validateParameters(this, method,
                    parameterValues);

            if (violations.size() == 0) {
                com.squareup.okhttp.Call call = packagesValidateUploadMcpCall(owner, repo, data, progressListener, progressRequestListener);
                return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void packagesValidateUploadMcp(String owner, String repo, McpPackageUploadRequest data) throws ApiException {
        packagesValidateUploadMcpWithHttpInfo(owner, repo, data);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> packagesValidateUploadMcpWithHttpInfo( @NotNull String owner,  @NotNull String repo,  McpPackageUploadRequest data) throws ApiException {
        com.squareup.okhttp.Call call = packagesValidateUploadMcpValidateBeforeCall(owner, repo, data, null, null);
        return apiClient.execute(call);
    }

    /**
     * Validate parameters for create MCP package (asynchronously)
     * Validate parameters for create MCP package
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call packagesValidateUploadMcpAsync(String owner, String repo, McpPackageUploadRequest data, final ApiCallback<Void> callback) throws ApiException {
    ...
    /**
     * Build call for packagesValidateUploadVsx
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call packagesValidateUploadVsxCall(String owner, String repo, VsxPackageUploadRequest data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = data;

        // create path and map variables
        String localVarPath = "/packages/{owner}/{repo}/validate-upload/vsx/"
            .replaceAll("\\{" + "owner" + "\\}", apiClient.escapeString(owner.toString()))
            .replaceAll("\\{" + "repo" + "\\}", apiClient.escapeString(repo.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call packagesValidateUploadVsxValidateBeforeCall(String owner, String repo, VsxPackageUploadRequest data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        try {
            ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
            ExecutableValidator executableValidator = factory.getValidator().forExecutables();

            Object[] parameterValues = { owner, repo, data };
            Method method = this.getClass().getMethod("packagesValidateUploadVsxWithHttpInfo", String.class, String.class, VsxPackageUploadRequest.class);
            Set<ConstraintViolation<PackagesApi>> violations = executableValidator.validateParameters(this, method,
                    parameterValues);

            if (violations.size() == 0) {
                com.squareup.okhttp.Call call = packagesValidateUploadVsxCall(owner, repo, data, progressListener, progressRequestListener);
                return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void packagesValidateUploadVsx(String owner, String repo, VsxPackageUploadRequest data) throws ApiException {
        packagesValidateUploadVsxWithHttpInfo(owner, repo, data);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> packagesValidateUploadVsxWithHttpInfo( @NotNull String owner,  @NotNull String repo,  VsxPackageUploadRequest data) throws ApiException {
        com.squareup.okhttp.Call call = packagesValidateUploadVsxValidateBeforeCall(owner, repo, data, null, null);
        return apiClient.execute(call);
    }

    /**
     * Validate parameters for create VSX package (asynchronously)
     * Validate parameters for create VSX package
     * @param owner  (required)
     * @param repo  (required)
     * @param data  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call packagesValidateUploadVsxAsync(String owner, String repo, VsxPackageUploadRequest data, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = packagesValidateUploadVsxValidateBeforeCall(owner, repo, data, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
