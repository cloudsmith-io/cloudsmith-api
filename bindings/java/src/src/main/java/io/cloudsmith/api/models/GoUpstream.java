...
public class GoUpstream implements Serializable {
  ...
  public GoUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public GoUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public GoUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public GoUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public GoUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public GoUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public GoUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public GoUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public GoUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public GoUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public GoUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public GoUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public GoUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GoUpstream goUpstream = (GoUpstream) o;
    return Objects.equals(this.authMode, goUpstream.authMode) &&
        Objects.equals(this.authSecret, goUpstream.authSecret) &&
        Objects.equals(this.authUsername, goUpstream.authUsername) &&
        Objects.equals(this.available, goUpstream.available) &&
        Objects.equals(this.canReindex, goUpstream.canReindex) &&
        Objects.equals(this.createdAt, goUpstream.createdAt) &&
        Objects.equals(this.disableReason, goUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, goUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, goUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, goUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, goUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, goUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, goUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, goUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, goUpstream.indexStatus) &&
        Objects.equals(this.isActive, goUpstream.isActive) &&
        Objects.equals(this.lastIndexed, goUpstream.lastIndexed) &&
        Objects.equals(this.mode, goUpstream.mode) &&
        Objects.equals(this.name, goUpstream.name) &&
        Objects.equals(this.pendingValidation, goUpstream.pendingValidation) &&
        Objects.equals(this.priority, goUpstream.priority) &&
        Objects.equals(this.slugPerm, goUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, goUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, goUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, goUpstream.verifySsl);
  }
