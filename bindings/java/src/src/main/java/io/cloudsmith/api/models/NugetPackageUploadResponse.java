...
public class NugetPackageUploadResponse implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "A textual description of this package.")
  ...
  public NugetPackageUploadResponse distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public NugetPackageUploadResponse distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public NugetPackageUploadResponse tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NugetPackageUploadResponse nugetPackageUploadResponse = (NugetPackageUploadResponse) o;
    return Objects.equals(this.architectures, nugetPackageUploadResponse.architectures) &&
        Objects.equals(this.cdnUrl, nugetPackageUploadResponse.cdnUrl) &&
        Objects.equals(this.checksumMd5, nugetPackageUploadResponse.checksumMd5) &&
        Objects.equals(this.checksumSha1, nugetPackageUploadResponse.checksumSha1) &&
        Objects.equals(this.checksumSha256, nugetPackageUploadResponse.checksumSha256) &&
        Objects.equals(this.checksumSha512, nugetPackageUploadResponse.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, nugetPackageUploadResponse.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, nugetPackageUploadResponse.dependenciesUrl) &&
        Objects.equals(this.description, nugetPackageUploadResponse.description) &&
        Objects.equals(this.distro, nugetPackageUploadResponse.distro) &&
        Objects.equals(this.distroVersion, nugetPackageUploadResponse.distroVersion) &&
        Objects.equals(this.downloads, nugetPackageUploadResponse.downloads) &&
        Objects.equals(this.epoch, nugetPackageUploadResponse.epoch) &&
        Objects.equals(this.extension, nugetPackageUploadResponse.extension) &&
        Objects.equals(this.filename, nugetPackageUploadResponse.filename) &&
        Objects.equals(this.files, nugetPackageUploadResponse.files) &&
        Objects.equals(this.format, nugetPackageUploadResponse.format) &&
        Objects.equals(this.formatUrl, nugetPackageUploadResponse.formatUrl) &&
        Objects.equals(this.identifierPerm, nugetPackageUploadResponse.identifierPerm) &&
        Objects.equals(this.indexed, nugetPackageUploadResponse.indexed) &&
        Objects.equals(this.isDownloadable, nugetPackageUploadResponse.isDownloadable) &&
        Objects.equals(this.isQuarantined, nugetPackageUploadResponse.isQuarantined) &&
        Objects.equals(this.isSyncAwaiting, nugetPackageUploadResponse.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, nugetPackageUploadResponse.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, nugetPackageUploadResponse.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, nugetPackageUploadResponse.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, nugetPackageUploadResponse.isSyncInProgress) &&
        Objects.equals(this.license, nugetPackageUploadResponse.license) &&
        Objects.equals(this.name, nugetPackageUploadResponse.name) &&
        Objects.equals(this.namespace, nugetPackageUploadResponse.namespace) &&
        Objects.equals(this.namespaceUrl, nugetPackageUploadResponse.namespaceUrl) &&
        Objects.equals(this.numFiles, nugetPackageUploadResponse.numFiles) &&
        Objects.equals(this.originRepository, nugetPackageUploadResponse.originRepository) &&
        Objects.equals(this.originRepositoryUrl, nugetPackageUploadResponse.originRepositoryUrl) &&
        Objects.equals(this.packageType, nugetPackageUploadResponse.packageType) &&
        Objects.equals(this.release, nugetPackageUploadResponse.release) &&
        Objects.equals(this.repository, nugetPackageUploadResponse.repository) &&
        Objects.equals(this.repositoryUrl, nugetPackageUploadResponse.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, nugetPackageUploadResponse.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, nugetPackageUploadResponse.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, nugetPackageUploadResponse.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, nugetPackageUploadResponse.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, nugetPackageUploadResponse.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, nugetPackageUploadResponse.selfUrl) &&
        Objects.equals(this.signatureUrl, nugetPackageUploadResponse.signatureUrl) &&
        Objects.equals(this.size, nugetPackageUploadResponse.size) &&
        Objects.equals(this.slug, nugetPackageUploadResponse.slug) &&
        Objects.equals(this.slugPerm, nugetPackageUploadResponse.slugPerm) &&
        Objects.equals(this.stage, nugetPackageUploadResponse.stage) &&
        Objects.equals(this.stageStr, nugetPackageUploadResponse.stageStr) &&
        Objects.equals(this.stageUpdatedAt, nugetPackageUploadResponse.stageUpdatedAt) &&
        Objects.equals(this.status, nugetPackageUploadResponse.status) &&
        Objects.equals(this.statusReason, nugetPackageUploadResponse.statusReason) &&
        Objects.equals(this.statusStr, nugetPackageUploadResponse.statusStr) &&
        Objects.equals(this.statusUpdatedAt, nugetPackageUploadResponse.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, nugetPackageUploadResponse.statusUrl) &&
        Objects.equals(this.subtype, nugetPackageUploadResponse.subtype) &&
        Objects.equals(this.summary, nugetPackageUploadResponse.summary) &&
        Objects.equals(this.syncFinishedAt, nugetPackageUploadResponse.syncFinishedAt) &&
        Objects.equals(this.syncProgress, nugetPackageUploadResponse.syncProgress) &&
        Objects.equals(this.tagsImmutable, nugetPackageUploadResponse.tagsImmutable) &&
        Objects.equals(this.typeDisplay, nugetPackageUploadResponse.typeDisplay) &&
        Objects.equals(this.uploadedAt, nugetPackageUploadResponse.uploadedAt) &&
        Objects.equals(this.uploader, nugetPackageUploadResponse.uploader) &&
        Objects.equals(this.uploaderUrl, nugetPackageUploadResponse.uploaderUrl) &&
        Objects.equals(this.version, nugetPackageUploadResponse.version) &&
        Objects.equals(this.versionOrig, nugetPackageUploadResponse.versionOrig) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, nugetPackageUploadResponse.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class NugetPackageUploadResponse {\n");
