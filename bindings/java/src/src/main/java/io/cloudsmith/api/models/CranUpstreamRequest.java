...
public class CranUpstreamRequest implements Serializable {
  ...
  public CranUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public CranUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public CranUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public CranUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public CranUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public CranUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CranUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CranUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public CranUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public CranUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public CranUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public CranUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public CranUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CranUpstreamRequest cranUpstreamRequest = (CranUpstreamRequest) o;
    return Objects.equals(this.authMode, cranUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, cranUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, cranUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, cranUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, cranUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, cranUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, cranUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, cranUpstreamRequest.isActive) &&
        Objects.equals(this.mode, cranUpstreamRequest.mode) &&
        Objects.equals(this.name, cranUpstreamRequest.name) &&
        Objects.equals(this.priority, cranUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, cranUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, cranUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class CranUpstreamRequest {\n");
