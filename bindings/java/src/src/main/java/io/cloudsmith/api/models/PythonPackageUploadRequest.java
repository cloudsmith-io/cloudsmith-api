...
public class PythonPackageUploadRequest implements Serializable {
  ...
  **/
  ...
  public PythonPackageUploadRequest packageFile(String packageFile) {
 ...
 @Size(min=1)  @ApiModelProperty(required = true, value = "The primary file for the package.")
  ...
  public PythonPackageUploadRequest republish(Boolean republish) {
  ...
  **/
  ...
  public PythonPackageUploadRequest tags(String tags) {
    this.tags = tags;
    return this;
  }
 ...
 @Size(min=1,max=1024)  @ApiModelProperty(value = "A comma-separated values list of tags to add to the package.")
  ...
  public PythonPackageUploadRequest vulnerabilityCounts(WebOSVSeverityCounts vulnerabilityCounts) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PythonPackageUploadRequest pythonPackageUploadRequest = (PythonPackageUploadRequest) o;
    return Objects.equals(this.isMalwareDetected, pythonPackageUploadRequest.isMalwareDetected) &&
        Objects.equals(this.packageFile, pythonPackageUploadRequest.packageFile) &&
        Objects.equals(this.republish, pythonPackageUploadRequest.republish) &&
        Objects.equals(this.tags, pythonPackageUploadRequest.tags) &&
        Objects.equals(this.vulnerabilityCounts, pythonPackageUploadRequest.vulnerabilityCounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class PythonPackageUploadRequest {\n");
