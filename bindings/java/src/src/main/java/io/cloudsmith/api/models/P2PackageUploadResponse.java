...
public class P2PackageUploadResponse implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "A textual description of this package.")
  ...
  public P2PackageUploadResponse distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public P2PackageUploadResponse distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public P2PackageUploadResponse tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    P2PackageUploadResponse p2PackageUploadResponse = (P2PackageUploadResponse) o;
    return Objects.equals(this.architectures, p2PackageUploadResponse.architectures) &&
        Objects.equals(this.cdnUrl, p2PackageUploadResponse.cdnUrl) &&
        Objects.equals(this.checksumMd5, p2PackageUploadResponse.checksumMd5) &&
        Objects.equals(this.checksumSha1, p2PackageUploadResponse.checksumSha1) &&
        Objects.equals(this.checksumSha256, p2PackageUploadResponse.checksumSha256) &&
        Objects.equals(this.checksumSha512, p2PackageUploadResponse.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, p2PackageUploadResponse.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, p2PackageUploadResponse.dependenciesUrl) &&
        Objects.equals(this.description, p2PackageUploadResponse.description) &&
        Objects.equals(this.distro, p2PackageUploadResponse.distro) &&
        Objects.equals(this.distroVersion, p2PackageUploadResponse.distroVersion) &&
        Objects.equals(this.downloads, p2PackageUploadResponse.downloads) &&
        Objects.equals(this.epoch, p2PackageUploadResponse.epoch) &&
        Objects.equals(this.extension, p2PackageUploadResponse.extension) &&
        Objects.equals(this.filename, p2PackageUploadResponse.filename) &&
        Objects.equals(this.files, p2PackageUploadResponse.files) &&
        Objects.equals(this.format, p2PackageUploadResponse.format) &&
        Objects.equals(this.formatUrl, p2PackageUploadResponse.formatUrl) &&
        Objects.equals(this.identifierPerm, p2PackageUploadResponse.identifierPerm) &&
        Objects.equals(this.indexed, p2PackageUploadResponse.indexed) &&
        Objects.equals(this.isDownloadable, p2PackageUploadResponse.isDownloadable) &&
        Objects.equals(this.isQuarantined, p2PackageUploadResponse.isQuarantined) &&
        Objects.equals(this.isSyncAwaiting, p2PackageUploadResponse.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, p2PackageUploadResponse.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, p2PackageUploadResponse.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, p2PackageUploadResponse.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, p2PackageUploadResponse.isSyncInProgress) &&
        Objects.equals(this.license, p2PackageUploadResponse.license) &&
        Objects.equals(this.name, p2PackageUploadResponse.name) &&
        Objects.equals(this.namespace, p2PackageUploadResponse.namespace) &&
        Objects.equals(this.namespaceUrl, p2PackageUploadResponse.namespaceUrl) &&
        Objects.equals(this.numFiles, p2PackageUploadResponse.numFiles) &&
        Objects.equals(this.originRepository, p2PackageUploadResponse.originRepository) &&
        Objects.equals(this.originRepositoryUrl, p2PackageUploadResponse.originRepositoryUrl) &&
        Objects.equals(this.packageType, p2PackageUploadResponse.packageType) &&
        Objects.equals(this.release, p2PackageUploadResponse.release) &&
        Objects.equals(this.repository, p2PackageUploadResponse.repository) &&
        Objects.equals(this.repositoryUrl, p2PackageUploadResponse.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, p2PackageUploadResponse.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, p2PackageUploadResponse.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, p2PackageUploadResponse.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, p2PackageUploadResponse.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, p2PackageUploadResponse.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, p2PackageUploadResponse.selfUrl) &&
        Objects.equals(this.signatureUrl, p2PackageUploadResponse.signatureUrl) &&
        Objects.equals(this.size, p2PackageUploadResponse.size) &&
        Objects.equals(this.slug, p2PackageUploadResponse.slug) &&
        Objects.equals(this.slugPerm, p2PackageUploadResponse.slugPerm) &&
        Objects.equals(this.stage, p2PackageUploadResponse.stage) &&
        Objects.equals(this.stageStr, p2PackageUploadResponse.stageStr) &&
        Objects.equals(this.stageUpdatedAt, p2PackageUploadResponse.stageUpdatedAt) &&
        Objects.equals(this.status, p2PackageUploadResponse.status) &&
        Objects.equals(this.statusReason, p2PackageUploadResponse.statusReason) &&
        Objects.equals(this.statusStr, p2PackageUploadResponse.statusStr) &&
        Objects.equals(this.statusUpdatedAt, p2PackageUploadResponse.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, p2PackageUploadResponse.statusUrl) &&
        Objects.equals(this.subtype, p2PackageUploadResponse.subtype) &&
        Objects.equals(this.summary, p2PackageUploadResponse.summary) &&
        Objects.equals(this.syncFinishedAt, p2PackageUploadResponse.syncFinishedAt) &&
        Objects.equals(this.syncProgress, p2PackageUploadResponse.syncProgress) &&
        Objects.equals(this.tagsImmutable, p2PackageUploadResponse.tagsImmutable) &&
        Objects.equals(this.typeDisplay, p2PackageUploadResponse.typeDisplay) &&
        Objects.equals(this.uploadedAt, p2PackageUploadResponse.uploadedAt) &&
        Objects.equals(this.uploader, p2PackageUploadResponse.uploader) &&
        Objects.equals(this.uploaderUrl, p2PackageUploadResponse.uploaderUrl) &&
        Objects.equals(this.version, p2PackageUploadResponse.version) &&
        Objects.equals(this.versionOrig, p2PackageUploadResponse.versionOrig) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, p2PackageUploadResponse.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2PackageUploadResponse {\n");
