...
public class DebUpstreamRequestPatch implements Serializable {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DebUpstreamRequestPatch gpgKeyInline(String gpgKeyInline) {
  ...
  **/
  ...
  public DebUpstreamRequestPatch gpgKeyUrl(String gpgKeyUrl) {
 ...
 @Size(max=254)  @ApiModelProperty(value = "When provided, Cloudsmith will fetch, validate, and associate a public GPG key found at the provided URL. When using the Cloudsmith setup script, this GPG key will be automatically imported on your deployment machines to allow upstream packages to validate and install.")
  ...
  public DebUpstreamRequestPatch gpgVerification(GpgVerificationEnum gpgVerification) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.authMode, debUpstreamRequestPatch.authMode) &&
        ...
        Objects.equals(this.gpgKeyInline, debUpstreamRequestPatch.gpgKeyInline) &&
        Objects.equals(this.gpgKeyUrl, debUpstreamRequestPatch.gpgKeyUrl) &&
        Objects.equals(this.gpgVerification, debUpstreamRequestPatch.gpgVerification) &&
