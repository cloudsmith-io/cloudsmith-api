...
public class NixUpstreamRequestPatch implements Serializable {
  ...
  public NixUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public NixUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public NixUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public NixUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public NixUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public NixUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NixUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NixUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public NixUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public NixUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public NixUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public NixUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public NixUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NixUpstreamRequestPatch nixUpstreamRequestPatch = (NixUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, nixUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, nixUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, nixUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, nixUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, nixUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, nixUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, nixUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, nixUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, nixUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, nixUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, nixUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, nixUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, nixUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class NixUpstreamRequestPatch {\n");
