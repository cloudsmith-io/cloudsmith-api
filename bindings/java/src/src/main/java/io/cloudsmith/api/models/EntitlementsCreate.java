...
public class EntitlementsCreate implements Serializable {
  ...
  **/
  ...
  public EntitlementsCreate limitBandwidthUnit(LimitBandwidthUnitEnum limitBandwidthUnit) {
  ...
  **/
  ...
  public EntitlementsCreate scheduledResetPeriod(ScheduledResetPeriodEnum scheduledResetPeriod) {
