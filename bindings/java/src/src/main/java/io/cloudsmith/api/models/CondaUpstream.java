...
public class CondaUpstream implements Serializable {
  ...
  public CondaUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public CondaUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public CondaUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public CondaUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public CondaUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public CondaUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CondaUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public CondaUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public CondaUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public CondaUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CondaUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public CondaUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public CondaUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CondaUpstream condaUpstream = (CondaUpstream) o;
    return Objects.equals(this.authMode, condaUpstream.authMode) &&
        Objects.equals(this.authSecret, condaUpstream.authSecret) &&
        Objects.equals(this.authUsername, condaUpstream.authUsername) &&
        Objects.equals(this.available, condaUpstream.available) &&
        Objects.equals(this.canReindex, condaUpstream.canReindex) &&
        Objects.equals(this.createdAt, condaUpstream.createdAt) &&
        Objects.equals(this.disableReason, condaUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, condaUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, condaUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, condaUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, condaUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, condaUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, condaUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, condaUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, condaUpstream.indexStatus) &&
        Objects.equals(this.isActive, condaUpstream.isActive) &&
        Objects.equals(this.lastIndexed, condaUpstream.lastIndexed) &&
        Objects.equals(this.mode, condaUpstream.mode) &&
        Objects.equals(this.name, condaUpstream.name) &&
        Objects.equals(this.pendingValidation, condaUpstream.pendingValidation) &&
        Objects.equals(this.priority, condaUpstream.priority) &&
        Objects.equals(this.slugPerm, condaUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, condaUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, condaUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, condaUpstream.verifySsl);
  }
