...
public class DartUpstreamRequest implements Serializable {
  ...
  public DartUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public DartUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public DartUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public DartUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public DartUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public DartUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DartUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DartUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public DartUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public DartUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public DartUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public DartUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public DartUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DartUpstreamRequest dartUpstreamRequest = (DartUpstreamRequest) o;
    return Objects.equals(this.authMode, dartUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, dartUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, dartUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, dartUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, dartUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, dartUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, dartUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, dartUpstreamRequest.isActive) &&
        Objects.equals(this.mode, dartUpstreamRequest.mode) &&
        Objects.equals(this.name, dartUpstreamRequest.name) &&
        Objects.equals(this.priority, dartUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, dartUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, dartUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class DartUpstreamRequest {\n");
