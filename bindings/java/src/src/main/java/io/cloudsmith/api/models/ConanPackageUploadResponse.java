...
public class ConanPackageUploadResponse implements Serializable {
  ...
  **/
  ...
  public ConanPackageUploadResponse conanChannel(String conanChannel) {
 ...
 @Size(min=1,max=128)  @ApiModelProperty(value = "Conan channel.")
  ...
  public ConanPackageUploadResponse conanPrefix(String conanPrefix) {
 ...
 @Size(min=1)  @ApiModelProperty(value = "A textual description of this package.")
  ...
  public ConanPackageUploadResponse distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public ConanPackageUploadResponse distroVersion(DistributionVersion distroVersion) {
 ...
 @Size(min=1)  @ApiModelProperty(value = "The license of this package.")
  ...
  public ConanPackageUploadResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ConanPackageUploadResponse tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public ConanPackageUploadResponse version(String version) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConanPackageUploadResponse conanPackageUploadResponse = (ConanPackageUploadResponse) o;
    return Objects.equals(this.architectures, conanPackageUploadResponse.architectures) &&
        Objects.equals(this.cdnUrl, conanPackageUploadResponse.cdnUrl) &&
        Objects.equals(this.checksumMd5, conanPackageUploadResponse.checksumMd5) &&
        Objects.equals(this.checksumSha1, conanPackageUploadResponse.checksumSha1) &&
        Objects.equals(this.checksumSha256, conanPackageUploadResponse.checksumSha256) &&
        Objects.equals(this.checksumSha512, conanPackageUploadResponse.checksumSha512) &&
        Objects.equals(this.conanChannel, conanPackageUploadResponse.conanChannel) &&
        Objects.equals(this.conanPrefix, conanPackageUploadResponse.conanPrefix) &&
        Objects.equals(this.dependenciesChecksumMd5, conanPackageUploadResponse.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, conanPackageUploadResponse.dependenciesUrl) &&
        Objects.equals(this.description, conanPackageUploadResponse.description) &&
        Objects.equals(this.distro, conanPackageUploadResponse.distro) &&
        Objects.equals(this.distroVersion, conanPackageUploadResponse.distroVersion) &&
        Objects.equals(this.downloads, conanPackageUploadResponse.downloads) &&
        Objects.equals(this.epoch, conanPackageUploadResponse.epoch) &&
        Objects.equals(this.extension, conanPackageUploadResponse.extension) &&
        Objects.equals(this.filename, conanPackageUploadResponse.filename) &&
        Objects.equals(this.files, conanPackageUploadResponse.files) &&
        Objects.equals(this.format, conanPackageUploadResponse.format) &&
        Objects.equals(this.formatUrl, conanPackageUploadResponse.formatUrl) &&
        Objects.equals(this.identifierPerm, conanPackageUploadResponse.identifierPerm) &&
        Objects.equals(this.indexed, conanPackageUploadResponse.indexed) &&
        Objects.equals(this.isDownloadable, conanPackageUploadResponse.isDownloadable) &&
        Objects.equals(this.isQuarantined, conanPackageUploadResponse.isQuarantined) &&
        Objects.equals(this.isSyncAwaiting, conanPackageUploadResponse.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, conanPackageUploadResponse.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, conanPackageUploadResponse.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, conanPackageUploadResponse.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, conanPackageUploadResponse.isSyncInProgress) &&
        Objects.equals(this.license, conanPackageUploadResponse.license) &&
        Objects.equals(this.name, conanPackageUploadResponse.name) &&
        Objects.equals(this.namespace, conanPackageUploadResponse.namespace) &&
        Objects.equals(this.namespaceUrl, conanPackageUploadResponse.namespaceUrl) &&
        Objects.equals(this.numFiles, conanPackageUploadResponse.numFiles) &&
        Objects.equals(this.originRepository, conanPackageUploadResponse.originRepository) &&
        Objects.equals(this.originRepositoryUrl, conanPackageUploadResponse.originRepositoryUrl) &&
        Objects.equals(this.packageType, conanPackageUploadResponse.packageType) &&
        Objects.equals(this.release, conanPackageUploadResponse.release) &&
        Objects.equals(this.repository, conanPackageUploadResponse.repository) &&
        Objects.equals(this.repositoryUrl, conanPackageUploadResponse.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, conanPackageUploadResponse.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, conanPackageUploadResponse.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, conanPackageUploadResponse.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, conanPackageUploadResponse.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, conanPackageUploadResponse.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, conanPackageUploadResponse.selfUrl) &&
        Objects.equals(this.signatureUrl, conanPackageUploadResponse.signatureUrl) &&
        Objects.equals(this.size, conanPackageUploadResponse.size) &&
        Objects.equals(this.slug, conanPackageUploadResponse.slug) &&
        Objects.equals(this.slugPerm, conanPackageUploadResponse.slugPerm) &&
        Objects.equals(this.stage, conanPackageUploadResponse.stage) &&
        Objects.equals(this.stageStr, conanPackageUploadResponse.stageStr) &&
        Objects.equals(this.stageUpdatedAt, conanPackageUploadResponse.stageUpdatedAt) &&
        Objects.equals(this.status, conanPackageUploadResponse.status) &&
        Objects.equals(this.statusReason, conanPackageUploadResponse.statusReason) &&
        Objects.equals(this.statusStr, conanPackageUploadResponse.statusStr) &&
        Objects.equals(this.statusUpdatedAt, conanPackageUploadResponse.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, conanPackageUploadResponse.statusUrl) &&
        Objects.equals(this.subtype, conanPackageUploadResponse.subtype) &&
        Objects.equals(this.summary, conanPackageUploadResponse.summary) &&
        Objects.equals(this.syncFinishedAt, conanPackageUploadResponse.syncFinishedAt) &&
        Objects.equals(this.syncProgress, conanPackageUploadResponse.syncProgress) &&
        Objects.equals(this.tagsImmutable, conanPackageUploadResponse.tagsImmutable) &&
        Objects.equals(this.typeDisplay, conanPackageUploadResponse.typeDisplay) &&
        Objects.equals(this.uploadedAt, conanPackageUploadResponse.uploadedAt) &&
        Objects.equals(this.uploader, conanPackageUploadResponse.uploader) &&
        Objects.equals(this.uploaderUrl, conanPackageUploadResponse.uploaderUrl) &&
        Objects.equals(this.version, conanPackageUploadResponse.version) &&
        Objects.equals(this.versionOrig, conanPackageUploadResponse.versionOrig) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, conanPackageUploadResponse.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConanPackageUploadResponse {\n");
