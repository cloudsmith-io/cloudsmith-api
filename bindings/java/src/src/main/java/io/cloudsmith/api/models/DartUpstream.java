...
public class DartUpstream implements Serializable {
  ...
  public DartUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public DartUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public DartUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public DartUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public DartUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public DartUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public DartUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public DartUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public DartUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public DartUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DartUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public DartUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public DartUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DartUpstream dartUpstream = (DartUpstream) o;
    return Objects.equals(this.authMode, dartUpstream.authMode) &&
        Objects.equals(this.authSecret, dartUpstream.authSecret) &&
        Objects.equals(this.authUsername, dartUpstream.authUsername) &&
        Objects.equals(this.available, dartUpstream.available) &&
        Objects.equals(this.canReindex, dartUpstream.canReindex) &&
        Objects.equals(this.createdAt, dartUpstream.createdAt) &&
        Objects.equals(this.disableReason, dartUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, dartUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, dartUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, dartUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, dartUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, dartUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, dartUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, dartUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, dartUpstream.indexStatus) &&
        Objects.equals(this.isActive, dartUpstream.isActive) &&
        Objects.equals(this.lastIndexed, dartUpstream.lastIndexed) &&
        Objects.equals(this.mode, dartUpstream.mode) &&
        Objects.equals(this.name, dartUpstream.name) &&
        Objects.equals(this.pendingValidation, dartUpstream.pendingValidation) &&
        Objects.equals(this.priority, dartUpstream.priority) &&
        Objects.equals(this.slugPerm, dartUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, dartUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, dartUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, dartUpstream.verifySsl);
  }
