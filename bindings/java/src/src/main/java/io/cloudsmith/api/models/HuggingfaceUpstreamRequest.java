...
public class HuggingfaceUpstreamRequest implements Serializable {
  ...
  public HuggingfaceUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public HuggingfaceUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public HuggingfaceUpstreamRequest authUsername(String authUsername) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public HuggingfaceUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public HuggingfaceUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HuggingfaceUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HuggingfaceUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public HuggingfaceUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public HuggingfaceUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public HuggingfaceUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public HuggingfaceUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public HuggingfaceUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HuggingfaceUpstreamRequest huggingfaceUpstreamRequest = (HuggingfaceUpstreamRequest) o;
    return Objects.equals(this.authMode, huggingfaceUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, huggingfaceUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, huggingfaceUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, huggingfaceUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, huggingfaceUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, huggingfaceUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, huggingfaceUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, huggingfaceUpstreamRequest.isActive) &&
        Objects.equals(this.mode, huggingfaceUpstreamRequest.mode) &&
        Objects.equals(this.name, huggingfaceUpstreamRequest.name) &&
        Objects.equals(this.priority, huggingfaceUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, huggingfaceUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, huggingfaceUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class HuggingfaceUpstreamRequest {\n");
