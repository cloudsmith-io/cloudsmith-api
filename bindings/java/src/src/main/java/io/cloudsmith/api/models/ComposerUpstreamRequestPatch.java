...
public class ComposerUpstreamRequestPatch implements Serializable {
  ...
  public ComposerUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public ComposerUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public ComposerUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public ComposerUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public ComposerUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public ComposerUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public ComposerUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public ComposerUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public ComposerUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public ComposerUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public ComposerUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public ComposerUpstreamRequestPatch upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public ComposerUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ComposerUpstreamRequestPatch composerUpstreamRequestPatch = (ComposerUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, composerUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, composerUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, composerUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, composerUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, composerUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, composerUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, composerUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, composerUpstreamRequestPatch.isActive) &&
        Objects.equals(this.mode, composerUpstreamRequestPatch.mode) &&
        Objects.equals(this.name, composerUpstreamRequestPatch.name) &&
        Objects.equals(this.priority, composerUpstreamRequestPatch.priority) &&
        Objects.equals(this.upstreamUrl, composerUpstreamRequestPatch.upstreamUrl) &&
        Objects.equals(this.verifySsl, composerUpstreamRequestPatch.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComposerUpstreamRequestPatch {\n");
