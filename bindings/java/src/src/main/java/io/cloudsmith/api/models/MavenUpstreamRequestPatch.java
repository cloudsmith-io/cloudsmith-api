...
public class MavenUpstreamRequestPatch implements Serializable {
  ...
  public MavenUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public MavenUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public MavenUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public MavenUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public MavenUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public MavenUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public MavenUpstreamRequestPatch extraValue2(String extraValue2) {
  ...
  **/
  ...
  public MavenUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public MavenUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public MavenUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public MavenUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MavenUpstreamRequestPatch mavenUpstreamRequestPatch = (MavenUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, mavenUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, mavenUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, mavenUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, mavenUpstreamRequestPatch.extraHeader1) &&
  ...
  public String toString() {
    ...
    sb.append("class MavenUpstreamRequestPatch {\n");
