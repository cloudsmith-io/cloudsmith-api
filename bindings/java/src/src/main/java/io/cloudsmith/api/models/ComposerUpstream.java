...
public class ComposerUpstream implements Serializable {
  ...
  public ComposerUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public ComposerUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public ComposerUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public ComposerUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public ComposerUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public ComposerUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public ComposerUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public ComposerUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public ComposerUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public ComposerUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ComposerUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public ComposerUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public ComposerUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ComposerUpstream composerUpstream = (ComposerUpstream) o;
    return Objects.equals(this.authMode, composerUpstream.authMode) &&
        Objects.equals(this.authSecret, composerUpstream.authSecret) &&
        Objects.equals(this.authUsername, composerUpstream.authUsername) &&
        Objects.equals(this.available, composerUpstream.available) &&
        Objects.equals(this.canReindex, composerUpstream.canReindex) &&
        Objects.equals(this.createdAt, composerUpstream.createdAt) &&
        Objects.equals(this.disableReason, composerUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, composerUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, composerUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, composerUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, composerUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, composerUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, composerUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, composerUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, composerUpstream.indexStatus) &&
        Objects.equals(this.isActive, composerUpstream.isActive) &&
        Objects.equals(this.lastIndexed, composerUpstream.lastIndexed) &&
        Objects.equals(this.mode, composerUpstream.mode) &&
        Objects.equals(this.name, composerUpstream.name) &&
        Objects.equals(this.pendingValidation, composerUpstream.pendingValidation) &&
        Objects.equals(this.priority, composerUpstream.priority) &&
        Objects.equals(this.slugPerm, composerUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, composerUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, composerUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, composerUpstream.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComposerUpstream {\n");
