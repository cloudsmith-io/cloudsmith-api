...
public class GoPackageUpload implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).")
  ...
  public GoPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public GoPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public GoPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public GoPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GoPackageUpload goPackageUpload = (GoPackageUpload) o;
    return Objects.equals(this.architectures, goPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, goPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, goPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, goPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, goPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, goPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, goPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, goPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, goPackageUpload.description) &&
        Objects.equals(this.displayName, goPackageUpload.displayName) &&
        Objects.equals(this.displaySource, goPackageUpload.displaySource) &&
        Objects.equals(this.distro, goPackageUpload.distro) &&
        Objects.equals(this.distroVersion, goPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, goPackageUpload.downloads) &&
        Objects.equals(this.epoch, goPackageUpload.epoch) &&
        Objects.equals(this.extension, goPackageUpload.extension) &&
        Objects.equals(this.filename, goPackageUpload.filename) &&
        Objects.equals(this.files, goPackageUpload.files) &&
        Objects.equals(this.format, goPackageUpload.format) &&
        Objects.equals(this.formatUrl, goPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, goPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, goPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, goPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, goPackageUpload.identifiers) &&
        Objects.equals(this.indexed, goPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, goPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, goPackageUpload.isCopyable) &&
        ...
        Objects.equals(this.isResyncable, goPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, goPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, goPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, goPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, goPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, goPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, goPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, goPackageUpload.license) &&
        Objects.equals(this.name, goPackageUpload.name) &&
        Objects.equals(this.namespace, goPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, goPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, goPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, goPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, goPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, goPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, goPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, goPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, goPackageUpload.rawLicense) &&
        Objects.equals(this.release, goPackageUpload.release) &&
        Objects.equals(this.repository, goPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, goPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, goPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, goPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, goPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, goPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, goPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, goPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, goPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, goPackageUpload.signatureUrl) &&
        Objects.equals(this.size, goPackageUpload.size) &&
        Objects.equals(this.slug, goPackageUpload.slug) &&
        Objects.equals(this.slugPerm, goPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, goPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, goPackageUpload.stage) &&
        Objects.equals(this.stageStr, goPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, goPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, goPackageUpload.status) &&
        Objects.equals(this.statusReason, goPackageUpload.statusReason) &&
  ...
  public String toString() {
    ...
    sb.append("class GoPackageUpload {\n");
