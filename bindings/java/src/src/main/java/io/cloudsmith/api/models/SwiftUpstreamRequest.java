...
public class SwiftUpstreamRequest implements Serializable {
  ...
  public SwiftUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public SwiftUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public SwiftUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public SwiftUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public SwiftUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public SwiftUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public SwiftUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public SwiftUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public SwiftUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public SwiftUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public SwiftUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public SwiftUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public SwiftUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SwiftUpstreamRequest swiftUpstreamRequest = (SwiftUpstreamRequest) o;
    return Objects.equals(this.authMode, swiftUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, swiftUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, swiftUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, swiftUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, swiftUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, swiftUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, swiftUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, swiftUpstreamRequest.isActive) &&
        Objects.equals(this.mode, swiftUpstreamRequest.mode) &&
        Objects.equals(this.name, swiftUpstreamRequest.name) &&
        Objects.equals(this.priority, swiftUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, swiftUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, swiftUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwiftUpstreamRequest {\n");
