...
public class HuggingfaceUpstream implements Serializable {
  ...
  public HuggingfaceUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public HuggingfaceUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public HuggingfaceUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public HuggingfaceUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public HuggingfaceUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public HuggingfaceUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HuggingfaceUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public HuggingfaceUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public HuggingfaceUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public HuggingfaceUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public HuggingfaceUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public HuggingfaceUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public HuggingfaceUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HuggingfaceUpstream huggingfaceUpstream = (HuggingfaceUpstream) o;
    return Objects.equals(this.authMode, huggingfaceUpstream.authMode) &&
        Objects.equals(this.authSecret, huggingfaceUpstream.authSecret) &&
        Objects.equals(this.authUsername, huggingfaceUpstream.authUsername) &&
        Objects.equals(this.available, huggingfaceUpstream.available) &&
        Objects.equals(this.canReindex, huggingfaceUpstream.canReindex) &&
        Objects.equals(this.createdAt, huggingfaceUpstream.createdAt) &&
        Objects.equals(this.disableReason, huggingfaceUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, huggingfaceUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, huggingfaceUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, huggingfaceUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, huggingfaceUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, huggingfaceUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, huggingfaceUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, huggingfaceUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, huggingfaceUpstream.indexStatus) &&
        Objects.equals(this.isActive, huggingfaceUpstream.isActive) &&
        Objects.equals(this.lastIndexed, huggingfaceUpstream.lastIndexed) &&
        Objects.equals(this.mode, huggingfaceUpstream.mode) &&
        Objects.equals(this.name, huggingfaceUpstream.name) &&
        Objects.equals(this.pendingValidation, huggingfaceUpstream.pendingValidation) &&
        Objects.equals(this.priority, huggingfaceUpstream.priority) &&
        Objects.equals(this.slugPerm, huggingfaceUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, huggingfaceUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, huggingfaceUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, huggingfaceUpstream.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class HuggingfaceUpstream {\n");
