...
public class RubyPackageUpload implements Serializable {
  ...
  **/
  ...
  public RubyPackageUpload distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public RubyPackageUpload distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public RubyPackageUpload tagsAutomatic(Tags tagsAutomatic) {
  ...
  **/
  ...
  public RubyPackageUpload tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public RubyPackageUpload vulnerabilityCounts(WebOSVSeverityCounts vulnerabilityCounts) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RubyPackageUpload rubyPackageUpload = (RubyPackageUpload) o;
    return Objects.equals(this.architectures, rubyPackageUpload.architectures) &&
        Objects.equals(this.cdnUrl, rubyPackageUpload.cdnUrl) &&
        Objects.equals(this.checksumMd5, rubyPackageUpload.checksumMd5) &&
        Objects.equals(this.checksumSha1, rubyPackageUpload.checksumSha1) &&
        Objects.equals(this.checksumSha256, rubyPackageUpload.checksumSha256) &&
        Objects.equals(this.checksumSha512, rubyPackageUpload.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, rubyPackageUpload.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, rubyPackageUpload.dependenciesUrl) &&
        Objects.equals(this.description, rubyPackageUpload.description) &&
        Objects.equals(this.displayName, rubyPackageUpload.displayName) &&
        Objects.equals(this.distro, rubyPackageUpload.distro) &&
        Objects.equals(this.distroVersion, rubyPackageUpload.distroVersion) &&
        Objects.equals(this.downloads, rubyPackageUpload.downloads) &&
        Objects.equals(this.epoch, rubyPackageUpload.epoch) &&
        Objects.equals(this.extension, rubyPackageUpload.extension) &&
        Objects.equals(this.filename, rubyPackageUpload.filename) &&
        Objects.equals(this.files, rubyPackageUpload.files) &&
        Objects.equals(this.format, rubyPackageUpload.format) &&
        Objects.equals(this.formatUrl, rubyPackageUpload.formatUrl) &&
        Objects.equals(this.freeableStorage, rubyPackageUpload.freeableStorage) &&
        Objects.equals(this.fullyQualifiedName, rubyPackageUpload.fullyQualifiedName) &&
        Objects.equals(this.identifierPerm, rubyPackageUpload.identifierPerm) &&
        Objects.equals(this.identifiers, rubyPackageUpload.identifiers) &&
        Objects.equals(this.indexed, rubyPackageUpload.indexed) &&
        Objects.equals(this.isCancellable, rubyPackageUpload.isCancellable) &&
        Objects.equals(this.isCopyable, rubyPackageUpload.isCopyable) &&
        Objects.equals(this.isDeleteable, rubyPackageUpload.isDeleteable) &&
        Objects.equals(this.isDownloadable, rubyPackageUpload.isDownloadable) &&
        Objects.equals(this.isHidden, rubyPackageUpload.isHidden) &&
        Objects.equals(this.isMalwareDetected, rubyPackageUpload.isMalwareDetected) &&
        Objects.equals(this.isMoveable, rubyPackageUpload.isMoveable) &&
        Objects.equals(this.isQuarantinable, rubyPackageUpload.isQuarantinable) &&
        Objects.equals(this.isQuarantined, rubyPackageUpload.isQuarantined) &&
        Objects.equals(this.isResyncable, rubyPackageUpload.isResyncable) &&
        Objects.equals(this.isSecurityScannable, rubyPackageUpload.isSecurityScannable) &&
        Objects.equals(this.isSyncAwaiting, rubyPackageUpload.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, rubyPackageUpload.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, rubyPackageUpload.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, rubyPackageUpload.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, rubyPackageUpload.isSyncInProgress) &&
        Objects.equals(this.license, rubyPackageUpload.license) &&
        Objects.equals(this.name, rubyPackageUpload.name) &&
        Objects.equals(this.namespace, rubyPackageUpload.namespace) &&
        Objects.equals(this.namespaceUrl, rubyPackageUpload.namespaceUrl) &&
        Objects.equals(this.numFiles, rubyPackageUpload.numFiles) &&
        Objects.equals(this.originRepository, rubyPackageUpload.originRepository) &&
        Objects.equals(this.originRepositoryUrl, rubyPackageUpload.originRepositoryUrl) &&
        Objects.equals(this.osiApproved, rubyPackageUpload.osiApproved) &&
        Objects.equals(this.packageType, rubyPackageUpload.packageType) &&
        Objects.equals(this.policyViolated, rubyPackageUpload.policyViolated) &&
        Objects.equals(this.rawLicense, rubyPackageUpload.rawLicense) &&
        Objects.equals(this.release, rubyPackageUpload.release) &&
        Objects.equals(this.repository, rubyPackageUpload.repository) &&
        Objects.equals(this.repositoryUrl, rubyPackageUpload.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, rubyPackageUpload.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, rubyPackageUpload.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, rubyPackageUpload.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, rubyPackageUpload.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, rubyPackageUpload.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, rubyPackageUpload.selfUrl) &&
        Objects.equals(this.selfWebappUrl, rubyPackageUpload.selfWebappUrl) &&
        Objects.equals(this.signatureUrl, rubyPackageUpload.signatureUrl) &&
        Objects.equals(this.size, rubyPackageUpload.size) &&
        Objects.equals(this.slug, rubyPackageUpload.slug) &&
        Objects.equals(this.slugPerm, rubyPackageUpload.slugPerm) &&
        Objects.equals(this.spdxLicense, rubyPackageUpload.spdxLicense) &&
        Objects.equals(this.stage, rubyPackageUpload.stage) &&
        Objects.equals(this.stageStr, rubyPackageUpload.stageStr) &&
        Objects.equals(this.stageUpdatedAt, rubyPackageUpload.stageUpdatedAt) &&
        Objects.equals(this.status, rubyPackageUpload.status) &&
        Objects.equals(this.statusReason, rubyPackageUpload.statusReason) &&
        Objects.equals(this.statusStr, rubyPackageUpload.statusStr) &&
        Objects.equals(this.statusUpdatedAt, rubyPackageUpload.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, rubyPackageUpload.statusUrl) &&
        Objects.equals(this.storePath, rubyPackageUpload.storePath) &&
        Objects.equals(this.subtype, rubyPackageUpload.subtype) &&
        Objects.equals(this.summary, rubyPackageUpload.summary) &&
        Objects.equals(this.syncFinishedAt, rubyPackageUpload.syncFinishedAt) &&
        Objects.equals(this.syncProgress, rubyPackageUpload.syncProgress) &&
        Objects.equals(this.tagsAutomatic, rubyPackageUpload.tagsAutomatic) &&
        Objects.equals(this.tagsImmutable, rubyPackageUpload.tagsImmutable) &&
        Objects.equals(this.tagsStatic, rubyPackageUpload.tagsStatic) &&
        Objects.equals(this.typeDisplay, rubyPackageUpload.typeDisplay) &&
        Objects.equals(this.uploadedAt, rubyPackageUpload.uploadedAt) &&
        Objects.equals(this.uploader, rubyPackageUpload.uploader) &&
        Objects.equals(this.uploaderUrl, rubyPackageUpload.uploaderUrl) &&
        Objects.equals(this.version, rubyPackageUpload.version) &&
        Objects.equals(this.versionOrig, rubyPackageUpload.versionOrig) &&
        Objects.equals(this.vulnerabilityCounts, rubyPackageUpload.vulnerabilityCounts) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, rubyPackageUpload.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class RubyPackageUpload {\n");
