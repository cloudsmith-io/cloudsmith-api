...
public class VsxPackageUploadRequest implements Serializable {
  ...
  **/
  ...
  public VsxPackageUploadRequest packageFile(String packageFile) {
 ...
 @Size(min=1)  @ApiModelProperty(required = true, value = "The primary file for the package.")
  ...
  public VsxPackageUploadRequest republish(Boolean republish) {
  ...
  **/
  ...
  public VsxPackageUploadRequest tags(String tags) {
    this.tags = tags;
    return this;
  }
 ...
 @Size(min=1,max=1024)  @ApiModelProperty(value = "A comma-separated values list of tags to add to the package.")
  ...
  public VsxPackageUploadRequest vulnerabilityCounts(WebOSVSeverityCounts vulnerabilityCounts) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VsxPackageUploadRequest vsxPackageUploadRequest = (VsxPackageUploadRequest) o;
    return Objects.equals(this.isMalwareDetected, vsxPackageUploadRequest.isMalwareDetected) &&
        Objects.equals(this.packageFile, vsxPackageUploadRequest.packageFile) &&
        Objects.equals(this.republish, vsxPackageUploadRequest.republish) &&
        Objects.equals(this.tags, vsxPackageUploadRequest.tags) &&
        Objects.equals(this.vulnerabilityCounts, vsxPackageUploadRequest.vulnerabilityCounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class VsxPackageUploadRequest {\n");
