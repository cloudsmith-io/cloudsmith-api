...
public class NixUpstream implements Serializable {
  ...
  public NixUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public NixUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public NixUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public NixUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public NixUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public NixUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public NixUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public NixUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public NixUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public NixUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public NixUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public NixUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public NixUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NixUpstream nixUpstream = (NixUpstream) o;
    return Objects.equals(this.authMode, nixUpstream.authMode) &&
        Objects.equals(this.authSecret, nixUpstream.authSecret) &&
        Objects.equals(this.authUsername, nixUpstream.authUsername) &&
        Objects.equals(this.available, nixUpstream.available) &&
        Objects.equals(this.canReindex, nixUpstream.canReindex) &&
        Objects.equals(this.createdAt, nixUpstream.createdAt) &&
        Objects.equals(this.disableReason, nixUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, nixUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, nixUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, nixUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, nixUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, nixUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, nixUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, nixUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, nixUpstream.indexStatus) &&
        Objects.equals(this.isActive, nixUpstream.isActive) &&
        Objects.equals(this.lastIndexed, nixUpstream.lastIndexed) &&
        Objects.equals(this.mode, nixUpstream.mode) &&
        Objects.equals(this.name, nixUpstream.name) &&
        Objects.equals(this.pendingValidation, nixUpstream.pendingValidation) &&
        Objects.equals(this.priority, nixUpstream.priority) &&
        Objects.equals(this.slugPerm, nixUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, nixUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, nixUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, nixUpstream.verifySsl);
  }
