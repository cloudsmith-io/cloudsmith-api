...
public class CargoUpstream implements Serializable {
  ...
  public CargoUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public CargoUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public CargoUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public CargoUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public CargoUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public CargoUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public CargoUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public CargoUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public CargoUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public CargoUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CargoUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public CargoUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public CargoUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CargoUpstream cargoUpstream = (CargoUpstream) o;
    return Objects.equals(this.authMode, cargoUpstream.authMode) &&
        Objects.equals(this.authSecret, cargoUpstream.authSecret) &&
        Objects.equals(this.authUsername, cargoUpstream.authUsername) &&
        Objects.equals(this.available, cargoUpstream.available) &&
        Objects.equals(this.canReindex, cargoUpstream.canReindex) &&
        Objects.equals(this.createdAt, cargoUpstream.createdAt) &&
        Objects.equals(this.disableReason, cargoUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, cargoUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, cargoUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, cargoUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, cargoUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, cargoUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, cargoUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, cargoUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, cargoUpstream.indexStatus) &&
        Objects.equals(this.isActive, cargoUpstream.isActive) &&
        Objects.equals(this.lastIndexed, cargoUpstream.lastIndexed) &&
        Objects.equals(this.mode, cargoUpstream.mode) &&
        Objects.equals(this.name, cargoUpstream.name) &&
        Objects.equals(this.pendingValidation, cargoUpstream.pendingValidation) &&
        Objects.equals(this.priority, cargoUpstream.priority) &&
        Objects.equals(this.slugPerm, cargoUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, cargoUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, cargoUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, cargoUpstream.verifySsl);
  }
