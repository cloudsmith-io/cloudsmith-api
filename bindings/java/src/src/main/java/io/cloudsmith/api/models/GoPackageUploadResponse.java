...
public class GoPackageUploadResponse implements Serializable {
 ...
 @Size(min=1)  @ApiModelProperty(value = "A textual description of this package.")
  ...
  public GoPackageUploadResponse distro(Distribution distro) {
    this.distro = distro;
    return this;
  }
  ...
  **/
  ...
  public GoPackageUploadResponse distroVersion(DistributionVersion distroVersion) {
  ...
  **/
  ...
  public GoPackageUploadResponse tagsImmutable(Tags tagsImmutable) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GoPackageUploadResponse goPackageUploadResponse = (GoPackageUploadResponse) o;
    return Objects.equals(this.architectures, goPackageUploadResponse.architectures) &&
        Objects.equals(this.cdnUrl, goPackageUploadResponse.cdnUrl) &&
        Objects.equals(this.checksumMd5, goPackageUploadResponse.checksumMd5) &&
        Objects.equals(this.checksumSha1, goPackageUploadResponse.checksumSha1) &&
        Objects.equals(this.checksumSha256, goPackageUploadResponse.checksumSha256) &&
        Objects.equals(this.checksumSha512, goPackageUploadResponse.checksumSha512) &&
        Objects.equals(this.dependenciesChecksumMd5, goPackageUploadResponse.dependenciesChecksumMd5) &&
        Objects.equals(this.dependenciesUrl, goPackageUploadResponse.dependenciesUrl) &&
        Objects.equals(this.description, goPackageUploadResponse.description) &&
        Objects.equals(this.distro, goPackageUploadResponse.distro) &&
        Objects.equals(this.distroVersion, goPackageUploadResponse.distroVersion) &&
        Objects.equals(this.downloads, goPackageUploadResponse.downloads) &&
        Objects.equals(this.epoch, goPackageUploadResponse.epoch) &&
        Objects.equals(this.extension, goPackageUploadResponse.extension) &&
        Objects.equals(this.filename, goPackageUploadResponse.filename) &&
        Objects.equals(this.files, goPackageUploadResponse.files) &&
        Objects.equals(this.format, goPackageUploadResponse.format) &&
        Objects.equals(this.formatUrl, goPackageUploadResponse.formatUrl) &&
        Objects.equals(this.identifierPerm, goPackageUploadResponse.identifierPerm) &&
        Objects.equals(this.indexed, goPackageUploadResponse.indexed) &&
        Objects.equals(this.isDownloadable, goPackageUploadResponse.isDownloadable) &&
        Objects.equals(this.isQuarantined, goPackageUploadResponse.isQuarantined) &&
        Objects.equals(this.isSyncAwaiting, goPackageUploadResponse.isSyncAwaiting) &&
        Objects.equals(this.isSyncCompleted, goPackageUploadResponse.isSyncCompleted) &&
        Objects.equals(this.isSyncFailed, goPackageUploadResponse.isSyncFailed) &&
        Objects.equals(this.isSyncInFlight, goPackageUploadResponse.isSyncInFlight) &&
        Objects.equals(this.isSyncInProgress, goPackageUploadResponse.isSyncInProgress) &&
        Objects.equals(this.license, goPackageUploadResponse.license) &&
        Objects.equals(this.name, goPackageUploadResponse.name) &&
        Objects.equals(this.namespace, goPackageUploadResponse.namespace) &&
        Objects.equals(this.namespaceUrl, goPackageUploadResponse.namespaceUrl) &&
        Objects.equals(this.numFiles, goPackageUploadResponse.numFiles) &&
        Objects.equals(this.originRepository, goPackageUploadResponse.originRepository) &&
        Objects.equals(this.originRepositoryUrl, goPackageUploadResponse.originRepositoryUrl) &&
        Objects.equals(this.packageType, goPackageUploadResponse.packageType) &&
        Objects.equals(this.release, goPackageUploadResponse.release) &&
        Objects.equals(this.repository, goPackageUploadResponse.repository) &&
        Objects.equals(this.repositoryUrl, goPackageUploadResponse.repositoryUrl) &&
        Objects.equals(this.securityScanCompletedAt, goPackageUploadResponse.securityScanCompletedAt) &&
        Objects.equals(this.securityScanStartedAt, goPackageUploadResponse.securityScanStartedAt) &&
        Objects.equals(this.securityScanStatus, goPackageUploadResponse.securityScanStatus) &&
        Objects.equals(this.securityScanStatusUpdatedAt, goPackageUploadResponse.securityScanStatusUpdatedAt) &&
        Objects.equals(this.selfHtmlUrl, goPackageUploadResponse.selfHtmlUrl) &&
        Objects.equals(this.selfUrl, goPackageUploadResponse.selfUrl) &&
        Objects.equals(this.signatureUrl, goPackageUploadResponse.signatureUrl) &&
        Objects.equals(this.size, goPackageUploadResponse.size) &&
        Objects.equals(this.slug, goPackageUploadResponse.slug) &&
        Objects.equals(this.slugPerm, goPackageUploadResponse.slugPerm) &&
        Objects.equals(this.stage, goPackageUploadResponse.stage) &&
        Objects.equals(this.stageStr, goPackageUploadResponse.stageStr) &&
        Objects.equals(this.stageUpdatedAt, goPackageUploadResponse.stageUpdatedAt) &&
        Objects.equals(this.status, goPackageUploadResponse.status) &&
        Objects.equals(this.statusReason, goPackageUploadResponse.statusReason) &&
        Objects.equals(this.statusStr, goPackageUploadResponse.statusStr) &&
        Objects.equals(this.statusUpdatedAt, goPackageUploadResponse.statusUpdatedAt) &&
        Objects.equals(this.statusUrl, goPackageUploadResponse.statusUrl) &&
        Objects.equals(this.subtype, goPackageUploadResponse.subtype) &&
        Objects.equals(this.summary, goPackageUploadResponse.summary) &&
        Objects.equals(this.syncFinishedAt, goPackageUploadResponse.syncFinishedAt) &&
        Objects.equals(this.syncProgress, goPackageUploadResponse.syncProgress) &&
        Objects.equals(this.tagsImmutable, goPackageUploadResponse.tagsImmutable) &&
        Objects.equals(this.typeDisplay, goPackageUploadResponse.typeDisplay) &&
        Objects.equals(this.uploadedAt, goPackageUploadResponse.uploadedAt) &&
        Objects.equals(this.uploader, goPackageUploadResponse.uploader) &&
        Objects.equals(this.uploaderUrl, goPackageUploadResponse.uploaderUrl) &&
        Objects.equals(this.version, goPackageUploadResponse.version) &&
        Objects.equals(this.versionOrig, goPackageUploadResponse.versionOrig) &&
        Objects.equals(this.vulnerabilityScanResultsUrl, goPackageUploadResponse.vulnerabilityScanResultsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoPackageUploadResponse {\n");
