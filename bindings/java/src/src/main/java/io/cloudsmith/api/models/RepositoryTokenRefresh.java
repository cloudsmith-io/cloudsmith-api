...
public class RepositoryTokenRefresh implements Serializable {
  ...
  **/
  ...
  public RepositoryTokenRefresh eulaAccepted(Eula eulaAccepted) {
  ...
  **/
  ...
  public RepositoryTokenRefresh limitBandwidth(java.math.BigInteger limitBandwidth) {
  ...
  **/
  ...
  public RepositoryTokenRefresh limitDateRangeFrom(OffsetDateTime limitDateRangeFrom) {
  ...
  **/
  ...
  public RepositoryTokenRefresh limitDateRangeTo(OffsetDateTime limitDateRangeTo) {
  ...
  **/
  ...
  public RepositoryTokenRefresh limitNumClients(java.math.BigInteger limitNumClients) {
 ...
 @Min(-9223372036854775808L) @Max(9223372036854775807L)  @ApiModelProperty(value = "The maximum number of unique clients allowed for the token. Please note that since clients are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point.")
  ...
  public RepositoryTokenRefresh limitNumDownloads(java.math.BigInteger limitNumDownloads) {
  ...
  **/
  ...
  public RepositoryTokenRefresh scheduledResetAt(OffsetDateTime scheduledResetAt) {
