...
public class HelmUpstream implements Serializable {
  ...
  public HelmUpstream authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public HelmUpstream authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public HelmUpstream authUsername(String authUsername) {
  ...
  **/
  ...
  public HelmUpstream extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public HelmUpstream extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public HelmUpstream extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public HelmUpstream extraValue2(String extraValue2) {
  ...
  **/
  ...
  public HelmUpstream isActive(Boolean isActive) {
  ...
  **/
  ...
  public HelmUpstream mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public HelmUpstream name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public HelmUpstream priority(java.math.BigInteger priority) {
  ...
  **/
  ...
  public HelmUpstream upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public HelmUpstream verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HelmUpstream helmUpstream = (HelmUpstream) o;
    return Objects.equals(this.authMode, helmUpstream.authMode) &&
        Objects.equals(this.authSecret, helmUpstream.authSecret) &&
        Objects.equals(this.authUsername, helmUpstream.authUsername) &&
        Objects.equals(this.available, helmUpstream.available) &&
        Objects.equals(this.canReindex, helmUpstream.canReindex) &&
        Objects.equals(this.createdAt, helmUpstream.createdAt) &&
        Objects.equals(this.disableReason, helmUpstream.disableReason) &&
        Objects.equals(this.disableReasonText, helmUpstream.disableReasonText) &&
        Objects.equals(this.extraHeader1, helmUpstream.extraHeader1) &&
        Objects.equals(this.extraHeader2, helmUpstream.extraHeader2) &&
        Objects.equals(this.extraValue1, helmUpstream.extraValue1) &&
        Objects.equals(this.extraValue2, helmUpstream.extraValue2) &&
        Objects.equals(this.hasFailedSignatureVerification, helmUpstream.hasFailedSignatureVerification) &&
        Objects.equals(this.indexPackageCount, helmUpstream.indexPackageCount) &&
        Objects.equals(this.indexStatus, helmUpstream.indexStatus) &&
        Objects.equals(this.isActive, helmUpstream.isActive) &&
        Objects.equals(this.lastIndexed, helmUpstream.lastIndexed) &&
        Objects.equals(this.mode, helmUpstream.mode) &&
        Objects.equals(this.name, helmUpstream.name) &&
        Objects.equals(this.pendingValidation, helmUpstream.pendingValidation) &&
        Objects.equals(this.priority, helmUpstream.priority) &&
        Objects.equals(this.slugPerm, helmUpstream.slugPerm) &&
        Objects.equals(this.updatedAt, helmUpstream.updatedAt) &&
        Objects.equals(this.upstreamUrl, helmUpstream.upstreamUrl) &&
        Objects.equals(this.verifySsl, helmUpstream.verifySsl);
  }
