...
public class ProviderSettings implements Serializable {
  ...
  public ProviderSettings claims(Object claims) {
    this.claims = claims;
    return this;
  }
  ...
  **/
  ...
  public ProviderSettings enabled(Boolean enabled) {
 ...
 @Size(min=1)  @ApiModelProperty(required = true, value = "The name of the provider settings are being configured for")
  ...
  public ProviderSettings providerUrl(String providerUrl) {
 ...
 @Size(min=1)  @ApiModelProperty(required = true, value = "The URL from the provider that serves as the base for the OpenID configuration. For example, if the OpenID configuration is available at https://token.actions.githubusercontent.com/.well-known/openid-configuration, the provider URL would be https://token.actions.githubusercontent.com/")
  ...
  public ProviderSettings serviceAccounts(List<String> serviceAccounts) {
 ...
 @Pattern(regexp="^[-a-zA-Z0-9_]+$") @Size(min=1)  @ApiModelProperty(value = "The unique, immutable identifier of the provider settings.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.claims, providerSettings.claims) &&
        ...
        Objects.equals(this.slug, providerSettings.slug) &&
        Objects.equals(this.slugPerm, providerSettings.slugPerm);
  }
