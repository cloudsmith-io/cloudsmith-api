...
public class ComposerUpstreamRequest implements Serializable {
  ...
  public ComposerUpstreamRequest authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public ComposerUpstreamRequest authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public ComposerUpstreamRequest authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public ComposerUpstreamRequest extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public ComposerUpstreamRequest extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public ComposerUpstreamRequest extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public ComposerUpstreamRequest extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public ComposerUpstreamRequest isActive(Boolean isActive) {
  ...
  **/
  ...
  public ComposerUpstreamRequest mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public ComposerUpstreamRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public ComposerUpstreamRequest priority(java.math.BigInteger priority) {
 ...
 @Min(1L) @Max(32767L)  @ApiModelProperty(value = "Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.")
  ...
  public ComposerUpstreamRequest upstreamUrl(String upstreamUrl) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(required = true, value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public ComposerUpstreamRequest verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ComposerUpstreamRequest composerUpstreamRequest = (ComposerUpstreamRequest) o;
    return Objects.equals(this.authMode, composerUpstreamRequest.authMode) &&
        Objects.equals(this.authSecret, composerUpstreamRequest.authSecret) &&
        Objects.equals(this.authUsername, composerUpstreamRequest.authUsername) &&
        Objects.equals(this.extraHeader1, composerUpstreamRequest.extraHeader1) &&
        Objects.equals(this.extraHeader2, composerUpstreamRequest.extraHeader2) &&
        Objects.equals(this.extraValue1, composerUpstreamRequest.extraValue1) &&
        Objects.equals(this.extraValue2, composerUpstreamRequest.extraValue2) &&
        Objects.equals(this.isActive, composerUpstreamRequest.isActive) &&
        Objects.equals(this.mode, composerUpstreamRequest.mode) &&
        Objects.equals(this.name, composerUpstreamRequest.name) &&
        Objects.equals(this.priority, composerUpstreamRequest.priority) &&
        Objects.equals(this.upstreamUrl, composerUpstreamRequest.upstreamUrl) &&
        Objects.equals(this.verifySsl, composerUpstreamRequest.verifySsl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComposerUpstreamRequest {\n");
