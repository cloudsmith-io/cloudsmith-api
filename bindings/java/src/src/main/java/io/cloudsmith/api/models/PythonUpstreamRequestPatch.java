...
public class PythonUpstreamRequestPatch implements Serializable {
  ...
  public PythonUpstreamRequestPatch authMode(AuthModeEnum authMode) {
  ...
  **/
  ...
  public PythonUpstreamRequestPatch authSecret(String authSecret) {
 ...
 @Size(max=4096)  @ApiModelProperty(value = "Secret to provide with requests to upstream.")
  ...
  public PythonUpstreamRequestPatch authUsername(String authUsername) {
 ...
 @Size(max=64)  @ApiModelProperty(value = "Username to provide with requests to upstream.")
  ...
  public PythonUpstreamRequestPatch extraHeader1(String extraHeader1) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #1 to send to upstream.")
  ...
  public PythonUpstreamRequestPatch extraHeader2(String extraHeader2) {
 ...
 @Pattern(regexp="^[-\\w]+$") @Size(max=64)  @ApiModelProperty(value = "The key for extra header #2 to send to upstream.")
  ...
  public PythonUpstreamRequestPatch extraValue1(String extraValue1) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public PythonUpstreamRequestPatch extraValue2(String extraValue2) {
 ...
 @Pattern(regexp="^[^\\n\\r]+$") @Size(max=128)  @ApiModelProperty(value = "The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.")
  ...
  public PythonUpstreamRequestPatch isActive(Boolean isActive) {
  ...
  **/
  ...
  public PythonUpstreamRequestPatch mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  **/
  ...
  public PythonUpstreamRequestPatch name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Pattern(regexp="^\\w[\\w \\-'\\./()]+$") @Size(min=1,max=64)  @ApiModelProperty(value = "A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.")
  ...
  public PythonUpstreamRequestPatch priority(java.math.BigInteger priority) {
 ...
 @Size(min=1,max=200)  @ApiModelProperty(value = "The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. ")
  ...
  public PythonUpstreamRequestPatch verifySsl(Boolean verifySsl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PythonUpstreamRequestPatch pythonUpstreamRequestPatch = (PythonUpstreamRequestPatch) o;
    return Objects.equals(this.authMode, pythonUpstreamRequestPatch.authMode) &&
        Objects.equals(this.authSecret, pythonUpstreamRequestPatch.authSecret) &&
        Objects.equals(this.authUsername, pythonUpstreamRequestPatch.authUsername) &&
        Objects.equals(this.extraHeader1, pythonUpstreamRequestPatch.extraHeader1) &&
        Objects.equals(this.extraHeader2, pythonUpstreamRequestPatch.extraHeader2) &&
        Objects.equals(this.extraValue1, pythonUpstreamRequestPatch.extraValue1) &&
        Objects.equals(this.extraValue2, pythonUpstreamRequestPatch.extraValue2) &&
        Objects.equals(this.isActive, pythonUpstreamRequestPatch.isActive) &&
  ...
  public String toString() {
    ...
    sb.append("class PythonUpstreamRequestPatch {\n");
