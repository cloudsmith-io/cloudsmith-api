...
public class RubyPackageUploadRequest implements Serializable {
  ...
  **/
  ...
  public RubyPackageUploadRequest packageFile(String packageFile) {
 ...
 @Size(min=1)  @ApiModelProperty(required = true, value = "The primary file for the package.")
  ...
  public RubyPackageUploadRequest republish(Boolean republish) {
  ...
  **/
  ...
  public RubyPackageUploadRequest tags(String tags) {
    this.tags = tags;
    return this;
  }
 ...
 @Size(min=1,max=1024)  @ApiModelProperty(value = "A comma-separated values list of tags to add to the package.")
  ...
  public RubyPackageUploadRequest vulnerabilityCounts(WebOSVSeverityCounts vulnerabilityCounts) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RubyPackageUploadRequest rubyPackageUploadRequest = (RubyPackageUploadRequest) o;
    return Objects.equals(this.isMalwareDetected, rubyPackageUploadRequest.isMalwareDetected) &&
        Objects.equals(this.packageFile, rubyPackageUploadRequest.packageFile) &&
        Objects.equals(this.republish, rubyPackageUploadRequest.republish) &&
        Objects.equals(this.tags, rubyPackageUploadRequest.tags) &&
        Objects.equals(this.vulnerabilityCounts, rubyPackageUploadRequest.vulnerabilityCounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class RubyPackageUploadRequest {\n");
