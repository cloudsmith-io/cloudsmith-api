...
class OrgsInvitesExtend(object):
    ...
    def __init__(self, email=None, inviter=None, role=None, user=None, _configuration=None):  # noqa: E501
        """OrgsInvitesExtend - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrgsInvitesExtend, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrgsInvitesExtend):
            return False
