...
class RawPackageUpload(object):
    ...
    def display_source(self):
        """Gets the display_source of this RawPackageUpload.
        ...
        :return: The display_source of this RawPackageUpload.
        :rtype: str
        """
    ...
    def display_source(self, display_source):
        """Sets the display_source of this RawPackageUpload.

        Where the package originated, for example: 'upstream' (proxied/cached from a configured upstream), 'connected_repository' (blended in from a connected target repository), or 'manual_upload' (uploaded directly to Cloudsmith).

        :param display_source: The display_source of this RawPackageUpload.
        :type: str
        """
        if (self._configuration.client_side_validation and
