...
class RepositoryResponse(object):
    ...
    @property
    def cdn_url(self):
        """Gets the cdn_url of this RepositoryResponse.

        Base URL from which packages and other artifacts are downloaded.

        :return: The cdn_url of this RepositoryResponse.
        :rtype: str
        """
    ...
    def cdn_url(self, cdn_url):
        """Sets the cdn_url of this RepositoryResponse.

        Base URL from which packages and other artifacts are downloaded.

        :param cdn_url: The cdn_url of this RepositoryResponse.
        :type: str
        """
    ...
    def content_kind(self):
        """Gets the content_kind of this RepositoryResponse.
        ...
        :return: The content_kind of this RepositoryResponse.
        :rtype: str
        """
    ...
    def content_kind(self, content_kind):
        """Sets the content_kind of this RepositoryResponse.

        The repository content kind determines whether this repository contains packages, or provides a distribution of packages from other repositories. You can only select the content kind at repository creation time.

        :param content_kind: The content_kind of this RepositoryResponse.
        :type: str
        """
    ...
    def contextual_auth_realm(self):
        """Gets the contextual_auth_realm of this RepositoryResponse.
        ...
        :return: The contextual_auth_realm of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def contextual_auth_realm(self, contextual_auth_realm):
        """Sets the contextual_auth_realm of this RepositoryResponse.

        If checked, missing credentials for this repository where basic authentication is required shall present an enriched value in the 'WWW-Authenticate' header containing the namespace and repository. This can be useful for tooling such as SBT where the authentication realm is used to distinguish and disambiguate credentials.

        :param contextual_auth_realm: The contextual_auth_realm of this RepositoryResponse.
        :type: bool
        """
    ...
    @property
    def copy_own(self):
        """Gets the copy_own of this RepositoryResponse.
        ...
        :return: The copy_own of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def copy_own(self, copy_own):
        """Sets the copy_own of this RepositoryResponse.

        If checked, users can copy any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param copy_own: The copy_own of this RepositoryResponse.
        :type: bool
        """
    ...
    def copy_packages(self):
        """Gets the copy_packages of this RepositoryResponse.
        ...
        :return: The copy_packages of this RepositoryResponse.
        :rtype: str
        """
    ...
    def copy_packages(self, copy_packages):
        """Sets the copy_packages of this RepositoryResponse.

        This defines the minimum level of privilege required for a user to copy packages. Unless the package was uploaded by that user, in which the permission may be overridden by the user-specific copy setting.

        :param copy_packages: The copy_packages of this RepositoryResponse.
        :type: str
        """
    ...
    @property
    def created_at(self):
        """Gets the created_at of this RepositoryResponse.


        :return: The created_at of this RepositoryResponse.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this RepositoryResponse.


        :param created_at: The created_at of this RepositoryResponse.
        :type: datetime
        """
    ...
    def default_privilege(self):
        """Gets the default_privilege of this RepositoryResponse.
        ...
        :return: The default_privilege of this RepositoryResponse.
        :rtype: str
        """
    ...
    def default_privilege(self, default_privilege):
        """Sets the default_privilege of this RepositoryResponse.

        This defines the default level of privilege that all of your organization members have for this repository. This does not include collaborators, but applies to any member of the org regardless of their own membership role (i.e. it applies to owners, managers and members). Be careful if setting this to admin, because any member will be able to change settings.

        :param default_privilege: The default_privilege of this RepositoryResponse.
        :type: str
        """
    ...
    @property
    def delete_own(self):
        """Gets the delete_own of this RepositoryResponse.
        ...
        :return: The delete_own of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def delete_own(self, delete_own):
        """Sets the delete_own of this RepositoryResponse.

        If checked, users can delete any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param delete_own: The delete_own of this RepositoryResponse.
        :type: bool
        """
    ...
    def delete_packages(self):
        """Gets the delete_packages of this RepositoryResponse.
        ...
        :return: The delete_packages of this RepositoryResponse.
        :rtype: str
        """
    ...
    def delete_packages(self, delete_packages):
        """Sets the delete_packages of this RepositoryResponse.

        This defines the minimum level of privilege required for a user to delete packages. Unless the package was uploaded by that user, in which the permission may be overridden by the user-specific delete setting.

        :param delete_packages: The delete_packages of this RepositoryResponse.
        :type: str
        """
    ...
    @property
    def deleted_at(self):
        """Gets the deleted_at of this RepositoryResponse.


        :return: The deleted_at of this RepositoryResponse.
        :rtype: datetime
        """
    ...
    def deleted_at(self, deleted_at):
        """Sets the deleted_at of this RepositoryResponse.


        :param deleted_at: The deleted_at of this RepositoryResponse.
        :type: datetime
        """
    ...
    def description(self):
        """Gets the description of this RepositoryResponse.

        A description of the repository's purpose/contents.

        :return: The description of this RepositoryResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this RepositoryResponse.
        :type: str
        """
    ...
    def distributes(self, distributes):
        """Sets the distributes of this RepositoryResponse.

        The repositories distributed through this repo. Adding repos here is only valid if the content_kind is DISTRIBUTION.

        :param distributes: The distributes of this RepositoryResponse.
        :type: list[str]
        """
    ...
    def docker_refresh_tokens_enabled(self):
        """Gets the docker_refresh_tokens_enabled of this RepositoryResponse.
        ...
        :return: The docker_refresh_tokens_enabled of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def docker_refresh_tokens_enabled(self, docker_refresh_tokens_enabled):
        """Sets the docker_refresh_tokens_enabled of this RepositoryResponse.

        If checked, refresh tokens will be issued in addition to access tokens for Docker authentication. This allows unlimited extension of the lifetime of access tokens.

        :param docker_refresh_tokens_enabled: The docker_refresh_tokens_enabled of this RepositoryResponse.
        :type: bool
        """
    ...
    @property
    def gpg_keys(self):
        """Gets the gpg_keys of this RepositoryResponse.


        :return: The gpg_keys of this RepositoryResponse.
    ...
    def gpg_keys(self, gpg_keys):
        """Sets the gpg_keys of this RepositoryResponse.


        :param gpg_keys: The gpg_keys of this RepositoryResponse.
    ...
    def index_files(self):
        """Gets the index_files of this RepositoryResponse.

        If checked, files contained in packages will be indexed, which increase the synchronisation time required for packages. Note that it is recommended you keep this enabled unless the synchronisation time is significantly impacted.

        :return: The index_files of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def index_files(self, index_files):
        """Sets the index_files of this RepositoryResponse.

        If checked, files contained in packages will be indexed, which increase the synchronisation time required for packages. Note that it is recommended you keep this enabled unless the synchronisation time is significantly impacted.

        :param index_files: The index_files of this RepositoryResponse.
        :type: bool
        """
    ...
    def is_open_source(self):
        """Gets the is_open_source of this RepositoryResponse.


        :return: The is_open_source of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def is_open_source(self, is_open_source):
        """Sets the is_open_source of this RepositoryResponse.


        :param is_open_source: The is_open_source of this RepositoryResponse.
        :type: bool
        """
    ...
    @property
    def is_private(self):
        """Gets the is_private of this RepositoryResponse.


        :return: The is_private of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def is_private(self, is_private):
        """Sets the is_private of this RepositoryResponse.


        :param is_private: The is_private of this RepositoryResponse.
        :type: bool
        """
    ...
    @property
    def is_public(self):
        """Gets the is_public of this RepositoryResponse.


        :return: The is_public of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def is_public(self, is_public):
        """Sets the is_public of this RepositoryResponse.


        :param is_public: The is_public of this RepositoryResponse.
        :type: bool
        """
    ...
    @property
    def move_own(self):
        """Gets the move_own of this RepositoryResponse.
        ...
        :return: The move_own of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def move_own(self, move_own):
        """Sets the move_own of this RepositoryResponse.

        If checked, users can move any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param move_own: The move_own of this RepositoryResponse.
        :type: bool
        """
    ...
    def move_packages(self):
        """Gets the move_packages of this RepositoryResponse.
        ...
        :return: The move_packages of this RepositoryResponse.
        :rtype: str
        """
    ...
    def move_packages(self, move_packages):
        """Sets the move_packages of this RepositoryResponse.

        This defines the minimum level of privilege required for a user to move packages. Unless the package was uploaded by that user, in which the permission may be overridden by the user-specific move setting.

        :param move_packages: The move_packages of this RepositoryResponse.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this RepositoryResponse.

        A descriptive name for the repository.

        :return: The name of this RepositoryResponse.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this RepositoryResponse.
        :type: str
        """
    ...
    @property
    def namespace(self):
        """Gets the namespace of this RepositoryResponse.

        Namespace to which this repository belongs.

        :return: The namespace of this RepositoryResponse.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        """Sets the namespace of this RepositoryResponse.

        Namespace to which this repository belongs.

        :param namespace: The namespace of this RepositoryResponse.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def namespace_url(self):
        """Gets the namespace_url of this RepositoryResponse.

        API endpoint where data about this namespace can be retrieved.

        :return: The namespace_url of this RepositoryResponse.
        :rtype: str
        """
    ...
    def namespace_url(self, namespace_url):
        """Sets the namespace_url of this RepositoryResponse.

        API endpoint where data about this namespace can be retrieved.

        :param namespace_url: The namespace_url of this RepositoryResponse.
        :type: str
        """
    ...
    def num_downloads(self):
        """Gets the num_downloads of this RepositoryResponse.

        The number of downloads for packages in the repository.

        :return: The num_downloads of this RepositoryResponse.
        :rtype: int
        """
    ...
    def num_downloads(self, num_downloads):
        """Sets the num_downloads of this RepositoryResponse.

        The number of downloads for packages in the repository.

        :param num_downloads: The num_downloads of this RepositoryResponse.
        :type: int
        """
    ...
    def package_count(self):
        """Gets the package_count of this RepositoryResponse.

        The number of packages in the repository.

        :return: The package_count of this RepositoryResponse.
        :rtype: int
        """
    ...
    def package_count(self, package_count):
        """Sets the package_count of this RepositoryResponse.

        The number of packages in the repository.

        :param package_count: The package_count of this RepositoryResponse.
        :type: int
        """
    ...
    def package_group_count(self):
        """Gets the package_group_count of this RepositoryResponse.

        The number of groups in the repository.

        :return: The package_group_count of this RepositoryResponse.
        :rtype: int
        """
    ...
    def package_group_count(self, package_group_count):
        """Sets the package_group_count of this RepositoryResponse.

        The number of groups in the repository.

        :param package_group_count: The package_group_count of this RepositoryResponse.
        :type: int
        """
    ...
    def proxy_npmjs(self):
        """Gets the proxy_npmjs of this RepositoryResponse.
        ...
        :return: The proxy_npmjs of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def proxy_npmjs(self, proxy_npmjs):
        """Sets the proxy_npmjs of this RepositoryResponse.

        If checked, Npm packages that are not in the repository when requested by clients will automatically be proxied from the public npmjs.org registry. If there is at least one version for a package, others will not be proxied.

        :param proxy_npmjs: The proxy_npmjs of this RepositoryResponse.
        :type: bool
        """
    ...
    @property
    def proxy_pypi(self):
        """Gets the proxy_pypi of this RepositoryResponse.
        ...
        :return: The proxy_pypi of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def proxy_pypi(self, proxy_pypi):
        """Sets the proxy_pypi of this RepositoryResponse.

        If checked, Python packages that are not in the repository when requested by clients will automatically be proxied from the public pypi.python.org registry. If there is at least one version for a package, others will not be proxied.

        :param proxy_pypi: The proxy_pypi of this RepositoryResponse.
        :type: bool
        """
    ...
    def raw_package_index_enabled(self):
        """Gets the raw_package_index_enabled of this RepositoryResponse.

        If checked, HTML and JSON indexes will be generated that list all available raw packages in the repository.

        :return: The raw_package_index_enabled of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def raw_package_index_enabled(self, raw_package_index_enabled):
        """Sets the raw_package_index_enabled of this RepositoryResponse.

        If checked, HTML and JSON indexes will be generated that list all available raw packages in the repository.

        :param raw_package_index_enabled: The raw_package_index_enabled of this RepositoryResponse.
        :type: bool
        """
    ...
    def raw_package_index_signatures_enabled(self):
        """Gets the raw_package_index_signatures_enabled of this RepositoryResponse.

        If checked, the HTML and JSON indexes will display raw package GPG signatures alongside the index packages.

        :return: The raw_package_index_signatures_enabled of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def raw_package_index_signatures_enabled(self, raw_package_index_signatures_enabled):
        """Sets the raw_package_index_signatures_enabled of this RepositoryResponse.

        If checked, the HTML and JSON indexes will display raw package GPG signatures alongside the index packages.

        :param raw_package_index_signatures_enabled: The raw_package_index_signatures_enabled of this RepositoryResponse.
        :type: bool
        """
    ...
    def replace_packages(self):
        """Gets the replace_packages of this RepositoryResponse.
        ...
        :return: The replace_packages of this RepositoryResponse.
        :rtype: str
        """
    ...
    def replace_packages(self, replace_packages):
        """Sets the replace_packages of this RepositoryResponse.

        This defines the minimum level of privilege required for a user to republish packages. Unless the package was uploaded by that user, in which the permission may be overridden by the user-specific republish setting. Please note that the user still requires the privilege to delete packages that will be replaced by the new package; otherwise the republish will fail.

        :param replace_packages: The replace_packages of this RepositoryResponse.
        :type: str
        """
    ...
    def replace_packages_by_default(self):
        """Gets the replace_packages_by_default of this RepositoryResponse.
        ...
        :return: The replace_packages_by_default of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def replace_packages_by_default(self, replace_packages_by_default):
        """Sets the replace_packages_by_default of this RepositoryResponse.

        If checked, uploaded packages will overwrite/replace any others with the same attributes (e.g. same version) by default. This only applies if the user has the required privilege for the republishing AND has the required privilege to delete existing packages that they don't own.

        :param replace_packages_by_default: The replace_packages_by_default of this RepositoryResponse.
        :type: bool
        """
    ...
    def repository_type(self):
        """Gets the repository_type of this RepositoryResponse.
        ...
        :return: The repository_type of this RepositoryResponse.
        :rtype: int
        """
    ...
    def repository_type(self, repository_type):
        """Sets the repository_type of this RepositoryResponse.

        The repository type changes how it is accessed and billed. Private repositories are visible only to you or authorized delegates. Open-Source repositories are always visible to everyone and are restricted by licensing, but are free to use and come with generous bandwidth/storage. You can only select Open-Source at repository creation time.

        :param repository_type: The repository_type of this RepositoryResponse.
        :type: int
        """
    ...
    def repository_type_str(self):
        """Gets the repository_type_str of this RepositoryResponse.
        ...
        :return: The repository_type_str of this RepositoryResponse.
        :rtype: str
        """
    ...
    def repository_type_str(self, repository_type_str):
        """Sets the repository_type_str of this RepositoryResponse.

        The repository type changes how it is accessed and billed. Private repositories are visible only to you or authorized delegates. Public repositories are visible to all Cloudsmith users.

        :param repository_type_str: The repository_type_str of this RepositoryResponse.
        :type: str
        """
    ...
    @property
    def resync_own(self):
        """Gets the resync_own of this RepositoryResponse.
        ...
        :return: The resync_own of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def resync_own(self, resync_own):
        """Sets the resync_own of this RepositoryResponse.

        If checked, users can resync any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param resync_own: The resync_own of this RepositoryResponse.
        :type: bool
        """
    ...
    def resync_packages(self):
        """Gets the resync_packages of this RepositoryResponse.
        ...
        :return: The resync_packages of this RepositoryResponse.
        :rtype: str
        """
    ...
    def resync_packages(self, resync_packages):
        """Sets the resync_packages of this RepositoryResponse.

        This defines the minimum level of privilege required for a user to resync packages. Unless the package was uploaded by that user, in which the permission may be overridden by the user-specific resync setting.

        :param resync_packages: The resync_packages of this RepositoryResponse.
        :type: str
        """
    ...
    @property
    def scan_own(self):
        """Gets the scan_own of this RepositoryResponse.
        ...
        :return: The scan_own of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def scan_own(self, scan_own):
        """Sets the scan_own of this RepositoryResponse.

        If checked, users can scan any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param scan_own: The scan_own of this RepositoryResponse.
        :type: bool
        """
    ...
    def scan_packages(self):
        """Gets the scan_packages of this RepositoryResponse.
        ...
        :return: The scan_packages of this RepositoryResponse.
        :rtype: str
        """
    ...
    def scan_packages(self, scan_packages):
        """Sets the scan_packages of this RepositoryResponse.

        This defines the minimum level of privilege required for a user to scan packages. Unless the package was uploaded by that user, in which the permission may be overridden by the user-specific scan setting.

        :param scan_packages: The scan_packages of this RepositoryResponse.
        :type: str
        """
    ...
    def self_html_url(self):
        """Gets the self_html_url of this RepositoryResponse.

        Website URL for this repository.

        :return: The self_html_url of this RepositoryResponse.
        :rtype: str
        """
    ...
    def self_html_url(self, self_html_url):
        """Sets the self_html_url of this RepositoryResponse.

        Website URL for this repository.

        :param self_html_url: The self_html_url of this RepositoryResponse.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def self_url(self):
        """Gets the self_url of this RepositoryResponse.

        API endpoint where data about this repository can be retrieved.

        :return: The self_url of this RepositoryResponse.
        :rtype: str
        """
    ...
    def self_url(self, self_url):
        """Sets the self_url of this RepositoryResponse.

        API endpoint where data about this repository can be retrieved.

        :param self_url: The self_url of this RepositoryResponse.
        :type: str
        """
    ...
    def show_setup_all(self, show_setup_all):
        """Sets the show_setup_all of this RepositoryResponse.

        If checked, the Set Me Up help for all formats will always be shown, even if you don't have packages of that type uploaded. Otherwise, help will only be shown for packages that are in the repository. For example, if you have uploaded only NuGet packages, then the Set Me Up help for NuGet packages will be shown only.

        :param show_setup_all: The show_setup_all of this RepositoryResponse.
        :type: bool
        """
    ...
    @property
    def size(self):
        """Gets the size of this RepositoryResponse.

        The calculated size of the repository.

        :return: The size of this RepositoryResponse.
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this RepositoryResponse.

        The calculated size of the repository.

        :param size: The size of this RepositoryResponse.
        :type: int
        """
    ...
    @property
    def size_str(self):
        """Gets the size_str of this RepositoryResponse.

        The calculated size of the repository (human readable).

        :return: The size_str of this RepositoryResponse.
        :rtype: str
        """
    ...
    def size_str(self, size_str):
        """Sets the size_str of this RepositoryResponse.

        The calculated size of the repository (human readable).

        :param size_str: The size_str of this RepositoryResponse.
        :type: str
        """
    ...
    @property
    def slug(self):
        """Gets the slug of this RepositoryResponse.

        The slug identifies the repository in URIs.

        :return: The slug of this RepositoryResponse.
        :rtype: str
        """
        return self._slug
    ...
    @slug.setter
    def slug(self, slug):
        """Sets the slug of this RepositoryResponse.

        The slug identifies the repository in URIs.

        :param slug: The slug of this RepositoryResponse.
        :type: str
        """
    ...
    def slug_perm(self, slug_perm):
        """Sets the slug_perm of this RepositoryResponse.

        The slug_perm immutably identifies the repository. It will never change once a repository has been created.

        :param slug_perm: The slug_perm of this RepositoryResponse.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def storage_region(self):
        """Gets the storage_region of this RepositoryResponse.

        The Cloudsmith region in which package files are stored.

        :return: The storage_region of this RepositoryResponse.
        :rtype: str
        """
    ...
    def storage_region(self, storage_region):
        """Sets the storage_region of this RepositoryResponse.

        The Cloudsmith region in which package files are stored.

        :param storage_region: The storage_region of this RepositoryResponse.
        :type: str
        """
    ...
    def strict_npm_validation(self):
        """Gets the strict_npm_validation of this RepositoryResponse.
        ...
        :return: The strict_npm_validation of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def strict_npm_validation(self, strict_npm_validation):
        """Sets the strict_npm_validation of this RepositoryResponse.

        If checked, npm packages will be validated strictly to ensure the package matches specifcation. You can turn this off if you have packages that are old or otherwise mildly off-spec, but we can't guarantee the packages will work with npm-cli or other tooling correctly. Turn off at your own risk!

        :param strict_npm_validation: The strict_npm_validation of this RepositoryResponse.
        :type: bool
        """
    ...
    def use_debian_labels(self):
        """Gets the use_debian_labels of this RepositoryResponse.
        ...
        :return: The use_debian_labels of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def use_debian_labels(self, use_debian_labels):
        """Sets the use_debian_labels of this RepositoryResponse.

        If checked, a 'Label' field will be present in Debian-based repositories. It will contain a string that identifies the entitlement token used to authenticate the repository, in the form of 'source=t-<identifier>'; or 'source=none' if no token was used. You can use this to help with pinning.

        :param use_debian_labels: The use_debian_labels of this RepositoryResponse.
        :type: bool
        """
    ...
    def use_default_cargo_upstream(self):
        """Gets the use_default_cargo_upstream of this RepositoryResponse.
        ...
        :return: The use_default_cargo_upstream of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def use_default_cargo_upstream(self, use_default_cargo_upstream):
        """Sets the use_default_cargo_upstream of this RepositoryResponse.

        If checked, dependencies of uploaded Cargo crates which do not set an explicit value for \"registry\" will be assumed to be available from crates.io. If unchecked, dependencies with unspecified \"registry\" values will be assumed to be available in the registry being uploaded to. Uncheck this if you want to ensure that dependencies are only ever installed from Cloudsmith unless explicitly specified as belong to another registry.

        :param use_default_cargo_upstream: The use_default_cargo_upstream of this RepositoryResponse.
        :type: bool
        """
    ...
    def use_noarch_packages(self):
        """Gets the use_noarch_packages of this RepositoryResponse.
        ...
        :return: The use_noarch_packages of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def use_noarch_packages(self, use_noarch_packages):
        """Sets the use_noarch_packages of this RepositoryResponse.

        If checked, noarch packages (if supported) are enabled in installations/configurations. A noarch package is one that is not tied to specific system architecture (like i686).

        :param use_noarch_packages: The use_noarch_packages of this RepositoryResponse.
        :type: bool
        """
    ...
    def use_source_packages(self):
        """Gets the use_source_packages of this RepositoryResponse.
        ...
        :return: The use_source_packages of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def use_source_packages(self, use_source_packages):
        """Sets the use_source_packages of this RepositoryResponse.

        If checked, source packages (if supported) are enabled in installations/configurations. A source package is one that contains source code rather than built binaries.

        :param use_source_packages: The use_source_packages of this RepositoryResponse.
        :type: bool
        """
    ...
    def use_vulnerability_scanning(self):
        """Gets the use_vulnerability_scanning of this RepositoryResponse.

        If checked, vulnerability scanning will be enabled for all supported packages within this repository.

        :return: The use_vulnerability_scanning of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def use_vulnerability_scanning(self, use_vulnerability_scanning):
        """Sets the use_vulnerability_scanning of this RepositoryResponse.

        If checked, vulnerability scanning will be enabled for all supported packages within this repository.

        :param use_vulnerability_scanning: The use_vulnerability_scanning of this RepositoryResponse.
        :type: bool
        """
    ...
    def user_entitlements_enabled(self):
        """Gets the user_entitlements_enabled of this RepositoryResponse.
        ...
        :return: The user_entitlements_enabled of this RepositoryResponse.
        :rtype: bool
        """
    ...
    def user_entitlements_enabled(self, user_entitlements_enabled):
        """Sets the user_entitlements_enabled of this RepositoryResponse.

        If checked, users can use and manage their own user-specific entitlement token for the repository (if private). Otherwise, user-specific entitlements are disabled for all users.

        :param user_entitlements_enabled: The user_entitlements_enabled of this RepositoryResponse.
        :type: bool
        """
    ...
    def view_statistics(self):
        """Gets the view_statistics of this RepositoryResponse.
        ...
        :return: The view_statistics of this RepositoryResponse.
        :rtype: str
        """
    ...
    def view_statistics(self, view_statistics):
        """Sets the view_statistics of this RepositoryResponse.

        This defines the minimum level of privilege required for a user to view repository statistics, to include entitlement-based usage, if applicable. If a user does not have the permission, they won't be able to view any statistics, either via the UI, API or CLI.

        :param view_statistics: The view_statistics of this RepositoryResponse.
        :type: str
        """
