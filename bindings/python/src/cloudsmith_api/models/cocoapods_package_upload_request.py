...
class CocoapodsPackageUploadRequest(object):
    ...
    def __init__(self, is_malware_detected=None, package_file=None, republish=None, tags=None, vulnerability_counts=None, _configuration=None):  # noqa: E501
        """CocoapodsPackageUploadRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def is_malware_detected(self):
        """Gets the is_malware_detected of this CocoapodsPackageUploadRequest.

        Whether the package has been detected as containing malware. Requires Ultra plan.

        :return: The is_malware_detected of this CocoapodsPackageUploadRequest.
        :rtype: bool
        """
    ...
    def is_malware_detected(self, is_malware_detected):
        """Sets the is_malware_detected of this CocoapodsPackageUploadRequest.

        Whether the package has been detected as containing malware. Requires Ultra plan.

        :param is_malware_detected: The is_malware_detected of this CocoapodsPackageUploadRequest.
        :type: bool
        """
    ...
    def package_file(self):
        """Gets the package_file of this CocoapodsPackageUploadRequest.

        The primary file for the package.

        :return: The package_file of this CocoapodsPackageUploadRequest.
        :rtype: str
        """
    ...
    def package_file(self, package_file):
        """Sets the package_file of this CocoapodsPackageUploadRequest.

        The primary file for the package.

        :param package_file: The package_file of this CocoapodsPackageUploadRequest.
        :type: str
        """
    ...
    @property
    def republish(self):
        """Gets the republish of this CocoapodsPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :return: The republish of this CocoapodsPackageUploadRequest.
        :rtype: bool
        """
    ...
    def republish(self, republish):
        """Sets the republish of this CocoapodsPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :param republish: The republish of this CocoapodsPackageUploadRequest.
        :type: bool
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this CocoapodsPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :return: The tags of this CocoapodsPackageUploadRequest.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this CocoapodsPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :param tags: The tags of this CocoapodsPackageUploadRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def vulnerability_counts(self):
        """Gets the vulnerability_counts of this CocoapodsPackageUploadRequest.


        :return: The vulnerability_counts of this CocoapodsPackageUploadRequest.
    ...
    def vulnerability_counts(self, vulnerability_counts):
        """Sets the vulnerability_counts of this CocoapodsPackageUploadRequest.


        :param vulnerability_counts: The vulnerability_counts of this CocoapodsPackageUploadRequest.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CocoapodsPackageUploadRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CocoapodsPackageUploadRequest):
            return False
