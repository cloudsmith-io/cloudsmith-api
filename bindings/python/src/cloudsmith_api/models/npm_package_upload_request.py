...
class NpmPackageUploadRequest(object):
    ...
    def npm_dist_tag(self):
        """Gets the npm_dist_tag of this NpmPackageUploadRequest.
        ...
        :return: The npm_dist_tag of this NpmPackageUploadRequest.
        :rtype: str
        """
    ...
    def npm_dist_tag(self, npm_dist_tag):
        """Sets the npm_dist_tag of this NpmPackageUploadRequest.

        The default npm dist-tag for this package/version - This will replace any other package/version if they are using the same tag.

        :param npm_dist_tag: The npm_dist_tag of this NpmPackageUploadRequest.
        :type: str
        """
    ...
    def package_file(self):
        """Gets the package_file of this NpmPackageUploadRequest.

        The primary file for the package.

        :return: The package_file of this NpmPackageUploadRequest.
        :rtype: str
        """
    ...
    def package_file(self, package_file):
        """Sets the package_file of this NpmPackageUploadRequest.

        The primary file for the package.

        :param package_file: The package_file of this NpmPackageUploadRequest.
        :type: str
        """
    ...
    @property
    def republish(self):
        """Gets the republish of this NpmPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :return: The republish of this NpmPackageUploadRequest.
        :rtype: bool
        """
    ...
    def republish(self, republish):
        """Sets the republish of this NpmPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :param republish: The republish of this NpmPackageUploadRequest.
        :type: bool
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this NpmPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :return: The tags of this NpmPackageUploadRequest.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this NpmPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :param tags: The tags of this NpmPackageUploadRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NpmPackageUploadRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NpmPackageUploadRequest):
            return False
