...
class HexUpstreamRequest(object):
    ...
    def __init__(self, auth_mode='None', auth_secret=None, auth_username=None, extra_header_1=None, extra_header_2=None, extra_value_1=None, extra_value_2=None, is_active=None, mode='Proxy Only', name=None, priority=None, upstream_url=None, verify_ssl=None, _configuration=None):  # noqa: E501
        """HexUpstreamRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def auth_mode(self):
        """Gets the auth_mode of this HexUpstreamRequest.

        The authentication mode to use when accessing this upstream. 

        :return: The auth_mode of this HexUpstreamRequest.
        :rtype: str
        """
    ...
    def auth_mode(self, auth_mode):
        """Sets the auth_mode of this HexUpstreamRequest.

        The authentication mode to use when accessing this upstream. 

        :param auth_mode: The auth_mode of this HexUpstreamRequest.
        :type: str
        """
    ...
    def auth_secret(self):
        """Gets the auth_secret of this HexUpstreamRequest.

        Secret to provide with requests to upstream.

        :return: The auth_secret of this HexUpstreamRequest.
        :rtype: str
        """
    ...
    def auth_secret(self, auth_secret):
        """Sets the auth_secret of this HexUpstreamRequest.

        Secret to provide with requests to upstream.

        :param auth_secret: The auth_secret of this HexUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def auth_username(self):
        """Gets the auth_username of this HexUpstreamRequest.

        Username to provide with requests to upstream.

        :return: The auth_username of this HexUpstreamRequest.
        :rtype: str
        """
    ...
    def auth_username(self, auth_username):
        """Sets the auth_username of this HexUpstreamRequest.

        Username to provide with requests to upstream.

        :param auth_username: The auth_username of this HexUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_header_1(self):
        """Gets the extra_header_1 of this HexUpstreamRequest.

        The key for extra header #1 to send to upstream.

        :return: The extra_header_1 of this HexUpstreamRequest.
        :rtype: str
        """
    ...
    def extra_header_1(self, extra_header_1):
        """Sets the extra_header_1 of this HexUpstreamRequest.

        The key for extra header #1 to send to upstream.

        :param extra_header_1: The extra_header_1 of this HexUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_header_2(self):
        """Gets the extra_header_2 of this HexUpstreamRequest.

        The key for extra header #2 to send to upstream.

        :return: The extra_header_2 of this HexUpstreamRequest.
        :rtype: str
        """
    ...
    def extra_header_2(self, extra_header_2):
        """Sets the extra_header_2 of this HexUpstreamRequest.

        The key for extra header #2 to send to upstream.

        :param extra_header_2: The extra_header_2 of this HexUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_1(self):
        """Gets the extra_value_1 of this HexUpstreamRequest.

        The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :return: The extra_value_1 of this HexUpstreamRequest.
        :rtype: str
        """
    ...
    def extra_value_1(self, extra_value_1):
        """Sets the extra_value_1 of this HexUpstreamRequest.

        The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_1: The extra_value_1 of this HexUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_2(self):
        """Gets the extra_value_2 of this HexUpstreamRequest.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :return: The extra_value_2 of this HexUpstreamRequest.
        :rtype: str
        """
    ...
    def extra_value_2(self, extra_value_2):
        """Sets the extra_value_2 of this HexUpstreamRequest.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_2: The extra_value_2 of this HexUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def is_active(self):
        """Gets the is_active of this HexUpstreamRequest.

        Whether or not this upstream is active and ready for requests.

        :return: The is_active of this HexUpstreamRequest.
        :rtype: bool
        """
    ...
    def is_active(self, is_active):
        """Sets the is_active of this HexUpstreamRequest.

        Whether or not this upstream is active and ready for requests.

        :param is_active: The is_active of this HexUpstreamRequest.
        :type: bool
        """
    ...
    @property
    def mode(self):
        """Gets the mode of this HexUpstreamRequest.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :return: The mode of this HexUpstreamRequest.
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this HexUpstreamRequest.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :param mode: The mode of this HexUpstreamRequest.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this HexUpstreamRequest.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :return: The name of this HexUpstreamRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HexUpstreamRequest.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :param name: The name of this HexUpstreamRequest.
        :type: str
        """
    ...
    @property
    def priority(self):
        """Gets the priority of this HexUpstreamRequest.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :return: The priority of this HexUpstreamRequest.
        :rtype: int
        """
    ...
    def priority(self, priority):
        """Sets the priority of this HexUpstreamRequest.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :param priority: The priority of this HexUpstreamRequest.
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def upstream_url(self):
        """Gets the upstream_url of this HexUpstreamRequest.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :return: The upstream_url of this HexUpstreamRequest.
        :rtype: str
        """
    ...
    def upstream_url(self, upstream_url):
        """Sets the upstream_url of this HexUpstreamRequest.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :param upstream_url: The upstream_url of this HexUpstreamRequest.
        :type: str
        """
    ...
    @property
    def verify_ssl(self):
        """Gets the verify_ssl of this HexUpstreamRequest.
        ...
        :return: The verify_ssl of this HexUpstreamRequest.
        :rtype: bool
        """
    ...
    def verify_ssl(self, verify_ssl):
        """Sets the verify_ssl of this HexUpstreamRequest.

        If enabled, SSL certificates are verified when requests are made to this upstream. It's recommended to leave this enabled for all public sources to help mitigate Man-In-The-Middle (MITM) attacks. Please note this only applies to HTTPS upstreams.

        :param verify_ssl: The verify_ssl of this HexUpstreamRequest.
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HexUpstreamRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HexUpstreamRequest):
            return False
