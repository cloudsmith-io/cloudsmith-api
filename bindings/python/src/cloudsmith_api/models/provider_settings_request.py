...
class ProviderSettingsRequest(object):
    ...
    def __init__(self, claims=None, enabled=None, name=None, provider_url=None, service_accounts=None, _configuration=None):  # noqa: E501
        """ProviderSettingsRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def claims(self):
        """Gets the claims of this ProviderSettingsRequest.
        ...
        :return: The claims of this ProviderSettingsRequest.
        :rtype: object
        """
        return self._claims
    ...
    def claims(self, claims):
        """Sets the claims of this ProviderSettingsRequest.

        The set of claims that any received tokens from the provider must contain to authenticate as the configured service account.

        :param claims: The claims of this ProviderSettingsRequest.
        :type: object
        """
    ...
    @property
    def enabled(self):
        """Gets the enabled of this ProviderSettingsRequest.

        Whether the provider settings should be used for incoming OIDC requests.

        :return: The enabled of this ProviderSettingsRequest.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this ProviderSettingsRequest.

        Whether the provider settings should be used for incoming OIDC requests.

        :param enabled: The enabled of this ProviderSettingsRequest.
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProviderSettingsRequest.

        The name of the provider settings are being configured for

        :return: The name of this ProviderSettingsRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProviderSettingsRequest.

        The name of the provider settings are being configured for

        :param name: The name of this ProviderSettingsRequest.
        :type: str
        """
    ...
    def provider_url(self):
        """Gets the provider_url of this ProviderSettingsRequest.
        ...
        :return: The provider_url of this ProviderSettingsRequest.
        :rtype: str
        """
    ...
    def provider_url(self, provider_url):
        """Sets the provider_url of this ProviderSettingsRequest.

        The URL from the provider that serves as the base for the OpenID configuration. For example, if the OpenID configuration is available at https://token.actions.githubusercontent.com/.well-known/openid-configuration, the provider URL would be https://token.actions.githubusercontent.com/

        :param provider_url: The provider_url of this ProviderSettingsRequest.
        :type: str
        """
    ...
    def service_accounts(self):
        """Gets the service_accounts of this ProviderSettingsRequest.

        The service accounts associated with these provider settings

        :return: The service_accounts of this ProviderSettingsRequest.
        :rtype: list[str]
        """
    ...
    def service_accounts(self, service_accounts):
        """Sets the service_accounts of this ProviderSettingsRequest.

        The service accounts associated with these provider settings

        :param service_accounts: The service_accounts of this ProviderSettingsRequest.
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProviderSettingsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProviderSettingsRequest):
            return False
