...
class RpmUpstream(object):
    ...
    def __init__(self, auth_mode='None', auth_secret=None, auth_username=None, available=None, can_reindex=None, created_at=None, disable_reason='N/A', disable_reason_text=None, distro_version=None, extra_header_1=None, extra_header_2=None, extra_value_1=None, extra_value_2=None, gpg_key_fingerprint_short=None, gpg_key_inline=None, gpg_key_url=None, gpg_verification='Allow All', has_failed_signature_verification=None, include_sources=None, index_package_count=None, index_status=None, is_active=None, last_indexed=None, mode='Proxy Only', name=None, pending_validation=None, priority=None, slug_perm=None, updated_at=None, upstream_url=None, verification_status='Unknown', verify_ssl=None, _configuration=None):  # noqa: E501
        """RpmUpstream - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def auth_mode(self):
        """Gets the auth_mode of this RpmUpstream.

        The authentication mode to use when accessing this upstream. 

        :return: The auth_mode of this RpmUpstream.
        :rtype: str
        """
    ...
    def auth_mode(self, auth_mode):
        """Sets the auth_mode of this RpmUpstream.

        The authentication mode to use when accessing this upstream. 

        :param auth_mode: The auth_mode of this RpmUpstream.
        :type: str
        """
    ...
    def auth_secret(self):
        """Gets the auth_secret of this RpmUpstream.

        Secret to provide with requests to upstream.

        :return: The auth_secret of this RpmUpstream.
        :rtype: str
        """
    ...
    def auth_secret(self, auth_secret):
        """Sets the auth_secret of this RpmUpstream.

        Secret to provide with requests to upstream.

        :param auth_secret: The auth_secret of this RpmUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def auth_username(self):
        """Gets the auth_username of this RpmUpstream.

        Username to provide with requests to upstream.

        :return: The auth_username of this RpmUpstream.
        :rtype: str
        """
    ...
    def auth_username(self, auth_username):
        """Sets the auth_username of this RpmUpstream.

        Username to provide with requests to upstream.

        :param auth_username: The auth_username of this RpmUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def created_at(self):
        """Gets the created_at of this RpmUpstream.

        The datetime the upstream source was created.

        :return: The created_at of this RpmUpstream.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this RpmUpstream.

        The datetime the upstream source was created.

        :param created_at: The created_at of this RpmUpstream.
        :type: datetime
        """
    ...
    def disable_reason(self):
        """Gets the disable_reason of this RpmUpstream.


        :return: The disable_reason of this RpmUpstream.
        :rtype: str
        """
    ...
    def disable_reason(self, disable_reason):
        """Sets the disable_reason of this RpmUpstream.


        :param disable_reason: The disable_reason of this RpmUpstream.
        :type: str
        """
    ...
    def disable_reason_text(self):
        """Gets the disable_reason_text of this RpmUpstream.

        Human-readable explanation of why this upstream is disabled

        :return: The disable_reason_text of this RpmUpstream.
        :rtype: str
        """
    ...
    def disable_reason_text(self, disable_reason_text):
        """Sets the disable_reason_text of this RpmUpstream.

        Human-readable explanation of why this upstream is disabled

        :param disable_reason_text: The disable_reason_text of this RpmUpstream.
        :type: str
        """
    ...
    def distro_version(self):
        """Gets the distro_version of this RpmUpstream.

        The distribution version that packages found on this upstream will be associated with.

        :return: The distro_version of this RpmUpstream.
        :rtype: str
        """
    ...
    def distro_version(self, distro_version):
        """Sets the distro_version of this RpmUpstream.

        The distribution version that packages found on this upstream will be associated with.

        :param distro_version: The distro_version of this RpmUpstream.
        :type: str
        """
        if self._configuration.client_side_validation and distro_version is None:
            raise ValueError("Invalid value for `distro_version`, must not be `None`")  # noqa: E501

        self._distro_version = distro_version

    @property
    def extra_header_1(self):
        """Gets the extra_header_1 of this RpmUpstream.

        The key for extra header #1 to send to upstream.

        :return: The extra_header_1 of this RpmUpstream.
        :rtype: str
        """
    ...
    def extra_header_1(self, extra_header_1):
        """Sets the extra_header_1 of this RpmUpstream.

        The key for extra header #1 to send to upstream.

        :param extra_header_1: The extra_header_1 of this RpmUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_header_2(self):
        """Gets the extra_header_2 of this RpmUpstream.

        The key for extra header #2 to send to upstream.

        :return: The extra_header_2 of this RpmUpstream.
        :rtype: str
        """
    ...
    def extra_header_2(self, extra_header_2):
        """Sets the extra_header_2 of this RpmUpstream.

        The key for extra header #2 to send to upstream.

        :param extra_header_2: The extra_header_2 of this RpmUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_1(self, extra_value_1):
        """Sets the extra_value_1 of this RpmUpstream.

        The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_1: The extra_value_1 of this RpmUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_2(self):
        """Gets the extra_value_2 of this RpmUpstream.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :return: The extra_value_2 of this RpmUpstream.
        :rtype: str
        """
    ...
    def extra_value_2(self, extra_value_2):
        """Sets the extra_value_2 of this RpmUpstream.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_2: The extra_value_2 of this RpmUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def gpg_key_fingerprint_short(self):
        """Gets the gpg_key_fingerprint_short of this RpmUpstream.


        :return: The gpg_key_fingerprint_short of this RpmUpstream.
        :rtype: str
        """
    ...
    def gpg_key_fingerprint_short(self, gpg_key_fingerprint_short):
        """Sets the gpg_key_fingerprint_short of this RpmUpstream.


        :param gpg_key_fingerprint_short: The gpg_key_fingerprint_short of this RpmUpstream.
        :type: str
        """
    ...
    def gpg_key_inline(self):
        """Gets the gpg_key_inline of this RpmUpstream.
        ...
        :return: The gpg_key_inline of this RpmUpstream.
        :rtype: str
        """
    ...
    def gpg_key_inline(self, gpg_key_inline):
        """Sets the gpg_key_inline of this RpmUpstream.

        A public GPG key to associate with packages found on this upstream. When using the Cloudsmith setup script, this GPG key will be automatically imported on your deployment machines to allow upstream packages to validate and install.

        :param gpg_key_inline: The gpg_key_inline of this RpmUpstream.
        :type: str
        """
    ...
    def gpg_key_url(self):
        """Gets the gpg_key_url of this RpmUpstream.
        ...
        :return: The gpg_key_url of this RpmUpstream.
        :rtype: str
        """
    ...
    def gpg_key_url(self, gpg_key_url):
        """Sets the gpg_key_url of this RpmUpstream.

        When provided, Cloudsmith will fetch, validate, and associate a public GPG key found at the provided URL. When using the Cloudsmith setup script, this GPG key will be automatically imported on your deployment machines to allow upstream packages to validate and install.

        :param gpg_key_url: The gpg_key_url of this RpmUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def gpg_verification(self):
        """Gets the gpg_verification of this RpmUpstream.

        The GPG signature verification mode for this upstream.

        :return: The gpg_verification of this RpmUpstream.
        :rtype: str
        """
    ...
    def gpg_verification(self, gpg_verification):
        """Sets the gpg_verification of this RpmUpstream.

        The GPG signature verification mode for this upstream.

        :param gpg_verification: The gpg_verification of this RpmUpstream.
        :type: str
        """
    ...
    def include_sources(self):
        """Gets the include_sources of this RpmUpstream.

        When checked, source packages will be available from this upstream.

        :return: The include_sources of this RpmUpstream.
        :rtype: bool
        """
    ...
    def include_sources(self, include_sources):
        """Sets the include_sources of this RpmUpstream.

        When checked, source packages will be available from this upstream.

        :param include_sources: The include_sources of this RpmUpstream.
        :type: bool
        """
    ...
    def index_package_count(self):
        """Gets the index_package_count of this RpmUpstream.
    ...
    def index_package_count(self, index_package_count):
        """Sets the index_package_count of this RpmUpstream.
    ...
    def index_status(self):
        """Gets the index_status of this RpmUpstream.

        The current indexing status of this upstream source

        :return: The index_status of this RpmUpstream.
        :rtype: str
        """
    ...
    def index_status(self, index_status):
        """Sets the index_status of this RpmUpstream.

        The current indexing status of this upstream source

        :param index_status: The index_status of this RpmUpstream.
        :type: str
        """
    ...
    @property
    def is_active(self):
        """Gets the is_active of this RpmUpstream.

        Whether or not this upstream is active and ready for requests.

        :return: The is_active of this RpmUpstream.
        :rtype: bool
        """
    ...
    def is_active(self, is_active):
        """Sets the is_active of this RpmUpstream.

        Whether or not this upstream is active and ready for requests.

        :param is_active: The is_active of this RpmUpstream.
        :type: bool
        """
    ...
    def last_indexed(self):
        """Gets the last_indexed of this RpmUpstream.

        The last time this upstream source was indexed

        :return: The last_indexed of this RpmUpstream.
        :rtype: str
        """
    ...
    def last_indexed(self, last_indexed):
        """Sets the last_indexed of this RpmUpstream.

        The last time this upstream source was indexed

        :param last_indexed: The last_indexed of this RpmUpstream.
        :type: str
        """
    ...
    @property
    def mode(self):
        """Gets the mode of this RpmUpstream.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :return: The mode of this RpmUpstream.
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this RpmUpstream.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :param mode: The mode of this RpmUpstream.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this RpmUpstream.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :return: The name of this RpmUpstream.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RpmUpstream.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :param name: The name of this RpmUpstream.
        :type: str
        """
    ...
    def pending_validation(self):
        """Gets the pending_validation of this RpmUpstream.

        When true, this upstream source is pending validation.

        :return: The pending_validation of this RpmUpstream.
        :rtype: bool
        """
    ...
    def pending_validation(self, pending_validation):
        """Sets the pending_validation of this RpmUpstream.

        When true, this upstream source is pending validation.

        :param pending_validation: The pending_validation of this RpmUpstream.
        :type: bool
        """
    ...
    @property
    def priority(self):
        """Gets the priority of this RpmUpstream.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :return: The priority of this RpmUpstream.
        :rtype: int
        """
    ...
    def priority(self, priority):
        """Sets the priority of this RpmUpstream.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :param priority: The priority of this RpmUpstream.
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def slug_perm(self):
        """Gets the slug_perm of this RpmUpstream.


        :return: The slug_perm of this RpmUpstream.
        :rtype: str
        """
    ...
    def slug_perm(self, slug_perm):
        """Sets the slug_perm of this RpmUpstream.


        :param slug_perm: The slug_perm of this RpmUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this RpmUpstream.


        :return: The updated_at of this RpmUpstream.
        :rtype: datetime
        """
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this RpmUpstream.


        :param updated_at: The updated_at of this RpmUpstream.
        :type: datetime
        """
    ...
    def upstream_url(self):
        """Gets the upstream_url of this RpmUpstream.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :return: The upstream_url of this RpmUpstream.
        :rtype: str
        """
    ...
    def upstream_url(self, upstream_url):
        """Sets the upstream_url of this RpmUpstream.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :param upstream_url: The upstream_url of this RpmUpstream.
        :type: str
        """
    ...
    def verification_status(self):
        """Gets the verification_status of this RpmUpstream.

        The signature verification status for this upstream.

        :return: The verification_status of this RpmUpstream.
        :rtype: str
        """
    ...
    def verification_status(self, verification_status):
        """Sets the verification_status of this RpmUpstream.

        The signature verification status for this upstream.

        :param verification_status: The verification_status of this RpmUpstream.
        :type: str
        """
    ...
    @property
    def verify_ssl(self):
        """Gets the verify_ssl of this RpmUpstream.
        ...
        :return: The verify_ssl of this RpmUpstream.
        :rtype: bool
        """
    ...
    def verify_ssl(self, verify_ssl):
        """Sets the verify_ssl of this RpmUpstream.

        If enabled, SSL certificates are verified when requests are made to this upstream. It's recommended to leave this enabled for all public sources to help mitigate Man-In-The-Middle (MITM) attacks. Please note this only applies to HTTPS upstreams.

        :param verify_ssl: The verify_ssl of this RpmUpstream.
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RpmUpstream, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RpmUpstream):
            return False
