...
class PackageFileUploadResponse(object):
    ...
    def __init__(self, identifier=None, upload_fields=None, upload_headers=None, upload_querystring=None, upload_url=None, _configuration=None):  # noqa: E501
        """PackageFileUploadResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def identifier(self):
        """Gets the identifier of this PackageFileUploadResponse.

        The identifier for the file to use when creating packages

        :return: The identifier of this PackageFileUploadResponse.
        :rtype: str
        """
    ...
    def identifier(self, identifier):
        """Sets the identifier of this PackageFileUploadResponse.

        The identifier for the file to use when creating packages

        :param identifier: The identifier of this PackageFileUploadResponse.
        :type: str
        """
    ...
    def upload_fields(self):
        """Gets the upload_fields of this PackageFileUploadResponse.

        The dictionary of fields that must be sent with POST uploads

        :return: The upload_fields of this PackageFileUploadResponse.
        :rtype: object
        """
    ...
    def upload_fields(self, upload_fields):
        """Sets the upload_fields of this PackageFileUploadResponse.

        The dictionary of fields that must be sent with POST uploads

        :param upload_fields: The upload_fields of this PackageFileUploadResponse.
        :type: object
        """
    ...
    def upload_headers(self):
        """Gets the upload_headers of this PackageFileUploadResponse.

        The dictionary of headers that must be sent with uploads

        :return: The upload_headers of this PackageFileUploadResponse.
        :rtype: object
        """
    ...
    def upload_headers(self, upload_headers):
        """Sets the upload_headers of this PackageFileUploadResponse.

        The dictionary of headers that must be sent with uploads

        :param upload_headers: The upload_headers of this PackageFileUploadResponse.
        :type: object
        """
    ...
    def upload_querystring(self):
        """Gets the upload_querystring of this PackageFileUploadResponse.

        The querystring to use for the next-step POST or PUT upload

        :return: The upload_querystring of this PackageFileUploadResponse.
        :rtype: str
        """
    ...
    def upload_querystring(self, upload_querystring):
        """Sets the upload_querystring of this PackageFileUploadResponse.

        The querystring to use for the next-step POST or PUT upload

        :param upload_querystring: The upload_querystring of this PackageFileUploadResponse.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def upload_url(self):
        """Gets the upload_url of this PackageFileUploadResponse.

        The URL to use for the next-step POST or PUT upload

        :return: The upload_url of this PackageFileUploadResponse.
        :rtype: str
        """
    ...
    def upload_url(self, upload_url):
        """Sets the upload_url of this PackageFileUploadResponse.

        The URL to use for the next-step POST or PUT upload

        :param upload_url: The upload_url of this PackageFileUploadResponse.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PackageFileUploadResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PackageFileUploadResponse):
            return False
