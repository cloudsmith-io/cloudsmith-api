...
class FormatResponse(object):
    ...
    def __init__(self, description=None, distributions=None, extensions=None, name=None, premium=None, premium_plan_id=None, premium_plan_name=None, slug=None, supports=None, _configuration=None):  # noqa: E501
        """FormatResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this FormatResponse.

        Description of the package format

        :return: The description of this FormatResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this FormatResponse.

        Description of the package format

        :param description: The description of this FormatResponse.
        :type: str
        """
    ...
    def distributions(self):
        """Gets the distributions of this FormatResponse.

        The distributions supported by this package format

        :return: The distributions of this FormatResponse.
    ...
    def distributions(self, distributions):
        """Sets the distributions of this FormatResponse.

        The distributions supported by this package format

        :param distributions: The distributions of this FormatResponse.
    ...
    @property
    def extensions(self):
        """Gets the extensions of this FormatResponse.

        A non-exhaustive list of extensions supported

        :return: The extensions of this FormatResponse.
        :rtype: list[str]
        """
    ...
    def extensions(self, extensions):
        """Sets the extensions of this FormatResponse.

        A non-exhaustive list of extensions supported

        :param extensions: The extensions of this FormatResponse.
        :type: list[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this FormatResponse.

        Name for the package format

        :return: The name of this FormatResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FormatResponse.

        Name for the package format

        :param name: The name of this FormatResponse.
        :type: str
        """
    ...
    @property
    def premium(self):
        """Gets the premium of this FormatResponse.

        If true the package format is a premium-only feature

        :return: The premium of this FormatResponse.
        :rtype: bool
        """
    ...
    def premium(self, premium):
        """Sets the premium of this FormatResponse.

        If true the package format is a premium-only feature

        :param premium: The premium of this FormatResponse.
        :type: bool
        """
    ...
    def premium_plan_id(self):
        """Gets the premium_plan_id of this FormatResponse.

        The minimum plan id required for this package format

        :return: The premium_plan_id of this FormatResponse.
        :rtype: str
        """
    ...
    def premium_plan_id(self, premium_plan_id):
        """Sets the premium_plan_id of this FormatResponse.

        The minimum plan id required for this package format

        :param premium_plan_id: The premium_plan_id of this FormatResponse.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def premium_plan_name(self):
        """Gets the premium_plan_name of this FormatResponse.

        The minimum plan name required for this package format

        :return: The premium_plan_name of this FormatResponse.
        :rtype: str
        """
    ...
    def premium_plan_name(self, premium_plan_name):
        """Sets the premium_plan_name of this FormatResponse.

        The minimum plan name required for this package format

        :param premium_plan_name: The premium_plan_name of this FormatResponse.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def slug(self):
        """Gets the slug of this FormatResponse.

        Slug for the package format

        :return: The slug of this FormatResponse.
        :rtype: str
        """
        return self._slug
    ...
    @slug.setter
    def slug(self, slug):
        """Sets the slug of this FormatResponse.

        Slug for the package format

        :param slug: The slug of this FormatResponse.
        :type: str
        """
    ...
    @property
    def supports(self):
        """Gets the supports of this FormatResponse.


        :return: The supports of this FormatResponse.
        :rtype: FormatSupport
        """
    ...
    def supports(self, supports):
        """Sets the supports of this FormatResponse.


        :param supports: The supports of this FormatResponse.
        :type: FormatSupport
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FormatResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FormatResponse):
            return False
