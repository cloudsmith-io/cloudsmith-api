...
class NixUpstream(object):
    ...
    def __init__(self, auth_mode='None', auth_secret=None, auth_username=None, available=None, can_reindex=None, created_at=None, disable_reason='N/A', disable_reason_text=None, extra_header_1=None, extra_header_2=None, extra_value_1=None, extra_value_2=None, has_failed_signature_verification=None, index_package_count=None, index_status=None, is_active=None, last_indexed=None, mode='Proxy Only', name=None, pending_validation=None, priority=None, slug_perm=None, updated_at=None, upstream_url=None, verify_ssl=None, _configuration=None):  # noqa: E501
        """NixUpstream - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def auth_mode(self):
        """Gets the auth_mode of this NixUpstream.

        The authentication mode to use when accessing this upstream. 

        :return: The auth_mode of this NixUpstream.
        :rtype: str
        """
    ...
    def auth_mode(self, auth_mode):
        """Sets the auth_mode of this NixUpstream.

        The authentication mode to use when accessing this upstream. 

        :param auth_mode: The auth_mode of this NixUpstream.
        :type: str
        """
    ...
    def auth_secret(self):
        """Gets the auth_secret of this NixUpstream.

        Secret to provide with requests to upstream.

        :return: The auth_secret of this NixUpstream.
        :rtype: str
        """
    ...
    def auth_secret(self, auth_secret):
        """Sets the auth_secret of this NixUpstream.

        Secret to provide with requests to upstream.

        :param auth_secret: The auth_secret of this NixUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def auth_username(self):
        """Gets the auth_username of this NixUpstream.

        Username to provide with requests to upstream.

        :return: The auth_username of this NixUpstream.
        :rtype: str
        """
    ...
    def auth_username(self, auth_username):
        """Sets the auth_username of this NixUpstream.

        Username to provide with requests to upstream.

        :param auth_username: The auth_username of this NixUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def available(self):
        """Gets the available of this NixUpstream.

        Whether the upstream is available for use.

        :return: The available of this NixUpstream.
        :rtype: bool
        """
    ...
    def available(self, available):
        """Sets the available of this NixUpstream.

        Whether the upstream is available for use.

        :param available: The available of this NixUpstream.
        :type: bool
        """
    ...
    def can_reindex(self):
        """Gets the can_reindex of this NixUpstream.

        Whether the upstream can be reindexed.

        :return: The can_reindex of this NixUpstream.
        :rtype: bool
        """
    ...
    def can_reindex(self, can_reindex):
        """Sets the can_reindex of this NixUpstream.

        Whether the upstream can be reindexed.

        :param can_reindex: The can_reindex of this NixUpstream.
        :type: bool
        """
    ...
    @property
    def created_at(self):
        """Gets the created_at of this NixUpstream.

        The datetime the upstream source was created.

        :return: The created_at of this NixUpstream.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this NixUpstream.

        The datetime the upstream source was created.

        :param created_at: The created_at of this NixUpstream.
        :type: datetime
        """
    ...
    def disable_reason(self):
        """Gets the disable_reason of this NixUpstream.


        :return: The disable_reason of this NixUpstream.
        :rtype: str
        """
    ...
    def disable_reason(self, disable_reason):
        """Sets the disable_reason of this NixUpstream.


        :param disable_reason: The disable_reason of this NixUpstream.
        :type: str
        """
    ...
    def disable_reason_text(self):
        """Gets the disable_reason_text of this NixUpstream.

        Human-readable explanation of why this upstream is disabled

        :return: The disable_reason_text of this NixUpstream.
        :rtype: str
        """
    ...
    def disable_reason_text(self, disable_reason_text):
        """Sets the disable_reason_text of this NixUpstream.

        Human-readable explanation of why this upstream is disabled

        :param disable_reason_text: The disable_reason_text of this NixUpstream.
        :type: str
        """
    ...
    def extra_header_1(self):
        """Gets the extra_header_1 of this NixUpstream.

        The key for extra header #1 to send to upstream.

        :return: The extra_header_1 of this NixUpstream.
        :rtype: str
        """
    ...
    def extra_header_1(self, extra_header_1):
        """Sets the extra_header_1 of this NixUpstream.

        The key for extra header #1 to send to upstream.

        :param extra_header_1: The extra_header_1 of this NixUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_header_2(self):
        """Gets the extra_header_2 of this NixUpstream.

        The key for extra header #2 to send to upstream.

        :return: The extra_header_2 of this NixUpstream.
        :rtype: str
        """
    ...
    def extra_header_2(self, extra_header_2):
        """Sets the extra_header_2 of this NixUpstream.

        The key for extra header #2 to send to upstream.

        :param extra_header_2: The extra_header_2 of this NixUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_1(self, extra_value_1):
        """Sets the extra_value_1 of this NixUpstream.

        The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_1: The extra_value_1 of this NixUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_2(self):
        """Gets the extra_value_2 of this NixUpstream.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :return: The extra_value_2 of this NixUpstream.
        :rtype: str
        """
    ...
    def extra_value_2(self, extra_value_2):
        """Sets the extra_value_2 of this NixUpstream.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_2: The extra_value_2 of this NixUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def has_failed_signature_verification(self):
        """Gets the has_failed_signature_verification of this NixUpstream.

        Whether the upstream has failed signature verification.

        :return: The has_failed_signature_verification of this NixUpstream.
        :rtype: bool
        """
    ...
    def has_failed_signature_verification(self, has_failed_signature_verification):
        """Sets the has_failed_signature_verification of this NixUpstream.

        Whether the upstream has failed signature verification.

        :param has_failed_signature_verification: The has_failed_signature_verification of this NixUpstream.
        :type: bool
        """
    ...
    def index_package_count(self):
        """Gets the index_package_count of this NixUpstream.

        The number of packages available in this upstream source

        :return: The index_package_count of this NixUpstream.
        :rtype: int
        """
    ...
    def index_package_count(self, index_package_count):
        """Sets the index_package_count of this NixUpstream.

        The number of packages available in this upstream source

        :param index_package_count: The index_package_count of this NixUpstream.
        :type: int
        """
    ...
    def index_status(self):
        """Gets the index_status of this NixUpstream.

        The current indexing status of this upstream source

        :return: The index_status of this NixUpstream.
        :rtype: str
        """
    ...
    def index_status(self, index_status):
        """Sets the index_status of this NixUpstream.

        The current indexing status of this upstream source

        :param index_status: The index_status of this NixUpstream.
        :type: str
        """
    ...
    @property
    def is_active(self):
        """Gets the is_active of this NixUpstream.

        Whether or not this upstream is active and ready for requests.

        :return: The is_active of this NixUpstream.
        :rtype: bool
        """
    ...
    def is_active(self, is_active):
        """Sets the is_active of this NixUpstream.

        Whether or not this upstream is active and ready for requests.

        :param is_active: The is_active of this NixUpstream.
        :type: bool
        """
    ...
    def last_indexed(self):
        """Gets the last_indexed of this NixUpstream.

        The last time this upstream source was indexed

        :return: The last_indexed of this NixUpstream.
        :rtype: str
        """
    ...
    def last_indexed(self, last_indexed):
        """Sets the last_indexed of this NixUpstream.

        The last time this upstream source was indexed

        :param last_indexed: The last_indexed of this NixUpstream.
        :type: str
        """
    ...
    @property
    def mode(self):
        """Gets the mode of this NixUpstream.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :return: The mode of this NixUpstream.
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this NixUpstream.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :param mode: The mode of this NixUpstream.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this NixUpstream.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :return: The name of this NixUpstream.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NixUpstream.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :param name: The name of this NixUpstream.
        :type: str
        """
    ...
    def pending_validation(self):
        """Gets the pending_validation of this NixUpstream.

        When true, this upstream source is pending validation.

        :return: The pending_validation of this NixUpstream.
        :rtype: bool
        """
    ...
    def pending_validation(self, pending_validation):
        """Sets the pending_validation of this NixUpstream.

        When true, this upstream source is pending validation.

        :param pending_validation: The pending_validation of this NixUpstream.
        :type: bool
        """
    ...
    @property
    def priority(self):
        """Gets the priority of this NixUpstream.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :return: The priority of this NixUpstream.
        :rtype: int
        """
    ...
    def priority(self, priority):
        """Sets the priority of this NixUpstream.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :param priority: The priority of this NixUpstream.
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def slug_perm(self):
        """Gets the slug_perm of this NixUpstream.


        :return: The slug_perm of this NixUpstream.
        :rtype: str
        """
    ...
    def slug_perm(self, slug_perm):
        """Sets the slug_perm of this NixUpstream.


        :param slug_perm: The slug_perm of this NixUpstream.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this NixUpstream.


        :return: The updated_at of this NixUpstream.
        :rtype: datetime
        """
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this NixUpstream.


        :param updated_at: The updated_at of this NixUpstream.
        :type: datetime
        """
    ...
    def upstream_url(self):
        """Gets the upstream_url of this NixUpstream.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :return: The upstream_url of this NixUpstream.
        :rtype: str
        """
    ...
    def upstream_url(self, upstream_url):
        """Sets the upstream_url of this NixUpstream.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :param upstream_url: The upstream_url of this NixUpstream.
        :type: str
        """
    ...
    @property
    def verify_ssl(self):
        """Gets the verify_ssl of this NixUpstream.
        ...
        :return: The verify_ssl of this NixUpstream.
        :rtype: bool
        """
    ...
    def verify_ssl(self, verify_ssl):
        """Sets the verify_ssl of this NixUpstream.

        If enabled, SSL certificates are verified when requests are made to this upstream. It's recommended to leave this enabled for all public sources to help mitigate Man-In-The-Middle (MITM) attacks. Please note this only applies to HTTPS upstreams.

        :param verify_ssl: The verify_ssl of this NixUpstream.
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NixUpstream, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NixUpstream):
            return False
