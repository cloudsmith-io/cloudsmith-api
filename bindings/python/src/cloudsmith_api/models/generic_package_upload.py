...
class GenericPackageUpload(object):
    ...
    @property
    def is_hidden(self):
        """Gets the is_hidden of this GenericPackageUpload.


        :return: The is_hidden of this GenericPackageUpload.
        :rtype: bool
        """
    ...
    def is_hidden(self, is_hidden):
        """Sets the is_hidden of this GenericPackageUpload.


        :param is_hidden: The is_hidden of this GenericPackageUpload.
        :type: bool
        """
    ...
    def is_malware_detected(self):
        """Gets the is_malware_detected of this GenericPackageUpload.

        Whether the package has been detected as containing malware. Requires Ultra plan.

        :return: The is_malware_detected of this GenericPackageUpload.
        :rtype: bool
        """
    ...
    def is_malware_detected(self, is_malware_detected):
        """Sets the is_malware_detected of this GenericPackageUpload.

        Whether the package has been detected as containing malware. Requires Ultra plan.

        :param is_malware_detected: The is_malware_detected of this GenericPackageUpload.
        :type: bool
        """
    ...
    def osi_approved(self):
        """Gets the osi_approved of this GenericPackageUpload.

        Whether the package's SPDX license is OSI-approved.

        :return: The osi_approved of this GenericPackageUpload.
        :rtype: bool
        """
    ...
    def osi_approved(self, osi_approved):
        """Sets the osi_approved of this GenericPackageUpload.

        Whether the package's SPDX license is OSI-approved.

        :param osi_approved: The osi_approved of this GenericPackageUpload.
        :type: bool
        """
    ...
    def self_webapp_url(self):
        """Gets the self_webapp_url of this GenericPackageUpload.


        :return: The self_webapp_url of this GenericPackageUpload.
        :rtype: str
        """
    ...
    def self_webapp_url(self, self_webapp_url):
        """Sets the self_webapp_url of this GenericPackageUpload.


        :param self_webapp_url: The self_webapp_url of this GenericPackageUpload.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def store_path(self):
        """Gets the store_path of this GenericPackageUpload.

        Absolute store path for the package, including store hash and name.

        :return: The store_path of this GenericPackageUpload.
        :rtype: str
        """
    ...
    def store_path(self, store_path):
        """Sets the store_path of this GenericPackageUpload.

        Absolute store path for the package, including store hash and name.

        :param store_path: The store_path of this GenericPackageUpload.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def tags_static(self):
        """Gets the tags_static of this GenericPackageUpload.
        ...
        :return: The tags_static of this GenericPackageUpload.
    ...
    def tags_static(self, tags_static):
        """Sets the tags_static of this GenericPackageUpload.

        All static tags on the package, grouped by context. Static tags are derived from the package's properties at request time and carry a 'context' (rather than a tag type). Includes format-specific badges and the package's architecture, subtype, and extension.

        :param tags_static: The tags_static of this GenericPackageUpload.
    ...
    def vulnerability_counts(self):
        """Gets the vulnerability_counts of this GenericPackageUpload.


        :return: The vulnerability_counts of this GenericPackageUpload.
    ...
    def vulnerability_counts(self, vulnerability_counts):
        """Sets the vulnerability_counts of this GenericPackageUpload.


        :param vulnerability_counts: The vulnerability_counts of this GenericPackageUpload.
