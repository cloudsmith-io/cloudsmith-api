...
class ConanPackageUpload(object):
    ...
    @property
    def filepath(self):
        """Gets the filepath of this ConanPackageUpload.

        Full path to the file, including filename e.g. bin/utils/tool.tar.gz

        :return: The filepath of this ConanPackageUpload.
        :rtype: str
        """
    ...
    def filepath(self, filepath):
        """Sets the filepath of this ConanPackageUpload.

        Full path to the file, including filename e.g. bin/utils/tool.tar.gz

        :param filepath: The filepath of this ConanPackageUpload.
        :type: str
        """
        if (self._configuration.client_side_validation and
