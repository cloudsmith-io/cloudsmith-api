...
class OrgsTeamsCreate(object):
    ...
    def __init__(self, description=None, name=None, slug=None, visibility=None, _configuration=None):  # noqa: E501
        """OrgsTeamsCreate - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrgsTeamsCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrgsTeamsCreate):
            return False
