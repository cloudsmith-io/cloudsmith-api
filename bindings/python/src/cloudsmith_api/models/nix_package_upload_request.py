...
class NixPackageUploadRequest(object):
    ...
    def package_file(self):
        """Gets the package_file of this NixPackageUploadRequest.

        The primary file for the package.

        :return: The package_file of this NixPackageUploadRequest.
        :rtype: str
        """
    ...
    def package_file(self, package_file):
        """Sets the package_file of this NixPackageUploadRequest.

        The primary file for the package.

        :param package_file: The package_file of this NixPackageUploadRequest.
        :type: str
        """
    ...
    @property
    def republish(self):
        """Gets the republish of this NixPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :return: The republish of this NixPackageUploadRequest.
        :rtype: bool
        """
    ...
    def republish(self, republish):
        """Sets the republish of this NixPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :param republish: The republish of this NixPackageUploadRequest.
        :type: bool
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this NixPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :return: The tags of this NixPackageUploadRequest.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this NixPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :param tags: The tags of this NixPackageUploadRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def version(self):
        """Gets the version of this NixPackageUploadRequest.

        The raw version for this package.

        :return: The version of this NixPackageUploadRequest.
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this NixPackageUploadRequest.

        The raw version for this package.

        :param version: The version of this NixPackageUploadRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NixPackageUploadRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NixPackageUploadRequest):
            return False
