...
class OrganizationUsageUpdate(object):
    ...
    def __init__(self, allow_open_source_overage=None, bandwidth_overage_limit=None, storage_overage_limit=None, _configuration=None):  # noqa: E501
        """OrganizationUsageUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    def allow_open_source_overage(self):
        """Gets the allow_open_source_overage of this OrganizationUsageUpdate.


        :return: The allow_open_source_overage of this OrganizationUsageUpdate.
        :rtype: bool
        """
    ...
    def allow_open_source_overage(self, allow_open_source_overage):
        """Sets the allow_open_source_overage of this OrganizationUsageUpdate.


        :param allow_open_source_overage: The allow_open_source_overage of this OrganizationUsageUpdate.
        :type: bool
        """
    ...
    def bandwidth_overage_limit(self):
        """Gets the bandwidth_overage_limit of this OrganizationUsageUpdate.
    ...
    def bandwidth_overage_limit(self, bandwidth_overage_limit):
        """Sets the bandwidth_overage_limit of this OrganizationUsageUpdate.
    ...
    def storage_overage_limit(self):
        """Gets the storage_overage_limit of this OrganizationUsageUpdate.
    ...
    def storage_overage_limit(self, storage_overage_limit):
        """Sets the storage_overage_limit of this OrganizationUsageUpdate.


        :param storage_overage_limit: The storage_overage_limit of this OrganizationUsageUpdate.
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrganizationUsageUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrganizationUsageUpdate):
            return False
