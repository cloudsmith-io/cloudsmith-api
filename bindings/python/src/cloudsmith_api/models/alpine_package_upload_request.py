...
class AlpinePackageUploadRequest(object):
    ...
    def distribution(self):
        """Gets the distribution of this AlpinePackageUploadRequest.

        The distribution to store the package for.

        :return: The distribution of this AlpinePackageUploadRequest.
        :rtype: str
        """
    ...
    def distribution(self, distribution):
        """Sets the distribution of this AlpinePackageUploadRequest.

        The distribution to store the package for.

        :param distribution: The distribution of this AlpinePackageUploadRequest.
        :type: str
        """
    ...
    def package_file(self):
        """Gets the package_file of this AlpinePackageUploadRequest.

        The primary file for the package.

        :return: The package_file of this AlpinePackageUploadRequest.
        :rtype: str
        """
    ...
    def package_file(self, package_file):
        """Sets the package_file of this AlpinePackageUploadRequest.

        The primary file for the package.

        :param package_file: The package_file of this AlpinePackageUploadRequest.
        :type: str
        """
    ...
    @property
    def republish(self):
        """Gets the republish of this AlpinePackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :return: The republish of this AlpinePackageUploadRequest.
        :rtype: bool
        """
    ...
    def republish(self, republish):
        """Sets the republish of this AlpinePackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :param republish: The republish of this AlpinePackageUploadRequest.
        :type: bool
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this AlpinePackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :return: The tags of this AlpinePackageUploadRequest.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this AlpinePackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :param tags: The tags of this AlpinePackageUploadRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AlpinePackageUploadRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlpinePackageUploadRequest):
            return False
