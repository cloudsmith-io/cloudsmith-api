...
class OrganizationGroupSyncResponse(object):
    ...
    def __init__(self, idp_key=None, idp_value=None, role='Member', slug_perm=None, team=None, _configuration=None):  # noqa: E501
        """OrganizationGroupSyncResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def idp_key(self):
        """Gets the idp_key of this OrganizationGroupSyncResponse.


        :return: The idp_key of this OrganizationGroupSyncResponse.
        :rtype: str
        """
    ...
    def idp_key(self, idp_key):
        """Sets the idp_key of this OrganizationGroupSyncResponse.


        :param idp_key: The idp_key of this OrganizationGroupSyncResponse.
        :type: str
        """
    ...
    @property
    def idp_value(self):
        """Gets the idp_value of this OrganizationGroupSyncResponse.


        :return: The idp_value of this OrganizationGroupSyncResponse.
        :rtype: str
        """
    ...
    def idp_value(self, idp_value):
        """Sets the idp_value of this OrganizationGroupSyncResponse.


        :param idp_value: The idp_value of this OrganizationGroupSyncResponse.
        :type: str
        """
    ...
    @property
    def role(self):
        """Gets the role of this OrganizationGroupSyncResponse.
        ...
        :return: The role of this OrganizationGroupSyncResponse.
        :rtype: str
        """
        return self._role
    ...
    @role.setter
    def role(self, role):
        """Sets the role of this OrganizationGroupSyncResponse.

         User role within the team.   A `manager` is capable of adding/removing others to/from the team, and  can set the role of other users and other settings pertaining to the  team.   A 'member' is a normal user that inherits the settings and privileges  assigned to the team. 

        :param role: The role of this OrganizationGroupSyncResponse.
        :type: str
        """
    ...
    @property
    def slug_perm(self):
        """Gets the slug_perm of this OrganizationGroupSyncResponse.


        :return: The slug_perm of this OrganizationGroupSyncResponse.
        :rtype: str
        """
    ...
    def slug_perm(self, slug_perm):
        """Sets the slug_perm of this OrganizationGroupSyncResponse.


        :param slug_perm: The slug_perm of this OrganizationGroupSyncResponse.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def team(self):
        """Gets the team of this OrganizationGroupSyncResponse.


        :return: The team of this OrganizationGroupSyncResponse.
        :rtype: str
        """
        return self._team
    ...
    @team.setter
    def team(self, team):
        """Sets the team of this OrganizationGroupSyncResponse.


        :param team: The team of this OrganizationGroupSyncResponse.
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrganizationGroupSyncResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrganizationGroupSyncResponse):
            return False
