...
class LuarocksPackageUploadRequest(object):
    ...
    def __init__(self, is_malware_detected=None, package_file=None, republish=None, tags=None, vulnerability_counts=None, _configuration=None):  # noqa: E501
        """LuarocksPackageUploadRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def is_malware_detected(self):
        """Gets the is_malware_detected of this LuarocksPackageUploadRequest.

        Whether the package has been detected as containing malware. Requires Ultra plan.

        :return: The is_malware_detected of this LuarocksPackageUploadRequest.
        :rtype: bool
        """
    ...
    def is_malware_detected(self, is_malware_detected):
        """Sets the is_malware_detected of this LuarocksPackageUploadRequest.

        Whether the package has been detected as containing malware. Requires Ultra plan.

        :param is_malware_detected: The is_malware_detected of this LuarocksPackageUploadRequest.
        :type: bool
        """
    ...
    def package_file(self):
        """Gets the package_file of this LuarocksPackageUploadRequest.

        The primary file for the package.

        :return: The package_file of this LuarocksPackageUploadRequest.
        :rtype: str
        """
    ...
    def package_file(self, package_file):
        """Sets the package_file of this LuarocksPackageUploadRequest.

        The primary file for the package.

        :param package_file: The package_file of this LuarocksPackageUploadRequest.
        :type: str
        """
    ...
    @property
    def republish(self):
        """Gets the republish of this LuarocksPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :return: The republish of this LuarocksPackageUploadRequest.
        :rtype: bool
        """
    ...
    def republish(self, republish):
        """Sets the republish of this LuarocksPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :param republish: The republish of this LuarocksPackageUploadRequest.
        :type: bool
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this LuarocksPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :return: The tags of this LuarocksPackageUploadRequest.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this LuarocksPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :param tags: The tags of this LuarocksPackageUploadRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def vulnerability_counts(self):
        """Gets the vulnerability_counts of this LuarocksPackageUploadRequest.


        :return: The vulnerability_counts of this LuarocksPackageUploadRequest.
    ...
    def vulnerability_counts(self, vulnerability_counts):
        """Sets the vulnerability_counts of this LuarocksPackageUploadRequest.


        :param vulnerability_counts: The vulnerability_counts of this LuarocksPackageUploadRequest.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LuarocksPackageUploadRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LuarocksPackageUploadRequest):
            return False
