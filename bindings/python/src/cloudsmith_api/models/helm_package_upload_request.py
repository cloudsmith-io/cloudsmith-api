...
class HelmPackageUploadRequest(object):
    ...
    def __init__(self, is_malware_detected=None, package_file=None, provenance_file=None, republish=None, tags=None, vulnerability_counts=None, _configuration=None):  # noqa: E501
    ...
    def is_malware_detected(self):
        """Gets the is_malware_detected of this HelmPackageUploadRequest.

        Whether the package has been detected as containing malware. Requires Ultra plan.

        :return: The is_malware_detected of this HelmPackageUploadRequest.
        :rtype: bool
        """
    ...
    def is_malware_detected(self, is_malware_detected):
        """Sets the is_malware_detected of this HelmPackageUploadRequest.

        Whether the package has been detected as containing malware. Requires Ultra plan.

        :param is_malware_detected: The is_malware_detected of this HelmPackageUploadRequest.
        :type: bool
        """
    ...
    def package_file(self):
        """Gets the package_file of this HelmPackageUploadRequest.

        The primary file for the package.

        :return: The package_file of this HelmPackageUploadRequest.
        :rtype: str
        """
    ...
    def package_file(self, package_file):
        """Sets the package_file of this HelmPackageUploadRequest.

        The primary file for the package.

        :param package_file: The package_file of this HelmPackageUploadRequest.
        :type: str
        """
    ...
    def republish(self, republish):
        """Sets the republish of this HelmPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :param republish: The republish of this HelmPackageUploadRequest.
        :type: bool
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this HelmPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :return: The tags of this HelmPackageUploadRequest.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this HelmPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :param tags: The tags of this HelmPackageUploadRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def vulnerability_counts(self):
        """Gets the vulnerability_counts of this HelmPackageUploadRequest.


        :return: The vulnerability_counts of this HelmPackageUploadRequest.
    ...
    def vulnerability_counts(self, vulnerability_counts):
        """Sets the vulnerability_counts of this HelmPackageUploadRequest.


        :param vulnerability_counts: The vulnerability_counts of this HelmPackageUploadRequest.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HelmPackageUploadRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HelmPackageUploadRequest):
            return False
