...
class ComposerPackageUploadRequest(object):
    ...
    def package_file(self):
        """Gets the package_file of this ComposerPackageUploadRequest.

        The primary file for the package.

        :return: The package_file of this ComposerPackageUploadRequest.
        :rtype: str
        """
    ...
    def package_file(self, package_file):
        """Sets the package_file of this ComposerPackageUploadRequest.

        The primary file for the package.

        :param package_file: The package_file of this ComposerPackageUploadRequest.
        :type: str
        """
    ...
    @property
    def republish(self):
        """Gets the republish of this ComposerPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :return: The republish of this ComposerPackageUploadRequest.
        :rtype: bool
        """
    ...
    def republish(self, republish):
        """Sets the republish of this ComposerPackageUploadRequest.

        If true, the uploaded package will overwrite any others with the same attributes (e.g. same version); otherwise, it will be flagged as a duplicate.

        :param republish: The republish of this ComposerPackageUploadRequest.
        :type: bool
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this ComposerPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :return: The tags of this ComposerPackageUploadRequest.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ComposerPackageUploadRequest.

        A comma-separated values list of tags to add to the package.

        :param tags: The tags of this ComposerPackageUploadRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ComposerPackageUploadRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ComposerPackageUploadRequest):
            return False
