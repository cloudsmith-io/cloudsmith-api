...
class ProviderSettingsWrite(object):
    ...
    swagger_types = {
        'claims': 'object',
        'dynamic_mappings': 'list[DynamicMapping]',
        'enabled': 'bool',
        'mapping_claim': 'str',
        'name': 'str',
        'provider_url': 'str',
    ...
    def __init__(self, claims=None, dynamic_mappings=None, enabled=None, mapping_claim=None, name=None, provider_url=None, service_accounts=None, slug=None, slug_perm=None, _configuration=None):  # noqa: E501
        """ProviderSettingsWrite - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._claims = None
        self._dynamic_mappings = None
        self._enabled = None
        ...
        if dynamic_mappings is not None:
            self.dynamic_mappings = dynamic_mappings
    ...
    @property
    def claims(self):
        """Gets the claims of this ProviderSettingsWrite.
        ...
        :return: The claims of this ProviderSettingsWrite.
        :rtype: object
        """
        return self._claims
    ...
    def claims(self, claims):
        """Sets the claims of this ProviderSettingsWrite.

        The set of claims that any received tokens from the provider must contain to authenticate as the configured service account.

        :param claims: The claims of this ProviderSettingsWrite.
        :type: object
        """
    ...
    def dynamic_mappings(self):
        """Gets the dynamic_mappings of this ProviderSettingsWrite.
        ...
        :return: The dynamic_mappings of this ProviderSettingsWrite.
        :rtype: list[DynamicMapping]
        """
        return self._dynamic_mappings

    @dynamic_mappings.setter
    def dynamic_mappings(self, dynamic_mappings):
        """Sets the dynamic_mappings of this ProviderSettingsWrite.

        The dynamic mappings of `mapping_claim` values to service accounts. Cannot be provided if `service_accounts` is also set.  Note: This field and the dynamic mappings feature are still in early access. Breaking changes are possible as we receive feedback on this feature.

        :param dynamic_mappings: The dynamic_mappings of this ProviderSettingsWrite.
        :type: list[DynamicMapping]
        """
    ...
    @property
    def enabled(self):
        """Gets the enabled of this ProviderSettingsWrite.

        Whether the provider settings should be used for incoming OIDC requests.

        :return: The enabled of this ProviderSettingsWrite.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this ProviderSettingsWrite.

        Whether the provider settings should be used for incoming OIDC requests.

        :param enabled: The enabled of this ProviderSettingsWrite.
        :type: bool
        """
    ...
    def mapping_claim(self):
        """Gets the mapping_claim of this ProviderSettingsWrite.
        ...
        :return: The mapping_claim of this ProviderSettingsWrite.
        :rtype: str
        """
    ...
    def mapping_claim(self, mapping_claim):
        """Sets the mapping_claim of this ProviderSettingsWrite.

        The OIDC claim to use for mapping to service accounts in dynamic_mappings. Cannot be provided if `service_accounts` is also set.  Note: This field and the dynamic mappings feature are still in early access. Breaking changes are possible as we receive feedback on this feature.

        :param mapping_claim: The mapping_claim of this ProviderSettingsWrite.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProviderSettingsWrite.

        The name of the provider settings are being configured for

        :return: The name of this ProviderSettingsWrite.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProviderSettingsWrite.

        The name of the provider settings are being configured for

        :param name: The name of this ProviderSettingsWrite.
        :type: str
        """
    ...
    def provider_url(self):
        """Gets the provider_url of this ProviderSettingsWrite.
        ...
        :return: The provider_url of this ProviderSettingsWrite.
        :rtype: str
        """
    ...
    def provider_url(self, provider_url):
        """Sets the provider_url of this ProviderSettingsWrite.

        The URL from the provider that serves as the base for the OpenID configuration. For example, if the OpenID configuration is available at https://token.actions.githubusercontent.com/.well-known/openid-configuration, the provider URL would be https://token.actions.githubusercontent.com/

        :param provider_url: The provider_url of this ProviderSettingsWrite.
        :type: str
        """
    ...
    def service_accounts(self):
        """Gets the service_accounts of this ProviderSettingsWrite.
        ...
        :return: The service_accounts of this ProviderSettingsWrite.
        :rtype: list[str]
        """
    ...
    def service_accounts(self, service_accounts):
        """Sets the service_accounts of this ProviderSettingsWrite.

        The service accounts associated with these provider settings. Cannot be provided if `mapping_claim` or `dynamic_mappings` are specified.

        :param service_accounts: The service_accounts of this ProviderSettingsWrite.
        :type: list[str]
        """
    ...
    @property
    def slug(self):
        """Gets the slug of this ProviderSettingsWrite.

        The slug of the provider settings

        :return: The slug of this ProviderSettingsWrite.
        :rtype: str
        """
        return self._slug
    ...
    @slug.setter
    def slug(self, slug):
        """Sets the slug of this ProviderSettingsWrite.

        The slug of the provider settings

        :param slug: The slug of this ProviderSettingsWrite.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def slug_perm(self):
        """Gets the slug_perm of this ProviderSettingsWrite.

        The unique, immutable identifier of the provider settings.

        :return: The slug_perm of this ProviderSettingsWrite.
        :rtype: str
        """
    ...
    def slug_perm(self, slug_perm):
        """Sets the slug_perm of this ProviderSettingsWrite.

        The unique, immutable identifier of the provider settings.

        :param slug_perm: The slug_perm of this ProviderSettingsWrite.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProviderSettingsWrite, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProviderSettingsWrite):
            return False
