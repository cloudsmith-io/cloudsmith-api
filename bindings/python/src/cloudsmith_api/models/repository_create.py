...
class RepositoryCreate(object):
    ...
    def is_public_hidden(self):
        """Gets the is_public_hidden of this RepositoryCreate.

        If checked, this repository will be hidden from the list of public broadcasts for the workspace.

        :return: The is_public_hidden of this RepositoryCreate.
        :rtype: bool
        """
    ...
    def is_public_hidden(self, is_public_hidden):
        """Sets the is_public_hidden of this RepositoryCreate.

        If checked, this repository will be hidden from the list of public broadcasts for the workspace.

        :param is_public_hidden: The is_public_hidden of this RepositoryCreate.
        :type: bool
        """
    ...
    def self_webapp_url(self):
        """Gets the self_webapp_url of this RepositoryCreate.

        Webapp URL for this repository.

        :return: The self_webapp_url of this RepositoryCreate.
        :rtype: str
        """
    ...
    def self_webapp_url(self, self_webapp_url):
        """Sets the self_webapp_url of this RepositoryCreate.

        Webapp URL for this repository.

        :param self_webapp_url: The self_webapp_url of this RepositoryCreate.
        :type: str
        """
        if (self._configuration.client_side_validation and
