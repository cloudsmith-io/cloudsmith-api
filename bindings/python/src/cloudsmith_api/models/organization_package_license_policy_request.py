...
class OrganizationPackageLicensePolicyRequest(object):
    ...
    def allow_unknown_licenses(self):
        ...
        :return: The allow_unknown_licenses of this OrganizationPackageLicensePolicyRequest.
        :rtype: bool
        """
    ...
    def allow_unknown_licenses(self, allow_unknown_licenses):
        """Sets the allow_unknown_licenses of this OrganizationPackageLicensePolicyRequest.


        :param allow_unknown_licenses: The allow_unknown_licenses of this OrganizationPackageLicensePolicyRequest.
        :type: bool
        """
    ...
    def description(self):
        """Gets the description of this OrganizationPackageLicensePolicyRequest.


        :return: The description of this OrganizationPackageLicensePolicyRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this OrganizationPackageLicensePolicyRequest.


        :param description: The description of this OrganizationPackageLicensePolicyRequest.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this OrganizationPackageLicensePolicyRequest.


        :return: The name of this OrganizationPackageLicensePolicyRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OrganizationPackageLicensePolicyRequest.


        :param name: The name of this OrganizationPackageLicensePolicyRequest.
        :type: str
        """
    ...
    def on_violation_quarantine(self):
        """Gets the on_violation_quarantine of this OrganizationPackageLicensePolicyRequest.


        :return: The on_violation_quarantine of this OrganizationPackageLicensePolicyRequest.
        :rtype: bool
        """
    ...
    def on_violation_quarantine(self, on_violation_quarantine):
        """Sets the on_violation_quarantine of this OrganizationPackageLicensePolicyRequest.
    ...
    def spdx_identifiers(self, spdx_identifiers):
        """Sets the spdx_identifiers of this OrganizationPackageLicensePolicyRequest.


        :param spdx_identifiers: The spdx_identifiers of this OrganizationPackageLicensePolicyRequest.
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrganizationPackageLicensePolicyRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrganizationPackageLicensePolicyRequest):
            return False
