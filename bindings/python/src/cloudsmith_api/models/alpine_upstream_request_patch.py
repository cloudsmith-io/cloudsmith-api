...
class AlpineUpstreamRequestPatch(object):
    ...
    def __init__(self, auth_mode='None', auth_secret=None, auth_username=None, extra_header_1=None, extra_header_2=None, extra_value_1=None, extra_value_2=None, is_active=None, mode='Proxy Only', name=None, priority=None, rsa_key_url=None, rsa_verification='Allow All', upstream_url=None, verify_ssl=None, _configuration=None):  # noqa: E501
        """AlpineUpstreamRequestPatch - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def auth_mode(self):
        """Gets the auth_mode of this AlpineUpstreamRequestPatch.

        The authentication mode to use when accessing this upstream. 

        :return: The auth_mode of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def auth_mode(self, auth_mode):
        """Sets the auth_mode of this AlpineUpstreamRequestPatch.

        The authentication mode to use when accessing this upstream. 

        :param auth_mode: The auth_mode of this AlpineUpstreamRequestPatch.
        :type: str
        """
    ...
    def auth_secret(self):
        """Gets the auth_secret of this AlpineUpstreamRequestPatch.

        Secret to provide with requests to upstream.

        :return: The auth_secret of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def auth_secret(self, auth_secret):
        """Sets the auth_secret of this AlpineUpstreamRequestPatch.

        Secret to provide with requests to upstream.

        :param auth_secret: The auth_secret of this AlpineUpstreamRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def auth_username(self):
        """Gets the auth_username of this AlpineUpstreamRequestPatch.

        Username to provide with requests to upstream.

        :return: The auth_username of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def auth_username(self, auth_username):
        """Sets the auth_username of this AlpineUpstreamRequestPatch.

        Username to provide with requests to upstream.

        :param auth_username: The auth_username of this AlpineUpstreamRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_header_1(self):
        """Gets the extra_header_1 of this AlpineUpstreamRequestPatch.

        The key for extra header #1 to send to upstream.

        :return: The extra_header_1 of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def extra_header_1(self, extra_header_1):
        """Sets the extra_header_1 of this AlpineUpstreamRequestPatch.

        The key for extra header #1 to send to upstream.

        :param extra_header_1: The extra_header_1 of this AlpineUpstreamRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_header_2(self):
        """Gets the extra_header_2 of this AlpineUpstreamRequestPatch.

        The key for extra header #2 to send to upstream.

        :return: The extra_header_2 of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def extra_header_2(self, extra_header_2):
        """Sets the extra_header_2 of this AlpineUpstreamRequestPatch.

        The key for extra header #2 to send to upstream.

        :param extra_header_2: The extra_header_2 of this AlpineUpstreamRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_1(self):
        """Gets the extra_value_1 of this AlpineUpstreamRequestPatch.

        The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :return: The extra_value_1 of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def extra_value_1(self, extra_value_1):
        """Sets the extra_value_1 of this AlpineUpstreamRequestPatch.

        The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_1: The extra_value_1 of this AlpineUpstreamRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_2(self):
        """Gets the extra_value_2 of this AlpineUpstreamRequestPatch.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :return: The extra_value_2 of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def extra_value_2(self, extra_value_2):
        """Sets the extra_value_2 of this AlpineUpstreamRequestPatch.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_2: The extra_value_2 of this AlpineUpstreamRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def is_active(self):
        """Gets the is_active of this AlpineUpstreamRequestPatch.

        Whether or not this upstream is active and ready for requests.

        :return: The is_active of this AlpineUpstreamRequestPatch.
        :rtype: bool
        """
    ...
    def is_active(self, is_active):
        """Sets the is_active of this AlpineUpstreamRequestPatch.

        Whether or not this upstream is active and ready for requests.

        :param is_active: The is_active of this AlpineUpstreamRequestPatch.
        :type: bool
        """
    ...
    @property
    def mode(self):
        """Gets the mode of this AlpineUpstreamRequestPatch.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :return: The mode of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this AlpineUpstreamRequestPatch.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :param mode: The mode of this AlpineUpstreamRequestPatch.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this AlpineUpstreamRequestPatch.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :return: The name of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AlpineUpstreamRequestPatch.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :param name: The name of this AlpineUpstreamRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def priority(self):
        """Gets the priority of this AlpineUpstreamRequestPatch.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :return: The priority of this AlpineUpstreamRequestPatch.
        :rtype: int
        """
    ...
    def priority(self, priority):
        """Sets the priority of this AlpineUpstreamRequestPatch.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :param priority: The priority of this AlpineUpstreamRequestPatch.
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def rsa_key_url(self):
        """Gets the rsa_key_url of this AlpineUpstreamRequestPatch.
        ...
        :return: The rsa_key_url of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def rsa_key_url(self, rsa_key_url):
        """Sets the rsa_key_url of this AlpineUpstreamRequestPatch.

        When provided, Cloudsmith will fetch and validate the RSA public key at this URL and use it to verify package signatures from this upstream.

        :param rsa_key_url: The rsa_key_url of this AlpineUpstreamRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def rsa_verification(self):
        """Gets the rsa_verification of this AlpineUpstreamRequestPatch.

        The RSA signature verification mode for this upstream.

        :return: The rsa_verification of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def rsa_verification(self, rsa_verification):
        """Sets the rsa_verification of this AlpineUpstreamRequestPatch.

        The RSA signature verification mode for this upstream.

        :param rsa_verification: The rsa_verification of this AlpineUpstreamRequestPatch.
        :type: str
        """
    ...
    def upstream_url(self):
        """Gets the upstream_url of this AlpineUpstreamRequestPatch.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :return: The upstream_url of this AlpineUpstreamRequestPatch.
        :rtype: str
        """
    ...
    def upstream_url(self, upstream_url):
        """Sets the upstream_url of this AlpineUpstreamRequestPatch.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :param upstream_url: The upstream_url of this AlpineUpstreamRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def verify_ssl(self):
        """Gets the verify_ssl of this AlpineUpstreamRequestPatch.
        ...
        :return: The verify_ssl of this AlpineUpstreamRequestPatch.
        :rtype: bool
        """
    ...
    def verify_ssl(self, verify_ssl):
        """Sets the verify_ssl of this AlpineUpstreamRequestPatch.

        If enabled, SSL certificates are verified when requests are made to this upstream. It's recommended to leave this enabled for all public sources to help mitigate Man-In-The-Middle (MITM) attacks. Please note this only applies to HTTPS upstreams.

        :param verify_ssl: The verify_ssl of this AlpineUpstreamRequestPatch.
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AlpineUpstreamRequestPatch, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlpineUpstreamRequestPatch):
            return False
