...
class PackageDependenciesDependencies(object):
    ...
    def __init__(self, dep_type=None, name=None, operator=None, version=None, _configuration=None):  # noqa: E501
        """PackageDependenciesDependencies - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PackageDependenciesDependencies, dict):
