...
class RepositoryPrivilegeInput(object):
    ...
    def __init__(self, privileges=None, _configuration=None):  # noqa: E501
        """RepositoryPrivilegeInput - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def privileges(self):
        """Gets the privileges of this RepositoryPrivilegeInput.
    ...
    def privileges(self, privileges):
        """Sets the privileges of this RepositoryPrivilegeInput.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RepositoryPrivilegeInput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RepositoryPrivilegeInput):
            return False
