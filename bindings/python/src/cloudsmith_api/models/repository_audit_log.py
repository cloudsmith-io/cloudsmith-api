...
class RepositoryAuditLog(object):
    ...
    def __init__(self, actor=None, actor_ip_address=None, actor_kind=None, actor_location=None, actor_slug_perm=None, actor_url=None, context=None, event=None, event_at=None, object=None, object_kind=None, object_slug_perm=None, uuid=None, _configuration=None):  # noqa: E501
        """RepositoryAuditLog - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RepositoryAuditLog, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RepositoryAuditLog):
            return False
