...
class RpmUpstreamRequest(object):
    ...
    def __init__(self, auth_mode='None', auth_secret=None, auth_username=None, distro_version=None, extra_header_1=None, extra_header_2=None, extra_value_1=None, extra_value_2=None, gpg_key_inline=None, gpg_key_url=None, gpg_verification='Allow All', include_sources=None, is_active=None, mode='Proxy Only', name=None, priority=None, upstream_url=None, verify_ssl=None, _configuration=None):  # noqa: E501
        """RpmUpstreamRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def auth_mode(self):
        """Gets the auth_mode of this RpmUpstreamRequest.

        The authentication mode to use when accessing this upstream. 

        :return: The auth_mode of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def auth_mode(self, auth_mode):
        """Sets the auth_mode of this RpmUpstreamRequest.

        The authentication mode to use when accessing this upstream. 

        :param auth_mode: The auth_mode of this RpmUpstreamRequest.
        :type: str
        """
    ...
    def auth_secret(self):
        """Gets the auth_secret of this RpmUpstreamRequest.

        Secret to provide with requests to upstream.

        :return: The auth_secret of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def auth_secret(self, auth_secret):
        """Sets the auth_secret of this RpmUpstreamRequest.

        Secret to provide with requests to upstream.

        :param auth_secret: The auth_secret of this RpmUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def auth_username(self):
        """Gets the auth_username of this RpmUpstreamRequest.

        Username to provide with requests to upstream.

        :return: The auth_username of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def auth_username(self, auth_username):
        """Sets the auth_username of this RpmUpstreamRequest.

        Username to provide with requests to upstream.

        :param auth_username: The auth_username of this RpmUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def distro_version(self):
        """Gets the distro_version of this RpmUpstreamRequest.

        The distribution version that packages found on this upstream will be associated with.

        :return: The distro_version of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def distro_version(self, distro_version):
        """Sets the distro_version of this RpmUpstreamRequest.

        The distribution version that packages found on this upstream will be associated with.

        :param distro_version: The distro_version of this RpmUpstreamRequest.
        :type: str
        """
    ...
    def extra_header_1(self):
        """Gets the extra_header_1 of this RpmUpstreamRequest.

        The key for extra header #1 to send to upstream.

        :return: The extra_header_1 of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def extra_header_1(self, extra_header_1):
        """Sets the extra_header_1 of this RpmUpstreamRequest.

        The key for extra header #1 to send to upstream.

        :param extra_header_1: The extra_header_1 of this RpmUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_header_2(self):
        """Gets the extra_header_2 of this RpmUpstreamRequest.

        The key for extra header #2 to send to upstream.

        :return: The extra_header_2 of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def extra_header_2(self, extra_header_2):
        """Sets the extra_header_2 of this RpmUpstreamRequest.

        The key for extra header #2 to send to upstream.

        :param extra_header_2: The extra_header_2 of this RpmUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_1(self):
        """Gets the extra_value_1 of this RpmUpstreamRequest.

        The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :return: The extra_value_1 of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def extra_value_1(self, extra_value_1):
        """Sets the extra_value_1 of this RpmUpstreamRequest.

        The value for extra header #1 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_1: The extra_value_1 of this RpmUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def extra_value_2(self):
        """Gets the extra_value_2 of this RpmUpstreamRequest.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :return: The extra_value_2 of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def extra_value_2(self, extra_value_2):
        """Sets the extra_value_2 of this RpmUpstreamRequest.

        The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.

        :param extra_value_2: The extra_value_2 of this RpmUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def gpg_key_inline(self):
        """Gets the gpg_key_inline of this RpmUpstreamRequest.
        ...
        :return: The gpg_key_inline of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def gpg_key_inline(self, gpg_key_inline):
        """Sets the gpg_key_inline of this RpmUpstreamRequest.

        A public GPG key to associate with packages found on this upstream. When using the Cloudsmith setup script, this GPG key will be automatically imported on your deployment machines to allow upstream packages to validate and install.

        :param gpg_key_inline: The gpg_key_inline of this RpmUpstreamRequest.
        :type: str
        """
    ...
    def gpg_key_url(self):
        """Gets the gpg_key_url of this RpmUpstreamRequest.
        ...
        :return: The gpg_key_url of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def gpg_key_url(self, gpg_key_url):
        """Sets the gpg_key_url of this RpmUpstreamRequest.

        When provided, Cloudsmith will fetch, validate, and associate a public GPG key found at the provided URL. When using the Cloudsmith setup script, this GPG key will be automatically imported on your deployment machines to allow upstream packages to validate and install.

        :param gpg_key_url: The gpg_key_url of this RpmUpstreamRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def gpg_verification(self):
        """Gets the gpg_verification of this RpmUpstreamRequest.

        The GPG signature verification mode for this upstream.

        :return: The gpg_verification of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def gpg_verification(self, gpg_verification):
        """Sets the gpg_verification of this RpmUpstreamRequest.

        The GPG signature verification mode for this upstream.

        :param gpg_verification: The gpg_verification of this RpmUpstreamRequest.
        :type: str
        """
    ...
    def include_sources(self):
        """Gets the include_sources of this RpmUpstreamRequest.

        When checked, source packages will be available from this upstream.

        :return: The include_sources of this RpmUpstreamRequest.
        :rtype: bool
        """
    ...
    def include_sources(self, include_sources):
        """Sets the include_sources of this RpmUpstreamRequest.

        When checked, source packages will be available from this upstream.

        :param include_sources: The include_sources of this RpmUpstreamRequest.
        :type: bool
        """
    ...
    @property
    def is_active(self):
        """Gets the is_active of this RpmUpstreamRequest.

        Whether or not this upstream is active and ready for requests.

        :return: The is_active of this RpmUpstreamRequest.
        :rtype: bool
        """
    ...
    def is_active(self, is_active):
        """Sets the is_active of this RpmUpstreamRequest.

        Whether or not this upstream is active and ready for requests.

        :param is_active: The is_active of this RpmUpstreamRequest.
        :type: bool
        """
    ...
    @property
    def mode(self):
        """Gets the mode of this RpmUpstreamRequest.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :return: The mode of this RpmUpstreamRequest.
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this RpmUpstreamRequest.

        The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.

        :param mode: The mode of this RpmUpstreamRequest.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this RpmUpstreamRequest.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :return: The name of this RpmUpstreamRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RpmUpstreamRequest.

        A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.

        :param name: The name of this RpmUpstreamRequest.
        :type: str
        """
    ...
    @property
    def priority(self):
        """Gets the priority of this RpmUpstreamRequest.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :return: The priority of this RpmUpstreamRequest.
        :rtype: int
        """
    ...
    def priority(self, priority):
        """Sets the priority of this RpmUpstreamRequest.

        Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.

        :param priority: The priority of this RpmUpstreamRequest.
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def upstream_url(self):
        """Gets the upstream_url of this RpmUpstreamRequest.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :return: The upstream_url of this RpmUpstreamRequest.
        :rtype: str
        """
    ...
    def upstream_url(self, upstream_url):
        """Sets the upstream_url of this RpmUpstreamRequest.

        The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository. 

        :param upstream_url: The upstream_url of this RpmUpstreamRequest.
        :type: str
        """
    ...
    @property
    def verify_ssl(self):
        """Gets the verify_ssl of this RpmUpstreamRequest.
        ...
        :return: The verify_ssl of this RpmUpstreamRequest.
        :rtype: bool
        """
    ...
    def verify_ssl(self, verify_ssl):
        """Sets the verify_ssl of this RpmUpstreamRequest.

        If enabled, SSL certificates are verified when requests are made to this upstream. It's recommended to leave this enabled for all public sources to help mitigate Man-In-The-Middle (MITM) attacks. Please note this only applies to HTTPS upstreams.

        :param verify_ssl: The verify_ssl of this RpmUpstreamRequest.
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RpmUpstreamRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RpmUpstreamRequest):
            return False
