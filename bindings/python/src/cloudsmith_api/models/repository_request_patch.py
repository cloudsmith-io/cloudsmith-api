...
class RepositoryRequestPatch(object):
    ...
    def broadcast_state(self):
        """Gets the broadcast_state of this RepositoryRequestPatch.

        Broadcasting status of a repository.

        :return: The broadcast_state of this RepositoryRequestPatch.
        :rtype: str
        """
    ...
    def broadcast_state(self, broadcast_state):
        """Sets the broadcast_state of this RepositoryRequestPatch.

        Broadcasting status of a repository.

        :param broadcast_state: The broadcast_state of this RepositoryRequestPatch.
        :type: str
        """
    ...
    def generic_package_index_enabled(self):
        """Gets the generic_package_index_enabled of this RepositoryRequestPatch.

        If checked, HTML indexes will be generated that list all available generic packages in the repository.

        :return: The generic_package_index_enabled of this RepositoryRequestPatch.
        :rtype: bool
        """
    ...
    def generic_package_index_enabled(self, generic_package_index_enabled):
        """Sets the generic_package_index_enabled of this RepositoryRequestPatch.

        If checked, HTML indexes will be generated that list all available generic packages in the repository.

        :param generic_package_index_enabled: The generic_package_index_enabled of this RepositoryRequestPatch.
        :type: bool
        """
    ...
    def npm_upstream_tags_take_precedence(self):
        """Gets the npm_upstream_tags_take_precedence of this RepositoryRequestPatch.
        ...
        :return: The npm_upstream_tags_take_precedence of this RepositoryRequestPatch.
        :rtype: bool
        """
    ...
    def npm_upstream_tags_take_precedence(self, npm_upstream_tags_take_precedence):
        """Sets the npm_upstream_tags_take_precedence of this RepositoryRequestPatch.

        If checked, npm distribution tags from configured upstreams will take precedence over matching local tags. When both upstream and local repositories have the same tag name (e.g., 'latest'), the upstream tag will be used instead of the local one, even if the local repository has a semantically higher version.

        :param npm_upstream_tags_take_precedence: The npm_upstream_tags_take_precedence of this RepositoryRequestPatch.
        :type: bool
        """
