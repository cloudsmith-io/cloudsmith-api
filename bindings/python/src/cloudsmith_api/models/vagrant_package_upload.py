...
class VagrantPackageUpload(object):
    ...
    def __init__(self, status=None, stage_updated_at=None, checksum_sha512=None, is_sync_failed=None, sync_finished_at=None, checksum_sha256=None, repository_url=None, is_sync_in_progress=None, size=None, status_str=None, is_sync_awaiting=None, num_files=None, status_url=None, status_updated_at=None, namespace=None, distro_version=None, filename=None, sync_progress=None, epoch=None, version=None, is_sync_in_flight=None, namespace_url=None, slug_perm=None, uploader_url=None, checksum_sha1=None, distro=None, files=None, cdn_url=None, description=None, repository=None, format=None, is_sync_completed=None, downloads=None, provider=None, version_orig=None, architectures=None, uploader=None, self_html_url=None, stage=None, self_url=None, slug=None, uploaded_at=None, name=None, license=None, stage_str=None, package_type=None, summary=None, subtype=None, checksum_md5=None, extension=None, release=None, type_display=None, format_url=None):
        """
