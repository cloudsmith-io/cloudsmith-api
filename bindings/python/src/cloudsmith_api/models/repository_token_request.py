...
class RepositoryTokenRequest(object):
    ...
    def __init__(self, access_private_broadcasts=None, eula_required=None, is_active=None, limit_bandwidth=None, limit_bandwidth_unit='Byte', limit_date_range_from=None, limit_date_range_to=None, limit_num_clients=None, limit_num_downloads=None, limit_package_query=None, limit_path_query=None, metadata=None, name=None, scheduled_reset_at=None, scheduled_reset_period='Never Reset', token=None, _configuration=None):  # noqa: E501
        """RepositoryTokenRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def access_private_broadcasts(self):
        """Gets the access_private_broadcasts of this RepositoryTokenRequest.

        If enabled, this token can be used for private broadcasts

        :return: The access_private_broadcasts of this RepositoryTokenRequest.
        :rtype: bool
        """
    ...
    def access_private_broadcasts(self, access_private_broadcasts):
        """Sets the access_private_broadcasts of this RepositoryTokenRequest.

        If enabled, this token can be used for private broadcasts

        :param access_private_broadcasts: The access_private_broadcasts of this RepositoryTokenRequest.
        :type: bool
        """
    ...
    def eula_required(self):
        """Gets the eula_required of this RepositoryTokenRequest.

        If checked, a EULA acceptance is required for this token.

        :return: The eula_required of this RepositoryTokenRequest.
        :rtype: bool
        """
    ...
    def eula_required(self, eula_required):
        """Sets the eula_required of this RepositoryTokenRequest.

        If checked, a EULA acceptance is required for this token.

        :param eula_required: The eula_required of this RepositoryTokenRequest.
        :type: bool
        """
    ...
    @property
    def is_active(self):
        """Gets the is_active of this RepositoryTokenRequest.

        If enabled, the token will allow downloads based on configured restrictions (if any).

        :return: The is_active of this RepositoryTokenRequest.
        :rtype: bool
        """
    ...
    def is_active(self, is_active):
        """Sets the is_active of this RepositoryTokenRequest.

        If enabled, the token will allow downloads based on configured restrictions (if any).

        :param is_active: The is_active of this RepositoryTokenRequest.
        :type: bool
        """
    ...
    def limit_bandwidth(self):
        """Gets the limit_bandwidth of this RepositoryTokenRequest.

        The maximum download bandwidth allowed for the token. Values are expressed as the selected unit of bandwidth. Please note that since downloads are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point. 

        :return: The limit_bandwidth of this RepositoryTokenRequest.
        :rtype: int
        """
    ...
    def limit_bandwidth(self, limit_bandwidth):
        """Sets the limit_bandwidth of this RepositoryTokenRequest.

        The maximum download bandwidth allowed for the token. Values are expressed as the selected unit of bandwidth. Please note that since downloads are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point. 

        :param limit_bandwidth: The limit_bandwidth of this RepositoryTokenRequest.
        :type: int
        """
    ...
    def limit_bandwidth_unit(self):
        """Gets the limit_bandwidth_unit of this RepositoryTokenRequest.


        :return: The limit_bandwidth_unit of this RepositoryTokenRequest.
        :rtype: str
        """
    ...
    def limit_bandwidth_unit(self, limit_bandwidth_unit):
        """Sets the limit_bandwidth_unit of this RepositoryTokenRequest.


        :param limit_bandwidth_unit: The limit_bandwidth_unit of this RepositoryTokenRequest.
        :type: str
        """
    ...
    def limit_date_range_from(self):
        """Gets the limit_date_range_from of this RepositoryTokenRequest.

        The starting date/time the token is allowed to be used from.

        :return: The limit_date_range_from of this RepositoryTokenRequest.
        :rtype: datetime
        """
    ...
    def limit_date_range_from(self, limit_date_range_from):
        """Sets the limit_date_range_from of this RepositoryTokenRequest.

        The starting date/time the token is allowed to be used from.

        :param limit_date_range_from: The limit_date_range_from of this RepositoryTokenRequest.
        :type: datetime
        """
    ...
    def limit_date_range_to(self):
        """Gets the limit_date_range_to of this RepositoryTokenRequest.

        The ending date/time the token is allowed to be used until.

        :return: The limit_date_range_to of this RepositoryTokenRequest.
        :rtype: datetime
        """
    ...
    def limit_date_range_to(self, limit_date_range_to):
        """Sets the limit_date_range_to of this RepositoryTokenRequest.

        The ending date/time the token is allowed to be used until.

        :param limit_date_range_to: The limit_date_range_to of this RepositoryTokenRequest.
        :type: datetime
        """
    ...
    def limit_num_clients(self):
        """Gets the limit_num_clients of this RepositoryTokenRequest.
        ...
        :return: The limit_num_clients of this RepositoryTokenRequest.
        :rtype: int
        """
    ...
    def limit_num_clients(self, limit_num_clients):
        """Sets the limit_num_clients of this RepositoryTokenRequest.

        The maximum number of unique clients allowed for the token. Please note that since clients are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point.

        :param limit_num_clients: The limit_num_clients of this RepositoryTokenRequest.
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def limit_num_downloads(self):
        """Gets the limit_num_downloads of this RepositoryTokenRequest.
        ...
        :return: The limit_num_downloads of this RepositoryTokenRequest.
        :rtype: int
        """
    ...
    def limit_num_downloads(self, limit_num_downloads):
        """Sets the limit_num_downloads of this RepositoryTokenRequest.

        The maximum number of downloads allowed for the token. Please note that since downloads are calculated asynchronously (after the download happens), the limit may not be imposed immediately but at a later point.

        :param limit_num_downloads: The limit_num_downloads of this RepositoryTokenRequest.
        :type: int
        """
        if (self._configuration.client_side_validation and
    ...
    def limit_package_query(self):
        """Gets the limit_package_query of this RepositoryTokenRequest.
        ...
        :return: The limit_package_query of this RepositoryTokenRequest.
        :rtype: str
        """
    ...
    def limit_package_query(self, limit_package_query):
        """Sets the limit_package_query of this RepositoryTokenRequest.

        The package-based search query to apply to restrict downloads to. This uses the same syntax as the standard search used for repositories, and also supports boolean logic operators such as OR/AND/NOT and parentheses for grouping. This will still allow access to non-package files, such as metadata.

        :param limit_package_query: The limit_package_query of this RepositoryTokenRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def metadata(self):
        """Gets the metadata of this RepositoryTokenRequest.


        :return: The metadata of this RepositoryTokenRequest.
        :rtype: object
        """
    ...
    def metadata(self, metadata):
        """Sets the metadata of this RepositoryTokenRequest.


        :param metadata: The metadata of this RepositoryTokenRequest.
        :type: object
        """
    ...
    @property
    def name(self):
        """Gets the name of this RepositoryTokenRequest.


        :return: The name of this RepositoryTokenRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RepositoryTokenRequest.


        :param name: The name of this RepositoryTokenRequest.
        :type: str
        """
    ...
    def scheduled_reset_at(self):
        """Gets the scheduled_reset_at of this RepositoryTokenRequest.

        The time at which the scheduled reset period has elapsed and the token limits were automatically reset to zero.

        :return: The scheduled_reset_at of this RepositoryTokenRequest.
        :rtype: datetime
        """
    ...
    def scheduled_reset_at(self, scheduled_reset_at):
        """Sets the scheduled_reset_at of this RepositoryTokenRequest.

        The time at which the scheduled reset period has elapsed and the token limits were automatically reset to zero.

        :param scheduled_reset_at: The scheduled_reset_at of this RepositoryTokenRequest.
        :type: datetime
        """
    ...
    def scheduled_reset_period(self):
        """Gets the scheduled_reset_period of this RepositoryTokenRequest.


        :return: The scheduled_reset_period of this RepositoryTokenRequest.
        :rtype: str
        """
    ...
    def scheduled_reset_period(self, scheduled_reset_period):
        """Sets the scheduled_reset_period of this RepositoryTokenRequest.


        :param scheduled_reset_period: The scheduled_reset_period of this RepositoryTokenRequest.
        :type: str
        """
    ...
    @property
    def token(self):
        """Gets the token of this RepositoryTokenRequest.


        :return: The token of this RepositoryTokenRequest.
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this RepositoryTokenRequest.


        :param token: The token of this RepositoryTokenRequest.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RepositoryTokenRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RepositoryTokenRequest):
            return False
