...
class ProviderSettingsWriteRequest(object):
    ...
    def __init__(self, claims=None, dynamic_mappings=None, enabled=None, mapping_claim=None, name=None, provider_url=None, service_accounts=None, _configuration=None):  # noqa: E501
        """ProviderSettingsWriteRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def claims(self):
        """Gets the claims of this ProviderSettingsWriteRequest.
        ...
        :return: The claims of this ProviderSettingsWriteRequest.
        :rtype: object
        """
        return self._claims
    ...
    def claims(self, claims):
        """Sets the claims of this ProviderSettingsWriteRequest.

        The set of claims that any received tokens from the provider must contain to authenticate as the configured service account.

        :param claims: The claims of this ProviderSettingsWriteRequest.
        :type: object
        """
    ...
    def dynamic_mappings(self):
        """Gets the dynamic_mappings of this ProviderSettingsWriteRequest.
        ...
        :return: The dynamic_mappings of this ProviderSettingsWriteRequest.
    ...
    def dynamic_mappings(self, dynamic_mappings):
        """Sets the dynamic_mappings of this ProviderSettingsWriteRequest.

        The dynamic mappings of `mapping_claim` values to service accounts. Cannot be provided if `service_accounts` is also set.  Note: This field and the dynamic mappings feature are still in early access. Breaking changes are possible as we receive feedback on this feature.

        :param dynamic_mappings: The dynamic_mappings of this ProviderSettingsWriteRequest.
    ...
    @property
    def enabled(self):
        """Gets the enabled of this ProviderSettingsWriteRequest.

        Whether the provider settings should be used for incoming OIDC requests.

        :return: The enabled of this ProviderSettingsWriteRequest.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this ProviderSettingsWriteRequest.

        Whether the provider settings should be used for incoming OIDC requests.

        :param enabled: The enabled of this ProviderSettingsWriteRequest.
        :type: bool
        """
    ...
    def mapping_claim(self):
        """Gets the mapping_claim of this ProviderSettingsWriteRequest.
        ...
        :return: The mapping_claim of this ProviderSettingsWriteRequest.
        :rtype: str
        """
    ...
    def mapping_claim(self, mapping_claim):
        """Sets the mapping_claim of this ProviderSettingsWriteRequest.

        The OIDC claim to use for mapping to service accounts in dynamic_mappings. Cannot be provided if `service_accounts` is also set.  Note: This field and the dynamic mappings feature are still in early access. Breaking changes are possible as we receive feedback on this feature.

        :param mapping_claim: The mapping_claim of this ProviderSettingsWriteRequest.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProviderSettingsWriteRequest.

        The name of the provider settings are being configured for

        :return: The name of this ProviderSettingsWriteRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProviderSettingsWriteRequest.

        The name of the provider settings are being configured for

        :param name: The name of this ProviderSettingsWriteRequest.
        :type: str
        """
    ...
    def provider_url(self):
        """Gets the provider_url of this ProviderSettingsWriteRequest.
        ...
        :return: The provider_url of this ProviderSettingsWriteRequest.
        :rtype: str
        """
    ...
    def provider_url(self, provider_url):
        """Sets the provider_url of this ProviderSettingsWriteRequest.

        The URL from the provider that serves as the base for the OpenID configuration. For example, if the OpenID configuration is available at https://token.actions.githubusercontent.com/.well-known/openid-configuration, the provider URL would be https://token.actions.githubusercontent.com/

        :param provider_url: The provider_url of this ProviderSettingsWriteRequest.
        :type: str
        """
    ...
    def service_accounts(self):
        """Gets the service_accounts of this ProviderSettingsWriteRequest.
        ...
        :return: The service_accounts of this ProviderSettingsWriteRequest.
        :rtype: list[str]
        """
    ...
    def service_accounts(self, service_accounts):
        """Sets the service_accounts of this ProviderSettingsWriteRequest.

        The service accounts associated with these provider settings. Cannot be provided if `mapping_claim` or `dynamic_mappings` are specified.

        :param service_accounts: The service_accounts of this ProviderSettingsWriteRequest.
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProviderSettingsWriteRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProviderSettingsWriteRequest):
            return False
