...
class RepositoryCreateRequest(object):
    ...
    def content_kind(self):
        """Gets the content_kind of this RepositoryCreateRequest.
        ...
        :return: The content_kind of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def content_kind(self, content_kind):
        """Sets the content_kind of this RepositoryCreateRequest.
    ...
    def contextual_auth_realm(self):
        """Gets the contextual_auth_realm of this RepositoryCreateRequest.
        ...
        :return: The contextual_auth_realm of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def contextual_auth_realm(self, contextual_auth_realm):
        """Sets the contextual_auth_realm of this RepositoryCreateRequest.

        If checked, missing credentials for this repository where basic authentication is required shall present an enriched value in the 'WWW-Authenticate' header containing the namespace and repository. This can be useful for tooling such as SBT where the authentication realm is used to distinguish and disambiguate credentials.

        :param contextual_auth_realm: The contextual_auth_realm of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    @property
    def copy_own(self):
        """Gets the copy_own of this RepositoryCreateRequest.
        ...
        :return: The copy_own of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def copy_own(self, copy_own):
        """Sets the copy_own of this RepositoryCreateRequest.

        If checked, users can copy any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param copy_own: The copy_own of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def copy_packages(self):
        """Gets the copy_packages of this RepositoryCreateRequest.
        ...
        :return: The copy_packages of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def copy_packages(self, copy_packages):
        """Sets the copy_packages of this RepositoryCreateRequest.
    ...
    def cosign_signing_enabled(self):
        """Gets the cosign_signing_enabled of this RepositoryCreateRequest.
        ...
        :return: The cosign_signing_enabled of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def cosign_signing_enabled(self, cosign_signing_enabled):
        """Sets the cosign_signing_enabled of this RepositoryCreateRequest.

        When enabled, all pushed (or pulled from upstream) OCI packages and artifacts will be signed using cosign with the repository's ECDSA key. This generates a distinct cosign signature artifact per artifact.

        :param cosign_signing_enabled: The cosign_signing_enabled of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def default_privilege(self):
        """Gets the default_privilege of this RepositoryCreateRequest.
        ...
        :return: The default_privilege of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def default_privilege(self, default_privilege):
        """Sets the default_privilege of this RepositoryCreateRequest.
    ...
    @property
    def delete_own(self):
        """Gets the delete_own of this RepositoryCreateRequest.
        ...
        :return: The delete_own of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def delete_own(self, delete_own):
        """Sets the delete_own of this RepositoryCreateRequest.

        If checked, users can delete any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param delete_own: The delete_own of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def delete_packages(self):
        """Gets the delete_packages of this RepositoryCreateRequest.
        ...
        :return: The delete_packages of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def delete_packages(self, delete_packages):
        """Sets the delete_packages of this RepositoryCreateRequest.
    ...
    def description(self):
        """Gets the description of this RepositoryCreateRequest.

        A description of the repository's purpose/contents.

        :return: The description of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this RepositoryCreateRequest.

        A description of the repository's purpose/contents.

        :param description: The description of this RepositoryCreateRequest.
        :type: str
        """
    ...
    def distributes(self, distributes):
        """Sets the distributes of this RepositoryCreateRequest.

        The repositories distributed through this repo. Adding repos here is only valid if the content_kind is DISTRIBUTION.

        :param distributes: The distributes of this RepositoryCreateRequest.
        :type: list[str]
        """
    ...
    def docker_refresh_tokens_enabled(self):
        """Gets the docker_refresh_tokens_enabled of this RepositoryCreateRequest.
        ...
        :return: The docker_refresh_tokens_enabled of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def docker_refresh_tokens_enabled(self, docker_refresh_tokens_enabled):
        """Sets the docker_refresh_tokens_enabled of this RepositoryCreateRequest.

        If checked, refresh tokens will be issued in addition to access tokens for Docker authentication. This allows unlimited extension of the lifetime of access tokens.

        :param docker_refresh_tokens_enabled: The docker_refresh_tokens_enabled of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def index_files(self):
        ...
        :return: The index_files of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def index_files(self, index_files):
        """Sets the index_files of this RepositoryCreateRequest.

        If checked, files contained in packages will be indexed, which increase the synchronisation time required for packages. Note that it is recommended you keep this enabled unless the synchronisation time is significantly impacted.

        :param index_files: The index_files of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def is_public_hidden(self):
        """Gets the is_public_hidden of this RepositoryCreateRequest.

        If checked, this repository will be hidden from the list of public broadcasts for the workspace.

        :return: The is_public_hidden of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def is_public_hidden(self, is_public_hidden):
        """Sets the is_public_hidden of this RepositoryCreateRequest.

        If checked, this repository will be hidden from the list of public broadcasts for the workspace.

        :param is_public_hidden: The is_public_hidden of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    @property
    def move_own(self):
        """Gets the move_own of this RepositoryCreateRequest.
        ...
        :return: The move_own of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def move_own(self, move_own):
        """Sets the move_own of this RepositoryCreateRequest.

        If checked, users can move any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param move_own: The move_own of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def move_packages(self):
        """Gets the move_packages of this RepositoryCreateRequest.
        ...
        :return: The move_packages of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def move_packages(self, move_packages):
        """Sets the move_packages of this RepositoryCreateRequest.
    ...
    @property
    def name(self):
        """Gets the name of this RepositoryCreateRequest.

        A descriptive name for the repository.

        :return: The name of this RepositoryCreateRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RepositoryCreateRequest.

        A descriptive name for the repository.

        :param name: The name of this RepositoryCreateRequest.
        :type: str
        """
    ...
    def proxy_npmjs(self):
        ...
        :return: The proxy_npmjs of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def proxy_npmjs(self, proxy_npmjs):
        """Sets the proxy_npmjs of this RepositoryCreateRequest.

        If checked, Npm packages that are not in the repository when requested by clients will automatically be proxied from the public npmjs.org registry. If there is at least one version for a package, others will not be proxied.

        :param proxy_npmjs: The proxy_npmjs of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    @property
    def proxy_pypi(self):
        """Gets the proxy_pypi of this RepositoryCreateRequest.
        ...
        :return: The proxy_pypi of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def proxy_pypi(self, proxy_pypi):
        """Sets the proxy_pypi of this RepositoryCreateRequest.

        If checked, Python packages that are not in the repository when requested by clients will automatically be proxied from the public pypi.python.org registry. If there is at least one version for a package, others will not be proxied.

        :param proxy_pypi: The proxy_pypi of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def raw_package_index_enabled(self):
        """Gets the raw_package_index_enabled of this RepositoryCreateRequest.

        If checked, HTML and JSON indexes will be generated that list all available raw packages in the repository.

        :return: The raw_package_index_enabled of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def raw_package_index_enabled(self, raw_package_index_enabled):
        """Sets the raw_package_index_enabled of this RepositoryCreateRequest.

        If checked, HTML and JSON indexes will be generated that list all available raw packages in the repository.

        :param raw_package_index_enabled: The raw_package_index_enabled of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def raw_package_index_signatures_enabled(self):
        """Gets the raw_package_index_signatures_enabled of this RepositoryCreateRequest.

        If checked, the HTML and JSON indexes will display raw package GPG signatures alongside the index packages.

        :return: The raw_package_index_signatures_enabled of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def raw_package_index_signatures_enabled(self, raw_package_index_signatures_enabled):
        """Sets the raw_package_index_signatures_enabled of this RepositoryCreateRequest.

        If checked, the HTML and JSON indexes will display raw package GPG signatures alongside the index packages.

        :param raw_package_index_signatures_enabled: The raw_package_index_signatures_enabled of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def replace_packages(self):
        """Gets the replace_packages of this RepositoryCreateRequest.
        ...
        :return: The replace_packages of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def replace_packages(self, replace_packages):
        """Sets the replace_packages of this RepositoryCreateRequest.
    ...
    def replace_packages_by_default(self):
        """Gets the replace_packages_by_default of this RepositoryCreateRequest.
        ...
        :return: The replace_packages_by_default of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def replace_packages_by_default(self, replace_packages_by_default):
        """Sets the replace_packages_by_default of this RepositoryCreateRequest.

        If checked, uploaded packages will overwrite/replace any others with the same attributes (e.g. same version) by default. This only applies if the user has the required privilege for the republishing AND has the required privilege to delete existing packages that they don't own.

        :param replace_packages_by_default: The replace_packages_by_default of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def repository_type_str(self):
        """Gets the repository_type_str of this RepositoryCreateRequest.
        ...
        :return: The repository_type_str of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def repository_type_str(self, repository_type_str):
        """Sets the repository_type_str of this RepositoryCreateRequest.
    ...
    @property
    def resync_own(self):
        """Gets the resync_own of this RepositoryCreateRequest.
        ...
        :return: The resync_own of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def resync_own(self, resync_own):
        """Sets the resync_own of this RepositoryCreateRequest.

        If checked, users can resync any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param resync_own: The resync_own of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def resync_packages(self):
        """Gets the resync_packages of this RepositoryCreateRequest.
        ...
        :return: The resync_packages of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def resync_packages(self, resync_packages):
        """Sets the resync_packages of this RepositoryCreateRequest.
    ...
    @property
    def scan_own(self):
        """Gets the scan_own of this RepositoryCreateRequest.
        ...
        :return: The scan_own of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def scan_own(self, scan_own):
        """Sets the scan_own of this RepositoryCreateRequest.

        If checked, users can scan any of their own packages that they have uploaded, assuming that they still have write privilege for the repository. This takes precedence over privileges configured in the 'Access Controls' section of the repository, and any inherited from the org.

        :param scan_own: The scan_own of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def scan_packages(self):
        """Gets the scan_packages of this RepositoryCreateRequest.
        ...
        :return: The scan_packages of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def scan_packages(self, scan_packages):
        """Sets the scan_packages of this RepositoryCreateRequest.
    ...
    def show_setup_all(self, show_setup_all):
        """Sets the show_setup_all of this RepositoryCreateRequest.

        If checked, the Set Me Up help for all formats will always be shown, even if you don't have packages of that type uploaded. Otherwise, help will only be shown for packages that are in the repository. For example, if you have uploaded only NuGet packages, then the Set Me Up help for NuGet packages will be shown only.

        :param show_setup_all: The show_setup_all of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    @property
    def slug(self):
        """Gets the slug of this RepositoryCreateRequest.

        The slug identifies the repository in URIs.

        :return: The slug of this RepositoryCreateRequest.
        :rtype: str
        """
        return self._slug
    ...
    @slug.setter
    def slug(self, slug):
        """Sets the slug of this RepositoryCreateRequest.

        The slug identifies the repository in URIs.

        :param slug: The slug of this RepositoryCreateRequest.
        :type: str
        """
    ...
    def storage_region(self):
        """Gets the storage_region of this RepositoryCreateRequest.

        The Cloudsmith region in which package files are stored.

        :return: The storage_region of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def storage_region(self, storage_region):
        """Sets the storage_region of this RepositoryCreateRequest.

        The Cloudsmith region in which package files are stored.

        :param storage_region: The storage_region of this RepositoryCreateRequest.
        :type: str
        """
    ...
    def strict_npm_validation(self):
        """Gets the strict_npm_validation of this RepositoryCreateRequest.
        ...
        :return: The strict_npm_validation of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def strict_npm_validation(self, strict_npm_validation):
        """Sets the strict_npm_validation of this RepositoryCreateRequest.

        If checked, npm packages will be validated strictly to ensure the package matches specifcation. You can turn this on if you want to guarantee that the packages will work with npm-cli and other tools correctly.

        :param strict_npm_validation: The strict_npm_validation of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def use_debian_labels(self):
        ...
        :return: The use_debian_labels of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def use_debian_labels(self, use_debian_labels):
        """Sets the use_debian_labels of this RepositoryCreateRequest.

        If checked, a 'Label' field will be present in Debian-based repositories. It will contain a string that identifies the entitlement token used to authenticate the repository, in the form of 'source=t-<identifier>'; or 'source=none' if no token was used. You can use this to help with pinning.

        :param use_debian_labels: The use_debian_labels of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def use_default_cargo_upstream(self):
        """Gets the use_default_cargo_upstream of this RepositoryCreateRequest.
        ...
        :return: The use_default_cargo_upstream of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def use_default_cargo_upstream(self, use_default_cargo_upstream):
        """Sets the use_default_cargo_upstream of this RepositoryCreateRequest.

        If checked, dependencies of uploaded Cargo crates which do not set an explicit value for \"registry\" will be assumed to be available from crates.io. If unchecked, dependencies with unspecified \"registry\" values will be assumed to be available in the registry being uploaded to. Uncheck this if you want to ensure that dependencies are only ever installed from Cloudsmith unless explicitly specified as belong to another registry.

        :param use_default_cargo_upstream: The use_default_cargo_upstream of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def use_noarch_packages(self):
        """Gets the use_noarch_packages of this RepositoryCreateRequest.
        ...
        :return: The use_noarch_packages of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def use_noarch_packages(self, use_noarch_packages):
        """Sets the use_noarch_packages of this RepositoryCreateRequest.

        If checked, noarch packages (if supported) are enabled in installations/configurations. A noarch package is one that is not tied to specific system architecture (like i686).

        :param use_noarch_packages: The use_noarch_packages of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def use_source_packages(self):
        """Gets the use_source_packages of this RepositoryCreateRequest.
        ...
        :return: The use_source_packages of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def use_source_packages(self, use_source_packages):
        """Sets the use_source_packages of this RepositoryCreateRequest.

        If checked, source packages (if supported) are enabled in installations/configurations. A source package is one that contains source code rather than built binaries.

        :param use_source_packages: The use_source_packages of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def use_vulnerability_scanning(self):
        """Gets the use_vulnerability_scanning of this RepositoryCreateRequest.

        If checked, vulnerability scanning will be enabled for all supported packages within this repository.

        :return: The use_vulnerability_scanning of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def use_vulnerability_scanning(self, use_vulnerability_scanning):
        """Sets the use_vulnerability_scanning of this RepositoryCreateRequest.

        If checked, vulnerability scanning will be enabled for all supported packages within this repository.

        :param use_vulnerability_scanning: The use_vulnerability_scanning of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def user_entitlements_enabled(self):
        """Gets the user_entitlements_enabled of this RepositoryCreateRequest.
        ...
        :return: The user_entitlements_enabled of this RepositoryCreateRequest.
        :rtype: bool
        """
    ...
    def user_entitlements_enabled(self, user_entitlements_enabled):
        """Sets the user_entitlements_enabled of this RepositoryCreateRequest.

        If checked, users can use and manage their own user-specific entitlement token for the repository (if private). Otherwise, user-specific entitlements are disabled for all users.

        :param user_entitlements_enabled: The user_entitlements_enabled of this RepositoryCreateRequest.
        :type: bool
        """
    ...
    def view_statistics(self):
        """Gets the view_statistics of this RepositoryCreateRequest.
        ...
        :return: The view_statistics of this RepositoryCreateRequest.
        :rtype: str
        """
    ...
    def view_statistics(self, view_statistics):
        """Sets the view_statistics of this RepositoryCreateRequest.
