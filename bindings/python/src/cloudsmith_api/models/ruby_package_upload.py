...
class RubyPackageUpload(object):
    ...
    @property
    def filepath(self):
        """Gets the filepath of this RubyPackageUpload.

        Full path to the file, including filename e.g. bin/utils/tool.tar.gz

        :return: The filepath of this RubyPackageUpload.
        :rtype: str
        """
    ...
    def filepath(self, filepath):
        """Sets the filepath of this RubyPackageUpload.

        Full path to the file, including filename e.g. bin/utils/tool.tar.gz

        :param filepath: The filepath of this RubyPackageUpload.
        :type: str
        """
        if (self._configuration.client_side_validation and
