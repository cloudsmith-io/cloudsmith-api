...
class PackagesownerrepoArchitectures(object):
    """
    ...
    def __init__(self, description=None, name=None):
        """
        PackagesownerrepoArchitectures - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PackagesownerrepoArchitectures):
            return False
