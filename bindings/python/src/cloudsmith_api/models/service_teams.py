...
class ServiceTeams(object):
    ...
    def role(self):
        ...
        :return: The role of this ServiceTeams.
        :rtype: str
        """
        return self._role
    ...
    @role.setter
    def role(self, role):
        """Sets the role of this ServiceTeams.
    ...
    @property
    def slug(self):
        """Gets the slug of this ServiceTeams.

        The teams associated with the service

        :return: The slug of this ServiceTeams.
        :rtype: str
        """
        return self._slug
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceTeams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceTeams):
            return False
