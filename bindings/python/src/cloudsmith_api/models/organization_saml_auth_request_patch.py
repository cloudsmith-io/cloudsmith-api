...
class OrganizationSAMLAuthRequestPatch(object):
    ...
    def saml_metadata_inline_webapp(self):
        """Gets the saml_metadata_inline_webapp of this OrganizationSAMLAuthRequestPatch.
        ...
        :return: The saml_metadata_inline_webapp of this OrganizationSAMLAuthRequestPatch.
        :rtype: str
        """
    ...
    def saml_metadata_inline_webapp(self, saml_metadata_inline_webapp):
        """Sets the saml_metadata_inline_webapp of this OrganizationSAMLAuthRequestPatch.

        When configured, this inline SAML metadata is used instead of the legacy app SAML configuration when signing into the new Cloudsmith web application.

        :param saml_metadata_inline_webapp: The saml_metadata_inline_webapp of this OrganizationSAMLAuthRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def saml_metadata_url_webapp(self):
        """Gets the saml_metadata_url_webapp of this OrganizationSAMLAuthRequestPatch.
        ...
        :return: The saml_metadata_url_webapp of this OrganizationSAMLAuthRequestPatch.
        :rtype: str
        """
    ...
    def saml_metadata_url_webapp(self, saml_metadata_url_webapp):
        """Sets the saml_metadata_url_webapp of this OrganizationSAMLAuthRequestPatch.

        When configured, this SAML metadata URL is used instead of the legacy app SAML configuration when signing into the new Cloudsmith web application.

        :param saml_metadata_url_webapp: The saml_metadata_url_webapp of this OrganizationSAMLAuthRequestPatch.
        :type: str
        """
        if (self._configuration.client_side_validation and
