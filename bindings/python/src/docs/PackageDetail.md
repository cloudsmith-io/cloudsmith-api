...
**has_dependencies** | **bool** | Whether the package has any dependencies (top-level or from its SBOM). | [optional] 
...
**osi_approved** | **bool** | Whether the package&#39;s SPDX license is OSI-approved. | [optional] 
...
**store_path** | **str** | Absolute store path for the package, including store hash and name. | [optional] 
