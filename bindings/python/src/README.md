...
*ReposApi* | [**repos_list**](docs/ReposApi.md#repos_list) | **GET** /repos/ | Get a list of all repositories associated with current user.
*ReposApi* | [**repos_list0**](docs/ReposApi.md#repos_list0) | **GET** /repos/{owner}/ | Get a list of all repositories within a namespace.
