# Rust API client for cloudsmith_api
...
*UserApi* | [**user_token_create**](docs/UserApi.md#user_token_create) | **Post** /user/token/ | Retrieve/Create API key/token for the authenticated user.
