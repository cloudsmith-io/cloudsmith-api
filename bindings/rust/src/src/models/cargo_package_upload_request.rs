...
pub struct CargoPackageUploadRequest {
...
impl CargoPackageUploadRequest {
  pub fn new(package_file: String) -> CargoPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> CargoPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> CargoPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> CargoPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
