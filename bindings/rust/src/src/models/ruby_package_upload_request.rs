...
pub struct RubyPackageUploadRequest {
...
impl RubyPackageUploadRequest {
  pub fn new(package_file: String) -> RubyPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> RubyPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> RubyPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> RubyPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
