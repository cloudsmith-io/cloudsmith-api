...
pub struct AlpinePackageUploadRequest {
...
impl AlpinePackageUploadRequest {
  pub fn new(distribution: String, package_file: String) -> AlpinePackageUploadRequest {
  ...
  pub fn with_distribution(mut self, distribution: String) -> AlpinePackageUploadRequest {
    self.distribution = distribution;
    self
  }
  ...
  pub fn with_package_file(mut self, package_file: String) -> AlpinePackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> AlpinePackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> AlpinePackageUploadRequest {
    self.tags = Some(tags);
    self
  }
