...
pub struct MavenUpstreamRequestPatch {
...
impl MavenUpstreamRequestPatch {
  pub fn new() -> MavenUpstreamRequestPatch {
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> MavenUpstreamRequestPatch {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> MavenUpstreamRequestPatch {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> MavenUpstreamRequestPatch {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> MavenUpstreamRequestPatch {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> MavenUpstreamRequestPatch {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> MavenUpstreamRequestPatch {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> MavenUpstreamRequestPatch {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_gpg_key_inline(mut self, gpg_key_inline: String) -> MavenUpstreamRequestPatch {
    self.gpg_key_inline = Some(gpg_key_inline);
    self
  }
  ...
  pub fn with_gpg_key_url(mut self, gpg_key_url: String) -> MavenUpstreamRequestPatch {
    self.gpg_key_url = Some(gpg_key_url);
    self
  }
  ...
  pub fn with_gpg_verification(mut self, gpg_verification: String) -> MavenUpstreamRequestPatch {
    self.gpg_verification = Some(gpg_verification);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> MavenUpstreamRequestPatch {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> MavenUpstreamRequestPatch {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> MavenUpstreamRequestPatch {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> MavenUpstreamRequestPatch {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> MavenUpstreamRequestPatch {
    self.upstream_url = Some(upstream_url);
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> MavenUpstreamRequestPatch {
    self.verify_ssl = Some(verify_ssl);
    self
  }
