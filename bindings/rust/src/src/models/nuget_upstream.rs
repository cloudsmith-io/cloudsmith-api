...
impl NugetUpstream {
  pub fn new(name: String, upstream_url: String) -> NugetUpstream {
    NugetUpstream {
      auth_mode: None,
      auth_secret: None,
      auth_username: None,
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> NugetUpstream {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> NugetUpstream {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> NugetUpstream {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> NugetUpstream {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_disable_reason(mut self, disable_reason: String) -> NugetUpstream {
    self.disable_reason = Some(disable_reason);
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> NugetUpstream {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> NugetUpstream {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> NugetUpstream {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> NugetUpstream {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> NugetUpstream {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> NugetUpstream {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> NugetUpstream {
    self.name = name;
    self
  }
  ...
  pub fn with_pending_validation(mut self, pending_validation: bool) -> NugetUpstream {
    self.pending_validation = Some(pending_validation);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> NugetUpstream {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_slug_perm(mut self, slug_perm: String) -> NugetUpstream {
    self.slug_perm = Some(slug_perm);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> NugetUpstream {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> NugetUpstream {
    self.upstream_url = upstream_url;
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> NugetUpstream {
    self.verify_ssl = Some(verify_ssl);
    self
  }
