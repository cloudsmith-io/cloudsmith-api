...
pub struct DockerPackageUploadRequest {
...
impl DockerPackageUploadRequest {
  pub fn new(package_file: String) -> DockerPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> DockerPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> DockerPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> DockerPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
