...
pub struct RepositoryRequestPatch {
...
impl RepositoryRequestPatch {
  pub fn new() -> RepositoryRequestPatch {
  ...
  pub fn with_content_kind(mut self, content_kind: String) -> RepositoryRequestPatch {
    self.content_kind = Some(content_kind);
    self
  }
  ...
  pub fn with_contextual_auth_realm(mut self, contextual_auth_realm: bool) -> RepositoryRequestPatch {
    self.contextual_auth_realm = Some(contextual_auth_realm);
    self
  }
  ...
  pub fn with_copy_own(mut self, copy_own: bool) -> RepositoryRequestPatch {
    self.copy_own = Some(copy_own);
    self
  }
  ...
  pub fn with_copy_packages(mut self, copy_packages: String) -> RepositoryRequestPatch {
    self.copy_packages = Some(copy_packages);
    self
  }
  ...
  pub fn with_default_privilege(mut self, default_privilege: String) -> RepositoryRequestPatch {
    self.default_privilege = Some(default_privilege);
    self
  }
  ...
  pub fn with_delete_own(mut self, delete_own: bool) -> RepositoryRequestPatch {
    self.delete_own = Some(delete_own);
    self
  }
  ...
  pub fn with_delete_packages(mut self, delete_packages: String) -> RepositoryRequestPatch {
    self.delete_packages = Some(delete_packages);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> RepositoryRequestPatch {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_distributes(mut self, distributes: Vec<String>) -> RepositoryRequestPatch {
    self.distributes = Some(distributes);
    self
  }
  ...
  pub fn with_docker_refresh_tokens_enabled(mut self, docker_refresh_tokens_enabled: bool) -> RepositoryRequestPatch {
    self.docker_refresh_tokens_enabled = Some(docker_refresh_tokens_enabled);
    self
  }
  ...
  pub fn with_enforce_eula(mut self, enforce_eula: bool) -> RepositoryRequestPatch {
    self.enforce_eula = Some(enforce_eula);
    self
  }
  ...
  pub fn with_index_files(mut self, index_files: bool) -> RepositoryRequestPatch {
    self.index_files = Some(index_files);
    self
  }
  ...
  pub fn with_manage_entitlements_privilege(mut self, manage_entitlements_privilege: String) -> RepositoryRequestPatch {
    self.manage_entitlements_privilege = Some(manage_entitlements_privilege);
    self
  }
  ...
  pub fn with_move_own(mut self, move_own: bool) -> RepositoryRequestPatch {
    self.move_own = Some(move_own);
    self
  }
  ...
  pub fn with_move_packages(mut self, move_packages: String) -> RepositoryRequestPatch {
    self.move_packages = Some(move_packages);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> RepositoryRequestPatch {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_nuget_native_signing_enabled(mut self, nuget_native_signing_enabled: bool) -> RepositoryRequestPatch {
    self.nuget_native_signing_enabled = Some(nuget_native_signing_enabled);
    self
  }
  ...
  pub fn with_open_source_license(mut self, open_source_license: String) -> RepositoryRequestPatch {
    self.open_source_license = Some(open_source_license);
    self
  }
  ...
  pub fn with_open_source_project_url(mut self, open_source_project_url: String) -> RepositoryRequestPatch {
    self.open_source_project_url = Some(open_source_project_url);
    self
  }
  ...
  pub fn with_proxy_npmjs(mut self, proxy_npmjs: bool) -> RepositoryRequestPatch {
    self.proxy_npmjs = Some(proxy_npmjs);
    self
  }
  ...
  pub fn with_proxy_pypi(mut self, proxy_pypi: bool) -> RepositoryRequestPatch {
    self.proxy_pypi = Some(proxy_pypi);
    self
  }
  ...
  pub fn with_raw_package_index_enabled(mut self, raw_package_index_enabled: bool) -> RepositoryRequestPatch {
    self.raw_package_index_enabled = Some(raw_package_index_enabled);
    self
  }
  ...
  pub fn with_raw_package_index_signatures_enabled(mut self, raw_package_index_signatures_enabled: bool) -> RepositoryRequestPatch {
    self.raw_package_index_signatures_enabled = Some(raw_package_index_signatures_enabled);
    self
  }
  ...
  pub fn with_replace_packages(mut self, replace_packages: String) -> RepositoryRequestPatch {
    self.replace_packages = Some(replace_packages);
    self
  }
  ...
  pub fn with_replace_packages_by_default(mut self, replace_packages_by_default: bool) -> RepositoryRequestPatch {
    self.replace_packages_by_default = Some(replace_packages_by_default);
    self
  }
  ...
  pub fn with_repository_type_str(mut self, repository_type_str: String) -> RepositoryRequestPatch {
    self.repository_type_str = Some(repository_type_str);
    self
  }
  ...
  pub fn with_resync_own(mut self, resync_own: bool) -> RepositoryRequestPatch {
    self.resync_own = Some(resync_own);
    self
  }
  ...
  pub fn with_resync_packages(mut self, resync_packages: String) -> RepositoryRequestPatch {
    self.resync_packages = Some(resync_packages);
    self
  }
  ...
  pub fn with_scan_own(mut self, scan_own: bool) -> RepositoryRequestPatch {
    self.scan_own = Some(scan_own);
    self
  }
  ...
  pub fn with_scan_packages(mut self, scan_packages: String) -> RepositoryRequestPatch {
    self.scan_packages = Some(scan_packages);
    self
  }
  ...
  pub fn with_show_setup_all(mut self, show_setup_all: bool) -> RepositoryRequestPatch {
    self.show_setup_all = Some(show_setup_all);
    self
  }
  ...
  pub fn with_slug(mut self, slug: String) -> RepositoryRequestPatch {
    self.slug = Some(slug);
    self
  }
  ...
  pub fn with_strict_npm_validation(mut self, strict_npm_validation: bool) -> RepositoryRequestPatch {
    self.strict_npm_validation = Some(strict_npm_validation);
    self
  }
  ...
  pub fn with_tag_pre_releases_as_latest(mut self, tag_pre_releases_as_latest: bool) -> RepositoryRequestPatch {
    self.tag_pre_releases_as_latest = Some(tag_pre_releases_as_latest);
    self
  }
  ...
  pub fn with_use_debian_labels(mut self, use_debian_labels: bool) -> RepositoryRequestPatch {
    self.use_debian_labels = Some(use_debian_labels);
    self
  }
  ...
  pub fn with_use_default_cargo_upstream(mut self, use_default_cargo_upstream: bool) -> RepositoryRequestPatch {
    self.use_default_cargo_upstream = Some(use_default_cargo_upstream);
    self
  }
  ...
  pub fn with_use_entitlements_privilege(mut self, use_entitlements_privilege: String) -> RepositoryRequestPatch {
    self.use_entitlements_privilege = Some(use_entitlements_privilege);
    self
  }
  ...
  pub fn with_use_noarch_packages(mut self, use_noarch_packages: bool) -> RepositoryRequestPatch {
    self.use_noarch_packages = Some(use_noarch_packages);
    self
  }
  ...
  pub fn with_use_source_packages(mut self, use_source_packages: bool) -> RepositoryRequestPatch {
    self.use_source_packages = Some(use_source_packages);
    self
  }
  ...
  pub fn with_use_vulnerability_scanning(mut self, use_vulnerability_scanning: bool) -> RepositoryRequestPatch {
    self.use_vulnerability_scanning = Some(use_vulnerability_scanning);
    self
  }
  ...
  pub fn with_user_entitlements_enabled(mut self, user_entitlements_enabled: bool) -> RepositoryRequestPatch {
    self.user_entitlements_enabled = Some(user_entitlements_enabled);
    self
  }
  ...
  pub fn with_view_statistics(mut self, view_statistics: String) -> RepositoryRequestPatch {
    self.view_statistics = Some(view_statistics);
    self
  }
