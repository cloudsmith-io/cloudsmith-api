...
pub struct GoPackageUploadRequest {
...
impl GoPackageUploadRequest {
  pub fn new(package_file: String) -> GoPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> GoPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> GoPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> GoPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
