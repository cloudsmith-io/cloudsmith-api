...
pub struct HexPackageUploadRequest {
...
impl HexPackageUploadRequest {
  pub fn new(package_file: String) -> HexPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> HexPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> HexPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> HexPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
