...
pub struct LuarocksPackageUploadRequest {
...
impl LuarocksPackageUploadRequest {
  pub fn new(package_file: String) -> LuarocksPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> LuarocksPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> LuarocksPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> LuarocksPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
