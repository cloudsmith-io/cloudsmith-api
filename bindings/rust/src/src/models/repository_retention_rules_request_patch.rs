...
pub struct RepositoryRetentionRulesRequestPatch {
...
impl RepositoryRetentionRulesRequestPatch {
  pub fn new() -> RepositoryRetentionRulesRequestPatch {
  ...
  pub fn with_retention_count_limit(mut self, retention_count_limit: i32) -> RepositoryRetentionRulesRequestPatch {
    self.retention_count_limit = Some(retention_count_limit);
    self
  }
  ...
  pub fn with_retention_days_limit(mut self, retention_days_limit: i32) -> RepositoryRetentionRulesRequestPatch {
    self.retention_days_limit = Some(retention_days_limit);
    self
  }
  ...
  pub fn with_retention_enabled(mut self, retention_enabled: bool) -> RepositoryRetentionRulesRequestPatch {
    self.retention_enabled = Some(retention_enabled);
    self
  }
  ...
  pub fn with_retention_group_by_format(mut self, retention_group_by_format: bool) -> RepositoryRetentionRulesRequestPatch {
    self.retention_group_by_format = Some(retention_group_by_format);
    self
  }
  ...
  pub fn with_retention_group_by_name(mut self, retention_group_by_name: bool) -> RepositoryRetentionRulesRequestPatch {
    self.retention_group_by_name = Some(retention_group_by_name);
    self
  }
  ...
  pub fn with_retention_group_by_package_type(mut self, retention_group_by_package_type: bool) -> RepositoryRetentionRulesRequestPatch {
    self.retention_group_by_package_type = Some(retention_group_by_package_type);
    self
  }
  ...
  pub fn with_retention_size_limit(mut self, retention_size_limit: i32) -> RepositoryRetentionRulesRequestPatch {
    self.retention_size_limit = Some(retention_size_limit);
    self
  }
