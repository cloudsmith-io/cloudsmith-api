...
impl RepositoryToken {
  pub fn new(name: String) -> RepositoryToken {
    RepositoryToken {
      clients: None,
      created_at: None,
      created_by: None,
  ...
  pub fn with_clients(mut self, clients: i32) -> RepositoryToken {
    self.clients = Some(clients);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> RepositoryToken {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_created_by(mut self, created_by: String) -> RepositoryToken {
    self.created_by = Some(created_by);
    self
  }
  ...
  pub fn with_created_by_url(mut self, created_by_url: String) -> RepositoryToken {
    self.created_by_url = Some(created_by_url);
    self
  }
  ...
  pub fn with_default(mut self, default: bool) -> RepositoryToken {
    self.default = Some(default);
    self
  }
  ...
  pub fn with_disable_url(mut self, disable_url: String) -> RepositoryToken {
    self.disable_url = Some(disable_url);
    self
  }
  ...
  pub fn with_downloads(mut self, downloads: i32) -> RepositoryToken {
    self.downloads = Some(downloads);
    self
  }
  ...
  pub fn with_enable_url(mut self, enable_url: String) -> RepositoryToken {
    self.enable_url = Some(enable_url);
    self
  }
  ...
  pub fn with_eula_accepted(mut self, eula_accepted: ::models::Eula) -> RepositoryToken {
    self.eula_accepted = Some(eula_accepted);
    self
  }
  ...
  pub fn with_eula_accepted_at(mut self, eula_accepted_at: String) -> RepositoryToken {
    self.eula_accepted_at = Some(eula_accepted_at);
    self
  }
  ...
  pub fn with_eula_accepted_from(mut self, eula_accepted_from: String) -> RepositoryToken {
    self.eula_accepted_from = Some(eula_accepted_from);
    self
  }
  ...
  pub fn with_eula_required(mut self, eula_required: bool) -> RepositoryToken {
    self.eula_required = Some(eula_required);
    self
  }
  ...
  pub fn with_has_limits(mut self, has_limits: bool) -> RepositoryToken {
    self.has_limits = Some(has_limits);
    self
  }
  ...
  pub fn with_identifier(mut self, identifier: i32) -> RepositoryToken {
    self.identifier = Some(identifier);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> RepositoryToken {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_is_limited(mut self, is_limited: bool) -> RepositoryToken {
    self.is_limited = Some(is_limited);
    self
  }
  ...
  pub fn with_limit_bandwidth(mut self, limit_bandwidth: i32) -> RepositoryToken {
    self.limit_bandwidth = Some(limit_bandwidth);
    self
  }
  ...
  pub fn with_limit_bandwidth_unit(mut self, limit_bandwidth_unit: String) -> RepositoryToken {
    self.limit_bandwidth_unit = Some(limit_bandwidth_unit);
    self
  }
  ...
  pub fn with_limit_date_range_from(mut self, limit_date_range_from: String) -> RepositoryToken {
    self.limit_date_range_from = Some(limit_date_range_from);
    self
  }
  ...
  pub fn with_limit_date_range_to(mut self, limit_date_range_to: String) -> RepositoryToken {
    self.limit_date_range_to = Some(limit_date_range_to);
    self
  }
  ...
  pub fn with_limit_num_clients(mut self, limit_num_clients: i32) -> RepositoryToken {
    self.limit_num_clients = Some(limit_num_clients);
    self
  }
  ...
  pub fn with_limit_num_downloads(mut self, limit_num_downloads: i32) -> RepositoryToken {
    self.limit_num_downloads = Some(limit_num_downloads);
    self
  }
  ...
  pub fn with_limit_package_query(mut self, limit_package_query: String) -> RepositoryToken {
    self.limit_package_query = Some(limit_package_query);
    self
  }
  ...
  pub fn with_limit_path_query(mut self, limit_path_query: String) -> RepositoryToken {
    self.limit_path_query = Some(limit_path_query);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: Value) -> RepositoryToken {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> RepositoryToken {
    self.name = name;
    self
  }
  ...
  pub fn with_refresh_url(mut self, refresh_url: String) -> RepositoryToken {
    self.refresh_url = Some(refresh_url);
    self
  }
  ...
  pub fn with_reset_url(mut self, reset_url: String) -> RepositoryToken {
    self.reset_url = Some(reset_url);
    self
  }
  ...
  pub fn with_scheduled_reset_at(mut self, scheduled_reset_at: String) -> RepositoryToken {
    self.scheduled_reset_at = Some(scheduled_reset_at);
    self
  }
  ...
  pub fn with_scheduled_reset_period(mut self, scheduled_reset_period: String) -> RepositoryToken {
    self.scheduled_reset_period = Some(scheduled_reset_period);
    self
  }
  ...
  pub fn with_self_url(mut self, self_url: String) -> RepositoryToken {
    self.self_url = Some(self_url);
    self
  }
  ...
  pub fn with_slug_perm(mut self, slug_perm: String) -> RepositoryToken {
    self.slug_perm = Some(slug_perm);
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> RepositoryToken {
    self.token = Some(token);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> RepositoryToken {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn with_updated_by(mut self, updated_by: String) -> RepositoryToken {
    self.updated_by = Some(updated_by);
    self
  }
  ...
  pub fn with_updated_by_url(mut self, updated_by_url: String) -> RepositoryToken {
    self.updated_by_url = Some(updated_by_url);
    self
  }
  ...
  pub fn with_usage(mut self, usage: String) -> RepositoryToken {
    self.usage = Some(usage);
    self
  }
  ...
  pub fn with_user(mut self, user: String) -> RepositoryToken {
    self.user = Some(user);
    self
  }
  ...
  pub fn with_user_url(mut self, user_url: String) -> RepositoryToken {
    self.user_url = Some(user_url);
    self
  }
