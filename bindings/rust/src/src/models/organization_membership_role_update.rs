...
pub struct OrganizationMembershipRoleUpdate {
  #[serde(rename = "email")]
  email: Option<String>,
...
impl OrganizationMembershipRoleUpdate {
  pub fn new() -> OrganizationMembershipRoleUpdate {
  ...
  pub fn with_email(mut self, email: String) -> OrganizationMembershipRoleUpdate {
    self.email = Some(email);
    self
  }
  ...
  pub fn with_has_two_factor(mut self, has_two_factor: bool) -> OrganizationMembershipRoleUpdate {
    self.has_two_factor = Some(has_two_factor);
    self
  }
  ...
  pub fn with_joined_at(mut self, joined_at: String) -> OrganizationMembershipRoleUpdate {
    self.joined_at = Some(joined_at);
    self
  }
  ...
  pub fn with_last_login_at(mut self, last_login_at: String) -> OrganizationMembershipRoleUpdate {
    self.last_login_at = Some(last_login_at);
    self
  }
  ...
  pub fn with_last_login_method(mut self, last_login_method: String) -> OrganizationMembershipRoleUpdate {
    self.last_login_method = Some(last_login_method);
    self
  }
  ...
  pub fn with_role(mut self, role: String) -> OrganizationMembershipRoleUpdate {
    self.role = Some(role);
    self
  }
  ...
  pub fn with_user(mut self, user: String) -> OrganizationMembershipRoleUpdate {
    self.user = Some(user);
    self
  }
  ...
  pub fn with_user_id(mut self, user_id: String) -> OrganizationMembershipRoleUpdate {
    self.user_id = Some(user_id);
    self
  }
  ...
  pub fn with_user_name(mut self, user_name: String) -> OrganizationMembershipRoleUpdate {
    self.user_name = Some(user_name);
    self
  }
  ...
  pub fn with_user_url(mut self, user_url: String) -> OrganizationMembershipRoleUpdate {
    self.user_url = Some(user_url);
    self
  }
  ...
  pub fn with_visibility(mut self, visibility: String) -> OrganizationMembershipRoleUpdate {
    self.visibility = Some(visibility);
    self
  }
