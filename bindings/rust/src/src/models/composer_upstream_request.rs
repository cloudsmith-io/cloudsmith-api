...
pub struct ComposerUpstreamRequest {
...
impl ComposerUpstreamRequest {
  pub fn new(name: String, upstream_url: String) -> ComposerUpstreamRequest {
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> ComposerUpstreamRequest {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> ComposerUpstreamRequest {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> ComposerUpstreamRequest {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> ComposerUpstreamRequest {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> ComposerUpstreamRequest {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> ComposerUpstreamRequest {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> ComposerUpstreamRequest {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> ComposerUpstreamRequest {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> ComposerUpstreamRequest {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ComposerUpstreamRequest {
    self.name = name;
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> ComposerUpstreamRequest {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> ComposerUpstreamRequest {
    self.upstream_url = upstream_url;
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> ComposerUpstreamRequest {
    self.verify_ssl = Some(verify_ssl);
    self
  }
