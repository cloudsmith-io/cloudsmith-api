...
pub struct CranUpstreamRequestPatch {
...
impl CranUpstreamRequestPatch {
  pub fn new() -> CranUpstreamRequestPatch {
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> CranUpstreamRequestPatch {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> CranUpstreamRequestPatch {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> CranUpstreamRequestPatch {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> CranUpstreamRequestPatch {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> CranUpstreamRequestPatch {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> CranUpstreamRequestPatch {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> CranUpstreamRequestPatch {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> CranUpstreamRequestPatch {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> CranUpstreamRequestPatch {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> CranUpstreamRequestPatch {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> CranUpstreamRequestPatch {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> CranUpstreamRequestPatch {
    self.upstream_url = Some(upstream_url);
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> CranUpstreamRequestPatch {
    self.verify_ssl = Some(verify_ssl);
    self
  }
