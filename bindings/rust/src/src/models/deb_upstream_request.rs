...
impl DebUpstreamRequest {
  pub fn new(distro_versions: Vec<String>, name: String, upstream_url: String) -> DebUpstreamRequest {
    DebUpstreamRequest {
      auth_mode: None,
      auth_secret: None,
      auth_username: None,
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> DebUpstreamRequest {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> DebUpstreamRequest {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> DebUpstreamRequest {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_component(mut self, component: String) -> DebUpstreamRequest {
    self.component = Some(component);
    self
  }
  ...
  pub fn with_distro_versions(mut self, distro_versions: Vec<String>) -> DebUpstreamRequest {
    self.distro_versions = distro_versions;
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> DebUpstreamRequest {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> DebUpstreamRequest {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> DebUpstreamRequest {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> DebUpstreamRequest {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_gpg_key_inline(mut self, gpg_key_inline: String) -> DebUpstreamRequest {
    self.gpg_key_inline = Some(gpg_key_inline);
    self
  }
  ...
  pub fn with_gpg_key_url(mut self, gpg_key_url: String) -> DebUpstreamRequest {
    self.gpg_key_url = Some(gpg_key_url);
    self
  }
  ...
  pub fn with_gpg_verification(mut self, gpg_verification: String) -> DebUpstreamRequest {
    self.gpg_verification = Some(gpg_verification);
    self
  }
  ...
  pub fn with_include_sources(mut self, include_sources: bool) -> DebUpstreamRequest {
    self.include_sources = Some(include_sources);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> DebUpstreamRequest {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> DebUpstreamRequest {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> DebUpstreamRequest {
    self.name = name;
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> DebUpstreamRequest {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_upstream_distribution(mut self, upstream_distribution: String) -> DebUpstreamRequest {
    self.upstream_distribution = Some(upstream_distribution);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> DebUpstreamRequest {
    self.upstream_url = upstream_url;
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> DebUpstreamRequest {
    self.verify_ssl = Some(verify_ssl);
    self
  }
