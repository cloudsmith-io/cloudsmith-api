...
impl DockerUpstreamRequestPatch {
  pub fn new() -> DockerUpstreamRequestPatch {
    DockerUpstreamRequestPatch {
      auth_certificate: None,
      auth_certificate_key: None,
      auth_mode: None,
      auth_secret: None,
      auth_username: None,
      extra_header_1: None,
  ...
  pub fn set_auth_certificate(&mut self, auth_certificate: String) {
    self.auth_certificate = Some(auth_certificate);
  }

  pub fn with_auth_certificate(mut self, auth_certificate: String) -> DockerUpstreamRequestPatch {
    self.auth_certificate = Some(auth_certificate);
    self
  }

  pub fn auth_certificate(&self) -> Option<&String> {
    self.auth_certificate.as_ref()
  }

  pub fn reset_auth_certificate(&mut self) {
    self.auth_certificate = None;
  }

  pub fn set_auth_certificate_key(&mut self, auth_certificate_key: String) {
  ...
  pub fn auth_certificate_key(&self) -> Option<&String> {
    self.auth_certificate_key.as_ref()
  }

  pub fn reset_auth_certificate_key(&mut self) {
    self.auth_certificate_key = None;
  }
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> DockerUpstreamRequestPatch {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> DockerUpstreamRequestPatch {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> DockerUpstreamRequestPatch {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> DockerUpstreamRequestPatch {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> DockerUpstreamRequestPatch {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> DockerUpstreamRequestPatch {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> DockerUpstreamRequestPatch {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> DockerUpstreamRequestPatch {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> DockerUpstreamRequestPatch {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> DockerUpstreamRequestPatch {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> DockerUpstreamRequestPatch {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> DockerUpstreamRequestPatch {
    self.upstream_url = Some(upstream_url);
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> DockerUpstreamRequestPatch {
    self.verify_ssl = Some(verify_ssl);
    self
  }
