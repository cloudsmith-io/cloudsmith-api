...
pub struct OrganizationInviteExtend {
...
impl OrganizationInviteExtend {
  pub fn new() -> OrganizationInviteExtend {
  ...
  pub fn with_email(mut self, email: String) -> OrganizationInviteExtend {
    self.email = Some(email);
    self
  }
  ...
  pub fn with_expires_at(mut self, expires_at: String) -> OrganizationInviteExtend {
    self.expires_at = Some(expires_at);
    self
  }
  ...
  pub fn with_inviter(mut self, inviter: String) -> OrganizationInviteExtend {
    self.inviter = Some(inviter);
    self
  }
  ...
  pub fn with_inviter_url(mut self, inviter_url: String) -> OrganizationInviteExtend {
    self.inviter_url = Some(inviter_url);
    self
  }
  ...
  pub fn with_org(mut self, org: String) -> OrganizationInviteExtend {
    self.org = Some(org);
    self
  }
  ...
  pub fn with_role(mut self, role: String) -> OrganizationInviteExtend {
    self.role = Some(role);
    self
  }
  ...
  pub fn with_slug_perm(mut self, slug_perm: String) -> OrganizationInviteExtend {
    self.slug_perm = Some(slug_perm);
    self
  }
  ...
  pub fn with_teams(mut self, teams: Vec<::models::OrganizationTeamInvite>) -> OrganizationInviteExtend {
    self.teams = Some(teams);
    self
  }
  ...
  pub fn with_user(mut self, user: String) -> OrganizationInviteExtend {
    self.user = Some(user);
    self
  }
  ...
  pub fn with_user_url(mut self, user_url: String) -> OrganizationInviteExtend {
    self.user_url = Some(user_url);
    self
  }
