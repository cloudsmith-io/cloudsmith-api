...
pub struct RepositoryTokenRefreshRequest {
...
impl RepositoryTokenRefreshRequest {
  pub fn new() -> RepositoryTokenRefreshRequest {
  ...
  pub fn with_eula_required(mut self, eula_required: bool) -> RepositoryTokenRefreshRequest {
    self.eula_required = Some(eula_required);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> RepositoryTokenRefreshRequest {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_limit_bandwidth(mut self, limit_bandwidth: i32) -> RepositoryTokenRefreshRequest {
    self.limit_bandwidth = Some(limit_bandwidth);
    self
  }
  ...
  pub fn with_limit_bandwidth_unit(mut self, limit_bandwidth_unit: String) -> RepositoryTokenRefreshRequest {
    self.limit_bandwidth_unit = Some(limit_bandwidth_unit);
    self
  }
  ...
  pub fn with_limit_date_range_from(mut self, limit_date_range_from: String) -> RepositoryTokenRefreshRequest {
    self.limit_date_range_from = Some(limit_date_range_from);
    self
  }
  ...
  pub fn with_limit_date_range_to(mut self, limit_date_range_to: String) -> RepositoryTokenRefreshRequest {
    self.limit_date_range_to = Some(limit_date_range_to);
    self
  }
  ...
  pub fn with_limit_num_clients(mut self, limit_num_clients: i32) -> RepositoryTokenRefreshRequest {
    self.limit_num_clients = Some(limit_num_clients);
    self
  }
  ...
  pub fn with_limit_num_downloads(mut self, limit_num_downloads: i32) -> RepositoryTokenRefreshRequest {
    self.limit_num_downloads = Some(limit_num_downloads);
    self
  }
  ...
  pub fn with_limit_package_query(mut self, limit_package_query: String) -> RepositoryTokenRefreshRequest {
    self.limit_package_query = Some(limit_package_query);
    self
  }
  ...
  pub fn with_limit_path_query(mut self, limit_path_query: String) -> RepositoryTokenRefreshRequest {
    self.limit_path_query = Some(limit_path_query);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: Value) -> RepositoryTokenRefreshRequest {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_scheduled_reset_at(mut self, scheduled_reset_at: String) -> RepositoryTokenRefreshRequest {
    self.scheduled_reset_at = Some(scheduled_reset_at);
    self
  }
  ...
  pub fn with_scheduled_reset_period(mut self, scheduled_reset_period: String) -> RepositoryTokenRefreshRequest {
    self.scheduled_reset_period = Some(scheduled_reset_period);
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> RepositoryTokenRefreshRequest {
    self.token = Some(token);
    self
  }
