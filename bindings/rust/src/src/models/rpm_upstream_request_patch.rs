...
pub struct RpmUpstreamRequestPatch {
...
impl RpmUpstreamRequestPatch {
  pub fn new() -> RpmUpstreamRequestPatch {
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> RpmUpstreamRequestPatch {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> RpmUpstreamRequestPatch {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> RpmUpstreamRequestPatch {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_distro_version(mut self, distro_version: String) -> RpmUpstreamRequestPatch {
    self.distro_version = Some(distro_version);
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> RpmUpstreamRequestPatch {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> RpmUpstreamRequestPatch {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> RpmUpstreamRequestPatch {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> RpmUpstreamRequestPatch {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_gpg_key_inline(mut self, gpg_key_inline: String) -> RpmUpstreamRequestPatch {
    self.gpg_key_inline = Some(gpg_key_inline);
    self
  }
  ...
  pub fn with_gpg_key_url(mut self, gpg_key_url: String) -> RpmUpstreamRequestPatch {
    self.gpg_key_url = Some(gpg_key_url);
    self
  }
  ...
  pub fn with_gpg_verification(mut self, gpg_verification: String) -> RpmUpstreamRequestPatch {
    self.gpg_verification = Some(gpg_verification);
    self
  }
  ...
  pub fn with_include_sources(mut self, include_sources: bool) -> RpmUpstreamRequestPatch {
    self.include_sources = Some(include_sources);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> RpmUpstreamRequestPatch {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> RpmUpstreamRequestPatch {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> RpmUpstreamRequestPatch {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> RpmUpstreamRequestPatch {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> RpmUpstreamRequestPatch {
    self.upstream_url = Some(upstream_url);
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> RpmUpstreamRequestPatch {
    self.verify_ssl = Some(verify_ssl);
    self
  }
