...
pub struct P2PackageUploadRequest {
...
impl P2PackageUploadRequest {
  pub fn new(package_file: String) -> P2PackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> P2PackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> P2PackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> P2PackageUploadRequest {
    self.tags = Some(tags);
    self
  }
