...
impl RepositoryRsaKey {
  pub fn new() -> RepositoryRsaKey {
    RepositoryRsaKey {
      active: None,
      created_at: None,
      default: None,
  ...
  pub fn with_active(mut self, active: bool) -> RepositoryRsaKey {
    self.active = Some(active);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> RepositoryRsaKey {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_default(mut self, default: bool) -> RepositoryRsaKey {
    self.default = Some(default);
    self
  }
  ...
  pub fn with_fingerprint(mut self, fingerprint: String) -> RepositoryRsaKey {
    self.fingerprint = Some(fingerprint);
    self
  }
  ...
  pub fn with_fingerprint_short(mut self, fingerprint_short: String) -> RepositoryRsaKey {
    self.fingerprint_short = Some(fingerprint_short);
    self
  }
  ...
  pub fn with_public_key(mut self, public_key: String) -> RepositoryRsaKey {
    self.public_key = Some(public_key);
    self
  }
  ...
  pub fn with_ssh_fingerprint(mut self, ssh_fingerprint: String) -> RepositoryRsaKey {
    self.ssh_fingerprint = Some(ssh_fingerprint);
    self
  }
