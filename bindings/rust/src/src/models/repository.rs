...
impl Repository {
  ...
  pub fn with_cdn_url(mut self, cdn_url: String) -> Repository {
    self.cdn_url = Some(cdn_url);
    self
  }
  ...
  pub fn with_content_kind(mut self, content_kind: String) -> Repository {
    self.content_kind = Some(content_kind);
    self
  }
  ...
  pub fn with_contextual_auth_realm(mut self, contextual_auth_realm: bool) -> Repository {
    self.contextual_auth_realm = Some(contextual_auth_realm);
    self
  }
  ...
  pub fn with_copy_own(mut self, copy_own: bool) -> Repository {
    self.copy_own = Some(copy_own);
    self
  }
  ...
  pub fn with_copy_packages(mut self, copy_packages: String) -> Repository {
    self.copy_packages = Some(copy_packages);
    self
  }
  ...
  pub fn with_default_privilege(mut self, default_privilege: String) -> Repository {
    self.default_privilege = Some(default_privilege);
    self
  }
  ...
  pub fn with_delete_own(mut self, delete_own: bool) -> Repository {
    self.delete_own = Some(delete_own);
    self
  }
  ...
  pub fn with_delete_packages(mut self, delete_packages: String) -> Repository {
    self.delete_packages = Some(delete_packages);
    self
  }
  ...
  pub fn with_deleted_at(mut self, deleted_at: String) -> Repository {
    self.deleted_at = Some(deleted_at);
    self
  }
  ...
  pub fn with_distributes(mut self, distributes: Vec<String>) -> Repository {
    self.distributes = Some(distributes);
    self
  }
  ...
  pub fn with_docker_refresh_tokens_enabled(mut self, docker_refresh_tokens_enabled: bool) -> Repository {
    self.docker_refresh_tokens_enabled = Some(docker_refresh_tokens_enabled);
    self
  }
  ...
  pub fn with_ecdsa_keys(mut self, ecdsa_keys: Vec<::models::RepositoryEcdsaKey>) -> Repository {
    self.ecdsa_keys = Some(ecdsa_keys);
    self
  }
  ...
  pub fn with_enforce_eula(mut self, enforce_eula: bool) -> Repository {
    self.enforce_eula = Some(enforce_eula);
    self
  }
  ...
  pub fn with_gpg_keys(mut self, gpg_keys: Vec<::models::RepositoryGpgKey>) -> Repository {
    self.gpg_keys = Some(gpg_keys);
    self
  }
  ...
  pub fn with_index_files(mut self, index_files: bool) -> Repository {
    self.index_files = Some(index_files);
    self
  }
  ...
  pub fn with_is_open_source(mut self, is_open_source: bool) -> Repository {
    self.is_open_source = Some(is_open_source);
    self
  }
  ...
  pub fn with_is_private(mut self, is_private: bool) -> Repository {
    self.is_private = Some(is_private);
    self
  }
  ...
  pub fn with_is_public(mut self, is_public: bool) -> Repository {
    self.is_public = Some(is_public);
    self
  }
  ...
  pub fn with_manage_entitlements_privilege(mut self, manage_entitlements_privilege: String) -> Repository {
    self.manage_entitlements_privilege = Some(manage_entitlements_privilege);
    self
  }
  ...
  pub fn with_move_own(mut self, move_own: bool) -> Repository {
    self.move_own = Some(move_own);
    self
  }
  ...
  pub fn with_move_packages(mut self, move_packages: String) -> Repository {
    self.move_packages = Some(move_packages);
    self
  }
  ...
  pub fn with_namespace(mut self, namespace: String) -> Repository {
    self.namespace = Some(namespace);
    self
  }
  ...
  pub fn with_namespace_url(mut self, namespace_url: String) -> Repository {
    self.namespace_url = Some(namespace_url);
    self
  }
  ...
  pub fn with_nuget_native_signing_enabled(mut self, nuget_native_signing_enabled: bool) -> Repository {
    self.nuget_native_signing_enabled = Some(nuget_native_signing_enabled);
    self
  }
  ...
  pub fn with_num_downloads(mut self, num_downloads: i32) -> Repository {
    self.num_downloads = Some(num_downloads);
    self
  }
  ...
  pub fn with_num_policy_violated_packages(mut self, num_policy_violated_packages: i32) -> Repository {
    self.num_policy_violated_packages = Some(num_policy_violated_packages);
    self
  }
  ...
  pub fn with_num_quarantined_packages(mut self, num_quarantined_packages: i32) -> Repository {
    self.num_quarantined_packages = Some(num_quarantined_packages);
    self
  }
  ...
  pub fn with_open_source_license(mut self, open_source_license: String) -> Repository {
    self.open_source_license = Some(open_source_license);
    self
  }
  ...
  pub fn with_open_source_project_url(mut self, open_source_project_url: String) -> Repository {
    self.open_source_project_url = Some(open_source_project_url);
    self
  }
  ...
  pub fn with_package_count(mut self, package_count: i32) -> Repository {
    self.package_count = Some(package_count);
    self
  }
  ...
  pub fn with_package_group_count(mut self, package_group_count: i32) -> Repository {
    self.package_group_count = Some(package_group_count);
    self
  }
  ...
  pub fn with_proxy_npmjs(mut self, proxy_npmjs: bool) -> Repository {
    self.proxy_npmjs = Some(proxy_npmjs);
    self
  }
  ...
  pub fn with_proxy_pypi(mut self, proxy_pypi: bool) -> Repository {
    self.proxy_pypi = Some(proxy_pypi);
    self
  }
  ...
  pub fn with_raw_package_index_enabled(mut self, raw_package_index_enabled: bool) -> Repository {
    self.raw_package_index_enabled = Some(raw_package_index_enabled);
    self
  }
  ...
  pub fn with_replace_packages(mut self, replace_packages: String) -> Repository {
    self.replace_packages = Some(replace_packages);
    self
  }
  ...
  pub fn with_replace_packages_by_default(mut self, replace_packages_by_default: bool) -> Repository {
    self.replace_packages_by_default = Some(replace_packages_by_default);
    self
  }
  ...
  pub fn with_repository_type(mut self, repository_type: i32) -> Repository {
    self.repository_type = Some(repository_type);
    self
  }
  ...
  pub fn with_repository_type_str(mut self, repository_type_str: String) -> Repository {
    self.repository_type_str = Some(repository_type_str);
    self
  }
  ...
  pub fn with_resync_own(mut self, resync_own: bool) -> Repository {
    self.resync_own = Some(resync_own);
    self
  }
  ...
  pub fn with_resync_packages(mut self, resync_packages: String) -> Repository {
    self.resync_packages = Some(resync_packages);
    self
  }
  ...
  pub fn with_scan_own(mut self, scan_own: bool) -> Repository {
    self.scan_own = Some(scan_own);
    self
  }
  ...
  pub fn with_scan_packages(mut self, scan_packages: String) -> Repository {
    self.scan_packages = Some(scan_packages);
    self
  }
  ...
  pub fn with_self_html_url(mut self, self_html_url: String) -> Repository {
    self.self_html_url = Some(self_html_url);
    self
  }
  ...
  pub fn with_self_url(mut self, self_url: String) -> Repository {
    self.self_url = Some(self_url);
    self
  }
  ...
  pub fn with_show_setup_all(mut self, show_setup_all: bool) -> Repository {
    self.show_setup_all = Some(show_setup_all);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> Repository {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_size_str(mut self, size_str: String) -> Repository {
    self.size_str = Some(size_str);
    self
  }
  ...
  pub fn with_slug(mut self, slug: String) -> Repository {
    self.slug = Some(slug);
    self
  }
  ...
  pub fn with_slug_perm(mut self, slug_perm: String) -> Repository {
    self.slug_perm = Some(slug_perm);
    self
  }
  ...
  pub fn with_storage_region(mut self, storage_region: String) -> Repository {
    self.storage_region = Some(storage_region);
    self
  }
  ...
  pub fn with_strict_npm_validation(mut self, strict_npm_validation: bool) -> Repository {
    self.strict_npm_validation = Some(strict_npm_validation);
    self
  }
  ...
  pub fn with_tag_pre_releases_as_latest(mut self, tag_pre_releases_as_latest: bool) -> Repository {
    self.tag_pre_releases_as_latest = Some(tag_pre_releases_as_latest);
    self
  }
  ...
  pub fn with_use_debian_labels(mut self, use_debian_labels: bool) -> Repository {
    self.use_debian_labels = Some(use_debian_labels);
    self
  }
  ...
  pub fn with_use_default_cargo_upstream(mut self, use_default_cargo_upstream: bool) -> Repository {
    self.use_default_cargo_upstream = Some(use_default_cargo_upstream);
    self
  }
  ...
  pub fn with_use_entitlements_privilege(mut self, use_entitlements_privilege: String) -> Repository {
    self.use_entitlements_privilege = Some(use_entitlements_privilege);
    self
  }
  ...
  pub fn with_use_noarch_packages(mut self, use_noarch_packages: bool) -> Repository {
    self.use_noarch_packages = Some(use_noarch_packages);
    self
  }
  ...
  pub fn with_use_vulnerability_scanning(mut self, use_vulnerability_scanning: bool) -> Repository {
    self.use_vulnerability_scanning = Some(use_vulnerability_scanning);
    self
  }
  ...
  pub fn with_user_entitlements_enabled(mut self, user_entitlements_enabled: bool) -> Repository {
    self.user_entitlements_enabled = Some(user_entitlements_enabled);
    self
  }
  ...
  pub fn with_view_statistics(mut self, view_statistics: String) -> Repository {
    self.view_statistics = Some(view_statistics);
    self
  }
