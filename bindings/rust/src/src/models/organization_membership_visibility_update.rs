...
pub struct OrganizationMembershipVisibilityUpdate {
  #[serde(rename = "email")]
  email: Option<String>,
...
impl OrganizationMembershipVisibilityUpdate {
  pub fn new() -> OrganizationMembershipVisibilityUpdate {
  ...
  pub fn with_email(mut self, email: String) -> OrganizationMembershipVisibilityUpdate {
    self.email = Some(email);
    self
  }
  ...
  pub fn with_has_two_factor(mut self, has_two_factor: bool) -> OrganizationMembershipVisibilityUpdate {
    self.has_two_factor = Some(has_two_factor);
    self
  }
  ...
  pub fn with_joined_at(mut self, joined_at: String) -> OrganizationMembershipVisibilityUpdate {
    self.joined_at = Some(joined_at);
    self
  }
  ...
  pub fn with_last_login_at(mut self, last_login_at: String) -> OrganizationMembershipVisibilityUpdate {
    self.last_login_at = Some(last_login_at);
    self
  }
  ...
  pub fn with_last_login_method(mut self, last_login_method: String) -> OrganizationMembershipVisibilityUpdate {
    self.last_login_method = Some(last_login_method);
    self
  }
  ...
  pub fn with_role(mut self, role: String) -> OrganizationMembershipVisibilityUpdate {
    self.role = Some(role);
    self
  }
  ...
  pub fn with_user(mut self, user: String) -> OrganizationMembershipVisibilityUpdate {
    self.user = Some(user);
    self
  }
  ...
  pub fn with_user_id(mut self, user_id: String) -> OrganizationMembershipVisibilityUpdate {
    self.user_id = Some(user_id);
    self
  }
  ...
  pub fn with_user_name(mut self, user_name: String) -> OrganizationMembershipVisibilityUpdate {
    self.user_name = Some(user_name);
    self
  }
  ...
  pub fn with_user_url(mut self, user_url: String) -> OrganizationMembershipVisibilityUpdate {
    self.user_url = Some(user_url);
    self
  }
  ...
  pub fn with_visibility(mut self, visibility: String) -> OrganizationMembershipVisibilityUpdate {
    self.visibility = Some(visibility);
    self
  }
