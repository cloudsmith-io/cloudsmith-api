...
pub struct DartPackageUploadRequest {
...
impl DartPackageUploadRequest {
  pub fn new(package_file: String) -> DartPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> DartPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> DartPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> DartPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
