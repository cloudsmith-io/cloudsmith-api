...
pub struct RepositoryX509RsaCertificate {
...
impl RepositoryX509RsaCertificate {
  pub fn new() -> RepositoryX509RsaCertificate {
  ...
  pub fn with_active(mut self, active: bool) -> RepositoryX509RsaCertificate {
    self.active = Some(active);
    self
  }
  ...
  pub fn with_certificate(mut self, certificate: String) -> RepositoryX509RsaCertificate {
    self.certificate = Some(certificate);
    self
  }
  ...
  pub fn with_certificate_chain(mut self, certificate_chain: String) -> RepositoryX509RsaCertificate {
    self.certificate_chain = Some(certificate_chain);
    self
  }
  ...
  pub fn with_certificate_chain_fingerprint(mut self, certificate_chain_fingerprint: String) -> RepositoryX509RsaCertificate {
    self.certificate_chain_fingerprint = Some(certificate_chain_fingerprint);
    self
  }
  ...
  pub fn with_certificate_chain_fingerprint_short(mut self, certificate_chain_fingerprint_short: String) -> RepositoryX509RsaCertificate {
    self.certificate_chain_fingerprint_short = Some(certificate_chain_fingerprint_short);
    self
  }
  ...
  pub fn with_certificate_fingerprint(mut self, certificate_fingerprint: String) -> RepositoryX509RsaCertificate {
    self.certificate_fingerprint = Some(certificate_fingerprint);
    self
  }
  ...
  pub fn with_certificate_fingerprint_short(mut self, certificate_fingerprint_short: String) -> RepositoryX509RsaCertificate {
    self.certificate_fingerprint_short = Some(certificate_fingerprint_short);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> RepositoryX509RsaCertificate {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_default(mut self, default: bool) -> RepositoryX509RsaCertificate {
    self.default = Some(default);
    self
  }
  ...
  pub fn with_issuing_status(mut self, issuing_status: String) -> RepositoryX509RsaCertificate {
    self.issuing_status = Some(issuing_status);
    self
  }
