...
pub struct TerraformPackageUploadRequest {
...
impl TerraformPackageUploadRequest {
  pub fn new(package_file: String) -> TerraformPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> TerraformPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> TerraformPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> TerraformPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
