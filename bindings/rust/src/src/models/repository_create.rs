...
pub struct RepositoryCreate {
  ...
  #[serde(rename = "num_downloads")]
  num_downloads: Option<i32>,
  /// Number of packages with policy violations in a repository.
  #[serde(rename = "num_policy_violated_packages")]
  num_policy_violated_packages: Option<i32>,
  /// Number of quarantined packages in a repository.
  #[serde(rename = "num_quarantined_packages")]
  num_quarantined_packages: Option<i32>,
  ...
  #[serde(rename = "package_group_count")]
  package_group_count: Option<i32>,
...
impl RepositoryCreate {
  pub fn new(name: String) -> RepositoryCreate {
    RepositoryCreate {
      cdn_url: None,
      content_kind: None,
      ...
      num_downloads: None,
      num_policy_violated_packages: None,
      num_quarantined_packages: None,
      open_source_license: None,
      open_source_project_url: None,
      package_count: None,
      package_group_count: None,
      proxy_npmjs: None,
      proxy_pypi: None,
  ...
  pub fn with_cdn_url(mut self, cdn_url: String) -> RepositoryCreate {
    self.cdn_url = Some(cdn_url);
    self
  }
  ...
  pub fn with_content_kind(mut self, content_kind: String) -> RepositoryCreate {
    self.content_kind = Some(content_kind);
    self
  }
  ...
  pub fn with_contextual_auth_realm(mut self, contextual_auth_realm: bool) -> RepositoryCreate {
    self.contextual_auth_realm = Some(contextual_auth_realm);
    self
  }
  ...
  pub fn with_copy_own(mut self, copy_own: bool) -> RepositoryCreate {
    self.copy_own = Some(copy_own);
    self
  }
  ...
  pub fn with_copy_packages(mut self, copy_packages: String) -> RepositoryCreate {
    self.copy_packages = Some(copy_packages);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> RepositoryCreate {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_default_privilege(mut self, default_privilege: String) -> RepositoryCreate {
    self.default_privilege = Some(default_privilege);
    self
  }
  ...
  pub fn with_delete_own(mut self, delete_own: bool) -> RepositoryCreate {
    self.delete_own = Some(delete_own);
    self
  }
  ...
  pub fn with_delete_packages(mut self, delete_packages: String) -> RepositoryCreate {
    self.delete_packages = Some(delete_packages);
    self
  }
  ...
  pub fn set_deleted_at(&mut self, deleted_at: String) {
    self.deleted_at = Some(deleted_at);
  }

  pub fn with_deleted_at(mut self, deleted_at: String) -> RepositoryCreate {
    self.deleted_at = Some(deleted_at);
    self
  }
  ...
  pub fn reset_deleted_at(&mut self) {
  ...
  pub fn with_description(mut self, description: String) -> RepositoryCreate {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_distributes(mut self, distributes: Vec<String>) -> RepositoryCreate {
    self.distributes = Some(distributes);
    self
  }
  ...
  pub fn with_docker_refresh_tokens_enabled(mut self, docker_refresh_tokens_enabled: bool) -> RepositoryCreate {
    self.docker_refresh_tokens_enabled = Some(docker_refresh_tokens_enabled);
    self
  }
  ...
  pub fn set_ecdsa_keys(&mut self, ecdsa_keys: Vec<::models::RepositoryEcdsaKey>) {
    self.ecdsa_keys = Some(ecdsa_keys);
  }

  pub fn with_ecdsa_keys(mut self, ecdsa_keys: Vec<::models::RepositoryEcdsaKey>) -> RepositoryCreate {
    self.ecdsa_keys = Some(ecdsa_keys);
    self
  }

  pub fn ecdsa_keys(&self) -> Option<&Vec<::models::RepositoryEcdsaKey>> {
    self.ecdsa_keys.as_ref()
  }

  pub fn reset_ecdsa_keys(&mut self) {
    self.ecdsa_keys = None;
  }
  ...
  pub fn with_enforce_eula(mut self, enforce_eula: bool) -> RepositoryCreate {
    self.enforce_eula = Some(enforce_eula);
    self
  }
  ...
  pub fn set_gpg_keys(&mut self, gpg_keys: Vec<::models::RepositoryGpgKey>) {
    self.gpg_keys = Some(gpg_keys);
  }

  pub fn with_gpg_keys(mut self, gpg_keys: Vec<::models::RepositoryGpgKey>) -> RepositoryCreate {
    self.gpg_keys = Some(gpg_keys);
    self
  }

  pub fn gpg_keys(&self) -> Option<&Vec<::models::RepositoryGpgKey>> {
    self.gpg_keys.as_ref()
  }

  pub fn reset_gpg_keys(&mut self) {
    self.gpg_keys = None;
  }
  ...
  pub fn with_index_files(mut self, index_files: bool) -> RepositoryCreate {
    self.index_files = Some(index_files);
    self
  }
  ...
  pub fn set_is_open_source(&mut self, is_open_source: bool) {
    self.is_open_source = Some(is_open_source);
  }

  pub fn with_is_open_source(mut self, is_open_source: bool) -> RepositoryCreate {
    self.is_open_source = Some(is_open_source);
    self
  }

  pub fn is_open_source(&self) -> Option<&bool> {
    self.is_open_source.as_ref()
  }

  pub fn reset_is_open_source(&mut self) {
  ...
  pub fn with_is_private(mut self, is_private: bool) -> RepositoryCreate {
    self.is_private = Some(is_private);
    self
  }
  ...
  pub fn with_is_public(mut self, is_public: bool) -> RepositoryCreate {
    self.is_public = Some(is_public);
    self
  }
  ...
  pub fn with_manage_entitlements_privilege(mut self, manage_entitlements_privilege: String) -> RepositoryCreate {
    self.manage_entitlements_privilege = Some(manage_entitlements_privilege);
    self
  }
  ...
  pub fn with_move_own(mut self, move_own: bool) -> RepositoryCreate {
    self.move_own = Some(move_own);
    self
  }
  ...
  pub fn with_move_packages(mut self, move_packages: String) -> RepositoryCreate {
    self.move_packages = Some(move_packages);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> RepositoryCreate {
    self.name = name;
    self
  }
  ...
  pub fn with_namespace(mut self, namespace: String) -> RepositoryCreate {
    self.namespace = Some(namespace);
    self
  }
  ...
  pub fn with_namespace_url(mut self, namespace_url: String) -> RepositoryCreate {
    self.namespace_url = Some(namespace_url);
    self
  }
  ...
  pub fn with_nuget_native_signing_enabled(mut self, nuget_native_signing_enabled: bool) -> RepositoryCreate {
    self.nuget_native_signing_enabled = Some(nuget_native_signing_enabled);
    self
  }
  ...
  pub fn set_num_downloads(&mut self, num_downloads: i32) {
    self.num_downloads = Some(num_downloads);
  }

  pub fn with_num_downloads(mut self, num_downloads: i32) -> RepositoryCreate {
    self.num_downloads = Some(num_downloads);
    self
  }

  pub fn num_downloads(&self) -> Option<&i32> {
    self.num_downloads.as_ref()
  }

  pub fn reset_num_downloads(&mut self) {
    self.num_downloads = None;
  }

  pub fn set_num_policy_violated_packages(&mut self, num_policy_violated_packages: i32) {
    self.num_policy_violated_packages = Some(num_policy_violated_packages);
  }

  pub fn with_num_policy_violated_packages(mut self, num_policy_violated_packages: i32) -> RepositoryCreate {
    self.num_policy_violated_packages = Some(num_policy_violated_packages);
    self
  }

  pub fn num_policy_violated_packages(&self) -> Option<&i32> {
    self.num_policy_violated_packages.as_ref()
  }

  pub fn reset_num_policy_violated_packages(&mut self) {
    self.num_policy_violated_packages = None;
  }

  pub fn set_num_quarantined_packages(&mut self, num_quarantined_packages: i32) {
    self.num_quarantined_packages = Some(num_quarantined_packages);
  }

  pub fn with_num_quarantined_packages(mut self, num_quarantined_packages: i32) -> RepositoryCreate {
    self.num_quarantined_packages = Some(num_quarantined_packages);
    self
  }

  pub fn num_quarantined_packages(&self) -> Option<&i32> {
    self.num_quarantined_packages.as_ref()
  }

  pub fn reset_num_quarantined_packages(&mut self) {
    self.num_quarantined_packages = None;
  }
  ...
  pub fn with_open_source_license(mut self, open_source_license: String) -> RepositoryCreate {
    self.open_source_license = Some(open_source_license);
    self
  }
  ...
  pub fn with_open_source_project_url(mut self, open_source_project_url: String) -> RepositoryCreate {
    self.open_source_project_url = Some(open_source_project_url);
    self
  }
  ...
  pub fn set_package_count(&mut self, package_count: i32) {
    self.package_count = Some(package_count);
  }

  pub fn with_package_count(mut self, package_count: i32) -> RepositoryCreate {
    self.package_count = Some(package_count);
    self
  }

  pub fn package_count(&self) -> Option<&i32> {
    self.package_count.as_ref()
  }

  pub fn reset_package_count(&mut self) {
    self.package_count = None;
  }

  pub fn set_package_group_count(&mut self, package_group_count: i32) {
    self.package_group_count = Some(package_group_count);
  }

  pub fn with_package_group_count(mut self, package_group_count: i32) -> RepositoryCreate {
    self.package_group_count = Some(package_group_count);
    self
  }

  pub fn package_group_count(&self) -> Option<&i32> {
    self.package_group_count.as_ref()
  }

  pub fn reset_package_group_count(&mut self) {
    self.package_group_count = None;
  }
  ...
  pub fn with_proxy_npmjs(mut self, proxy_npmjs: bool) -> RepositoryCreate {
    self.proxy_npmjs = Some(proxy_npmjs);
    self
  }
  ...
  pub fn with_proxy_pypi(mut self, proxy_pypi: bool) -> RepositoryCreate {
    self.proxy_pypi = Some(proxy_pypi);
    self
  }
  ...
  pub fn with_raw_package_index_enabled(mut self, raw_package_index_enabled: bool) -> RepositoryCreate {
    self.raw_package_index_enabled = Some(raw_package_index_enabled);
    self
  }
  ...
  pub fn with_raw_package_index_signatures_enabled(mut self, raw_package_index_signatures_enabled: bool) -> RepositoryCreate {
    self.raw_package_index_signatures_enabled = Some(raw_package_index_signatures_enabled);
    self
  }
  ...
  pub fn with_replace_packages(mut self, replace_packages: String) -> RepositoryCreate {
    self.replace_packages = Some(replace_packages);
    self
  }
  ...
  pub fn with_replace_packages_by_default(mut self, replace_packages_by_default: bool) -> RepositoryCreate {
    self.replace_packages_by_default = Some(replace_packages_by_default);
    self
  }
  ...
  pub fn set_repository_type(&mut self, repository_type: i32) {
    self.repository_type = Some(repository_type);
  }

  pub fn with_repository_type(mut self, repository_type: i32) -> RepositoryCreate {
    self.repository_type = Some(repository_type);
    self
  }

  pub fn repository_type(&self) -> Option<&i32> {
    self.repository_type.as_ref()
  }

  pub fn reset_repository_type(&mut self) {
  ...
  pub fn with_repository_type_str(mut self, repository_type_str: String) -> RepositoryCreate {
    self.repository_type_str = Some(repository_type_str);
    self
  }
  ...
  pub fn with_resync_own(mut self, resync_own: bool) -> RepositoryCreate {
    self.resync_own = Some(resync_own);
    self
  }
  ...
  pub fn with_resync_packages(mut self, resync_packages: String) -> RepositoryCreate {
    self.resync_packages = Some(resync_packages);
    self
  }
  ...
  pub fn with_scan_own(mut self, scan_own: bool) -> RepositoryCreate {
    self.scan_own = Some(scan_own);
    self
  }
  ...
  pub fn with_scan_packages(mut self, scan_packages: String) -> RepositoryCreate {
    self.scan_packages = Some(scan_packages);
    self
  }
  ...
  pub fn with_self_html_url(mut self, self_html_url: String) -> RepositoryCreate {
    self.self_html_url = Some(self_html_url);
    self
  }
  ...
  pub fn with_self_url(mut self, self_url: String) -> RepositoryCreate {
    self.self_url = Some(self_url);
    self
  }
  ...
  pub fn with_show_setup_all(mut self, show_setup_all: bool) -> RepositoryCreate {
    self.show_setup_all = Some(show_setup_all);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> RepositoryCreate {
    self.size = Some(size);
    self
  }
  ...
  pub fn set_size_str(&mut self, size_str: String) {
    self.size_str = Some(size_str);
  }

  pub fn with_size_str(mut self, size_str: String) -> RepositoryCreate {
    self.size_str = Some(size_str);
    self
  }

  pub fn size_str(&self) -> Option<&String> {
    self.size_str.as_ref()
  }

  pub fn reset_size_str(&mut self) {
    self.size_str = None;
  }
  ...
  pub fn with_slug(mut self, slug: String) -> RepositoryCreate {
    self.slug = Some(slug);
    self
  }
  ...
  pub fn with_slug_perm(mut self, slug_perm: String) -> RepositoryCreate {
    self.slug_perm = Some(slug_perm);
    self
  }
  ...
  pub fn with_storage_region(mut self, storage_region: String) -> RepositoryCreate {
    self.storage_region = Some(storage_region);
    self
  }
  ...
  pub fn with_strict_npm_validation(mut self, strict_npm_validation: bool) -> RepositoryCreate {
    self.strict_npm_validation = Some(strict_npm_validation);
    self
  }
  ...
  pub fn with_tag_pre_releases_as_latest(mut self, tag_pre_releases_as_latest: bool) -> RepositoryCreate {
    self.tag_pre_releases_as_latest = Some(tag_pre_releases_as_latest);
    self
  }
  ...
  pub fn with_use_debian_labels(mut self, use_debian_labels: bool) -> RepositoryCreate {
    self.use_debian_labels = Some(use_debian_labels);
    self
  }
  ...
  pub fn with_use_default_cargo_upstream(mut self, use_default_cargo_upstream: bool) -> RepositoryCreate {
    self.use_default_cargo_upstream = Some(use_default_cargo_upstream);
    self
  }
  ...
  pub fn with_use_entitlements_privilege(mut self, use_entitlements_privilege: String) -> RepositoryCreate {
    self.use_entitlements_privilege = Some(use_entitlements_privilege);
    self
  }
  ...
  pub fn with_use_noarch_packages(mut self, use_noarch_packages: bool) -> RepositoryCreate {
    self.use_noarch_packages = Some(use_noarch_packages);
    self
  }
  ...
  pub fn with_use_source_packages(mut self, use_source_packages: bool) -> RepositoryCreate {
    self.use_source_packages = Some(use_source_packages);
    self
  }
  ...
  pub fn with_use_vulnerability_scanning(mut self, use_vulnerability_scanning: bool) -> RepositoryCreate {
    self.use_vulnerability_scanning = Some(use_vulnerability_scanning);
    self
  }
  ...
  pub fn with_user_entitlements_enabled(mut self, user_entitlements_enabled: bool) -> RepositoryCreate {
    self.user_entitlements_enabled = Some(user_entitlements_enabled);
    self
  }
  ...
  pub fn with_view_statistics(mut self, view_statistics: String) -> RepositoryCreate {
    self.view_statistics = Some(view_statistics);
    self
  }
