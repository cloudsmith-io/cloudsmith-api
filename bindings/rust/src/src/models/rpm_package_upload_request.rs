...
pub struct RpmPackageUploadRequest {
...
impl RpmPackageUploadRequest {
  pub fn new(distribution: String, package_file: String) -> RpmPackageUploadRequest {
  ...
  pub fn with_distribution(mut self, distribution: String) -> RpmPackageUploadRequest {
    self.distribution = distribution;
    self
  }
  ...
  pub fn with_package_file(mut self, package_file: String) -> RpmPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> RpmPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> RpmPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
