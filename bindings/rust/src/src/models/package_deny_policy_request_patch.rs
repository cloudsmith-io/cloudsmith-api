...
pub struct PackageDenyPolicyRequestPatch {
...
impl PackageDenyPolicyRequestPatch {
  pub fn new() -> PackageDenyPolicyRequestPatch {
  ...
  pub fn with_description(mut self, description: String) -> PackageDenyPolicyRequestPatch {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> PackageDenyPolicyRequestPatch {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> PackageDenyPolicyRequestPatch {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_package_query_string(mut self, package_query_string: String) -> PackageDenyPolicyRequestPatch {
    self.package_query_string = Some(package_query_string);
    self
  }
