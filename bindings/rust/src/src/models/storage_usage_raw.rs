...
impl StorageUsageRaw {
  pub fn new() -> StorageUsageRaw {
    StorageUsageRaw {
      limit: None,
      peak: None,
      percentage: None,
  ...
  pub fn with_limit(mut self, limit: i32) -> StorageUsageRaw {
    self.limit = Some(limit);
    self
  }
  ...
  pub fn with_peak(mut self, peak: i32) -> StorageUsageRaw {
    self.peak = Some(peak);
    self
  }
  ...
  pub fn with_percentage(mut self, percentage: String) -> StorageUsageRaw {
    self.percentage = Some(percentage);
    self
  }
  ...
  pub fn with_used(mut self, used: i32) -> StorageUsageRaw {
    self.used = Some(used);
    self
  }
