...
impl RpmUpstreamRequest {
  pub fn new(distro_version: String, name: String, upstream_url: String) -> RpmUpstreamRequest {
    RpmUpstreamRequest {
      auth_mode: None,
      auth_secret: None,
      auth_username: None,
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> RpmUpstreamRequest {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> RpmUpstreamRequest {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> RpmUpstreamRequest {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_distro_version(mut self, distro_version: String) -> RpmUpstreamRequest {
    self.distro_version = distro_version;
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> RpmUpstreamRequest {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> RpmUpstreamRequest {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> RpmUpstreamRequest {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> RpmUpstreamRequest {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_gpg_key_inline(mut self, gpg_key_inline: String) -> RpmUpstreamRequest {
    self.gpg_key_inline = Some(gpg_key_inline);
    self
  }
  ...
  pub fn with_gpg_key_url(mut self, gpg_key_url: String) -> RpmUpstreamRequest {
    self.gpg_key_url = Some(gpg_key_url);
    self
  }
  ...
  pub fn with_gpg_verification(mut self, gpg_verification: String) -> RpmUpstreamRequest {
    self.gpg_verification = Some(gpg_verification);
    self
  }
  ...
  pub fn with_include_sources(mut self, include_sources: bool) -> RpmUpstreamRequest {
    self.include_sources = Some(include_sources);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> RpmUpstreamRequest {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> RpmUpstreamRequest {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> RpmUpstreamRequest {
    self.name = name;
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> RpmUpstreamRequest {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> RpmUpstreamRequest {
    self.upstream_url = upstream_url;
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> RpmUpstreamRequest {
    self.verify_ssl = Some(verify_ssl);
    self
  }
