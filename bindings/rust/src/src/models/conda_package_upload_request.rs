...
pub struct CondaPackageUploadRequest {
...
impl CondaPackageUploadRequest {
  pub fn new(package_file: String) -> CondaPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> CondaPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> CondaPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> CondaPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
