...
pub struct CocoapodsPackageUploadRequest {
...
impl CocoapodsPackageUploadRequest {
  pub fn new(package_file: String) -> CocoapodsPackageUploadRequest {
  ...
  pub fn with_package_file(mut self, package_file: String) -> CocoapodsPackageUploadRequest {
    self.package_file = package_file;
    self
  }
  ...
  pub fn with_republish(mut self, republish: bool) -> CocoapodsPackageUploadRequest {
    self.republish = Some(republish);
    self
  }
  ...
  pub fn with_tags(mut self, tags: String) -> CocoapodsPackageUploadRequest {
    self.tags = Some(tags);
    self
  }
