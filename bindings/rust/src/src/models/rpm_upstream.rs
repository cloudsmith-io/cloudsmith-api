...
impl RpmUpstream {
  pub fn new(distro_version: String, name: String, upstream_url: String) -> RpmUpstream {
    RpmUpstream {
      auth_mode: None,
      auth_secret: None,
      auth_username: None,
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> RpmUpstream {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> RpmUpstream {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> RpmUpstream {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> RpmUpstream {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_disable_reason(mut self, disable_reason: String) -> RpmUpstream {
    self.disable_reason = Some(disable_reason);
    self
  }
  ...
  pub fn set_distro_version(&mut self, distro_version: String) {
    self.distro_version = distro_version;
  }

  pub fn with_distro_version(mut self, distro_version: String) -> RpmUpstream {
    self.distro_version = distro_version;
    self
  }

  pub fn distro_version(&self) -> &String {
    &self.distro_version
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> RpmUpstream {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> RpmUpstream {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> RpmUpstream {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> RpmUpstream {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_gpg_key_inline(mut self, gpg_key_inline: String) -> RpmUpstream {
    self.gpg_key_inline = Some(gpg_key_inline);
    self
  }
  ...
  pub fn with_gpg_key_url(mut self, gpg_key_url: String) -> RpmUpstream {
    self.gpg_key_url = Some(gpg_key_url);
    self
  }
  ...
  pub fn with_gpg_verification(mut self, gpg_verification: String) -> RpmUpstream {
    self.gpg_verification = Some(gpg_verification);
    self
  }
  ...
  pub fn with_include_sources(mut self, include_sources: bool) -> RpmUpstream {
    self.include_sources = Some(include_sources);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> RpmUpstream {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> RpmUpstream {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> RpmUpstream {
    self.name = name;
    self
  }
  ...
  pub fn with_pending_validation(mut self, pending_validation: bool) -> RpmUpstream {
    self.pending_validation = Some(pending_validation);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> RpmUpstream {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_slug_perm(mut self, slug_perm: String) -> RpmUpstream {
    self.slug_perm = Some(slug_perm);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> RpmUpstream {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> RpmUpstream {
    self.upstream_url = upstream_url;
    self
  }
  ...
  pub fn with_verification_status(mut self, verification_status: String) -> RpmUpstream {
    self.verification_status = Some(verification_status);
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> RpmUpstream {
    self.verify_ssl = Some(verify_ssl);
    self
  }
