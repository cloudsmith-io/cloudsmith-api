...
impl SwiftUpstream {
  pub fn new(name: String, upstream_url: String) -> SwiftUpstream {
    SwiftUpstream {
      auth_mode: None,
      auth_secret: None,
      auth_username: None,
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> SwiftUpstream {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> SwiftUpstream {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> SwiftUpstream {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> SwiftUpstream {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_disable_reason(mut self, disable_reason: String) -> SwiftUpstream {
    self.disable_reason = Some(disable_reason);
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> SwiftUpstream {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> SwiftUpstream {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> SwiftUpstream {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> SwiftUpstream {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> SwiftUpstream {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> SwiftUpstream {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> SwiftUpstream {
    self.name = name;
    self
  }
  ...
  pub fn with_pending_validation(mut self, pending_validation: bool) -> SwiftUpstream {
    self.pending_validation = Some(pending_validation);
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> SwiftUpstream {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_slug_perm(mut self, slug_perm: String) -> SwiftUpstream {
    self.slug_perm = Some(slug_perm);
    self
  }
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> SwiftUpstream {
    self.updated_at = Some(updated_at);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> SwiftUpstream {
    self.upstream_url = upstream_url;
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> SwiftUpstream {
    self.verify_ssl = Some(verify_ssl);
    self
  }
