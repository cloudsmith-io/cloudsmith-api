...
pub struct MavenUpstreamRequest {
...
impl MavenUpstreamRequest {
  pub fn new(name: String, upstream_url: String) -> MavenUpstreamRequest {
  ...
  pub fn with_auth_mode(mut self, auth_mode: String) -> MavenUpstreamRequest {
    self.auth_mode = Some(auth_mode);
    self
  }
  ...
  pub fn with_auth_secret(mut self, auth_secret: String) -> MavenUpstreamRequest {
    self.auth_secret = Some(auth_secret);
    self
  }
  ...
  pub fn with_auth_username(mut self, auth_username: String) -> MavenUpstreamRequest {
    self.auth_username = Some(auth_username);
    self
  }
  ...
  pub fn with_extra_header_1(mut self, extra_header_1: String) -> MavenUpstreamRequest {
    self.extra_header_1 = Some(extra_header_1);
    self
  }
  ...
  pub fn with_extra_header_2(mut self, extra_header_2: String) -> MavenUpstreamRequest {
    self.extra_header_2 = Some(extra_header_2);
    self
  }
  ...
  pub fn with_extra_value_1(mut self, extra_value_1: String) -> MavenUpstreamRequest {
    self.extra_value_1 = Some(extra_value_1);
    self
  }
  ...
  pub fn with_extra_value_2(mut self, extra_value_2: String) -> MavenUpstreamRequest {
    self.extra_value_2 = Some(extra_value_2);
    self
  }
  ...
  pub fn with_gpg_key_inline(mut self, gpg_key_inline: String) -> MavenUpstreamRequest {
    self.gpg_key_inline = Some(gpg_key_inline);
    self
  }
  ...
  pub fn with_gpg_key_url(mut self, gpg_key_url: String) -> MavenUpstreamRequest {
    self.gpg_key_url = Some(gpg_key_url);
    self
  }
  ...
  pub fn with_gpg_verification(mut self, gpg_verification: String) -> MavenUpstreamRequest {
    self.gpg_verification = Some(gpg_verification);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> MavenUpstreamRequest {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_mode(mut self, mode: String) -> MavenUpstreamRequest {
    self.mode = Some(mode);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> MavenUpstreamRequest {
    self.name = name;
    self
  }
  ...
  pub fn with_priority(mut self, priority: i32) -> MavenUpstreamRequest {
    self.priority = Some(priority);
    self
  }
  ...
  pub fn with_upstream_url(mut self, upstream_url: String) -> MavenUpstreamRequest {
    self.upstream_url = upstream_url;
    self
  }
  ...
  pub fn with_verify_ssl(mut self, verify_ssl: bool) -> MavenUpstreamRequest {
    self.verify_ssl = Some(verify_ssl);
    self
  }
