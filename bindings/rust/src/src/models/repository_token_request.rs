...
pub struct RepositoryTokenRequest {
...
impl RepositoryTokenRequest {
  pub fn new(name: String) -> RepositoryTokenRequest {
  ...
  pub fn with_eula_required(mut self, eula_required: bool) -> RepositoryTokenRequest {
    self.eula_required = Some(eula_required);
    self
  }
  ...
  pub fn with_is_active(mut self, is_active: bool) -> RepositoryTokenRequest {
    self.is_active = Some(is_active);
    self
  }
  ...
  pub fn with_limit_bandwidth(mut self, limit_bandwidth: i32) -> RepositoryTokenRequest {
    self.limit_bandwidth = Some(limit_bandwidth);
    self
  }
  ...
  pub fn with_limit_bandwidth_unit(mut self, limit_bandwidth_unit: String) -> RepositoryTokenRequest {
    self.limit_bandwidth_unit = Some(limit_bandwidth_unit);
    self
  }
  ...
  pub fn with_limit_date_range_from(mut self, limit_date_range_from: String) -> RepositoryTokenRequest {
    self.limit_date_range_from = Some(limit_date_range_from);
    self
  }
  ...
  pub fn with_limit_date_range_to(mut self, limit_date_range_to: String) -> RepositoryTokenRequest {
    self.limit_date_range_to = Some(limit_date_range_to);
    self
  }
  ...
  pub fn with_limit_num_clients(mut self, limit_num_clients: i32) -> RepositoryTokenRequest {
    self.limit_num_clients = Some(limit_num_clients);
    self
  }
  ...
  pub fn with_limit_num_downloads(mut self, limit_num_downloads: i32) -> RepositoryTokenRequest {
    self.limit_num_downloads = Some(limit_num_downloads);
    self
  }
  ...
  pub fn with_limit_package_query(mut self, limit_package_query: String) -> RepositoryTokenRequest {
    self.limit_package_query = Some(limit_package_query);
    self
  }
  ...
  pub fn with_limit_path_query(mut self, limit_path_query: String) -> RepositoryTokenRequest {
    self.limit_path_query = Some(limit_path_query);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: Value) -> RepositoryTokenRequest {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> RepositoryTokenRequest {
    self.name = name;
    self
  }
  ...
  pub fn with_scheduled_reset_at(mut self, scheduled_reset_at: String) -> RepositoryTokenRequest {
    self.scheduled_reset_at = Some(scheduled_reset_at);
    self
  }
  ...
  pub fn with_scheduled_reset_period(mut self, scheduled_reset_period: String) -> RepositoryTokenRequest {
    self.scheduled_reset_period = Some(scheduled_reset_period);
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> RepositoryTokenRequest {
    self.token = Some(token);
    self
  }
