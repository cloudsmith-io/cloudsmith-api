...
impl NpmPackageUpload {
  pub fn new() -> NpmPackageUpload {
    NpmPackageUpload {
      architectures: None,
      cdn_url: None,
      checksum_md5: None,
  ...
  pub fn with_architectures(mut self, architectures: Vec<::models::Architecture>) -> NpmPackageUpload {
    self.architectures = Some(architectures);
    self
  }
  ...
  pub fn with_cdn_url(mut self, cdn_url: String) -> NpmPackageUpload {
    self.cdn_url = Some(cdn_url);
    self
  }
  ...
  pub fn with_checksum_md5(mut self, checksum_md5: String) -> NpmPackageUpload {
    self.checksum_md5 = Some(checksum_md5);
    self
  }
  ...
  pub fn with_checksum_sha1(mut self, checksum_sha1: String) -> NpmPackageUpload {
    self.checksum_sha1 = Some(checksum_sha1);
    self
  }
  ...
  pub fn with_checksum_sha256(mut self, checksum_sha256: String) -> NpmPackageUpload {
    self.checksum_sha256 = Some(checksum_sha256);
    self
  }
  ...
  pub fn with_checksum_sha512(mut self, checksum_sha512: String) -> NpmPackageUpload {
    self.checksum_sha512 = Some(checksum_sha512);
    self
  }
  ...
  pub fn with_dependencies_checksum_md5(mut self, dependencies_checksum_md5: String) -> NpmPackageUpload {
    self.dependencies_checksum_md5 = Some(dependencies_checksum_md5);
    self
  }
  ...
  pub fn with_dependencies_url(mut self, dependencies_url: String) -> NpmPackageUpload {
    self.dependencies_url = Some(dependencies_url);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> NpmPackageUpload {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_display_name(mut self, display_name: String) -> NpmPackageUpload {
    self.display_name = Some(display_name);
    self
  }
  ...
  pub fn with_distro(mut self, distro: ::models::Distribution) -> NpmPackageUpload {
    self.distro = Some(distro);
    self
  }
  ...
  pub fn with_distro_version(mut self, distro_version: ::models::DistributionVersion) -> NpmPackageUpload {
    self.distro_version = Some(distro_version);
    self
  }
  ...
  pub fn with_downloads(mut self, downloads: i32) -> NpmPackageUpload {
    self.downloads = Some(downloads);
    self
  }
  ...
  pub fn with_epoch(mut self, epoch: i32) -> NpmPackageUpload {
    self.epoch = Some(epoch);
    self
  }
  ...
  pub fn with_extension(mut self, extension: String) -> NpmPackageUpload {
    self.extension = Some(extension);
    self
  }
  ...
  pub fn with_filename(mut self, filename: String) -> NpmPackageUpload {
    self.filename = Some(filename);
    self
  }
  ...
  pub fn with_files(mut self, files: Vec<::models::PackageFile>) -> NpmPackageUpload {
    self.files = Some(files);
    self
  }
  ...
  pub fn with_format(mut self, format: String) -> NpmPackageUpload {
    self.format = Some(format);
    self
  }
  ...
  pub fn with_format_url(mut self, format_url: String) -> NpmPackageUpload {
    self.format_url = Some(format_url);
    self
  }
  ...
  pub fn with_freeable_storage(mut self, freeable_storage: i32) -> NpmPackageUpload {
    self.freeable_storage = Some(freeable_storage);
    self
  }
  ...
  pub fn with_fully_qualified_name(mut self, fully_qualified_name: String) -> NpmPackageUpload {
    self.fully_qualified_name = Some(fully_qualified_name);
    self
  }
  ...
  pub fn with_identifier_perm(mut self, identifier_perm: String) -> NpmPackageUpload {
    self.identifier_perm = Some(identifier_perm);
    self
  }
  ...
  pub fn with_identifiers(mut self, identifiers: ::std::collections::HashMap<String, String>) -> NpmPackageUpload {
    self.identifiers = Some(identifiers);
    self
  }
  ...
  pub fn with_indexed(mut self, indexed: bool) -> NpmPackageUpload {
    self.indexed = Some(indexed);
    self
  }
  ...
  pub fn with_is_cancellable(mut self, is_cancellable: bool) -> NpmPackageUpload {
    self.is_cancellable = Some(is_cancellable);
    self
  }
  ...
  pub fn with_is_copyable(mut self, is_copyable: bool) -> NpmPackageUpload {
    self.is_copyable = Some(is_copyable);
    self
  }
  ...
  pub fn with_is_deleteable(mut self, is_deleteable: bool) -> NpmPackageUpload {
    self.is_deleteable = Some(is_deleteable);
    self
  }
  ...
  pub fn with_is_downloadable(mut self, is_downloadable: bool) -> NpmPackageUpload {
    self.is_downloadable = Some(is_downloadable);
    self
  }
  ...
  pub fn with_is_moveable(mut self, is_moveable: bool) -> NpmPackageUpload {
    self.is_moveable = Some(is_moveable);
    self
  }
  ...
  pub fn with_is_quarantinable(mut self, is_quarantinable: bool) -> NpmPackageUpload {
    self.is_quarantinable = Some(is_quarantinable);
    self
  }
  ...
  pub fn with_is_quarantined(mut self, is_quarantined: bool) -> NpmPackageUpload {
    self.is_quarantined = Some(is_quarantined);
    self
  }
  ...
  pub fn with_is_resyncable(mut self, is_resyncable: bool) -> NpmPackageUpload {
    self.is_resyncable = Some(is_resyncable);
    self
  }
  ...
  pub fn with_is_security_scannable(mut self, is_security_scannable: bool) -> NpmPackageUpload {
    self.is_security_scannable = Some(is_security_scannable);
    self
  }
  ...
  pub fn with_is_sync_awaiting(mut self, is_sync_awaiting: bool) -> NpmPackageUpload {
    self.is_sync_awaiting = Some(is_sync_awaiting);
    self
  }
  ...
  pub fn with_is_sync_completed(mut self, is_sync_completed: bool) -> NpmPackageUpload {
    self.is_sync_completed = Some(is_sync_completed);
    self
  }
  ...
  pub fn with_is_sync_failed(mut self, is_sync_failed: bool) -> NpmPackageUpload {
    self.is_sync_failed = Some(is_sync_failed);
    self
  }
  ...
  pub fn with_is_sync_in_flight(mut self, is_sync_in_flight: bool) -> NpmPackageUpload {
    self.is_sync_in_flight = Some(is_sync_in_flight);
    self
  }
  ...
  pub fn with_is_sync_in_progress(mut self, is_sync_in_progress: bool) -> NpmPackageUpload {
    self.is_sync_in_progress = Some(is_sync_in_progress);
    self
  }
  ...
  pub fn with_license(mut self, license: String) -> NpmPackageUpload {
    self.license = Some(license);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> NpmPackageUpload {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_namespace(mut self, namespace: String) -> NpmPackageUpload {
    self.namespace = Some(namespace);
    self
  }
  ...
  pub fn with_namespace_url(mut self, namespace_url: String) -> NpmPackageUpload {
    self.namespace_url = Some(namespace_url);
    self
  }
  ...
  pub fn with_num_files(mut self, num_files: i32) -> NpmPackageUpload {
    self.num_files = Some(num_files);
    self
  }
  ...
  pub fn with_origin_repository(mut self, origin_repository: String) -> NpmPackageUpload {
    self.origin_repository = Some(origin_repository);
    self
  }
  ...
  pub fn with_origin_repository_url(mut self, origin_repository_url: String) -> NpmPackageUpload {
    self.origin_repository_url = Some(origin_repository_url);
    self
  }
  ...
  pub fn with_policy_violated(mut self, policy_violated: bool) -> NpmPackageUpload {
    self.policy_violated = Some(policy_violated);
    self
  }
  ...
  pub fn with_release(mut self, release: String) -> NpmPackageUpload {
    self.release = Some(release);
    self
  }
  ...
  pub fn with_repository(mut self, repository: String) -> NpmPackageUpload {
    self.repository = Some(repository);
    self
  }
  ...
  pub fn with_repository_url(mut self, repository_url: String) -> NpmPackageUpload {
    self.repository_url = Some(repository_url);
    self
  }
  ...
  pub fn with_security_scan_completed_at(mut self, security_scan_completed_at: String) -> NpmPackageUpload {
    self.security_scan_completed_at = Some(security_scan_completed_at);
    self
  }
  ...
  pub fn with_security_scan_started_at(mut self, security_scan_started_at: String) -> NpmPackageUpload {
    self.security_scan_started_at = Some(security_scan_started_at);
    self
  }
  ...
  pub fn with_security_scan_status(mut self, security_scan_status: String) -> NpmPackageUpload {
    self.security_scan_status = Some(security_scan_status);
    self
  }
  ...
  pub fn with_security_scan_status_updated_at(mut self, security_scan_status_updated_at: String) -> NpmPackageUpload {
    self.security_scan_status_updated_at = Some(security_scan_status_updated_at);
    self
  }
  ...
  pub fn with_self_html_url(mut self, self_html_url: String) -> NpmPackageUpload {
    self.self_html_url = Some(self_html_url);
    self
  }
  ...
  pub fn with_self_url(mut self, self_url: String) -> NpmPackageUpload {
    self.self_url = Some(self_url);
    self
  }
  ...
  pub fn with_signature_url(mut self, signature_url: String) -> NpmPackageUpload {
    self.signature_url = Some(signature_url);
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> NpmPackageUpload {
    self.size = Some(size);
    self
  }
  ...
  pub fn with_slug(mut self, slug: String) -> NpmPackageUpload {
    self.slug = Some(slug);
    self
  }
  ...
  pub fn with_slug_perm(mut self, slug_perm: String) -> NpmPackageUpload {
    self.slug_perm = Some(slug_perm);
    self
  }
  ...
  pub fn with_stage(mut self, stage: i32) -> NpmPackageUpload {
    self.stage = Some(stage);
    self
  }
  ...
  pub fn with_stage_str(mut self, stage_str: String) -> NpmPackageUpload {
    self.stage_str = Some(stage_str);
    self
  }
  ...
  pub fn with_stage_updated_at(mut self, stage_updated_at: String) -> NpmPackageUpload {
    self.stage_updated_at = Some(stage_updated_at);
    self
  }
  ...
  pub fn with_status(mut self, status: i32) -> NpmPackageUpload {
    self.status = Some(status);
    self
  }
  ...
  pub fn with_status_reason(mut self, status_reason: String) -> NpmPackageUpload {
    self.status_reason = Some(status_reason);
    self
  }
  ...
  pub fn with_status_str(mut self, status_str: String) -> NpmPackageUpload {
    self.status_str = Some(status_str);
    self
  }
  ...
  pub fn with_status_updated_at(mut self, status_updated_at: String) -> NpmPackageUpload {
    self.status_updated_at = Some(status_updated_at);
    self
  }
  ...
  pub fn with_status_url(mut self, status_url: String) -> NpmPackageUpload {
    self.status_url = Some(status_url);
    self
  }
  ...
  pub fn with_subtype(mut self, subtype: String) -> NpmPackageUpload {
    self.subtype = Some(subtype);
    self
  }
  ...
  pub fn with_summary(mut self, summary: String) -> NpmPackageUpload {
    self.summary = Some(summary);
    self
  }
  ...
  pub fn with_sync_finished_at(mut self, sync_finished_at: String) -> NpmPackageUpload {
    self.sync_finished_at = Some(sync_finished_at);
    self
  }
  ...
  pub fn with_sync_progress(mut self, sync_progress: i32) -> NpmPackageUpload {
    self.sync_progress = Some(sync_progress);
    self
  }
  ...
  pub fn with_tags_immutable(mut self, tags_immutable: ::models::Tags) -> NpmPackageUpload {
    self.tags_immutable = Some(tags_immutable);
    self
  }
  ...
  pub fn with_type_display(mut self, type_display: String) -> NpmPackageUpload {
    self.type_display = Some(type_display);
    self
  }
  ...
  pub fn with_uploaded_at(mut self, uploaded_at: String) -> NpmPackageUpload {
    self.uploaded_at = Some(uploaded_at);
    self
  }
  ...
  pub fn with_uploader(mut self, uploader: String) -> NpmPackageUpload {
    self.uploader = Some(uploader);
    self
  }
  ...
  pub fn with_uploader_url(mut self, uploader_url: String) -> NpmPackageUpload {
    self.uploader_url = Some(uploader_url);
    self
  }
  ...
  pub fn with_version(mut self, version: String) -> NpmPackageUpload {
    self.version = Some(version);
    self
  }
  ...
  pub fn with_version_orig(mut self, version_orig: String) -> NpmPackageUpload {
    self.version_orig = Some(version_orig);
    self
  }
  ...
  pub fn with_vulnerability_scan_results_url(mut self, vulnerability_scan_results_url: String) -> NpmPackageUpload {
    self.vulnerability_scan_results_url = Some(vulnerability_scan_results_url);
    self
  }
