...
pub trait UsersApi {
    fn users_profile_read(&self, slug: &str) -> Box<Future<Item = ::models::UserProfile, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>UsersApi for UsersApiClient<C> {
    fn users_profile_read(&self, slug: &str) -> Box<Future<Item = ::models::UserProfile, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/users/profile/{slug}/?{}", configuration.base_path, query_string, slug=slug);
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::UserProfile, _> = serde_json::from_slice(&body);
