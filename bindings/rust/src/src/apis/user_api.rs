...
pub trait UserApi {
    fn user_self(&self, ) -> Box<Future<Item = ::models::UserBrief, Error = Error<serde_json::Value>>>;
    fn user_token_create(&self, data: ::models::UserAuthTokenRequest) -> Box<Future<Item = ::models::UserAuthToken, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>UserApi for UserApiClient<C> {
    fn user_self(&self, ) -> Box<Future<Item = ::models::UserBrief, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::UserBrief, _> = serde_json::from_slice(&body);
    ...
    fn user_token_create(&self, data: ::models::UserAuthTokenRequest) -> Box<Future<Item = ::models::UserAuthToken, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::UserAuthToken, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
