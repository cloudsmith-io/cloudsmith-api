...
pub trait NamespacesApi {
    fn namespaces_list(&self, page: i32, page_size: i32) -> Box<Future<Item = Vec<::models::Namespace>, Error = Error<serde_json::Value>>>;
    fn namespaces_read(&self, slug: &str) -> Box<Future<Item = ::models::Namespace, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>NamespacesApi for NamespacesApiClient<C> {
    fn namespaces_list(&self, page: i32, page_size: i32) -> Box<Future<Item = Vec<::models::Namespace>, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/namespaces/?{}", configuration.base_path, query_string);
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<Vec<::models::Namespace>, _> = serde_json::from_slice(&body);
    ...
    fn namespaces_read(&self, slug: &str) -> Box<Future<Item = ::models::Namespace, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/namespaces/{slug}/?{}", configuration.base_path, query_string, slug=slug);
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::Namespace, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
