...
pub trait WebhooksApi {
    fn webhooks_create(&self, owner: &str, repo: &str, data: ::models::RepositoryWebhookRequest) -> Box<Future<Item = ::models::RepositoryWebhook, Error = Error<serde_json::Value>>>;
    fn webhooks_delete(&self, owner: &str, repo: &str, identifier: &str) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn webhooks_list(&self, owner: &str, repo: &str, page: i32, page_size: i32) -> Box<Future<Item = Vec<::models::RepositoryWebhook>, Error = Error<serde_json::Value>>>;
    fn webhooks_partial_update(&self, owner: &str, repo: &str, identifier: &str, data: ::models::RepositoryWebhookRequestPatch) -> Box<Future<Item = ::models::RepositoryWebhook, Error = Error<serde_json::Value>>>;
    fn webhooks_read(&self, owner: &str, repo: &str, identifier: &str) -> Box<Future<Item = ::models::RepositoryWebhook, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>WebhooksApi for WebhooksApiClient<C> {
    fn webhooks_create(&self, owner: &str, repo: &str, data: ::models::RepositoryWebhookRequest) -> Box<Future<Item = ::models::RepositoryWebhook, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::RepositoryWebhook, _> = serde_json::from_slice(&body);
    ...
    fn webhooks_list(&self, owner: &str, repo: &str, page: i32, page_size: i32) -> Box<Future<Item = Vec<::models::RepositoryWebhook>, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<Vec<::models::RepositoryWebhook>, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
