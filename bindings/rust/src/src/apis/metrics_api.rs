...
pub trait MetricsApi {
    fn metrics_entitlements_account_list(&self, owner: &str, page: i32, page_size: i32, finish: &str, start: &str, tokens: &str) -> Box<Future<Item = ::models::EntitlementUsageMetrics, Error = Error<serde_json::Value>>>;
    fn metrics_entitlements_repo_list(&self, owner: &str, repo: &str, page: i32, page_size: i32, finish: &str, start: &str, tokens: &str) -> Box<Future<Item = ::models::EntitlementUsageMetrics, Error = Error<serde_json::Value>>>;
    fn metrics_packages_list(&self, owner: &str, repo: &str, page: i32, page_size: i32, finish: &str, packages: &str, start: &str) -> Box<Future<Item = ::models::PackageUsageMetrics, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>MetricsApi for MetricsApiClient<C> {
    fn metrics_entitlements_account_list(&self, owner: &str, page: i32, page_size: i32, finish: &str, start: &str, tokens: &str) -> Box<Future<Item = ::models::EntitlementUsageMetrics, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::EntitlementUsageMetrics, _> = serde_json::from_slice(&body);
    ...
    fn metrics_packages_list(&self, owner: &str, repo: &str, page: i32, page_size: i32, finish: &str, packages: &str, start: &str) -> Box<Future<Item = ::models::PackageUsageMetrics, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::PackageUsageMetrics, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
