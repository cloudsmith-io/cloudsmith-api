...
**component** | **String** | The component to fetch from the upstream | [optional] [default to null]
**distro_versions** | **Vec<String>** | The distribution version that packages found on this upstream could be associated with. | [optional] [default to null]
...
**include_sources** | **bool** | When true, source packages will be available from this upstream. | [optional] [default to null]
...
**upstream_distribution** | **String** | The distribution to fetch from the upstream | [optional] [default to null]
